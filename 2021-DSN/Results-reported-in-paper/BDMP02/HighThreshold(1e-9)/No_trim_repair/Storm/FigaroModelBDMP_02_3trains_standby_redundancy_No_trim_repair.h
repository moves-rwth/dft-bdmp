    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_BDMP_02_3trains_standby_redundancy_No_trim_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_BDMP_02_3trains_standby_redundancy_No_trim_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_1" , 0},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
            ...
            bool FIRE_xx11_OF_A_op;
            bool FIRE_xx23_OF_A_start_INS_2;
            bool FIRE_xx23_OF_A_start_INS_3;
            bool FIRE_xx24_OF_A_start;
            bool FIRE_xx10_OF_B_op;
            bool FIRE_xx11_OF_B_op;
            bool FIRE_xx10_OF_C_fail;
            bool FIRE_xx11_OF_C_fail;
            bool FIRE_xx23_OF_C_start_INS_9;
            bool FIRE_xx23_OF_C_start_INS_10;
            bool FIRE_xx24_OF_C_start;
            bool FIRE_xx10_OF_P_op;
            bool FIRE_xx11_OF_P_op;
