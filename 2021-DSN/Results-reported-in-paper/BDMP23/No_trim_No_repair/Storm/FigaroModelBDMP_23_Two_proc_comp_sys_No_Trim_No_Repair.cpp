#include <iostream>
#include "FigaroModelBDMP_23_Two_proc_comp_sys_No_Trim_No_Repair.h"
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::init()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_D12] == false) && (boolState[required_OF_D12] && ( !boolState[failS_OF_D12])))
	{
		//cout << "1 : xx17_OF_D12 : FAULT failF  LABEL \"failure in operation D12\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_D12]  =  TRUE" << endl;
		list.push_back(make_tuple(1, 0.0001, "EXP", 0));
	}
	if ((boolState[failS_OF_D12] == false) && (( !boolState[required_OF_D12]) && ( !boolState[failF_OF_D12])))
	{
		//cout << "2 : xx18_OF_D12 : FAULT failS  LABEL \"standby failure D12\"  DIST EXP (1e-05)  INDUCING boolState[failS_OF_D12]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 1e-05, "EXP", 0));
	}
	if ((boolState[failF_OF_D21] == false) && boolState[required_OF_D21])
	{
		//cout << "3 : xx10_OF_D21 : FAULT failF  LABEL \"failure in operation D21\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_D21]  =  TRUE" << endl;
		list.push_back(make_tuple(3, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_D22] == false) && (boolState[required_OF_D22] && ( !boolState[failS_OF_D22])))
	{
		//cout << "4 : xx17_OF_D22 : FAULT failF  LABEL \"failure in operation D22\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_D22]  =  TRUE" << endl;
		list.push_back(make_tuple(4, 0.0001, "EXP", 0));
	}
	if ((boolState[failS_OF_D22] == false) && (( !boolState[required_OF_D22]) && ( !boolState[failF_OF_D22])))
	{
		//cout << "5 : xx18_OF_D22 : FAULT failS  LABEL \"standby failure D22\"  DIST EXP (1e-05)  INDUCING boolState[failS_OF_D22]  =  TRUE" << endl;
		list.push_back(make_tuple(5, 1e-05, "EXP", 0));
	}
	if ((boolState[failF_OF_M1] == false) && boolState[required_OF_M1])
	{
		//cout << "6 : xx10_OF_M1 : FAULT failF  LABEL \"failure in operation M1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_M1]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_M2] == false) && boolState[required_OF_M2])
	{
		//cout << "7 : xx10_OF_M2 : FAULT failF  LABEL \"failure in operation M2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_M2]  =  TRUE" << endl;
		list.push_back(make_tuple(7, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_M3] == false) && (boolState[required_OF_M3] && ( !boolState[failS_OF_M3])))
	{
		//cout << "8 : xx17_OF_M3 : FAULT failF  LABEL \"failure in operation M3\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_M3]  =  TRUE" << endl;
		list.push_back(make_tuple(8, 0.0001, "EXP", 0));
	}
	if ((boolState[failS_OF_M3] == false) && (( !boolState[required_OF_M3]) && ( !boolState[failF_OF_M3])))
	{
		//cout << "9 : xx18_OF_M3 : FAULT failS  LABEL \"standby failure M3\"  DIST EXP (1e-05)  INDUCING boolState[failS_OF_M3]  =  TRUE" << endl;
		list.push_back(make_tuple(9, 1e-05, "EXP", 0));
	}
	if ((boolState[failF_OF_N] == false) && boolState[required_OF_N])
	{
		//cout << "10 : xx10_OF_N : FAULT failF  LABEL \"failure in operation N\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_N]  =  TRUE" << endl;
		list.push_back(make_tuple(10, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_PS] == false) && boolState[required_OF_PS])
	{
		//cout << "11 : xx10_OF_PS : FAULT failF  LABEL \"failure in operation PS\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_PS]  =  TRUE" << endl;
		list.push_back(make_tuple(11, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_Pa] == false) && boolState[required_OF_Pa])
	{
		//cout << "12 : xx10_OF_Pa : FAULT failF  LABEL \"failure in operation Pa\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Pa]  =  TRUE" << endl;
		list.push_back(make_tuple(12, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_Pb] == false) && boolState[required_OF_Pb])
	{
		//cout << "13 : xx10_OF_Pb : FAULT failF  LABEL \"failure in operation Pb\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Pb]  =  TRUE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_No_Trim_No_Repair::fireinsttransitiongroup(std::string user_input_ins)
