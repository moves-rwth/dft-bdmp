    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
            ...
            bool FIRE_xx23_OF_RS_dies_INS_12;
            bool FIRE_xx23_OF_RS_dies_INS_13;
