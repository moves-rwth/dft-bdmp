#include <iostream>
#include "FigaroModelBDMP_04_Demoeng_No_trim_No_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::init()
{
	...
	FIRE_xx23_OF_RS_dies_INS_12 = false;
	FIRE_xx23_OF_RS_dies_INS_13 = false;
...
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 12)
	{
		FIRE_xx23_OF_RS_dies_INS_12 = true;
	}

	if (numFire == 13)
	{
		FIRE_xx23_OF_RS_dies_INS_13 = true;
	}
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failI_OF_RS_dies] == false) && boolState[to_be_fired_OF_RS_dies]) 
	{
		...
		if (FIRE_xx23_OF_RS_dies_INS_12) 
		{
	...
	if ((boolState[failI_OF_RS_dies] == false) && boolState[to_be_fired_OF_RS_dies]) 
	{
		...
		if (FIRE_xx23_OF_RS_dies_INS_13) 
		{
			boolState[already_standby_OF_RS_dies]  =  false;
			boolState[already_required_OF_RS_dies]  =  false;
			FIRE_xx23_OF_RS_dies_INS_13 = false;
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::showFireableOccurrences()
{
	...
	if ((boolState[failI_OF_RS_dies] == false) && boolState[to_be_fired_OF_RS_dies])
	{
		//cout << "12 :  INS_SUB_COUNT (4) |FAULT | failI  LABEL \"instantaneous failure RS_dies\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_RS_dies]  =  TRUE,already_standby_OF_RS_dies  =  FALSE,already_required_OF_RS_dies  =  FALSE" << endl;
		list.push_back(make_tuple(12, 0.0001, "INS", 4));
	}
	if ((boolState[failI_OF_RS_dies] == false) && boolState[to_be_fired_OF_RS_dies])
	{
		//cout << "13 :  INS_SUB_COUNT (4) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_RS_dies]  =  FALSE,already_required_OF_RS_dies  =  FALSE" << endl;
	...
	if ((boolState[failF_OF_Transfo1] == false) && boolState[required_OF_Transfo1])
	{
		//cout << "14 : xx10_OF_Transfo1 : FAULT failF  LABEL \"failure in operation Transfo1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Transfo1]  =  TRUE" << endl;
		list.push_back(make_tuple(14, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_Transfo2] == false) && boolState[required_OF_Transfo2])
	{
		//cout << "15 : xx10_OF_Transfo2 : FAULT failF  LABEL \"failure in operation Transfo2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Transfo2]  =  TRUE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_04_Demoeng_No_trim_No_repair::fireinsttransitiongroup(std::string user_input_ins)
