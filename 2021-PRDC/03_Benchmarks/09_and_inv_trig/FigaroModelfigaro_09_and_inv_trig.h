    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_figaro_09_and_inv_trig: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_figaro_09_and_inv_trig(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_1" , 0},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
			...
			std::string const calculate_required_OF_F_2 = "fn_fathers_opp_trig";
			...
			std::string const trigger_kind_OF_t_1 = "fn_fathers_opp_trig";
