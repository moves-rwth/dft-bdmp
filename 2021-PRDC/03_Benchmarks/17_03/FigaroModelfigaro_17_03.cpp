#include <iostream>
#include "FigaroModelfigaro_17_03.h"
...
void storm::figaro::FigaroProgram_figaro_17_03::init()
{
	...
	FIRE_xx23_OF_A2_INS_2 = false;
	FIRE_xx23_OF_A2_INS_3 = false;
	...
	FIRE_xx23_OF_A6_INS_12 = false;
	FIRE_xx23_OF_A6_INS_13 = false;
...
void storm::figaro::FigaroProgram_figaro_17_03::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_03::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_03::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_03::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_figaro_17_03::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_03::fireOccurrence(int numFire)
{
	...
	if (numFire == 2)
	{
		FIRE_xx23_OF_A2_INS_2 = true;
	}

	if (numFire == 3)
	{
		FIRE_xx23_OF_A2_INS_3 = true;
	}
	...
	if (numFire == 12)
	{
		FIRE_xx23_OF_A6_INS_12 = true;
	}

	if (numFire == 13)
	{
		FIRE_xx23_OF_A6_INS_13 = true;
	}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_03::showFireableOccurrences()
{
	...
	if ((boolState[failI_OF_A2] == false) && boolState[to_be_fired_OF_A2])
	{
		//cout << "2 :  INS_SUB_COUNT (1) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.01) | INDUCING boolState[failI_OF_A2]  =  TRUE,already_standby_OF_A2  =  FALSE,already_required_OF_A2  =  FALSE" << endl;
		list.push_back(make_tuple(2, 0.01, "INS", 1));
	}
	if ((boolState[failI_OF_A2] == false) && boolState[to_be_fired_OF_A2])
	{
		//cout << "3 :  INS_SUB_COUNT (1) |TRANSITION | good | DIST INS (0.99) | INDUCING boolState[already_standby_OF_A2]  =  FALSE,already_required_OF_A2  =  FALSE" << endl;
		list.push_back(make_tuple(3, 0.99, "INS", 1));
	}
	if ((boolState[failI_OF_A4] == false) && boolState[to_be_fired_OF_A4])
	{
		//cout << "7 :  INS_SUB_COUNT (2) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.01) | INDUCING boolState[failI_OF_A4]  =  TRUE,already_standby_OF_A4  =  FALSE,already_required_OF_A4  =  FALSE" << endl;
		list.push_back(make_tuple(7, 0.01, "INS", 2));
	}
	if ((boolState[failI_OF_A4] == false) && boolState[to_be_fired_OF_A4])
	{
		//cout << "8 :  INS_SUB_COUNT (2) |TRANSITION | good | DIST INS (0.99) | INDUCING boolState[already_standby_OF_A4]  =  FALSE,already_required_OF_A4  =  FALSE" << endl;
		list.push_back(make_tuple(8, 0.99, "INS", 2));
	}
	if ((boolState[failI_OF_A6] == false) && boolState[to_be_fired_OF_A6])
	{
		//cout << "12 :  INS_SUB_COUNT (3) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.01) | INDUCING boolState[failI_OF_A6]  =  TRUE,already_standby_OF_A6  =  FALSE,already_required_OF_A6  =  FALSE" << endl;
		list.push_back(make_tuple(12, 0.01, "INS", 3));
	}
	if ((boolState[failI_OF_A6] == false) && boolState[to_be_fired_OF_A6])
	{
		//cout << "13 :  INS_SUB_COUNT (3) |TRANSITION | good | DIST INS (0.99) | INDUCING boolState[already_standby_OF_A6]  =  FALSE,already_required_OF_A6  =  FALSE" << endl;
		list.push_back(make_tuple(13, 0.99, "INS", 3));
	}
        if (list.size() > 0)
        {
	...
	if (boolState[failI_OF_A2] == true)
	{
		//cout << "4 : xx24_OF_A2 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_A2]  =  FALSE" << endl;
		list.push_back(make_tuple(4, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A3] == false) && boolState[required_OF_A3])
	{
		//cout << "5 : xx10_OF_A3 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A3]  =  TRUE" << endl;
		list.push_back(make_tuple(5, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A3] == true)
	{
		//cout << "6 : xx11_OF_A3 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A3]  =  FALSE" << endl;
	...
	if ((boolState[failF_OF_A5] == false) && boolState[required_OF_A5])
	{
		//cout << "10 : xx10_OF_A5 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A5]  =  TRUE" << endl;
		list.push_back(make_tuple(10, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A5] == true)
	{
		//cout << "11 : xx11_OF_A5 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A5]  =  FALSE" << endl;
		list.push_back(make_tuple(11, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_A6] == true)
	{
		//cout << "14 : xx24_OF_A6 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_A6]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_figaro_17_03::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_03::runOnceInteractionStep_propagate_effect_S()
{
	...
	if ((2 <= (boolState[S_OF_A10] + boolState[S_OF_A8] + boolState[S_OF_A9])) )
	{
...
void storm::figaro::FigaroProgram_figaro_17_03::runOnceInteractionStep_propagate_effect_required()
{
	...
	if (( !boolState[required_OF_A8]) || ( !boolState[S_OF_A7]) )
	{
	...
	if (( !boolState[required_OF_A10]) || ( !boolState[S_OF_A7]) )
	{
	...
	if (((boolState[relevant_evt_OF_A6] && ( !boolState[S_OF_A6])) || (boolState[relevant_evt_OF_A2] && ( !boolState[S_OF_A2]))) || (boolState[relevant_evt_OF_A4] && ( !boolState[S_OF_A4])) )
	{
...
void storm::figaro::FigaroProgram_figaro_17_03::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_figaro_17_03::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_figaro_17_03::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_03::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_03::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_03::fireinsttransitiongroup(std::string user_input_ins)
