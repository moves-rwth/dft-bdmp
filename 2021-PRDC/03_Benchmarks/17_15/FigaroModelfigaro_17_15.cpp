#include <iostream>
#include "FigaroModelfigaro_17_15.h"
...
void storm::figaro::FigaroProgram_figaro_17_15::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_15::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_15::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_15::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_15::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_17_15::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_15::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_K1] == false) && boolState[required_OF_K1]) 
	{
	...
	if ((boolState[failF_OF_K2] == false) && boolState[required_OF_K2]) 
	{
	...
	if ((boolState[failF_OF_K3] == false) && boolState[required_OF_K3]) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_15::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_B1] == false) && boolState[required_OF_B1])
	{
		//cout << "4 : xx10_OF_B1 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_B1]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_B2] == false) && boolState[required_OF_B2])
	{
		//cout << "6 : xx10_OF_B2 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_B2]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_K1] == false) && boolState[required_OF_K1])
	{
		//cout << "8 : xx10_OF_K1 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_K1]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_K2] == false) && boolState[required_OF_K2])
	{
		//cout << "10 : xx10_OF_K2 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_K2]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_K3] == false) && boolState[required_OF_K3])
	{
		//cout << "12 : xx10_OF_K3 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_K3]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_SF_1] == false) && (boolState[required_OF_SF_1] && ( !boolState[failS_OF_SF_1])))
	{
		//cout << "14 : xx17_OF_SF_1 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_SF_1]  =  TRUE" << endl;
		list.push_back(make_tuple(14, 0.01, "EXP", 0));
	}
	if ((boolState[failS_OF_SF_1] == false) && (( !boolState[required_OF_SF_1]) && ( !boolState[failF_OF_SF_1])))
	{
		//cout << "15 : xx18_OF_SF_1 : FAULT failS  LABEL \"défaillance en attente %OBJET\"  DIST EXP (0.001)  INDUCING boolState[failS_OF_SF_1]  =  TRUE" << endl;
...
void storm::figaro::FigaroProgram_figaro_17_15::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_15::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_figaro_17_15::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_A1_lost] && ( !boolState[S_OF_A1_lost])) || (  boolState[relevant_evt_OF_A2] && ( !boolState[S_OF_A2])) )
	{
	...
	if ((boolState[relevant_evt_OF_B1_lost] && ( !boolState[S_OF_B1_lost])) || (  boolState[relevant_evt_OF_B2] && ( !boolState[S_OF_B2])) )
	{
	...
	if (boolState[relevant_evt_OF_SF_1] && ( !boolState[S_OF_SF_1]) )
	{
...
void storm::figaro::FigaroProgram_figaro_17_15::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_17_15::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_15::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_15::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_15::fireinsttransitiongroup(std::string user_input_ins)
