    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_figaro_17_15: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_figaro_17_15(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_A1" , 0},
            	{"already_S_OF_A1" , 1},
            	{"S_OF_A1" , 2},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
			...
			double const lambda_OF_K3 = 0.01;
			...
			double const lambda_OF_K2 = 0.01;
			...
			double const lambda_OF_K1 = 0.01;
