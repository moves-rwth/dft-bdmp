#include <iostream>
#include "FigaroModelfigaro_08_and_and_trig_common.h"
...
void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::init()
{
	...
	REINITIALISATION_OF_required_OF_AND_4 = true;
	boolState[already_S_OF_AND_4] = false;
	REINITIALISATION_OF_S_OF_AND_4 = false;
	REINITIALISATION_OF_relevant_evt_OF_AND_4 = false;
...
void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::printState()
{
	...
	//cout << "Attribute :  boolState[required_OF_AND_4] | Value : " << boolState[required_OF_AND_4] << endl;
	//cout << "Attribute :  boolState[already_S_OF_AND_4] | Value : " << boolState[already_S_OF_AND_4] << endl;
	//cout << "Attribute :  boolState[S_OF_AND_4] | Value : " << boolState[S_OF_AND_4] << endl;
	//cout << "Attribute :  boolState[relevant_evt_OF_AND_4] | Value : " << boolState[relevant_evt_OF_AND_4] << endl;
...
bool storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::doReinitialisations()
{
	...
	boolState[required_OF_AND_4] = REINITIALISATION_OF_required_OF_AND_4;
	boolState[S_OF_AND_4] = REINITIALISATION_OF_S_OF_AND_4;
	boolState[relevant_evt_OF_AND_4] = REINITIALISATION_OF_relevant_evt_OF_AND_4;
...
void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_F_1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::runOnceInteractionStep_propagate_effect_S()
{
	if (boolState[S_OF_F_1] && boolState[S_OF_F_3] )
	{
	...
	if (boolState[S_OF_AND_2] && boolState[S_OF_AND_3] )
	{
		boolState[S_OF_AND_4]  =  true;
	}

	if (boolState[S_OF_AND_4] )
	{
...
void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::runOnceInteractionStep_propagate_effect_required()
{
	if (( !boolState[required_OF_AND_4]) || ( !boolState[S_OF_AND_3]) )
	{
		boolState[required_OF_AND_2]  =  false;
	}

	if (boolState[relevant_evt_OF_AND_4] && ( !boolState[S_OF_AND_4]) )
	{
		boolState[relevant_evt_OF_AND_2]  =  true;
	}

	if ( !boolState[required_OF_AND_4] )
	{
		boolState[required_OF_AND_3]  =  false;
	}

	if ((boolState[relevant_evt_OF_AND_4] && ( !boolState[S_OF_AND_4])) || (  boolState[relevant_evt_OF_AND_2] && ( !boolState[S_OF_AND_2])) )
	{
	...
	{
		boolState[required_OF_AND_4]  =  false;
	}

	if (boolState[relevant_evt_OF_UE_1] && ( !boolState[S_OF_UE_1]) )
	{
		boolState[relevant_evt_OF_AND_4]  =  true;
	}

	if (( !boolState[required_OF_AND_2]) && ( !boolState[required_OF_AND_3]) )
	{
		boolState[required_OF_F_1]  =  false;
	}

	if ((boolState[relevant_evt_OF_AND_2] && ( !boolState[S_OF_AND_2])) || (  boolState[relevant_evt_OF_AND_3] && ( !boolState[S_OF_AND_3])) )
	{
...
void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::runOnceInteractionStep_propagate_leaves()
{
	...
	boolState[already_S_OF_AND_4]  =  boolState[S_OF_AND_4]  ;
...
void
storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_08_and_and_trig_common::fireinsttransitiongroup(std::string user_input_ins)
