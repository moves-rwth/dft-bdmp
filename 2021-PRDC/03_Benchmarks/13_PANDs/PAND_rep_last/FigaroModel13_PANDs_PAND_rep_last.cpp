#include <iostream>
#include "FigaroModel13_PANDs_PAND_rep_last.h"
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::init()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::compareStates()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::printState()
{
...
bool storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_F_1] == true )
	{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_last::fireinsttransitiongroup(std::string user_input_ins)
