#include <iostream>
#include "FigaroModel13_PANDs_PAND_rep_all.h"
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::init()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::compareStates()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::printState()
{
...
bool storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_F_1] == true )
	{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_13_PANDs_PAND_rep_all::fireinsttransitiongroup(std::string user_input_ins)
