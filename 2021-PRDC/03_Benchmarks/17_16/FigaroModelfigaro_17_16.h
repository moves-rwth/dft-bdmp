    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_figaro_17_16: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_figaro_17_16(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_1" , 0},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
			...
			bool const Profil_base_OF___ARBRE__EIRM = true;
			...
			double const lambda_OF_SF_A = 0.01;
			double const standby_lambda_OF_SF_A = 0.001;
			std::string const trigger_kind_OF_t_1 = "fn_fathers_and_trig";
			bool const failF_FROZEN_OF_SF_A = false;
			double const lambda_OF_D1 = 0.01;
			double const lambda_OF_SF_B = 0.01;
			double const standby_lambda_OF_SF_B = 0.001;
			...
			double const lambda_OF_E1 = 0.01;
