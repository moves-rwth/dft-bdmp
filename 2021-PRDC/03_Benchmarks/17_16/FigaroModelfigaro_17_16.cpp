#include <iostream>
#include "FigaroModelfigaro_17_16.h"
...
void storm::figaro::FigaroProgram_figaro_17_16::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_16::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_16::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_16::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_16::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_17_16::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_16::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_D1] == false) && boolState[required_OF_D1]) 
	{
	...
	if ((boolState[failF_OF_E1] == false) && boolState[required_OF_E1]) 
	{
	...
	if ((boolState[failF_OF_SF_A] == false) && (boolState[required_OF_SF_A] && ( !boolState[failS_OF_SF_A]))) 
	{
	...
	if ((boolState[failS_OF_SF_A] == false) && (( !boolState[required_OF_SF_A]) && ( !boolState[failF_OF_SF_A]))) 
	{
	...
	if ((boolState[failF_OF_SF_B] == false) && (boolState[required_OF_SF_B] && ( !boolState[failS_OF_SF_B]))) 
	{
	...
	if ((boolState[failS_OF_SF_B] == false) && (( !boolState[required_OF_SF_B]) && ( !boolState[failF_OF_SF_B]))) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_16::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_C1] == false) && boolState[required_OF_C1])
	{
		//cout << "0 : xx10_OF_C1 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_C1]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_D1] == false) && boolState[required_OF_D1])
	{
		//cout << "2 : xx10_OF_D1 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_D1]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_E1] == false) && boolState[required_OF_E1])
	{
		//cout << "4 : xx10_OF_E1 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_E1]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_SF_A] == false) && (boolState[required_OF_SF_A] && ( !boolState[failS_OF_SF_A])))
	{
		//cout << "6 : xx17_OF_SF_A : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_SF_A]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 0.01, "EXP", 0));
	}
	if ((boolState[failS_OF_SF_A] == false) && (( !boolState[required_OF_SF_A]) && ( !boolState[failF_OF_SF_A])))
	{
		//cout << "7 : xx18_OF_SF_A : FAULT failS  LABEL \"défaillance en attente %OBJET\"  DIST EXP (0.001)  INDUCING boolState[failS_OF_SF_A]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_SF_B] == false) && (boolState[required_OF_SF_B] && ( !boolState[failS_OF_SF_B])))
	{
		//cout << "9 : xx17_OF_SF_B : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_SF_B]  =  TRUE" << endl;
		list.push_back(make_tuple(9, 0.01, "EXP", 0));
	}
	if ((boolState[failS_OF_SF_B] == false) && (( !boolState[required_OF_SF_B]) && ( !boolState[failF_OF_SF_B])))
	{
		//cout << "10 : xx18_OF_SF_B : FAULT failS  LABEL \"défaillance en attente %OBJET\"  DIST EXP (0.001)  INDUCING boolState[failS_OF_SF_B]  =  TRUE" << endl;
		list.push_back(make_tuple(10, 0.001, "EXP", 0));
	}
	if ((boolState[failS_OF_SF_B] == true) || (boolState[failF_OF_SF_B] == true))
	{
...
void storm::figaro::FigaroProgram_figaro_17_16::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_C1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_16::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_figaro_17_16::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_figaro_17_16::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_17_16::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_16::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_16::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_16::fireinsttransitiongroup(std::string user_input_ins)
