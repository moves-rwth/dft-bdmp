#include <iostream>
#include "FigaroModelfigaro_17_04.h"
...
void storm::figaro::FigaroProgram_figaro_17_04::init()
{
	...
	boolState[failI_OF_A8] = false;
	REINITIALISATION_OF_to_be_fired_OF_A8 = false;
	boolState[already_standby_OF_A8] = false;
	boolState[already_required_OF_A8] = false;
	...
	FIRE_xx23_OF_A2_INS_10 = false;
	FIRE_xx23_OF_A2_INS_11 = false;
	FIRE_xx24_OF_A2 = false;
	FIRE_xx23_OF_A3_INS_13 = false;
	FIRE_xx23_OF_A3_INS_14 = false;
	...
	FIRE_xx23_OF_A7_INS_22 = false;
	FIRE_xx23_OF_A7_INS_23 = false;
	FIRE_xx24_OF_A7 = false;
	FIRE_xx23_OF_A8_INS_25 = false;
	FIRE_xx23_OF_A8_INS_26 = false;
	FIRE_xx24_OF_A8 = false;
	FIRE_xx10_OF_A9 = false;
	FIRE_xx11_OF_A9 = false;

}

void storm::figaro::FigaroProgram_figaro_17_04::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_04::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_04::printState()
{
	...
	//cout << "Attribute :  boolState[failI_OF_A8] | Value : " << boolState[failI_OF_A8] << endl;
	//cout << "Attribute :  boolState[to_be_fired_OF_A8] | Value : " << boolState[to_be_fired_OF_A8] << endl;
	//cout << "Attribute :  boolState[already_standby_OF_A8] | Value : " << boolState[already_standby_OF_A8] << endl;
	//cout << "Attribute :  boolState[already_required_OF_A8] | Value : " << boolState[already_required_OF_A8] << endl;
...
bool storm::figaro::FigaroProgram_figaro_17_04::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_figaro_17_04::doReinitialisations()
{
	...
	boolState[to_be_fired_OF_A8] = REINITIALISATION_OF_to_be_fired_OF_A8;
...
void storm::figaro::FigaroProgram_figaro_17_04::fireOccurrence(int numFire)
{
	...
	if (numFire == 10)
	{
		FIRE_xx23_OF_A2_INS_10 = true;
	}

	if (numFire == 11)
	{
		FIRE_xx23_OF_A2_INS_11 = true;
	}
	...
	if (numFire == 13)
	{
		FIRE_xx23_OF_A3_INS_13 = true;
	}

	if (numFire == 14)
	{
		FIRE_xx23_OF_A3_INS_14 = true;
	}
	...
	if (numFire == 22)
	{
		FIRE_xx23_OF_A7_INS_22 = true;
	}

	if (numFire == 23)
	{
		FIRE_xx23_OF_A7_INS_23 = true;
	}
	...
	if (numFire == 25)
	{
		FIRE_xx23_OF_A8_INS_25 = true;
	}

	if (numFire == 26)
	{
		FIRE_xx23_OF_A8_INS_26 = true;
	}

	if (numFire == 27)
	{
		FIRE_xx24_OF_A8 = true;
	}
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_A14] == false) && boolState[required_OF_A14]) 
	{
	...
	if ((boolState[failF_OF_A15] == false) && boolState[required_OF_A15]) 
	{
	...
	// Occurrence xx23_OF_A8

	if ((boolState[failI_OF_A8] == false) && boolState[to_be_fired_OF_A8]) 
	{
	
		
		if (FIRE_xx23_OF_A8_INS_25) 
		{
			boolState[failI_OF_A8]  =  true;
			boolState[already_standby_OF_A8]  =  false;
			boolState[already_required_OF_A8]  =  false;
			FIRE_xx23_OF_A8_INS_25 = false;
		}
	...
	// Occurrence xx24_OF_A8
	if (boolState[failI_OF_A8] == true) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_04::showFireableOccurrences()
{
	...
	if ((boolState[failI_OF_A2] == false) && boolState[to_be_fired_OF_A2])
	{
		//cout << "10 :  INS_SUB_COUNT (1) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.5) | INDUCING boolState[failI_OF_A2]  =  TRUE,already_standby_OF_A2  =  FALSE,already_required_OF_A2  =  FALSE" << endl;
		list.push_back(make_tuple(10, 0.5, "INS", 1));
	}
	if ((boolState[failI_OF_A2] == false) && boolState[to_be_fired_OF_A2])
	{
		//cout << "11 :  INS_SUB_COUNT (1) |TRANSITION | good | DIST INS (0.5) | INDUCING boolState[already_standby_OF_A2]  =  FALSE,already_required_OF_A2  =  FALSE" << endl;
		list.push_back(make_tuple(11, 0.5, "INS", 1));
	}
	if ((boolState[failI_OF_A3] == false) && boolState[to_be_fired_OF_A3])
	{
		//cout << "13 :  INS_SUB_COUNT (2) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.5) | INDUCING boolState[failI_OF_A3]  =  TRUE,already_standby_OF_A3  =  FALSE,already_required_OF_A3  =  FALSE" << endl;
		list.push_back(make_tuple(13, 0.5, "INS", 2));
	}
	if ((boolState[failI_OF_A3] == false) && boolState[to_be_fired_OF_A3])
	{
		//cout << "14 :  INS_SUB_COUNT (2) |TRANSITION | good | DIST INS (0.5) | INDUCING boolState[already_standby_OF_A3]  =  FALSE,already_required_OF_A3  =  FALSE" << endl;
		list.push_back(make_tuple(14, 0.5, "INS", 2));
	}
	if ((boolState[failI_OF_A7] == false) && boolState[to_be_fired_OF_A7])
	{
		//cout << "22 :  INS_SUB_COUNT (3) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.5) | INDUCING boolState[failI_OF_A7]  =  TRUE,already_standby_OF_A7  =  FALSE,already_required_OF_A7  =  FALSE" << endl;
		list.push_back(make_tuple(22, 0.5, "INS", 3));
	}
	if ((boolState[failI_OF_A7] == false) && boolState[to_be_fired_OF_A7])
	{
		//cout << "23 :  INS_SUB_COUNT (3) |TRANSITION | good | DIST INS (0.5) | INDUCING boolState[already_standby_OF_A7]  =  FALSE,already_required_OF_A7  =  FALSE" << endl;
		list.push_back(make_tuple(23, 0.5, "INS", 3));
	}
	if ((boolState[failI_OF_A8] == false) && boolState[to_be_fired_OF_A8])
	{
		//cout << "25 :  INS_SUB_COUNT (4) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.5) | INDUCING boolState[failI_OF_A8]  =  TRUE,already_standby_OF_A8  =  FALSE,already_required_OF_A8  =  FALSE" << endl;
		list.push_back(make_tuple(25, 0.5, "INS", 4));
	}
	if ((boolState[failI_OF_A8] == false) && boolState[to_be_fired_OF_A8])
	{
		//cout << "26 :  INS_SUB_COUNT (4) |TRANSITION | good | DIST INS (0.5) | INDUCING boolState[already_standby_OF_A8]  =  FALSE,already_required_OF_A8  =  FALSE" << endl;
		list.push_back(make_tuple(26, 0.5, "INS", 4));
	}
        if (list.size() > 0)
        {
	...
	if ((boolState[failF_OF_A10] == false) && boolState[required_OF_A10])
	{
		//cout << "2 : xx10_OF_A10 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A10]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_A13] == false) && boolState[required_OF_A13])
	{
		//cout << "4 : xx10_OF_A13 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A13]  =  TRUE" << endl;
		list.push_back(make_tuple(4, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A13] == true)
	{
		//cout << "5 : xx11_OF_A13 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A13]  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A14] == false) && boolState[required_OF_A14])
	{
		//cout << "6 : xx10_OF_A14 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A14]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A14] == true)
	{
		//cout << "7 : xx11_OF_A14 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A14]  =  FALSE" << endl;
		list.push_back(make_tuple(7, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A15] == false) && boolState[required_OF_A15])
	{
		//cout << "8 : xx10_OF_A15 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A15]  =  TRUE" << endl;
		list.push_back(make_tuple(8, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A15] == true)
	{
		//cout << "9 : xx11_OF_A15 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A15]  =  FALSE" << endl;
		list.push_back(make_tuple(9, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_A2] == true)
	{
		//cout << "12 : xx24_OF_A2 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_A2]  =  FALSE" << endl;
		list.push_back(make_tuple(12, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_A3] == true)
	{
		//cout << "15 : xx24_OF_A3 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_A3]  =  FALSE" << endl;
		list.push_back(make_tuple(15, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A4] == false) && boolState[required_OF_A4])
	{
		//cout << "16 : xx10_OF_A4 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A4]  =  TRUE" << endl;
		list.push_back(make_tuple(16, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A4] == true)
	{
		//cout << "17 : xx11_OF_A4 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A4]  =  FALSE" << endl;
		list.push_back(make_tuple(17, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A5] == false) && boolState[required_OF_A5])
	{
		//cout << "18 : xx10_OF_A5 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A5]  =  TRUE" << endl;
		list.push_back(make_tuple(18, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A5] == true)
	{
		//cout << "19 : xx11_OF_A5 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A5]  =  FALSE" << endl;
		list.push_back(make_tuple(19, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A6] == false) && boolState[required_OF_A6])
	{
		//cout << "20 : xx10_OF_A6 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A6]  =  TRUE" << endl;
		list.push_back(make_tuple(20, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A6] == true)
	{
		//cout << "21 : xx11_OF_A6 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A6]  =  FALSE" << endl;
		list.push_back(make_tuple(21, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_A7] == true)
	{
		//cout << "24 : xx24_OF_A7 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_A7]  =  FALSE" << endl;
		list.push_back(make_tuple(24, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_A8] == true)
	{
		//cout << "27 : xx24_OF_A8 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_A8]  =  FALSE" << endl;
		list.push_back(make_tuple(27, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A9] == false) && boolState[required_OF_A9])
	{
		//cout << "28 : xx10_OF_A9 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A9]  =  TRUE" << endl;
		list.push_back(make_tuple(28, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A9] == true)
	{
		//cout << "29 : xx11_OF_A9 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A9]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_figaro_17_04::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_04::runOnceInteractionStep_propagate_effect_S()
{
	if (((boolState[S_OF_A9] || boolState[S_OF_A8]) || boolState[S_OF_A7]) || boolState[S_OF_A10] )
	{
		boolState[S_OF_A12]  =  true;
	}

	if (((((boolState[S_OF_A4] || boolState[S_OF_A3]) || boolState[S_OF_A6]) || boolState[S_OF_A5]) || boolState[S_OF_A1]) || boolState[S_OF_A2] )
	{
		boolState[S_OF_A16]  =  true;
	}

	if (((boolState[S_OF_A13] || boolState[S_OF_A1]) || boolState[S_OF_A14]) || boolState[S_OF_A15] )
	{
		boolState[S_OF_A17]  =  true;
	}

	if (boolState[S_OF_A12] && boolState[S_OF_A16] )
	{
		boolState[S_OF_A18]  =  true;
	}

	if (boolState[S_OF_A18] && boolState[S_OF_A17] )
	{
		boolState[S_OF_A19]  =  true;
	}

	if (boolState[S_OF_A19] )
	{
...
void storm::figaro::FigaroProgram_figaro_17_04::runOnceInteractionStep_propagate_effect_required()
{
	if (( !boolState[required_OF_A17]) && ( !boolState[required_OF_A16]) )
	{
		boolState[required_OF_A1]  =  false;
	}

	if ((boolState[relevant_evt_OF_A17] && ( !boolState[S_OF_A17])) || (boolState[relevant_evt_OF_A16] && ( !boolState[S_OF_A16])) )
	{
	...
	if (( !boolState[required_OF_A18]) || ( !boolState[S_OF_A16]) )
	{
	...
	if ((boolState[relevant_evt_OF_A18] && ( !boolState[S_OF_A18])) || (boolState[relevant_evt_OF_A12] && ( !boolState[S_OF_A12])) )
	{
	...
	if ((boolState[relevant_evt_OF_A19] && ( !boolState[S_OF_A19])) || (boolState[relevant_evt_OF_A18] && ( !boolState[S_OF_A18])) )
	{
		boolState[relevant_evt_OF_A17]  =  true;
	}

	if (( !boolState[required_OF_A19]) || ( !boolState[S_OF_A17]) )
	{
...
void storm::figaro::FigaroProgram_figaro_17_04::runOnceInteractionStep_propagate_leaves()
{
	...
	if (( !boolState[required_OF_A8]) && (( !boolState[already_standby_OF_A8]) && (   !boolState[already_required_OF_A8])) )
	{
		boolState[already_standby_OF_A8]  =  true;
	}
...
void storm::figaro::FigaroProgram_figaro_17_04::runOnceInteractionStep_tops()
{
	...
	if (boolState[required_OF_A8] && boolState[already_standby_OF_A8] )
	{
		boolState[to_be_fired_OF_A8]  =  true;
	}

}

void
storm::figaro::FigaroProgram_figaro_17_04::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_04::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_04::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_04::fireinsttransitiongroup(std::string user_input_ins)
