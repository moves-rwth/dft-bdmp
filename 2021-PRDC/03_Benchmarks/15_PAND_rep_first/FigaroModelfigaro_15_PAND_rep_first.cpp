#include <iostream>
#include "FigaroModelfigaro_15_PAND_rep_first.h"
...
void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::init()
{
...
void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_F_1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::runOnceInteractionStep_propagate_effect_S()
{
	...
	if (boolState[already_S_OF_THEN_1] && boolState[S_OF_THEN_3] )
	{
		boolState[S_OF_THEN_1]  =  true;
	}
	...
	if (boolState[already_S_OF_THEN_3] && boolState[S_OF_F_1] )
	{
		boolState[S_OF_THEN_3]  =  true;
	}
	...
	if (boolState[already_S_OF_THEN_4] && boolState[S_OF_F_3] )
	{
		boolState[S_OF_THEN_4]  =  true;
	}
...
void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_15_PAND_rep_first::fireinsttransitiongroup(std::string user_input_ins)
