    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_figaro_01_and: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_figaro_01_and(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_1" , 0},
