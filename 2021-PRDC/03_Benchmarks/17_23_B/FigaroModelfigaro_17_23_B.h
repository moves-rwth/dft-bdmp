    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_figaro_17_23_B: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_figaro_17_23_B(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
			...
			double const standby_lambda_OF_D22 = 1e-11;
			std::string const calculate_required_OF_P2_loss = "fn_fathers_and_trig";
			double const lambda_OF_D22 = 0.1;
			...
			double const lambda_OF_M1 = 0.003;
			double const standby_lambda_OF_M3 = 1e-11;
			std::string const calculate_required_OF_Disk1_loss = "fn_fathers_and_trig";
			double const mu_OF_M1 = 0.03;
			bool const force_relevant_events_OF_M1 = false;
			double const lambda_OF_M3 = 0.1;
			...
			double const mu_OF_M3 = 1;
			bool const failF_FROZEN_OF_D21 = false;
			std::string const calculate_required_OF_Bus = "fn_fathers_and_trig";
			double const mu_OF_D22 = 1;
			double const standby_lambda_OF_D12 = 1e-11;
			double const lambda_OF_D12 = 0.1;
			bool const failF_FROZEN_OF_D11 = false;
			double const lambda_OF_M2 = 0.003;
            ...
            int required_OF_Bus = 66 ;
            int already_S_OF_Bus = 67 ;
            int S_OF_Bus = 68 ;
            int relevant_evt_OF_Bus = 69 ;
            int failF_OF_Bus = 70 ;
