#include <iostream>
#include "FigaroModelfigaro_17_23_B.h"
...
void storm::figaro::FigaroProgram_figaro_17_23_B::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_23_B::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_23_B::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_23_B::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_23_B::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_17_23_B::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_23_B::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_23_B::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_D11] == false) && boolState[required_OF_D11])
	{
		//cout << "0 : xx10_OF_D11 : FAULT failF  LABEL \"failure in operation D11\"  DIST EXP (8e-05)  INDUCING boolState[failF_OF_D11]  =  TRUE" << endl;
		list.push_back(make_tuple(0, 8e-05, "EXP", 0));
	}
	if (boolState[failF_OF_D11] == true)
	{
		//cout << "1 : xx11_OF_D11 : REPAIR rep  DIST EXP (0.0008)  INDUCING boolState[failF_OF_D11]  =  FALSE" << endl;
		list.push_back(make_tuple(1, 0.0008, "EXP", 0));
	}
	if ((boolState[failF_OF_D12] == false) && (boolState[required_OF_D12] && ( !boolState[failS_OF_D12])))
	{
		//cout << "2 : xx17_OF_D12 : FAULT failF  LABEL \"failure in operation D12\"  DIST EXP (0.1)  INDUCING boolState[failF_OF_D12]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 0.1, "EXP", 0));
	}
	if ((boolState[failS_OF_D12] == false) && (( !boolState[required_OF_D12]) && ( !boolState[failF_OF_D12])))
	{
		//cout << "3 : xx18_OF_D12 : FAULT failS  LABEL \"standby failure D12\"  DIST EXP (1e-11)  INDUCING boolState[failS_OF_D12]  =  TRUE" << endl;
		list.push_back(make_tuple(3, 1e-11, "EXP", 0));
	}
	if ((boolState[failS_OF_D12] == true) || (boolState[failF_OF_D12] == true))
	{
		//cout << "4 : xx19_OF_D12 : REPAIR rep  DIST EXP (1)  INDUCING boolState[failS_OF_D12]  =  FALSE,failF_OF_D12  =  FALSE" << endl;
		list.push_back(make_tuple(4, 1, "EXP", 0));
	}
	if ((boolState[failF_OF_D21] == false) && boolState[required_OF_D21])
	{
		//cout << "5 : xx10_OF_D21 : FAULT failF  LABEL \"failure in operation D21\"  DIST EXP (8e-05)  INDUCING boolState[failF_OF_D21]  =  TRUE" << endl;
		list.push_back(make_tuple(5, 8e-05, "EXP", 0));
	}
	if (boolState[failF_OF_D21] == true)
	{
		//cout << "6 : xx11_OF_D21 : REPAIR rep  DIST EXP (0.3)  INDUCING boolState[failF_OF_D21]  =  FALSE" << endl;
		list.push_back(make_tuple(6, 0.3, "EXP", 0));
	}
	if ((boolState[failF_OF_D22] == false) && (boolState[required_OF_D22] && ( !boolState[failS_OF_D22])))
	{
		//cout << "7 : xx17_OF_D22 : FAULT failF  LABEL \"failure in operation D22\"  DIST EXP (0.1)  INDUCING boolState[failF_OF_D22]  =  TRUE" << endl;
		list.push_back(make_tuple(7, 0.1, "EXP", 0));
	}
	if ((boolState[failS_OF_D22] == false) && (( !boolState[required_OF_D22]) && ( !boolState[failF_OF_D22])))
	{
		//cout << "8 : xx18_OF_D22 : FAULT failS  LABEL \"standby failure D22\"  DIST EXP (1e-11)  INDUCING boolState[failS_OF_D22]  =  TRUE" << endl;
		list.push_back(make_tuple(8, 1e-11, "EXP", 0));
	}
	if ((boolState[failS_OF_D22] == true) || (boolState[failF_OF_D22] == true))
	{
		//cout << "9 : xx19_OF_D22 : REPAIR rep  DIST EXP (1)  INDUCING boolState[failS_OF_D22]  =  FALSE,failF_OF_D22  =  FALSE" << endl;
		list.push_back(make_tuple(9, 1, "EXP", 0));
	}
	if ((boolState[failF_OF_M1] == false) && boolState[required_OF_M1])
	{
		//cout << "10 : xx10_OF_M1 : FAULT failF  LABEL \"failure in operation M1\"  DIST EXP (0.003)  INDUCING boolState[failF_OF_M1]  =  TRUE" << endl;
		list.push_back(make_tuple(10, 0.003, "EXP", 0));
	}
	if (boolState[failF_OF_M1] == true)
	{
		//cout << "11 : xx11_OF_M1 : REPAIR rep  DIST EXP (0.03)  INDUCING boolState[failF_OF_M1]  =  FALSE" << endl;
		list.push_back(make_tuple(11, 0.03, "EXP", 0));
	}
	if ((boolState[failF_OF_M2] == false) && boolState[required_OF_M2])
	{
		//cout << "12 : xx10_OF_M2 : FAULT failF  LABEL \"failure in operation M2\"  DIST EXP (0.003)  INDUCING boolState[failF_OF_M2]  =  TRUE" << endl;
		list.push_back(make_tuple(12, 0.003, "EXP", 0));
	}
	if (boolState[failF_OF_M2] == true)
	{
		//cout << "13 : xx11_OF_M2 : REPAIR rep  DIST EXP (0.03)  INDUCING boolState[failF_OF_M2]  =  FALSE" << endl;
		list.push_back(make_tuple(13, 0.03, "EXP", 0));
	}
	if ((boolState[failF_OF_M3] == false) && (boolState[required_OF_M3] && ( !boolState[failS_OF_M3])))
	{
		//cout << "14 : xx17_OF_M3 : FAULT failF  LABEL \"failure in operation M3\"  DIST EXP (0.1)  INDUCING boolState[failF_OF_M3]  =  TRUE" << endl;
		list.push_back(make_tuple(14, 0.1, "EXP", 0));
	}
	if ((boolState[failS_OF_M3] == false) && (( !boolState[required_OF_M3]) && ( !boolState[failF_OF_M3])))
	{
		//cout << "15 : xx18_OF_M3 : FAULT failS  LABEL \"standby failure M3\"  DIST EXP (1e-11)  INDUCING boolState[failS_OF_M3]  =  TRUE" << endl;
		list.push_back(make_tuple(15, 1e-11, "EXP", 0));
	}
	if ((boolState[failS_OF_M3] == true) || (boolState[failF_OF_M3] == true))
	{
		//cout << "16 : xx19_OF_M3 : REPAIR rep  DIST EXP (1)  INDUCING boolState[failS_OF_M3]  =  FALSE,failF_OF_M3  =  FALSE" << endl;
		list.push_back(make_tuple(16, 1, "EXP", 0));
	}
	if ((boolState[failF_OF_Bus] == false) && boolState[required_OF_Bus])
	{
		//cout << "17 : xx10_OF_Bus : FAULT failF  LABEL \"failure in operation Bus\"  DIST EXP (2e-09)  INDUCING boolState[failF_OF_Bus]  =  TRUE" << endl;
		list.push_back(make_tuple(17, 2e-09, "EXP", 0));
	}
	if (boolState[failF_OF_Bus] == true)
	{
		//cout << "18 : xx11_OF_Bus : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_Bus]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_figaro_17_23_B::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_D11] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_23_B::runOnceInteractionStep_propagate_effect_S()
{
	...
	if (boolState[S_OF_Loss_of_both_calculators] || boolState[S_OF_Bus] )
	{
...
void storm::figaro::FigaroProgram_figaro_17_23_B::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_figaro_17_23_B::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_17_23_B::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_23_B::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_23_B::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_23_B::fireinsttransitiongroup(std::string user_input_ins)
