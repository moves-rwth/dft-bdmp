#include <iostream>
#include "FigaroModelfigaro_17_09.h"
...
void storm::figaro::FigaroProgram_figaro_17_09::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_09::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_09::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_09::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_09::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_figaro_17_09::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_09::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_Cpt_A] == false) && boolState[required_OF_Cpt_A]) 
	{
	...
	if ((boolState[failF_OF_Cpt_B] == false) && boolState[required_OF_Cpt_B]) 
	{
	...
	if ((boolState[failF_OF_Cpt_C] == false) && boolState[required_OF_Cpt_C]) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_09::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_Cpt_A] == false) && boolState[required_OF_Cpt_A])
	{
		//cout << "0 : xx10_OF_Cpt_A : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_Cpt_A]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_Cpt_B] == false) && boolState[required_OF_Cpt_B])
	{
		//cout << "2 : xx10_OF_Cpt_B : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_Cpt_B]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_Cpt_C] == false) && boolState[required_OF_Cpt_C])
	{
		//cout << "4 : xx10_OF_Cpt_C : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_Cpt_C]  =  TRUE" << endl;
	...
	if (boolState[in_progress_OF_phase_1])
	{
		//cout << "6 : xx43_a_OF_phase_1 : TRANSITION end  LABEL \"End of phase phase_1\"  DIST EXP (0.01)  INDUCING boolState[in_progress_OF_phase_1]  =  FALSE" << endl;
		list.push_back(make_tuple(6, 0.01, "EXP", 0));
	}
	if (boolState[in_progress_OF_phase_2])
	{
		//cout << "8 : xx43_a_OF_phase_2 : TRANSITION end  LABEL \"End of phase phase_2\"  DIST EXP (1)  INDUCING boolState[in_progress_OF_phase_2]  =  FALSE" << endl;
		list.push_back(make_tuple(8, 1, "EXP", 0));
	}
	return list;
}


void storm::figaro::FigaroProgram_figaro_17_09::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_Cpt_A] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_09::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_figaro_17_09::runOnceInteractionStep_propagate_effect_required()
{
	...
	if (boolState[relevant_evt_OF_Cpt_C] && ( !boolState[S_OF_Cpt_C]) )
	{
	...
	if ((boolState[relevant_evt_OF_AND_1] && ( !boolState[S_OF_AND_1])) || ((  boolState[relevant_evt_OF_AND_3] && ( !boolState[S_OF_AND_3])) || (boolState[relevant_evt_OF_phase_2] && ( !boolState[S_OF_phase_2]))) )
	{
	...
	if ((boolState[relevant_evt_OF_AND_2] && ( !boolState[S_OF_AND_2])) || (  boolState[relevant_evt_OF_OR_3] && ( !boolState[S_OF_OR_3])) )
	{
...
void storm::figaro::FigaroProgram_figaro_17_09::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_figaro_17_09::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_figaro_17_09::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_09::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_09::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_09::fireinsttransitiongroup(std::string user_input_ins)
