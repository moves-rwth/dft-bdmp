    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_figaro_17_09: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_figaro_17_09(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_1" , 0},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
			...
			double const lambda_OF_Cpt_A = 0.01;
			...
			double const lambda_OF_Cpt_C = 0.01;
			double const duration_OF_phase_2 = 1;
