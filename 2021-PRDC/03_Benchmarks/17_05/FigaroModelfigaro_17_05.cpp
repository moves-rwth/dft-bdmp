#include <iostream>
#include "FigaroModelfigaro_17_05.h"
...
void storm::figaro::FigaroProgram_figaro_17_05::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_05::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_05::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_05::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_05::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_17_05::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_05::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_05::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_A11] == false) && boolState[required_OF_A11])
	{
		//cout << "4 : xx10_OF_A11 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A11]  =  TRUE" << endl;
		list.push_back(make_tuple(4, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A11] == true)
	{
		//cout << "5 : xx11_OF_A11 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A11]  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A2] == false) && boolState[required_OF_A2])
	{
		//cout << "6 : xx10_OF_A2 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A2]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A2] == true)
	{
		//cout << "7 : xx11_OF_A2 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A2]  =  FALSE" << endl;
		list.push_back(make_tuple(7, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A3] == false) && boolState[required_OF_A3])
	{
		//cout << "8 : xx10_OF_A3 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A3]  =  TRUE" << endl;
		list.push_back(make_tuple(8, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A3] == true)
	{
		//cout << "9 : xx11_OF_A3 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A3]  =  FALSE" << endl;
		list.push_back(make_tuple(9, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A4] == false) && boolState[required_OF_A4])
	{
		//cout << "10 : xx10_OF_A4 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A4]  =  TRUE" << endl;
		list.push_back(make_tuple(10, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A4] == true)
	{
		//cout << "11 : xx11_OF_A4 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A4]  =  FALSE" << endl;
		list.push_back(make_tuple(11, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A5] == false) && boolState[required_OF_A5])
	{
		//cout << "12 : xx10_OF_A5 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A5]  =  TRUE" << endl;
		list.push_back(make_tuple(12, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A5] == true)
	{
		//cout << "13 : xx11_OF_A5 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A5]  =  FALSE" << endl;
		list.push_back(make_tuple(13, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A6] == false) && boolState[required_OF_A6])
	{
		//cout << "14 : xx10_OF_A6 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A6]  =  TRUE" << endl;
		list.push_back(make_tuple(14, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A6] == true)
	{
		//cout << "15 : xx11_OF_A6 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A6]  =  FALSE" << endl;
		list.push_back(make_tuple(15, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A9] == false) && boolState[required_OF_A9])
	{
		//cout << "16 : xx10_OF_A9 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A9]  =  TRUE" << endl;
		list.push_back(make_tuple(16, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A9] == true)
	{
		//cout << "17 : xx11_OF_A9 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A9]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_figaro_17_05::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_05::runOnceInteractionStep_propagate_effect_S()
{
	if (((boolState[S_OF_A9] || boolState[S_OF_A1]) || boolState[S_OF_A10]) || boolState[S_OF_A11] )
	{
	...
	if (boolState[S_OF_A13] && boolState[S_OF_A12] )
	{
		boolState[S_OF_A14]  =  true;
	}

	if (((boolState[S_OF_A2] || boolState[S_OF_A4]) || boolState[S_OF_A3]) || boolState[S_OF_A1] )
	{
...
void storm::figaro::FigaroProgram_figaro_17_05::runOnceInteractionStep_propagate_effect_required()
{
	if (( !boolState[required_OF_A12]) && ( !boolState[required_OF_A7]) )
	{
		boolState[required_OF_A1]  =  false;
	}

	if ((boolState[relevant_evt_OF_A12] && ( !boolState[S_OF_A12])) || (boolState[relevant_evt_OF_A7] && ( !boolState[S_OF_A7])) )
	{
	...
	if (( !boolState[required_OF_A14]) || ( !boolState[S_OF_A12]) )
	{
	...
	if ((boolState[relevant_evt_OF_A13] && ( !boolState[S_OF_A13])) || (boolState[relevant_evt_OF_A8] && ( !boolState[S_OF_A8])) )
	{
		boolState[relevant_evt_OF_A7]  =  true;
	}

	if (( !boolState[required_OF_A13]) || ( !boolState[S_OF_A7]) )
	{
...
void storm::figaro::FigaroProgram_figaro_17_05::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_17_05::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_05::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_05::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_05::fireinsttransitiongroup(std::string user_input_ins)
