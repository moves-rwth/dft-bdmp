#include <iostream>
#include "FigaroModelfigaro_17_13.h"
...
void storm::figaro::FigaroProgram_figaro_17_13::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_13::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_13::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_13::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_13::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_figaro_17_13::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_13::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_13::showFireableOccurrences()
{
	...
	if ((boolState[failI_OF_A3] == false) && boolState[to_be_fired_OF_A3])
	{
		//cout << "4 :  INS_SUB_COUNT (1) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.01) | INDUCING boolState[failI_OF_A3]  =  TRUE,already_standby_OF_A3  =  FALSE,already_required_OF_A3  =  FALSE" << endl;
		list.push_back(make_tuple(4, 0.01, "INS", 1));
	}
	if ((boolState[failI_OF_A3] == false) && boolState[to_be_fired_OF_A3])
	{
		//cout << "5 :  INS_SUB_COUNT (1) |TRANSITION | good | DIST INS (0.99) | INDUCING boolState[already_standby_OF_A3]  =  FALSE,already_required_OF_A3  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.99, "INS", 1));
	}
        if (list.size() > 0)
        {
	...
	if ((boolState[failF_OF_A4] == false) && boolState[required_OF_A4])
	{
		//cout << "7 : xx10_OF_A4 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A4]  =  TRUE" << endl;
		list.push_back(make_tuple(7, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A4] == true)
	{
		//cout << "8 : xx11_OF_A4 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A4]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_figaro_17_13::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_13::runOnceInteractionStep_propagate_effect_S()
{
	if (boolState[S_OF_A4] || boolState[S_OF_A3] )
	{
		boolState[S_OF_A5]  =  true;
	}

	if (boolState[S_OF_A2] || boolState[S_OF_A1] )
	{
		boolState[S_OF_A6]  =  true;
	}

	if (((boolState[S_OF_A2] && boolState[S_OF_A1]) && boolState[already_S_OF_A1]) && ( !  boolState[already_S_OF_A2]) )
	{
		boolState[S_OF_A7]  =  true;
	}

	if (boolState[already_S_OF_A7] && (boolState[S_OF_A1] && boolState[S_OF_A2]) )
	{
		boolState[S_OF_A7]  =  true;
	}

	if (boolState[S_OF_A2] && boolState[S_OF_A5] )
	{
...
void storm::figaro::FigaroProgram_figaro_17_13::runOnceInteractionStep_propagate_effect_required()
{
	if (( !boolState[required_OF_A6]) && ( !boolState[required_OF_A7]) )
	{
		boolState[required_OF_A1]  =  false;
	}

	if ((boolState[relevant_evt_OF_A6] && ( !boolState[S_OF_A6])) || (boolState[relevant_evt_OF_A7] && ( !boolState[S_OF_A7])) )
	{
		boolState[relevant_evt_OF_A1]  =  true;
	}

	if ((( !boolState[required_OF_A7]) && ( !boolState[required_OF_A6])) && ( !  boolState[required_OF_A8]) )
	{
		boolState[required_OF_A2]  =  false;
	}

	if (((boolState[relevant_evt_OF_A7] && ( !boolState[S_OF_A7])) || (boolState[relevant_evt_OF_A6] && ( !boolState[S_OF_A6]))) || (boolState[relevant_evt_OF_A8] && ( !boolState[S_OF_A8])) )
	{
...
void storm::figaro::FigaroProgram_figaro_17_13::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_figaro_17_13::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_figaro_17_13::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_13::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_13::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_13::fireinsttransitiongroup(std::string user_input_ins)
