#include <iostream>
#include "FigaroModelfigaro_17_12.h"
...
void storm::figaro::FigaroProgram_figaro_17_12::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_12::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_12::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_12::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_12::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_figaro_17_12::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_12::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_12::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_figaro_17_12::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_12::runOnceInteractionStep_propagate_effect_S()
{
	...
	if (boolState[S_OF_A1] && boolState[S_OF_A4] )
	{
		boolState[S_OF_A5]  =  true;
	}

	if (boolState[S_OF_A5] )
	{
...
void storm::figaro::FigaroProgram_figaro_17_12::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_figaro_17_12::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_figaro_17_12::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_figaro_17_12::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_12::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_12::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_12::fireinsttransitiongroup(std::string user_input_ins)
