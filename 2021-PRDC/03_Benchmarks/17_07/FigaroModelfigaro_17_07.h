    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_figaro_17_07: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_figaro_17_07(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_A1" , 0},
            	{"already_S_OF_A1" , 1},
            	{"S_OF_A1" , 2},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
			...
			std::string const trigger_kind_OF_t_4 = "fn_fathers_opp_trig";
			...
			std::string const calculate_required_OF_A1 = "fn_fathers_opp_trig";
