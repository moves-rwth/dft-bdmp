#include <iostream>
#include "FigaroModelfigaro_10_vot.h"
...
void storm::figaro::FigaroProgram_figaro_10_vot::init()
{
	...
	REINITIALISATION_OF_required_OF_K_N_1 = true;
	boolState[already_S_OF_K_N_1] = false;
	REINITIALISATION_OF_S_OF_K_N_1 = false;
	REINITIALISATION_OF_relevant_evt_OF_K_N_1 = false;
...
void storm::figaro::FigaroProgram_figaro_10_vot::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_10_vot::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_10_vot::printState()
{
	...
	//cout << "Attribute :  boolState[required_OF_K_N_1] | Value : " << boolState[required_OF_K_N_1] << endl;
	//cout << "Attribute :  boolState[already_S_OF_K_N_1] | Value : " << boolState[already_S_OF_K_N_1] << endl;
	//cout << "Attribute :  boolState[S_OF_K_N_1] | Value : " << boolState[S_OF_K_N_1] << endl;
	//cout << "Attribute :  boolState[relevant_evt_OF_K_N_1] | Value : " << boolState[relevant_evt_OF_K_N_1] << endl;
...
bool storm::figaro::FigaroProgram_figaro_10_vot::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_10_vot::doReinitialisations()
{
	...
	boolState[required_OF_K_N_1] = REINITIALISATION_OF_required_OF_K_N_1;
	boolState[S_OF_K_N_1] = REINITIALISATION_OF_S_OF_K_N_1;
	boolState[relevant_evt_OF_K_N_1] = REINITIALISATION_OF_relevant_evt_OF_K_N_1;
...
void storm::figaro::FigaroProgram_figaro_10_vot::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_10_vot::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_figaro_10_vot::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_F_1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_10_vot::runOnceInteractionStep_propagate_effect_S()
{
	if ((2 <= (boolState[S_OF_F_1] + boolState[S_OF_F_2] + boolState[S_OF_F_3])) )
	{
		boolState[S_OF_K_N_1]  =  true;
	}

	if (boolState[S_OF_K_N_1] )
	{
...
void storm::figaro::FigaroProgram_figaro_10_vot::runOnceInteractionStep_propagate_effect_required()
{
	if ( !boolState[required_OF_K_N_1] )
	{
		boolState[required_OF_F_1]  =  false;
	}

	if (boolState[relevant_evt_OF_K_N_1] && ( !boolState[S_OF_K_N_1]) )
	{
	...
	{
		boolState[required_OF_K_N_1]  =  false;
	}

	if (boolState[relevant_evt_OF_UE_1] && ( !boolState[S_OF_UE_1]) )
	{
		boolState[relevant_evt_OF_K_N_1]  =  true;
	}
...
void storm::figaro::FigaroProgram_figaro_10_vot::runOnceInteractionStep_propagate_leaves()
{
	...
	boolState[already_S_OF_K_N_1]  =  boolState[S_OF_K_N_1]  ;
...
void
storm::figaro::FigaroProgram_figaro_10_vot::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_10_vot::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_10_vot::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_10_vot::fireinsttransitiongroup(std::string user_input_ins)
