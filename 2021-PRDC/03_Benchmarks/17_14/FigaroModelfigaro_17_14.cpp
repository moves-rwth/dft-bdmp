#include <iostream>
#include "FigaroModelfigaro_17_14.h"
...
void storm::figaro::FigaroProgram_figaro_17_14::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_14::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_14::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_14::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_14::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_17_14::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_14::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_14::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_figaro_17_14::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_14::runOnceInteractionStep_propagate_effect_S()
{
	...
	if (boolState[already_S_OF_A4] && (boolState[S_OF_A1] && boolState[S_OF_A2]) )
	{
		boolState[S_OF_A4]  =  true;
	}
...
void storm::figaro::FigaroProgram_figaro_17_14::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_figaro_17_14::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_17_14::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_14::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_14::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_14::fireinsttransitiongroup(std::string user_input_ins)
