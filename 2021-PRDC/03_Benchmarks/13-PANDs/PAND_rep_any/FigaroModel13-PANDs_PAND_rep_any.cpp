#include <iostream>
#include "FigaroModel13-PANDs_PAND_rep_any.h"
...
void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::init()
{
...
void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::compareStates()
{
...
void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::printState()
{
...
bool storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_F_1] == true )
	{
...
void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_13-PANDs_PAND_rep_any::fireinsttransitiongroup(std::string user_input_ins)
