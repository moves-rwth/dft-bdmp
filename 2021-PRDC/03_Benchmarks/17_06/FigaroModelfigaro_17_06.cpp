#include <iostream>
#include "FigaroModelfigaro_17_06.h"
...
void storm::figaro::FigaroProgram_figaro_17_06::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_06::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_06::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_06::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_06::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_17_06::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_06::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_06::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_figaro_17_06::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_F_1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_06::runOnceInteractionStep_propagate_effect_S()
{
	if (boolState[S_OF_OR_1] || boolState[S_OF_F_3] )
	{
		boolState[S_OF_A1]  =  true;
	}

	if (boolState[S_OF_F_2] || boolState[S_OF_F_1] )
	{
...
void storm::figaro::FigaroProgram_figaro_17_06::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_figaro_17_06::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_17_06::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_06::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_06::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_06::fireinsttransitiongroup(std::string user_input_ins)
