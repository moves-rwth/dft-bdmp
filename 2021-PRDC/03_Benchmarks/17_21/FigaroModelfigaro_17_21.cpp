#include <iostream>
#include "FigaroModelfigaro_17_21.h"
...
void storm::figaro::FigaroProgram_figaro_17_21::init()
{
...
void storm::figaro::FigaroProgram_figaro_17_21::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_21::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_21::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_17_21::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_17_21::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_17_21::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_21::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_A2] == false) && boolState[required_OF_A2])
	{
		//cout << "2 : xx10_OF_A2 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.05)  INDUCING boolState[failF_OF_A2]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 0.05, "EXP", 0));
	}
	if (boolState[failF_OF_A2] == true)
	{
	...
	if ((boolState[failF_OF_A3] == false) && boolState[required_OF_A3])
	{
		//cout << "4 : xx10_OF_A3 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.1)  INDUCING boolState[failF_OF_A3]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_A4] == false) && boolState[required_OF_A4])
	{
		//cout << "6 : xx10_OF_A4 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.1)  INDUCING boolState[failF_OF_A4]  =  TRUE" << endl;
...
void storm::figaro::FigaroProgram_figaro_17_21::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_21::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_figaro_17_21::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_A6] && ( !boolState[S_OF_A6])) || (boolState[relevant_evt_OF_A4] && ( !boolState[S_OF_A4])) )
	{
...
void storm::figaro::FigaroProgram_figaro_17_21::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_17_21::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_21::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_21::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_21::fireinsttransitiongroup(std::string user_input_ins)
