    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_figaro_13_PAND_rep_all: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_figaro_13_PAND_rep_all(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_F_1" , 0},
            	{"already_S_OF_F_1" , 1},
            	{"S_OF_F_1" , 2},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
			...
			std::string const step_down_OF_THEN_3 = "rep_all";
			std::string const step_down_OF_THEN_4 = "rep_all";
			...
			std::string const step_down_OF_THEN_1 = "rep_all";
