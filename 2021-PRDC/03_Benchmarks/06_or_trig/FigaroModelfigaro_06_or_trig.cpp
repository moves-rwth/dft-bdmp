#include <iostream>
#include "FigaroModelfigaro_06_or_trig.h"
...
void storm::figaro::FigaroProgram_figaro_06_or_trig::init()
{
...
void storm::figaro::FigaroProgram_figaro_06_or_trig::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_06_or_trig::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_06_or_trig::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_06_or_trig::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_06_or_trig::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_06_or_trig::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_06_or_trig::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_figaro_06_or_trig::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_F_1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_06_or_trig::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_figaro_06_or_trig::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_OR_1] && ( !boolState[S_OF_OR_1])) || (boolState[relevant_evt_OF_F_2] && ( !boolState[S_OF_F_2])) )
	{
		boolState[relevant_evt_OF_F_1]  =  true;
	}

	if (( !boolState[required_OF_OR_1]) || ( !boolState[S_OF_F_1]) )
	{
...
void storm::figaro::FigaroProgram_figaro_06_or_trig::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_06_or_trig::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_06_or_trig::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_06_or_trig::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_06_or_trig::fireinsttransitiongroup(std::string user_input_ins)
