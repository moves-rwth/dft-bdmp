    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_figaro_02_or: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_figaro_02_or(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_F_1" , 0},
            	{"already_S_OF_F_1" , 1},
            	{"S_OF_F_1" , 2},
