#include <iostream>
#include "FigaroModelfigaro_02_or.h"
...
void storm::figaro::FigaroProgram_figaro_02_or::init()
{
...
void storm::figaro::FigaroProgram_figaro_02_or::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_02_or::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_02_or::printState()
{
...
bool storm::figaro::FigaroProgram_figaro_02_or::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_figaro_02_or::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_figaro_02_or::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_02_or::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_figaro_02_or::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_F_1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_02_or::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_figaro_02_or::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_figaro_02_or::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_figaro_02_or::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_02_or::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_02_or::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_02_or::fireinsttransitiongroup(std::string user_input_ins)
