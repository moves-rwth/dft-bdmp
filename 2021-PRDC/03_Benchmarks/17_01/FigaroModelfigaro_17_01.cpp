#include <iostream>
#include "FigaroModelfigaro_17_01.h"
...
void storm::figaro::FigaroProgram_figaro_17_01::init()
{
	...
	boolState[failI_OF_A5] = false;
	REINITIALISATION_OF_to_be_fired_OF_A5 = false;
	boolState[already_standby_OF_A5] = false;
	boolState[already_required_OF_A5] = false;
	...
	FIRE_xx23_OF_A3_INS_4 = false;
	FIRE_xx23_OF_A3_INS_5 = false;
	FIRE_xx24_OF_A3 = false;
	FIRE_xx23_OF_A4_INS_7 = false;
	FIRE_xx23_OF_A4_INS_8 = false;
	FIRE_xx24_OF_A4 = false;
	FIRE_xx23_OF_A5_INS_10 = false;
	FIRE_xx23_OF_A5_INS_11 = false;
	FIRE_xx24_OF_A5 = false;
	FIRE_xx10_OF_A6 = false;
	FIRE_xx11_OF_A6 = false;

}

void storm::figaro::FigaroProgram_figaro_17_01::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_figaro_17_01::compareStates()
{
...
void storm::figaro::FigaroProgram_figaro_17_01::printState()
{
	...
	//cout << "Attribute :  boolState[failI_OF_A5] | Value : " << boolState[failI_OF_A5] << endl;
	//cout << "Attribute :  boolState[to_be_fired_OF_A5] | Value : " << boolState[to_be_fired_OF_A5] << endl;
	//cout << "Attribute :  boolState[already_standby_OF_A5] | Value : " << boolState[already_standby_OF_A5] << endl;
	//cout << "Attribute :  boolState[already_required_OF_A5] | Value : " << boolState[already_required_OF_A5] << endl;
...
bool storm::figaro::FigaroProgram_figaro_17_01::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_figaro_17_01::doReinitialisations()
{
	...
	boolState[to_be_fired_OF_A5] = REINITIALISATION_OF_to_be_fired_OF_A5;
...
void storm::figaro::FigaroProgram_figaro_17_01::fireOccurrence(int numFire)
{
	...
	if (numFire == 4)
	{
		FIRE_xx23_OF_A3_INS_4 = true;
	}

	if (numFire == 5)
	{
		FIRE_xx23_OF_A3_INS_5 = true;
	}
	...
	if (numFire == 7)
	{
		FIRE_xx23_OF_A4_INS_7 = true;
	}

	if (numFire == 8)
	{
		FIRE_xx23_OF_A4_INS_8 = true;
	}
	...
	if (numFire == 10)
	{
		FIRE_xx23_OF_A5_INS_10 = true;
	}

	if (numFire == 11)
	{
		FIRE_xx23_OF_A5_INS_11 = true;
	}

	if (numFire == 12)
	{
		FIRE_xx24_OF_A5 = true;
	}
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	// Occurrence xx23_OF_A5

	if ((boolState[failI_OF_A5] == false) && boolState[to_be_fired_OF_A5]) 
	{
	
		
		if (FIRE_xx23_OF_A5_INS_10) 
		{
			boolState[failI_OF_A5]  =  true;
			boolState[already_standby_OF_A5]  =  false;
			boolState[already_required_OF_A5]  =  false;
			FIRE_xx23_OF_A5_INS_10 = false;
		}
	...
	// Occurrence xx24_OF_A5
	if (boolState[failI_OF_A5] == true) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_figaro_17_01::showFireableOccurrences()
{
	...
	if ((boolState[failI_OF_A3] == false) && boolState[to_be_fired_OF_A3])
	{
		//cout << "4 :  INS_SUB_COUNT (1) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.5) | INDUCING boolState[failI_OF_A3]  =  TRUE,already_standby_OF_A3  =  FALSE,already_required_OF_A3  =  FALSE" << endl;
		list.push_back(make_tuple(4, 0.5, "INS", 1));
	}
	if ((boolState[failI_OF_A3] == false) && boolState[to_be_fired_OF_A3])
	{
		//cout << "5 :  INS_SUB_COUNT (1) |TRANSITION | good | DIST INS (0.5) | INDUCING boolState[already_standby_OF_A3]  =  FALSE,already_required_OF_A3  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.5, "INS", 1));
	}
	if ((boolState[failI_OF_A4] == false) && boolState[to_be_fired_OF_A4])
	{
		//cout << "7 :  INS_SUB_COUNT (2) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.5) | INDUCING boolState[failI_OF_A4]  =  TRUE,already_standby_OF_A4  =  FALSE,already_required_OF_A4  =  FALSE" << endl;
		list.push_back(make_tuple(7, 0.5, "INS", 2));
	}
	if ((boolState[failI_OF_A4] == false) && boolState[to_be_fired_OF_A4])
	{
		//cout << "8 :  INS_SUB_COUNT (2) |TRANSITION | good | DIST INS (0.5) | INDUCING boolState[already_standby_OF_A4]  =  FALSE,already_required_OF_A4  =  FALSE" << endl;
		list.push_back(make_tuple(8, 0.5, "INS", 2));
	}
	if ((boolState[failI_OF_A5] == false) && boolState[to_be_fired_OF_A5])
	{
		//cout << "10 :  INS_SUB_COUNT (3) |FAULT | failI  LABEL \"défaillance instantanée %OBJET\" | DIST INS (0.5) | INDUCING boolState[failI_OF_A5]  =  TRUE,already_standby_OF_A5  =  FALSE,already_required_OF_A5  =  FALSE" << endl;
		list.push_back(make_tuple(10, 0.5, "INS", 3));
	}
	if ((boolState[failI_OF_A5] == false) && boolState[to_be_fired_OF_A5])
	{
		//cout << "11 :  INS_SUB_COUNT (3) |TRANSITION | good | DIST INS (0.5) | INDUCING boolState[already_standby_OF_A5]  =  FALSE,already_required_OF_A5  =  FALSE" << endl;
		list.push_back(make_tuple(11, 0.5, "INS", 3));
	}
        if (list.size() > 0)
        {
	...
	if (boolState[failI_OF_A3] == true)
	{
		//cout << "6 : xx24_OF_A3 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_A3]  =  FALSE" << endl;
		list.push_back(make_tuple(6, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_A4] == true)
	{
		//cout << "9 : xx24_OF_A4 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_A4]  =  FALSE" << endl;
		list.push_back(make_tuple(9, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_A5] == true)
	{
		//cout << "12 : xx24_OF_A5 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_A5]  =  FALSE" << endl;
		list.push_back(make_tuple(12, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A6] == false) && boolState[required_OF_A6])
	{
		//cout << "13 : xx10_OF_A6 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.01)  INDUCING boolState[failF_OF_A6]  =  TRUE" << endl;
		list.push_back(make_tuple(13, 0.01, "EXP", 0));
	}
	if (boolState[failF_OF_A6] == true)
	{
		//cout << "14 : xx11_OF_A6 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A6]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_figaro_17_01::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_figaro_17_01::runOnceInteractionStep_propagate_effect_S()
{
	...
	if (((boolState[S_OF_A3] || boolState[S_OF_A4]) || boolState[S_OF_A5]) || boolState[S_OF_A6] )
	{
		boolState[S_OF_A8]  =  true;
	}

	if (boolState[S_OF_A8] && boolState[S_OF_A7] )
	{
...
void storm::figaro::FigaroProgram_figaro_17_01::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_A7] && ( !boolState[S_OF_A7])) || (boolState[relevant_evt_OF_A3] && ( !boolState[S_OF_A3])) )
	{
		boolState[relevant_evt_OF_A2]  =  true;
	}

	if (( !boolState[required_OF_A8]) || boolState[S_OF_A2] )
	{
	...
	if (( !boolState[required_OF_A9]) || ( !boolState[S_OF_A7]) )
	{
...
void storm::figaro::FigaroProgram_figaro_17_01::runOnceInteractionStep_propagate_leaves()
{
	...
	if (( !boolState[required_OF_A5]) && (( !boolState[already_standby_OF_A5]) && (   !boolState[already_required_OF_A5])) )
	{
		boolState[already_standby_OF_A5]  =  true;
	}
...
void storm::figaro::FigaroProgram_figaro_17_01::runOnceInteractionStep_tops()
{
	...
	if (boolState[required_OF_A5] && boolState[already_standby_OF_A5] )
	{
		boolState[to_be_fired_OF_A5]  =  true;
	}

}

void
storm::figaro::FigaroProgram_figaro_17_01::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_figaro_17_01::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_figaro_17_01::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_figaro_17_01::fireinsttransitiongroup(std::string user_input_ins)
