...
res1=$(date +%s.%N)
python3 ../../PythonScript/src/main.py -i '01.fi' -o 'DummyForPNPRO.modest'
...
rm *.parsing *.net *.def *.PNPRO
exit
storm-gspn -gspn ../BENCHMARK/BENCHMARK.PNPRO  --exportGspn:to-jani ../BENCHMARK/temp.jani  --gspn:capacity 1
