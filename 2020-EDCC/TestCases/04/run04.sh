...
res1=$(date +%s.%N)
python3 ../../PythonScript/src/main.py -i '04-algebra.fi' -o 'DummyForPNPRO.modest'
...
#storm --jani ../BENCHMARK/temp.jani --prop "Pmin=? [F<=2 FAIL>0];Pmin=? [F<=10 FAIL>0] "  --precision 1e-6
