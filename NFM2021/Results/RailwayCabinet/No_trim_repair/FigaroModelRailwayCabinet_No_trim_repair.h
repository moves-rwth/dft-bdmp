    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_RailwayCabinet_No_trim_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_RailwayCabinet_No_trim_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
