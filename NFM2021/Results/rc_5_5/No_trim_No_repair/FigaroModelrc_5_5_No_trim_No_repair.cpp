#include <iostream>
#include "FigaroModelrc_5_5_No_trim_No_repair.h"
...
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::init()
{
...
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_mp1] == false) && boolState[required_OF_mp1]) 
	{
	...
	if ((boolState[failF_OF_mp2] == false) && boolState[required_OF_mp2]) 
	{
	...
	if ((boolState[failF_OF_mp3] == false) && boolState[required_OF_mp3]) 
	{
	...
	if ((boolState[failF_OF_mp4] == false) && boolState[required_OF_mp4]) 
	{
	...
	if ((boolState[failF_OF_mp5] == false) && boolState[required_OF_mp5]) 
	{
	...
	if ((boolState[failF_OF_ms1] == false) && boolState[required_OF_ms1]) 
	{
	...
	if ((boolState[failF_OF_ms2] == false) && boolState[required_OF_ms2]) 
	{
	...
	if ((boolState[failF_OF_ms3] == false) && boolState[required_OF_ms3]) 
	{
	...
	if ((boolState[failF_OF_ms4] == false) && boolState[required_OF_ms4]) 
	{
	...
	if ((boolState[failF_OF_ms5] == false) && boolState[required_OF_ms5]) 
	{
	...
	if ((boolState[failF_OF_network_1] == false) && boolState[required_OF_network_1]) 
	{
	...
	if ((boolState[failF_OF_network_2] == false) && boolState[required_OF_network_2]) 
	{
	...
	if ((boolState[failF_OF_network_3] == false) && boolState[required_OF_network_3]) 
	{
	...
	if ((boolState[failF_OF_network_4] == false) && boolState[required_OF_network_4]) 
	{
	...
	if ((boolState[failF_OF_network_5] == false) && boolState[required_OF_network_5]) 
	{
	...
	if ((boolState[failF_OF_sA_1] == false) && boolState[required_OF_sA_1]) 
	{
	...
	if ((boolState[failF_OF_sA_2] == false) && boolState[required_OF_sA_2]) 
	{
	...
	if ((boolState[failF_OF_sA_3] == false) && boolState[required_OF_sA_3]) 
	{
	...
	if ((boolState[failF_OF_sA_4] == false) && boolState[required_OF_sA_4]) 
	{
	...
	if ((boolState[failF_OF_sA_5] == false) && boolState[required_OF_sA_5]) 
	{
	...
	if ((boolState[failF_OF_sB_1] == false) && boolState[required_OF_sB_1]) 
	{
	...
	if ((boolState[failF_OF_sB_2] == false) && boolState[required_OF_sB_2]) 
	{
	...
	if ((boolState[failF_OF_sB_3] == false) && boolState[required_OF_sB_3]) 
	{
	...
	if ((boolState[failF_OF_sB_4] == false) && boolState[required_OF_sB_4]) 
	{
	...
	if ((boolState[failF_OF_sB_5] == false) && boolState[required_OF_sB_5]) 
	{
	...
	if ((boolState[failF_OF_sC_1] == false) && boolState[required_OF_sC_1]) 
	{
	...
	if ((boolState[failF_OF_sC_2] == false) && boolState[required_OF_sC_2]) 
	{
	...
	if ((boolState[failF_OF_sC_3] == false) && boolState[required_OF_sC_3]) 
	{
	...
	if ((boolState[failF_OF_sC_4] == false) && boolState[required_OF_sC_4]) 
	{
	...
	if ((boolState[failF_OF_sC_5] == false) && boolState[required_OF_sC_5]) 
	{
	...
	if ((boolState[failF_OF_sD_1] == false) && boolState[required_OF_sD_1]) 
	{
	...
	if ((boolState[failF_OF_sD_2] == false) && boolState[required_OF_sD_2]) 
	{
	...
	if ((boolState[failF_OF_sD_3] == false) && boolState[required_OF_sD_3]) 
	{
	...
	if ((boolState[failF_OF_sD_4] == false) && boolState[required_OF_sD_4]) 
	{
	...
	if ((boolState[failF_OF_sD_5] == false) && boolState[required_OF_sD_5]) 
	{
	...
	if ((boolState[failF_OF_sw_1] == false) && boolState[required_OF_sw_1]) 
	{
	...
	if ((boolState[failF_OF_sw_2] == false) && boolState[required_OF_sw_2]) 
	{
	...
	if ((boolState[failF_OF_sw_3] == false) && boolState[required_OF_sw_3]) 
	{
	...
	if ((boolState[failF_OF_sw_4] == false) && boolState[required_OF_sw_4]) 
	{
	...
	if ((boolState[failF_OF_sw_5] == false) && boolState[required_OF_sw_5]) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_rc_5_5_No_trim_No_repair::fireinsttransitiongroup(std::string user_input_ins)
