    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_rc_5_5_Trim_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_rc_5_5_Trim_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
