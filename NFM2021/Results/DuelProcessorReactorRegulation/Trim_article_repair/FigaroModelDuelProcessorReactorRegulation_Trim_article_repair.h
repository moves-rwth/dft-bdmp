    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_DuelProcessorReactorRegulation_Trim_article_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_DuelProcessorReactorRegulation_Trim_article_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
