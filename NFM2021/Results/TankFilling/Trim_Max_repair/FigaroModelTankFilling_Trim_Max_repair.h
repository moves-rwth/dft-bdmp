    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_TankFilling_Trim_Max_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_TankFilling_Trim_Max_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
