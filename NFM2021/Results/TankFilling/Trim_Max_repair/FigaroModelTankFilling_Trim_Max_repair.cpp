#include <iostream>
#include "FigaroModelTankFilling_Trim_Max_repair.h"
...
void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::init()
{
	...
	FIRE_xx11_OF_CCFV12 = false;
	FIRE_xx10_OF_CCFVSOL12 = false;
	FIRE_xx11_OF_CCFVSOL12 = false;
	FIRE_xx10_OF_Filling = false;
	FIRE_xx11_OF_Filling = false;
	FIRE_xx10_OF_LSH1 = false;
	FIRE_xx11_OF_LSH1 = false;
	FIRE_xx10_OF_PSH1 = false;
	FIRE_xx11_OF_PSH1 = false;
	FIRE_xx10_OF_V1 = false;
	FIRE_xx11_OF_V1 = false;
	FIRE_xx10_OF_V2 = false;
	FIRE_xx11_OF_V2 = false;
	FIRE_xx10_OF_VSOL1 = false;
	FIRE_xx11_OF_VSOL1 = false;
	FIRE_xx10_OF_VSOL2 = false;
	FIRE_xx11_OF_VSOL2 = false;

}

void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::printState()
{
...
bool storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	// Occurrence xx11_OF_CCFV12
	if (boolState[failF_OF_CCFV12] == true) 
	{
		 
		if (FIRE_xx11_OF_CCFV12)
		{
			boolState[failF_OF_CCFV12]  =  false;
			FIRE_xx11_OF_CCFV12 = false;
		}
	...
	// Occurrence xx11_OF_CCFVSOL12
	if (boolState[failF_OF_CCFVSOL12] == true) 
	{
		 
		if (FIRE_xx11_OF_CCFVSOL12)
		{
			boolState[failF_OF_CCFVSOL12]  =  false;
			FIRE_xx11_OF_CCFVSOL12 = false;
		}
	...
	// Occurrence xx11_OF_Filling
	if (boolState[failF_OF_Filling] == true) 
	{
		 
		if (FIRE_xx11_OF_Filling)
		{
			boolState[failF_OF_Filling]  =  false;
			FIRE_xx11_OF_Filling = false;
		}
	...
	// Occurrence xx11_OF_LSH1
	if (boolState[failF_OF_LSH1] == true) 
	{
		 
		if (FIRE_xx11_OF_LSH1)
		{
			boolState[failF_OF_LSH1]  =  false;
			FIRE_xx11_OF_LSH1 = false;
		}
	...
	// Occurrence xx11_OF_PSH1
	if (boolState[failF_OF_PSH1] == true) 
	{
		 
		if (FIRE_xx11_OF_PSH1)
		{
			boolState[failF_OF_PSH1]  =  false;
			FIRE_xx11_OF_PSH1 = false;
		}
	...
	// Occurrence xx11_OF_VSOL1
	if (boolState[failF_OF_VSOL1] == true) 
	{
		 
		if (FIRE_xx11_OF_VSOL1)
		{
			boolState[failF_OF_VSOL1]  =  false;
			FIRE_xx11_OF_VSOL1 = false;
		}
	...
	// Occurrence xx11_OF_VSOL2
	if (boolState[failF_OF_VSOL2] == true) 
	{
		 
		if (FIRE_xx11_OF_VSOL2)
		{
			boolState[failF_OF_VSOL2]  =  false;
			FIRE_xx11_OF_VSOL2 = false;
		}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::showFireableOccurrences()
{
	...
	if (boolState[failF_OF_CCFV12] == true)
	{
		//cout << "1 : xx11_OF_CCFV12 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_CCFV12]  =  FALSE" << endl;
		list.push_back(make_tuple(1, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_CCFVSOL12] == false) && (boolState[required_OF_CCFVSOL12] && boolState[relevant_evt_OF_CCFVSOL12]))
	{
		//cout << "2 : xx10_OF_CCFVSOL12 : FAULT failF  LABEL \"failure in operation CCFVSOL12\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_CCFVSOL12]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_CCFVSOL12] == true)
	{
		//cout << "3 : xx11_OF_CCFVSOL12 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_CCFVSOL12]  =  FALSE" << endl;
		list.push_back(make_tuple(3, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_Filling] == false) && (boolState[required_OF_Filling] && boolState[relevant_evt_OF_Filling]))
	{
		//cout << "4 : xx10_OF_Filling : FAULT failF  LABEL \"failure in operation Filling\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Filling]  =  TRUE" << endl;
		list.push_back(make_tuple(4, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_Filling] == true)
	{
		//cout << "5 : xx11_OF_Filling : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_Filling]  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_LSH1] == false) && (boolState[required_OF_LSH1] && boolState[relevant_evt_OF_LSH1]))
	{
		//cout << "6 : xx10_OF_LSH1 : FAULT failF  LABEL \"failure in operation LSH1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_LSH1]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_LSH1] == true)
	{
		//cout << "7 : xx11_OF_LSH1 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_LSH1]  =  FALSE" << endl;
		list.push_back(make_tuple(7, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_PSH1] == false) && (boolState[required_OF_PSH1] && boolState[relevant_evt_OF_PSH1]))
	{
		//cout << "8 : xx10_OF_PSH1 : FAULT failF  LABEL \"failure in operation PSH1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_PSH1]  =  TRUE" << endl;
		list.push_back(make_tuple(8, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_PSH1] == true)
	{
		//cout << "9 : xx11_OF_PSH1 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_PSH1]  =  FALSE" << endl;
		list.push_back(make_tuple(9, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_V1] == false) && (boolState[required_OF_V1] && boolState[relevant_evt_OF_V1]))
	{
		//cout << "10 : xx10_OF_V1 : FAULT failF  LABEL \"failure in operation V1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_V1]  =  TRUE" << endl;
		list.push_back(make_tuple(10, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_V1] == true)
	{
		//cout << "11 : xx11_OF_V1 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_V1]  =  FALSE" << endl;
		list.push_back(make_tuple(11, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_V2] == false) && (boolState[required_OF_V2] && boolState[relevant_evt_OF_V2]))
	{
		//cout << "12 : xx10_OF_V2 : FAULT failF  LABEL \"failure in operation V2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_V2]  =  TRUE" << endl;
		list.push_back(make_tuple(12, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_V2] == true)
	{
		//cout << "13 : xx11_OF_V2 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_V2]  =  FALSE" << endl;
		list.push_back(make_tuple(13, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_VSOL1] == false) && (boolState[required_OF_VSOL1] && boolState[relevant_evt_OF_VSOL1]))
	{
		//cout << "14 : xx10_OF_VSOL1 : FAULT failF  LABEL \"failure in operation VSOL1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_VSOL1]  =  TRUE" << endl;
		list.push_back(make_tuple(14, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_VSOL1] == true)
	{
		//cout << "15 : xx11_OF_VSOL1 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_VSOL1]  =  FALSE" << endl;
		list.push_back(make_tuple(15, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_VSOL2] == false) && (boolState[required_OF_VSOL2] && boolState[relevant_evt_OF_VSOL2]))
	{
		//cout << "16 : xx10_OF_VSOL2 : FAULT failF  LABEL \"failure in operation VSOL2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_VSOL2]  =  TRUE" << endl;
		list.push_back(make_tuple(16, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_VSOL2] == true)
	{
		//cout << "17 : xx11_OF_VSOL2 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_VSOL2]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_CCFV12] == true )
	{
...
void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_TankFilling_Trim_Max_repair::fireinsttransitiongroup(std::string user_input_ins)
