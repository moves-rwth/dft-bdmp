    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_TankFilling_No_trim_No_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_TankFilling_No_trim_No_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
