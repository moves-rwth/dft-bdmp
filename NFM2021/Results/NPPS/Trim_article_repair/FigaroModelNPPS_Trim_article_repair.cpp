#include <iostream>
#include "FigaroModelNPPS_Trim_article_repair.h"
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::init()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_NPPS_Trim_article_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::printState()
{
...
bool storm::figaro::FigaroProgram_NPPS_Trim_article_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_NPPS_Trim_article_repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_BAT_A1] == true )
	{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_NPPS_Trim_article_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_NPPS_Trim_article_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_NPPS_Trim_article_repair::fireinsttransitiongroup(std::string user_input_ins)
