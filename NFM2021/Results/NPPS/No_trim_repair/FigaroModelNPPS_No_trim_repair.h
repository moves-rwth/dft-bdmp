    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_NPPS_No_trim_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_NPPS_No_trim_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_3" , 0},
