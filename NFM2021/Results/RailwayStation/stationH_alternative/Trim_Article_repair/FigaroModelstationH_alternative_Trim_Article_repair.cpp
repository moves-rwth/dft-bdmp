#include <iostream>
#include "FigaroModelstationH_alternative_Trim_Article_repair.h"
...
void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::init()
{
...
void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::printState()
{
...
bool storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	// Occurrence xx11_OF_A152
	if (boolState[failF_OF_A152] == true) 
	{
		 
		if (FIRE_xx11_OF_A152)
		{
			boolState[failF_OF_A152]  =  false;
			FIRE_xx11_OF_A152 = false;
		}
	...
	// Occurrence xx11_OF_A161
	if (boolState[failF_OF_A161] == true) 
	{
		 
		if (FIRE_xx11_OF_A161)
		{
			boolState[failF_OF_A161]  =  false;
			FIRE_xx11_OF_A161 = false;
		}
	...
	// Occurrence xx11_OF_A162
	if (boolState[failF_OF_A162] == true) 
	{
		 
		if (FIRE_xx11_OF_A162)
		{
			boolState[failF_OF_A162]  =  false;
			FIRE_xx11_OF_A162 = false;
		}
	...
	// Occurrence xx11_OF_A166
	if (boolState[failF_OF_A166] == true) 
	{
		 
		if (FIRE_xx11_OF_A166)
		{
			boolState[failF_OF_A166]  =  false;
			FIRE_xx11_OF_A166 = false;
		}
	...
	// Occurrence xx11_OF_A171
	if (boolState[failF_OF_A171] == true) 
	{
		 
		if (FIRE_xx11_OF_A171)
		{
			boolState[failF_OF_A171]  =  false;
			FIRE_xx11_OF_A171 = false;
		}
	...
	// Occurrence xx11_OF_A178
	if (boolState[failF_OF_A178] == true) 
	{
		 
		if (FIRE_xx11_OF_A178)
		{
			boolState[failF_OF_A178]  =  false;
			FIRE_xx11_OF_A178 = false;
		}
	...
	// Occurrence xx11_OF_A182
	if (boolState[failF_OF_A182] == true) 
	{
		 
		if (FIRE_xx11_OF_A182)
		{
			boolState[failF_OF_A182]  =  false;
			FIRE_xx11_OF_A182 = false;
		}
	...
	// Occurrence xx11_OF_A183
	if (boolState[failF_OF_A183] == true) 
	{
		 
		if (FIRE_xx11_OF_A183)
		{
			boolState[failF_OF_A183]  =  false;
			FIRE_xx11_OF_A183 = false;
		}
	...
	// Occurrence xx11_OF_A184
	if (boolState[failF_OF_A184] == true) 
	{
		 
		if (FIRE_xx11_OF_A184)
		{
			boolState[failF_OF_A184]  =  false;
			FIRE_xx11_OF_A184 = false;
		}
	...
	// Occurrence xx11_OF_A185
	if (boolState[failF_OF_A185] == true) 
	{
		 
		if (FIRE_xx11_OF_A185)
		{
			boolState[failF_OF_A185]  =  false;
			FIRE_xx11_OF_A185 = false;
		}
	...
	// Occurrence xx11_OF_A187
	if (boolState[failF_OF_A187] == true) 
	{
		 
		if (FIRE_xx11_OF_A187)
		{
			boolState[failF_OF_A187]  =  false;
			FIRE_xx11_OF_A187 = false;
		}
	...
	// Occurrence xx11_OF_A188
	if (boolState[failF_OF_A188] == true) 
	{
		 
		if (FIRE_xx11_OF_A188)
		{
			boolState[failF_OF_A188]  =  false;
			FIRE_xx11_OF_A188 = false;
		}
	...
	// Occurrence xx11_OF_A190
	if (boolState[failF_OF_A190] == true) 
	{
		 
		if (FIRE_xx11_OF_A190)
		{
			boolState[failF_OF_A190]  =  false;
			FIRE_xx11_OF_A190 = false;
		}
	...
	// Occurrence xx11_OF_A191
	if (boolState[failF_OF_A191] == true) 
	{
		 
		if (FIRE_xx11_OF_A191)
		{
			boolState[failF_OF_A191]  =  false;
			FIRE_xx11_OF_A191 = false;
		}
	...
	// Occurrence xx11_OF_A192
	if (boolState[failF_OF_A192] == true) 
	{
		 
		if (FIRE_xx11_OF_A192)
		{
			boolState[failF_OF_A192]  =  false;
			FIRE_xx11_OF_A192 = false;
		}
	...
	// Occurrence xx11_OF_A193
	if (boolState[failF_OF_A193] == true) 
	{
		 
		if (FIRE_xx11_OF_A193)
		{
			boolState[failF_OF_A193]  =  false;
			FIRE_xx11_OF_A193 = false;
		}
	...
	// Occurrence xx11_OF_A198
	if (boolState[failF_OF_A198] == true) 
	{
		 
		if (FIRE_xx11_OF_A198)
		{
			boolState[failF_OF_A198]  =  false;
			FIRE_xx11_OF_A198 = false;
		}
	...
	// Occurrence xx11_OF_A199
	if (boolState[failF_OF_A199] == true) 
	{
		 
		if (FIRE_xx11_OF_A199)
		{
			boolState[failF_OF_A199]  =  false;
			FIRE_xx11_OF_A199 = false;
		}
	...
	// Occurrence xx11_OF_A200
	if (boolState[failF_OF_A200] == true) 
	{
		 
		if (FIRE_xx11_OF_A200)
		{
			boolState[failF_OF_A200]  =  false;
			FIRE_xx11_OF_A200 = false;
		}
	...
	// Occurrence xx11_OF_A201
	if (boolState[failF_OF_A201] == true) 
	{
		 
		if (FIRE_xx11_OF_A201)
		{
			boolState[failF_OF_A201]  =  false;
			FIRE_xx11_OF_A201 = false;
		}
	...
	// Occurrence xx11_OF_A203
	if (boolState[failF_OF_A203] == true) 
	{
		 
		if (FIRE_xx11_OF_A203)
		{
			boolState[failF_OF_A203]  =  false;
			FIRE_xx11_OF_A203 = false;
		}
	...
	// Occurrence xx11_OF_A204
	if (boolState[failF_OF_A204] == true) 
	{
		 
		if (FIRE_xx11_OF_A204)
		{
			boolState[failF_OF_A204]  =  false;
			FIRE_xx11_OF_A204 = false;
		}
	...
	// Occurrence xx11_OF_A206
	if (boolState[failF_OF_A206] == true) 
	{
		 
		if (FIRE_xx11_OF_A206)
		{
			boolState[failF_OF_A206]  =  false;
			FIRE_xx11_OF_A206 = false;
		}
	...
	// Occurrence xx11_OF_A207
	if (boolState[failF_OF_A207] == true) 
	{
		 
		if (FIRE_xx11_OF_A207)
		{
			boolState[failF_OF_A207]  =  false;
			FIRE_xx11_OF_A207 = false;
		}
	...
	// Occurrence xx11_OF_A208
	if (boolState[failF_OF_A208] == true) 
	{
		 
		if (FIRE_xx11_OF_A208)
		{
			boolState[failF_OF_A208]  =  false;
			FIRE_xx11_OF_A208 = false;
		}
	...
	// Occurrence xx11_OF_A209
	if (boolState[failF_OF_A209] == true) 
	{
		 
		if (FIRE_xx11_OF_A209)
		{
			boolState[failF_OF_A209]  =  false;
			FIRE_xx11_OF_A209 = false;
		}
	...
	// Occurrence xx11_OF_A212
	if (boolState[failF_OF_A212] == true) 
	{
		 
		if (FIRE_xx11_OF_A212)
		{
			boolState[failF_OF_A212]  =  false;
			FIRE_xx11_OF_A212 = false;
		}
	...
	// Occurrence xx11_OF_A213
	if (boolState[failF_OF_A213] == true) 
	{
		 
		if (FIRE_xx11_OF_A213)
		{
			boolState[failF_OF_A213]  =  false;
			FIRE_xx11_OF_A213 = false;
		}
	...
	// Occurrence xx11_OF_A214
	if (boolState[failF_OF_A214] == true) 
	{
		 
		if (FIRE_xx11_OF_A214)
		{
			boolState[failF_OF_A214]  =  false;
			FIRE_xx11_OF_A214 = false;
		}
	...
	// Occurrence xx11_OF_A215
	if (boolState[failF_OF_A215] == true) 
	{
		 
		if (FIRE_xx11_OF_A215)
		{
			boolState[failF_OF_A215]  =  false;
			FIRE_xx11_OF_A215 = false;
		}
	...
	// Occurrence xx11_OF_A217
	if (boolState[failF_OF_A217] == true) 
	{
		 
		if (FIRE_xx11_OF_A217)
		{
			boolState[failF_OF_A217]  =  false;
			FIRE_xx11_OF_A217 = false;
		}
	...
	// Occurrence xx11_OF_A218
	if (boolState[failF_OF_A218] == true) 
	{
		 
		if (FIRE_xx11_OF_A218)
		{
			boolState[failF_OF_A218]  =  false;
			FIRE_xx11_OF_A218 = false;
		}
	...
	// Occurrence xx11_OF_A220
	if (boolState[failF_OF_A220] == true) 
	{
		 
		if (FIRE_xx11_OF_A220)
		{
			boolState[failF_OF_A220]  =  false;
			FIRE_xx11_OF_A220 = false;
		}
	...
	// Occurrence xx11_OF_A221
	if (boolState[failF_OF_A221] == true) 
	{
		 
		if (FIRE_xx11_OF_A221)
		{
			boolState[failF_OF_A221]  =  false;
			FIRE_xx11_OF_A221 = false;
		}
	...
	// Occurrence xx11_OF_A222
	if (boolState[failF_OF_A222] == true) 
	{
		 
		if (FIRE_xx11_OF_A222)
		{
			boolState[failF_OF_A222]  =  false;
			FIRE_xx11_OF_A222 = false;
		}
	...
	// Occurrence xx11_OF_A223
	if (boolState[failF_OF_A223] == true) 
	{
		 
		if (FIRE_xx11_OF_A223)
		{
			boolState[failF_OF_A223]  =  false;
			FIRE_xx11_OF_A223 = false;
		}
	...
	// Occurrence xx11_OF_A239
	if (boolState[failF_OF_A239] == true) 
	{
		 
		if (FIRE_xx11_OF_A239)
		{
			boolState[failF_OF_A239]  =  false;
			FIRE_xx11_OF_A239 = false;
		}
	...
	// Occurrence xx11_OF_A240
	if (boolState[failF_OF_A240] == true) 
	{
		 
		if (FIRE_xx11_OF_A240)
		{
			boolState[failF_OF_A240]  =  false;
			FIRE_xx11_OF_A240 = false;
		}
	...
	// Occurrence xx11_OF_A241
	if (boolState[failF_OF_A241] == true) 
	{
		 
		if (FIRE_xx11_OF_A241)
		{
			boolState[failF_OF_A241]  =  false;
			FIRE_xx11_OF_A241 = false;
		}
	...
	// Occurrence xx11_OF_A242
	if (boolState[failF_OF_A242] == true) 
	{
		 
		if (FIRE_xx11_OF_A242)
		{
			boolState[failF_OF_A242]  =  false;
			FIRE_xx11_OF_A242 = false;
		}
	...
	// Occurrence xx11_OF_A244
	if (boolState[failF_OF_A244] == true) 
	{
		 
		if (FIRE_xx11_OF_A244)
		{
			boolState[failF_OF_A244]  =  false;
			FIRE_xx11_OF_A244 = false;
		}
	...
	// Occurrence xx11_OF_A245
	if (boolState[failF_OF_A245] == true) 
	{
		 
		if (FIRE_xx11_OF_A245)
		{
			boolState[failF_OF_A245]  =  false;
			FIRE_xx11_OF_A245 = false;
		}
	...
	// Occurrence xx11_OF_A247
	if (boolState[failF_OF_A247] == true) 
	{
		 
		if (FIRE_xx11_OF_A247)
		{
			boolState[failF_OF_A247]  =  false;
			FIRE_xx11_OF_A247 = false;
		}
	...
	// Occurrence xx11_OF_A248
	if (boolState[failF_OF_A248] == true) 
	{
		 
		if (FIRE_xx11_OF_A248)
		{
			boolState[failF_OF_A248]  =  false;
			FIRE_xx11_OF_A248 = false;
		}
	...
	// Occurrence xx11_OF_A249
	if (boolState[failF_OF_A249] == true) 
	{
		 
		if (FIRE_xx11_OF_A249)
		{
			boolState[failF_OF_A249]  =  false;
			FIRE_xx11_OF_A249 = false;
		}
	...
	// Occurrence xx11_OF_A250
	if (boolState[failF_OF_A250] == true) 
	{
		 
		if (FIRE_xx11_OF_A250)
		{
			boolState[failF_OF_A250]  =  false;
			FIRE_xx11_OF_A250 = false;
		}
	...
	// Occurrence xx11_OF_A256
	if (boolState[failF_OF_A256] == true) 
	{
		 
		if (FIRE_xx11_OF_A256)
		{
			boolState[failF_OF_A256]  =  false;
			FIRE_xx11_OF_A256 = false;
		}
	...
	// Occurrence xx11_OF_A257
	if (boolState[failF_OF_A257] == true) 
	{
		 
		if (FIRE_xx11_OF_A257)
		{
			boolState[failF_OF_A257]  =  false;
			FIRE_xx11_OF_A257 = false;
		}
	...
	// Occurrence xx11_OF_A258
	if (boolState[failF_OF_A258] == true) 
	{
		 
		if (FIRE_xx11_OF_A258)
		{
			boolState[failF_OF_A258]  =  false;
			FIRE_xx11_OF_A258 = false;
		}
	...
	// Occurrence xx11_OF_A259
	if (boolState[failF_OF_A259] == true) 
	{
		 
		if (FIRE_xx11_OF_A259)
		{
			boolState[failF_OF_A259]  =  false;
			FIRE_xx11_OF_A259 = false;
		}
	...
	// Occurrence xx11_OF_A261
	if (boolState[failF_OF_A261] == true) 
	{
		 
		if (FIRE_xx11_OF_A261)
		{
			boolState[failF_OF_A261]  =  false;
			FIRE_xx11_OF_A261 = false;
		}
	...
	// Occurrence xx11_OF_A262
	if (boolState[failF_OF_A262] == true) 
	{
		 
		if (FIRE_xx11_OF_A262)
		{
			boolState[failF_OF_A262]  =  false;
			FIRE_xx11_OF_A262 = false;
		}
	...
	// Occurrence xx11_OF_A264
	if (boolState[failF_OF_A264] == true) 
	{
		 
		if (FIRE_xx11_OF_A264)
		{
			boolState[failF_OF_A264]  =  false;
			FIRE_xx11_OF_A264 = false;
		}
	...
	// Occurrence xx11_OF_A265
	if (boolState[failF_OF_A265] == true) 
	{
		 
		if (FIRE_xx11_OF_A265)
		{
			boolState[failF_OF_A265]  =  false;
			FIRE_xx11_OF_A265 = false;
		}
	...
	// Occurrence xx11_OF_A266
	if (boolState[failF_OF_A266] == true) 
	{
		 
		if (FIRE_xx11_OF_A266)
		{
			boolState[failF_OF_A266]  =  false;
			FIRE_xx11_OF_A266 = false;
		}
	...
	// Occurrence xx11_OF_A267
	if (boolState[failF_OF_A267] == true) 
	{
		 
		if (FIRE_xx11_OF_A267)
		{
			boolState[failF_OF_A267]  =  false;
			FIRE_xx11_OF_A267 = false;
		}
	...
	// Occurrence xx11_OF_A272
	if (boolState[failF_OF_A272] == true) 
	{
		 
		if (FIRE_xx11_OF_A272)
		{
			boolState[failF_OF_A272]  =  false;
			FIRE_xx11_OF_A272 = false;
		}
	...
	// Occurrence xx11_OF_A273
	if (boolState[failF_OF_A273] == true) 
	{
		 
		if (FIRE_xx11_OF_A273)
		{
			boolState[failF_OF_A273]  =  false;
			FIRE_xx11_OF_A273 = false;
		}
	...
	// Occurrence xx11_OF_A274
	if (boolState[failF_OF_A274] == true) 
	{
		 
		if (FIRE_xx11_OF_A274)
		{
			boolState[failF_OF_A274]  =  false;
			FIRE_xx11_OF_A274 = false;
		}
	...
	// Occurrence xx11_OF_A275
	if (boolState[failF_OF_A275] == true) 
	{
		 
		if (FIRE_xx11_OF_A275)
		{
			boolState[failF_OF_A275]  =  false;
			FIRE_xx11_OF_A275 = false;
		}
	...
	// Occurrence xx11_OF_A277
	if (boolState[failF_OF_A277] == true) 
	{
		 
		if (FIRE_xx11_OF_A277)
		{
			boolState[failF_OF_A277]  =  false;
			FIRE_xx11_OF_A277 = false;
		}
	...
	// Occurrence xx11_OF_A278
	if (boolState[failF_OF_A278] == true) 
	{
		 
		if (FIRE_xx11_OF_A278)
		{
			boolState[failF_OF_A278]  =  false;
			FIRE_xx11_OF_A278 = false;
		}
	...
	// Occurrence xx11_OF_A280
	if (boolState[failF_OF_A280] == true) 
	{
		 
		if (FIRE_xx11_OF_A280)
		{
			boolState[failF_OF_A280]  =  false;
			FIRE_xx11_OF_A280 = false;
		}
	...
	// Occurrence xx11_OF_A281
	if (boolState[failF_OF_A281] == true) 
	{
		 
		if (FIRE_xx11_OF_A281)
		{
			boolState[failF_OF_A281]  =  false;
			FIRE_xx11_OF_A281 = false;
		}
	...
	// Occurrence xx11_OF_A282
	if (boolState[failF_OF_A282] == true) 
	{
		 
		if (FIRE_xx11_OF_A282)
		{
			boolState[failF_OF_A282]  =  false;
			FIRE_xx11_OF_A282 = false;
		}
	...
	// Occurrence xx11_OF_A283
	if (boolState[failF_OF_A283] == true) 
	{
		 
		if (FIRE_xx11_OF_A283)
		{
			boolState[failF_OF_A283]  =  false;
			FIRE_xx11_OF_A283 = false;
		}
	...
	// Occurrence xx11_OF_A288
	if (boolState[failF_OF_A288] == true) 
	{
		 
		if (FIRE_xx11_OF_A288)
		{
			boolState[failF_OF_A288]  =  false;
			FIRE_xx11_OF_A288 = false;
		}
	...
	// Occurrence xx11_OF_A289
	if (boolState[failF_OF_A289] == true) 
	{
		 
		if (FIRE_xx11_OF_A289)
		{
			boolState[failF_OF_A289]  =  false;
			FIRE_xx11_OF_A289 = false;
		}
	...
	// Occurrence xx11_OF_A290
	if (boolState[failF_OF_A290] == true) 
	{
		 
		if (FIRE_xx11_OF_A290)
		{
			boolState[failF_OF_A290]  =  false;
			FIRE_xx11_OF_A290 = false;
		}
	...
	// Occurrence xx11_OF_A291
	if (boolState[failF_OF_A291] == true) 
	{
		 
		if (FIRE_xx11_OF_A291)
		{
			boolState[failF_OF_A291]  =  false;
			FIRE_xx11_OF_A291 = false;
		}
	...
	// Occurrence xx11_OF_A293
	if (boolState[failF_OF_A293] == true) 
	{
		 
		if (FIRE_xx11_OF_A293)
		{
			boolState[failF_OF_A293]  =  false;
			FIRE_xx11_OF_A293 = false;
		}
	...
	// Occurrence xx11_OF_A294
	if (boolState[failF_OF_A294] == true) 
	{
		 
		if (FIRE_xx11_OF_A294)
		{
			boolState[failF_OF_A294]  =  false;
			FIRE_xx11_OF_A294 = false;
		}
	...
	// Occurrence xx11_OF_A296
	if (boolState[failF_OF_A296] == true) 
	{
		 
		if (FIRE_xx11_OF_A296)
		{
			boolState[failF_OF_A296]  =  false;
			FIRE_xx11_OF_A296 = false;
		}
	...
	// Occurrence xx11_OF_A297
	if (boolState[failF_OF_A297] == true) 
	{
		 
		if (FIRE_xx11_OF_A297)
		{
			boolState[failF_OF_A297]  =  false;
			FIRE_xx11_OF_A297 = false;
		}
	...
	// Occurrence xx11_OF_A298
	if (boolState[failF_OF_A298] == true) 
	{
		 
		if (FIRE_xx11_OF_A298)
		{
			boolState[failF_OF_A298]  =  false;
			FIRE_xx11_OF_A298 = false;
		}
	...
	// Occurrence xx11_OF_A299
	if (boolState[failF_OF_A299] == true) 
	{
		 
		if (FIRE_xx11_OF_A299)
		{
			boolState[failF_OF_A299]  =  false;
			FIRE_xx11_OF_A299 = false;
		}
	...
	// Occurrence xx11_OF_A317
	if (boolState[failF_OF_A317] == true) 
	{
		 
		if (FIRE_xx11_OF_A317)
		{
			boolState[failF_OF_A317]  =  false;
			FIRE_xx11_OF_A317 = false;
		}
	...
	// Occurrence xx11_OF_A318
	if (boolState[failF_OF_A318] == true) 
	{
		 
		if (FIRE_xx11_OF_A318)
		{
			boolState[failF_OF_A318]  =  false;
			FIRE_xx11_OF_A318 = false;
		}
	...
	// Occurrence xx11_OF_A319
	if (boolState[failF_OF_A319] == true) 
	{
		 
		if (FIRE_xx11_OF_A319)
		{
			boolState[failF_OF_A319]  =  false;
			FIRE_xx11_OF_A319 = false;
		}
	...
	// Occurrence xx11_OF_A320
	if (boolState[failF_OF_A320] == true) 
	{
		 
		if (FIRE_xx11_OF_A320)
		{
			boolState[failF_OF_A320]  =  false;
			FIRE_xx11_OF_A320 = false;
		}
	...
	// Occurrence xx11_OF_A322
	if (boolState[failF_OF_A322] == true) 
	{
		 
		if (FIRE_xx11_OF_A322)
		{
			boolState[failF_OF_A322]  =  false;
			FIRE_xx11_OF_A322 = false;
		}
	...
	// Occurrence xx11_OF_A323
	if (boolState[failF_OF_A323] == true) 
	{
		 
		if (FIRE_xx11_OF_A323)
		{
			boolState[failF_OF_A323]  =  false;
			FIRE_xx11_OF_A323 = false;
		}
	...
	// Occurrence xx11_OF_A325
	if (boolState[failF_OF_A325] == true) 
	{
		 
		if (FIRE_xx11_OF_A325)
		{
			boolState[failF_OF_A325]  =  false;
			FIRE_xx11_OF_A325 = false;
		}
	...
	// Occurrence xx11_OF_A326
	if (boolState[failF_OF_A326] == true) 
	{
		 
		if (FIRE_xx11_OF_A326)
		{
			boolState[failF_OF_A326]  =  false;
			FIRE_xx11_OF_A326 = false;
		}
	...
	// Occurrence xx11_OF_A327
	if (boolState[failF_OF_A327] == true) 
	{
		 
		if (FIRE_xx11_OF_A327)
		{
			boolState[failF_OF_A327]  =  false;
			FIRE_xx11_OF_A327 = false;
		}
	...
	// Occurrence xx11_OF_A328
	if (boolState[failF_OF_A328] == true) 
	{
		 
		if (FIRE_xx11_OF_A328)
		{
			boolState[failF_OF_A328]  =  false;
			FIRE_xx11_OF_A328 = false;
		}
	...
	// Occurrence xx11_OF_A333
	if (boolState[failF_OF_A333] == true) 
	{
		 
		if (FIRE_xx11_OF_A333)
		{
			boolState[failF_OF_A333]  =  false;
			FIRE_xx11_OF_A333 = false;
		}
	...
	// Occurrence xx11_OF_A335
	if (boolState[failF_OF_A335] == true) 
	{
		 
		if (FIRE_xx11_OF_A335)
		{
			boolState[failF_OF_A335]  =  false;
			FIRE_xx11_OF_A335 = false;
		}
	...
	// Occurrence xx11_OF_A337
	if (boolState[failF_OF_A337] == true) 
	{
		 
		if (FIRE_xx11_OF_A337)
		{
			boolState[failF_OF_A337]  =  false;
			FIRE_xx11_OF_A337 = false;
		}
	...
	// Occurrence xx11_OF_A338
	if (boolState[failF_OF_A338] == true) 
	{
		 
		if (FIRE_xx11_OF_A338)
		{
			boolState[failF_OF_A338]  =  false;
			FIRE_xx11_OF_A338 = false;
		}
	...
	// Occurrence xx11_OF_A339
	if (boolState[failF_OF_A339] == true) 
	{
		 
		if (FIRE_xx11_OF_A339)
		{
			boolState[failF_OF_A339]  =  false;
			FIRE_xx11_OF_A339 = false;
		}
	...
	// Occurrence xx11_OF_A340
	if (boolState[failF_OF_A340] == true) 
	{
		 
		if (FIRE_xx11_OF_A340)
		{
			boolState[failF_OF_A340]  =  false;
			FIRE_xx11_OF_A340 = false;
		}
	...
	// Occurrence xx11_OF_A342
	if (boolState[failF_OF_A342] == true) 
	{
		 
		if (FIRE_xx11_OF_A342)
		{
			boolState[failF_OF_A342]  =  false;
			FIRE_xx11_OF_A342 = false;
		}
	...
	// Occurrence xx11_OF_A343
	if (boolState[failF_OF_A343] == true) 
	{
		 
		if (FIRE_xx11_OF_A343)
		{
			boolState[failF_OF_A343]  =  false;
			FIRE_xx11_OF_A343 = false;
		}
	...
	// Occurrence xx11_OF_A345
	if (boolState[failF_OF_A345] == true) 
	{
		 
		if (FIRE_xx11_OF_A345)
		{
			boolState[failF_OF_A345]  =  false;
			FIRE_xx11_OF_A345 = false;
		}
	...
	// Occurrence xx11_OF_A346
	if (boolState[failF_OF_A346] == true) 
	{
		 
		if (FIRE_xx11_OF_A346)
		{
			boolState[failF_OF_A346]  =  false;
			FIRE_xx11_OF_A346 = false;
		}
	...
	// Occurrence xx11_OF_A347
	if (boolState[failF_OF_A347] == true) 
	{
		 
		if (FIRE_xx11_OF_A347)
		{
			boolState[failF_OF_A347]  =  false;
			FIRE_xx11_OF_A347 = false;
		}
	...
	// Occurrence xx11_OF_A348
	if (boolState[failF_OF_A348] == true) 
	{
		 
		if (FIRE_xx11_OF_A348)
		{
			boolState[failF_OF_A348]  =  false;
			FIRE_xx11_OF_A348 = false;
		}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_A106] == false) && (boolState[required_OF_A106] && boolState[relevant_evt_OF_A106]))
	{
		//cout << "2 : xx10_OF_A106 : FAULT failF  LABEL \"failure in operation A106\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A106]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A106] == true)
	{
		//cout << "3 : xx11_OF_A106 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A106]  =  FALSE" << endl;
		list.push_back(make_tuple(3, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A107] == false) && (boolState[required_OF_A107] && boolState[relevant_evt_OF_A107]))
	{
		//cout << "4 : xx10_OF_A107 : FAULT failF  LABEL \"failure in operation A107\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A107]  =  TRUE" << endl;
		list.push_back(make_tuple(4, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A107] == true)
	{
		//cout << "5 : xx11_OF_A107 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A107]  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A108] == false) && (boolState[required_OF_A108] && boolState[relevant_evt_OF_A108]))
	{
		//cout << "6 : xx10_OF_A108 : FAULT failF  LABEL \"failure in operation A108\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A108]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A108] == true)
	{
		//cout << "7 : xx11_OF_A108 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A108]  =  FALSE" << endl;
		list.push_back(make_tuple(7, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A109] == false) && (boolState[required_OF_A109] && boolState[relevant_evt_OF_A109]))
	{
		//cout << "8 : xx10_OF_A109 : FAULT failF  LABEL \"failure in operation A109\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A109]  =  TRUE" << endl;
		list.push_back(make_tuple(8, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A109] == true)
	{
		//cout << "9 : xx11_OF_A109 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A109]  =  FALSE" << endl;
		list.push_back(make_tuple(9, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A111] == false) && (boolState[required_OF_A111] && boolState[relevant_evt_OF_A111]))
	{
		//cout << "10 : xx10_OF_A111 : FAULT failF  LABEL \"failure in operation A111\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A111]  =  TRUE" << endl;
		list.push_back(make_tuple(10, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A111] == true)
	{
		//cout << "11 : xx11_OF_A111 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A111]  =  FALSE" << endl;
		list.push_back(make_tuple(11, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A112] == false) && (boolState[required_OF_A112] && boolState[relevant_evt_OF_A112]))
	{
		//cout << "12 : xx10_OF_A112 : FAULT failF  LABEL \"failure in operation A112\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A112]  =  TRUE" << endl;
		list.push_back(make_tuple(12, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A112] == true)
	{
		//cout << "13 : xx11_OF_A112 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A112]  =  FALSE" << endl;
		list.push_back(make_tuple(13, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A114] == false) && (boolState[required_OF_A114] && boolState[relevant_evt_OF_A114]))
	{
		//cout << "14 : xx10_OF_A114 : FAULT failF  LABEL \"failure in operation A114\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A114]  =  TRUE" << endl;
		list.push_back(make_tuple(14, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A114] == true)
	{
		//cout << "15 : xx11_OF_A114 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A114]  =  FALSE" << endl;
		list.push_back(make_tuple(15, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A115] == false) && (boolState[required_OF_A115] && boolState[relevant_evt_OF_A115]))
	{
		//cout << "16 : xx10_OF_A115 : FAULT failF  LABEL \"failure in operation A115\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A115]  =  TRUE" << endl;
		list.push_back(make_tuple(16, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A115] == true)
	{
		//cout << "17 : xx11_OF_A115 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A115]  =  FALSE" << endl;
		list.push_back(make_tuple(17, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A116] == false) && (boolState[required_OF_A116] && boolState[relevant_evt_OF_A116]))
	{
		//cout << "18 : xx10_OF_A116 : FAULT failF  LABEL \"failure in operation A116\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A116]  =  TRUE" << endl;
		list.push_back(make_tuple(18, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A116] == true)
	{
		//cout << "19 : xx11_OF_A116 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A116]  =  FALSE" << endl;
		list.push_back(make_tuple(19, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A117] == false) && (boolState[required_OF_A117] && boolState[relevant_evt_OF_A117]))
	{
		//cout << "20 : xx10_OF_A117 : FAULT failF  LABEL \"failure in operation A117\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A117]  =  TRUE" << endl;
		list.push_back(make_tuple(20, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A117] == true)
	{
		//cout << "21 : xx11_OF_A117 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A117]  =  FALSE" << endl;
		list.push_back(make_tuple(21, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A12] == false) && (boolState[required_OF_A12] && boolState[relevant_evt_OF_A12]))
	{
		//cout << "22 : xx10_OF_A12 : FAULT failF  LABEL \"failure in operation A12\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A12]  =  TRUE" << endl;
		list.push_back(make_tuple(22, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A12] == true)
	{
	...
	if ((boolState[failF_OF_A127] == false) && (boolState[required_OF_A127] && boolState[relevant_evt_OF_A127]))
	{
		//cout << "24 : xx10_OF_A127 : FAULT failF  LABEL \"failure in operation A127\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A127]  =  TRUE" << endl;
		list.push_back(make_tuple(24, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A127] == true)
	{
		//cout << "25 : xx11_OF_A127 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A127]  =  FALSE" << endl;
		list.push_back(make_tuple(25, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A128] == false) && (boolState[required_OF_A128] && boolState[relevant_evt_OF_A128]))
	{
		//cout << "26 : xx10_OF_A128 : FAULT failF  LABEL \"failure in operation A128\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A128]  =  TRUE" << endl;
		list.push_back(make_tuple(26, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A128] == true)
	{
		//cout << "27 : xx11_OF_A128 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A128]  =  FALSE" << endl;
		list.push_back(make_tuple(27, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A129] == false) && (boolState[required_OF_A129] && boolState[relevant_evt_OF_A129]))
	{
		//cout << "28 : xx10_OF_A129 : FAULT failF  LABEL \"failure in operation A129\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A129]  =  TRUE" << endl;
		list.push_back(make_tuple(28, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A129] == true)
	{
		//cout << "29 : xx11_OF_A129 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A129]  =  FALSE" << endl;
		list.push_back(make_tuple(29, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A13] == false) && (boolState[required_OF_A13] && boolState[relevant_evt_OF_A13]))
	{
		//cout << "30 : xx10_OF_A13 : FAULT failF  LABEL \"failure in operation A13\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A13]  =  TRUE" << endl;
		list.push_back(make_tuple(30, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A13] == true)
	{
		//cout << "31 : xx11_OF_A13 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A13]  =  FALSE" << endl;
		list.push_back(make_tuple(31, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A130] == false) && (boolState[required_OF_A130] && boolState[relevant_evt_OF_A130]))
	{
		//cout << "32 : xx10_OF_A130 : FAULT failF  LABEL \"failure in operation A130\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A130]  =  TRUE" << endl;
		list.push_back(make_tuple(32, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A130] == true)
	{
		//cout << "33 : xx11_OF_A130 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A130]  =  FALSE" << endl;
		list.push_back(make_tuple(33, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A132] == false) && (boolState[required_OF_A132] && boolState[relevant_evt_OF_A132]))
	{
		//cout << "34 : xx10_OF_A132 : FAULT failF  LABEL \"failure in operation A132\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A132]  =  TRUE" << endl;
		list.push_back(make_tuple(34, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A132] == true)
	{
		//cout << "35 : xx11_OF_A132 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A132]  =  FALSE" << endl;
		list.push_back(make_tuple(35, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A133] == false) && (boolState[required_OF_A133] && boolState[relevant_evt_OF_A133]))
	{
		//cout << "36 : xx10_OF_A133 : FAULT failF  LABEL \"failure in operation A133\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A133]  =  TRUE" << endl;
		list.push_back(make_tuple(36, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A133] == true)
	{
		//cout << "37 : xx11_OF_A133 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A133]  =  FALSE" << endl;
		list.push_back(make_tuple(37, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A135] == false) && (boolState[required_OF_A135] && boolState[relevant_evt_OF_A135]))
	{
		//cout << "38 : xx10_OF_A135 : FAULT failF  LABEL \"failure in operation A135\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A135]  =  TRUE" << endl;
		list.push_back(make_tuple(38, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A135] == true)
	{
		//cout << "39 : xx11_OF_A135 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A135]  =  FALSE" << endl;
		list.push_back(make_tuple(39, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A136] == false) && (boolState[required_OF_A136] && boolState[relevant_evt_OF_A136]))
	{
		//cout << "40 : xx10_OF_A136 : FAULT failF  LABEL \"failure in operation A136\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A136]  =  TRUE" << endl;
		list.push_back(make_tuple(40, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A136] == true)
	{
		//cout << "41 : xx11_OF_A136 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A136]  =  FALSE" << endl;
		list.push_back(make_tuple(41, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A137] == false) && (boolState[required_OF_A137] && boolState[relevant_evt_OF_A137]))
	{
		//cout << "42 : xx10_OF_A137 : FAULT failF  LABEL \"failure in operation A137\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A137]  =  TRUE" << endl;
		list.push_back(make_tuple(42, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A137] == true)
	{
		//cout << "43 : xx11_OF_A137 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A137]  =  FALSE" << endl;
		list.push_back(make_tuple(43, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A138] == false) && (boolState[required_OF_A138] && boolState[relevant_evt_OF_A138]))
	{
		//cout << "44 : xx10_OF_A138 : FAULT failF  LABEL \"failure in operation A138\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A138]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_A14] == false) && (boolState[required_OF_A14] && boolState[relevant_evt_OF_A14]))
	{
		//cout << "46 : xx10_OF_A14 : FAULT failF  LABEL \"failure in operation A14\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A14]  =  TRUE" << endl;
		list.push_back(make_tuple(46, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A14] == true)
	{
		//cout << "47 : xx11_OF_A14 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A14]  =  FALSE" << endl;
		list.push_back(make_tuple(47, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A144] == false) && (boolState[required_OF_A144] && boolState[relevant_evt_OF_A144]))
	{
		//cout << "48 : xx10_OF_A144 : FAULT failF  LABEL \"failure in operation A144\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A144]  =  TRUE" << endl;
		list.push_back(make_tuple(48, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A144] == true)
	{
		//cout << "49 : xx11_OF_A144 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A144]  =  FALSE" << endl;
		list.push_back(make_tuple(49, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A145] == false) && (boolState[required_OF_A145] && boolState[relevant_evt_OF_A145]))
	{
		//cout << "50 : xx10_OF_A145 : FAULT failF  LABEL \"failure in operation A145\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A145]  =  TRUE" << endl;
		list.push_back(make_tuple(50, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A145] == true)
	{
		//cout << "51 : xx11_OF_A145 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A145]  =  FALSE" << endl;
		list.push_back(make_tuple(51, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A146] == false) && (boolState[required_OF_A146] && boolState[relevant_evt_OF_A146]))
	{
		//cout << "52 : xx10_OF_A146 : FAULT failF  LABEL \"failure in operation A146\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A146]  =  TRUE" << endl;
		list.push_back(make_tuple(52, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A146] == true)
	{
		//cout << "53 : xx11_OF_A146 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A146]  =  FALSE" << endl;
		list.push_back(make_tuple(53, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A147] == false) && (boolState[required_OF_A147] && boolState[relevant_evt_OF_A147]))
	{
		//cout << "54 : xx10_OF_A147 : FAULT failF  LABEL \"failure in operation A147\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A147]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_A149] == false) && (boolState[required_OF_A149] && boolState[relevant_evt_OF_A149]))
	{
		//cout << "56 : xx10_OF_A149 : FAULT failF  LABEL \"failure in operation A149\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A149]  =  TRUE" << endl;
		list.push_back(make_tuple(56, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A149] == true)
	{
		//cout << "57 : xx11_OF_A149 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A149]  =  FALSE" << endl;
		list.push_back(make_tuple(57, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A15] == false) && (boolState[required_OF_A15] && boolState[relevant_evt_OF_A15]))
	{
		//cout << "58 : xx10_OF_A15 : FAULT failF  LABEL \"failure in operation A15\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A15]  =  TRUE" << endl;
		list.push_back(make_tuple(58, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A15] == true)
	{
		//cout << "59 : xx11_OF_A15 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A15]  =  FALSE" << endl;
		list.push_back(make_tuple(59, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A150] == false) && (boolState[required_OF_A150] && boolState[relevant_evt_OF_A150]))
	{
		//cout << "60 : xx10_OF_A150 : FAULT failF  LABEL \"failure in operation A150\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A150]  =  TRUE" << endl;
		list.push_back(make_tuple(60, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A150] == true)
	{
	...
	if ((boolState[failF_OF_A152] == false) && (boolState[required_OF_A152] && boolState[relevant_evt_OF_A152]))
	{
		//cout << "62 : xx10_OF_A152 : FAULT failF  LABEL \"failure in operation A152\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A152]  =  TRUE" << endl;
		list.push_back(make_tuple(62, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A152] == true)
	{
		//cout << "63 : xx11_OF_A152 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A152]  =  FALSE" << endl;
		list.push_back(make_tuple(63, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A153] == false) && (boolState[required_OF_A153] && boolState[relevant_evt_OF_A153]))
	{
		//cout << "64 : xx10_OF_A153 : FAULT failF  LABEL \"failure in operation A153\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A153]  =  TRUE" << endl;
		list.push_back(make_tuple(64, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A153] == true)
	{
		//cout << "65 : xx11_OF_A153 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A153]  =  FALSE" << endl;
		list.push_back(make_tuple(65, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A154] == false) && (boolState[required_OF_A154] && boolState[relevant_evt_OF_A154]))
	{
		//cout << "66 : xx10_OF_A154 : FAULT failF  LABEL \"failure in operation A154\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A154]  =  TRUE" << endl;
		list.push_back(make_tuple(66, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A154] == true)
	{
		//cout << "67 : xx11_OF_A154 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A154]  =  FALSE" << endl;
		list.push_back(make_tuple(67, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A155] == false) && (boolState[required_OF_A155] && boolState[relevant_evt_OF_A155]))
	{
		//cout << "68 : xx10_OF_A155 : FAULT failF  LABEL \"failure in operation A155\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A155]  =  TRUE" << endl;
		list.push_back(make_tuple(68, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A155] == true)
	{
		//cout << "69 : xx11_OF_A155 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A155]  =  FALSE" << endl;
		list.push_back(make_tuple(69, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A160] == false) && (boolState[required_OF_A160] && boolState[relevant_evt_OF_A160]))
	{
		//cout << "70 : xx10_OF_A160 : FAULT failF  LABEL \"failure in operation A160\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A160]  =  TRUE" << endl;
		list.push_back(make_tuple(70, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A160] == true)
	{
		//cout << "71 : xx11_OF_A160 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A160]  =  FALSE" << endl;
		list.push_back(make_tuple(71, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A161] == false) && (boolState[required_OF_A161] && boolState[relevant_evt_OF_A161]))
	{
		//cout << "72 : xx10_OF_A161 : FAULT failF  LABEL \"failure in operation A161\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A161]  =  TRUE" << endl;
		list.push_back(make_tuple(72, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A161] == true)
	{
		//cout << "73 : xx11_OF_A161 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A161]  =  FALSE" << endl;
		list.push_back(make_tuple(73, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A162] == false) && (boolState[required_OF_A162] && boolState[relevant_evt_OF_A162]))
	{
		//cout << "74 : xx10_OF_A162 : FAULT failF  LABEL \"failure in operation A162\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A162]  =  TRUE" << endl;
		list.push_back(make_tuple(74, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A162] == true)
	{
		//cout << "75 : xx11_OF_A162 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A162]  =  FALSE" << endl;
		list.push_back(make_tuple(75, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A163] == false) && (boolState[required_OF_A163] && boolState[relevant_evt_OF_A163]))
	{
		//cout << "76 : xx10_OF_A163 : FAULT failF  LABEL \"failure in operation A163\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A163]  =  TRUE" << endl;
		list.push_back(make_tuple(76, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A163] == true)
	{
	...
	if ((boolState[failF_OF_A165] == false) && (boolState[required_OF_A165] && boolState[relevant_evt_OF_A165]))
	{
		//cout << "78 : xx10_OF_A165 : FAULT failF  LABEL \"failure in operation A165\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A165]  =  TRUE" << endl;
		list.push_back(make_tuple(78, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A165] == true)
	{
		//cout << "79 : xx11_OF_A165 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A165]  =  FALSE" << endl;
		list.push_back(make_tuple(79, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A166] == false) && (boolState[required_OF_A166] && boolState[relevant_evt_OF_A166]))
	{
		//cout << "80 : xx10_OF_A166 : FAULT failF  LABEL \"failure in operation A166\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A166]  =  TRUE" << endl;
		list.push_back(make_tuple(80, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A166] == true)
	{
		//cout << "81 : xx11_OF_A166 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A166]  =  FALSE" << endl;
		list.push_back(make_tuple(81, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A168] == false) && (boolState[required_OF_A168] && boolState[relevant_evt_OF_A168]))
	{
		//cout << "82 : xx10_OF_A168 : FAULT failF  LABEL \"failure in operation A168\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A168]  =  TRUE" << endl;
		list.push_back(make_tuple(82, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A168] == true)
	{
	...
	if ((boolState[failF_OF_A169] == false) && (boolState[required_OF_A169] && boolState[relevant_evt_OF_A169]))
	{
		//cout << "84 : xx10_OF_A169 : FAULT failF  LABEL \"failure in operation A169\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A169]  =  TRUE" << endl;
		list.push_back(make_tuple(84, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A169] == true)
	{
	...
	if ((boolState[failF_OF_A170] == false) && (boolState[required_OF_A170] && boolState[relevant_evt_OF_A170]))
	{
		//cout << "86 : xx10_OF_A170 : FAULT failF  LABEL \"failure in operation A170\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A170]  =  TRUE" << endl;
		list.push_back(make_tuple(86, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A170] == true)
	{
	...
	if ((boolState[failF_OF_A171] == false) && (boolState[required_OF_A171] && boolState[relevant_evt_OF_A171]))
	{
		//cout << "88 : xx10_OF_A171 : FAULT failF  LABEL \"failure in operation A171\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A171]  =  TRUE" << endl;
		list.push_back(make_tuple(88, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A171] == true)
	{
		//cout << "89 : xx11_OF_A171 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A171]  =  FALSE" << endl;
		list.push_back(make_tuple(89, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A176] == false) && (boolState[required_OF_A176] && boolState[relevant_evt_OF_A176]))
	{
		//cout << "90 : xx10_OF_A176 : FAULT failF  LABEL \"failure in operation A176\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A176]  =  TRUE" << endl;
		list.push_back(make_tuple(90, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A176] == true)
	{
		//cout << "91 : xx11_OF_A176 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A176]  =  FALSE" << endl;
		list.push_back(make_tuple(91, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A178] == false) && (boolState[required_OF_A178] && boolState[relevant_evt_OF_A178]))
	{
		//cout << "92 : xx10_OF_A178 : FAULT failF  LABEL \"failure in operation A178\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A178]  =  TRUE" << endl;
		list.push_back(make_tuple(92, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A178] == true)
	{
		//cout << "93 : xx11_OF_A178 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A178]  =  FALSE" << endl;
		list.push_back(make_tuple(93, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A182] == false) && (boolState[required_OF_A182] && boolState[relevant_evt_OF_A182]))
	{
		//cout << "94 : xx10_OF_A182 : FAULT failF  LABEL \"failure in operation A182\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A182]  =  TRUE" << endl;
		list.push_back(make_tuple(94, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A182] == true)
	{
		//cout << "95 : xx11_OF_A182 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A182]  =  FALSE" << endl;
		list.push_back(make_tuple(95, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A183] == false) && (boolState[required_OF_A183] && boolState[relevant_evt_OF_A183]))
	{
		//cout << "96 : xx10_OF_A183 : FAULT failF  LABEL \"failure in operation A183\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A183]  =  TRUE" << endl;
		list.push_back(make_tuple(96, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A183] == true)
	{
		//cout << "97 : xx11_OF_A183 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A183]  =  FALSE" << endl;
		list.push_back(make_tuple(97, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A184] == false) && (boolState[required_OF_A184] && boolState[relevant_evt_OF_A184]))
	{
		//cout << "98 : xx10_OF_A184 : FAULT failF  LABEL \"failure in operation A184\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A184]  =  TRUE" << endl;
		list.push_back(make_tuple(98, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A184] == true)
	{
		//cout << "99 : xx11_OF_A184 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A184]  =  FALSE" << endl;
		list.push_back(make_tuple(99, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A185] == false) && (boolState[required_OF_A185] && boolState[relevant_evt_OF_A185]))
	{
		//cout << "100 : xx10_OF_A185 : FAULT failF  LABEL \"failure in operation A185\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A185]  =  TRUE" << endl;
		list.push_back(make_tuple(100, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A185] == true)
	{
		//cout << "101 : xx11_OF_A185 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A185]  =  FALSE" << endl;
		list.push_back(make_tuple(101, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A187] == false) && (boolState[required_OF_A187] && boolState[relevant_evt_OF_A187]))
	{
		//cout << "102 : xx10_OF_A187 : FAULT failF  LABEL \"failure in operation A187\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A187]  =  TRUE" << endl;
		list.push_back(make_tuple(102, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A187] == true)
	{
		//cout << "103 : xx11_OF_A187 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A187]  =  FALSE" << endl;
		list.push_back(make_tuple(103, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A188] == false) && (boolState[required_OF_A188] && boolState[relevant_evt_OF_A188]))
	{
		//cout << "104 : xx10_OF_A188 : FAULT failF  LABEL \"failure in operation A188\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A188]  =  TRUE" << endl;
		list.push_back(make_tuple(104, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A188] == true)
	{
		//cout << "105 : xx11_OF_A188 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A188]  =  FALSE" << endl;
		list.push_back(make_tuple(105, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A190] == false) && (boolState[required_OF_A190] && boolState[relevant_evt_OF_A190]))
	{
		//cout << "106 : xx10_OF_A190 : FAULT failF  LABEL \"failure in operation A190\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A190]  =  TRUE" << endl;
		list.push_back(make_tuple(106, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A190] == true)
	{
		//cout << "107 : xx11_OF_A190 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A190]  =  FALSE" << endl;
		list.push_back(make_tuple(107, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A191] == false) && (boolState[required_OF_A191] && boolState[relevant_evt_OF_A191]))
	{
		//cout << "108 : xx10_OF_A191 : FAULT failF  LABEL \"failure in operation A191\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A191]  =  TRUE" << endl;
		list.push_back(make_tuple(108, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A191] == true)
	{
		//cout << "109 : xx11_OF_A191 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A191]  =  FALSE" << endl;
		list.push_back(make_tuple(109, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A192] == false) && (boolState[required_OF_A192] && boolState[relevant_evt_OF_A192]))
	{
		//cout << "110 : xx10_OF_A192 : FAULT failF  LABEL \"failure in operation A192\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A192]  =  TRUE" << endl;
		list.push_back(make_tuple(110, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A192] == true)
	{
		//cout << "111 : xx11_OF_A192 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A192]  =  FALSE" << endl;
		list.push_back(make_tuple(111, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A193] == false) && (boolState[required_OF_A193] && boolState[relevant_evt_OF_A193]))
	{
		//cout << "112 : xx10_OF_A193 : FAULT failF  LABEL \"failure in operation A193\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A193]  =  TRUE" << endl;
		list.push_back(make_tuple(112, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A193] == true)
	{
		//cout << "113 : xx11_OF_A193 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A193]  =  FALSE" << endl;
		list.push_back(make_tuple(113, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A198] == false) && (boolState[required_OF_A198] && boolState[relevant_evt_OF_A198]))
	{
		//cout << "114 : xx10_OF_A198 : FAULT failF  LABEL \"failure in operation A198\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A198]  =  TRUE" << endl;
		list.push_back(make_tuple(114, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A198] == true)
	{
		//cout << "115 : xx11_OF_A198 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A198]  =  FALSE" << endl;
		list.push_back(make_tuple(115, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A199] == false) && (boolState[required_OF_A199] && boolState[relevant_evt_OF_A199]))
	{
		//cout << "116 : xx10_OF_A199 : FAULT failF  LABEL \"failure in operation A199\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A199]  =  TRUE" << endl;
		list.push_back(make_tuple(116, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A199] == true)
	{
		//cout << "117 : xx11_OF_A199 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A199]  =  FALSE" << endl;
		list.push_back(make_tuple(117, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A20] == false) && (boolState[required_OF_A20] && boolState[relevant_evt_OF_A20]))
	{
		//cout << "118 : xx10_OF_A20 : FAULT failF  LABEL \"failure in operation A20\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A20]  =  TRUE" << endl;
		list.push_back(make_tuple(118, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A20] == true)
	{
		//cout << "119 : xx11_OF_A20 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A20]  =  FALSE" << endl;
		list.push_back(make_tuple(119, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A200] == false) && (boolState[required_OF_A200] && boolState[relevant_evt_OF_A200]))
	{
		//cout << "120 : xx10_OF_A200 : FAULT failF  LABEL \"failure in operation A200\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A200]  =  TRUE" << endl;
		list.push_back(make_tuple(120, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A200] == true)
	{
		//cout << "121 : xx11_OF_A200 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A200]  =  FALSE" << endl;
		list.push_back(make_tuple(121, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A201] == false) && (boolState[required_OF_A201] && boolState[relevant_evt_OF_A201]))
	{
		//cout << "122 : xx10_OF_A201 : FAULT failF  LABEL \"failure in operation A201\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A201]  =  TRUE" << endl;
		list.push_back(make_tuple(122, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A201] == true)
	{
		//cout << "123 : xx11_OF_A201 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A201]  =  FALSE" << endl;
		list.push_back(make_tuple(123, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A203] == false) && (boolState[required_OF_A203] && boolState[relevant_evt_OF_A203]))
	{
		//cout << "124 : xx10_OF_A203 : FAULT failF  LABEL \"failure in operation A203\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A203]  =  TRUE" << endl;
		list.push_back(make_tuple(124, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A203] == true)
	{
		//cout << "125 : xx11_OF_A203 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A203]  =  FALSE" << endl;
		list.push_back(make_tuple(125, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A204] == false) && (boolState[required_OF_A204] && boolState[relevant_evt_OF_A204]))
	{
		//cout << "126 : xx10_OF_A204 : FAULT failF  LABEL \"failure in operation A204\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A204]  =  TRUE" << endl;
		list.push_back(make_tuple(126, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A204] == true)
	{
		//cout << "127 : xx11_OF_A204 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A204]  =  FALSE" << endl;
		list.push_back(make_tuple(127, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A206] == false) && (boolState[required_OF_A206] && boolState[relevant_evt_OF_A206]))
	{
		//cout << "128 : xx10_OF_A206 : FAULT failF  LABEL \"failure in operation A206\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A206]  =  TRUE" << endl;
		list.push_back(make_tuple(128, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A206] == true)
	{
		//cout << "129 : xx11_OF_A206 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A206]  =  FALSE" << endl;
		list.push_back(make_tuple(129, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A207] == false) && (boolState[required_OF_A207] && boolState[relevant_evt_OF_A207]))
	{
		//cout << "130 : xx10_OF_A207 : FAULT failF  LABEL \"failure in operation A207\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A207]  =  TRUE" << endl;
		list.push_back(make_tuple(130, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A207] == true)
	{
		//cout << "131 : xx11_OF_A207 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A207]  =  FALSE" << endl;
		list.push_back(make_tuple(131, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A208] == false) && (boolState[required_OF_A208] && boolState[relevant_evt_OF_A208]))
	{
		//cout << "132 : xx10_OF_A208 : FAULT failF  LABEL \"failure in operation A208\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A208]  =  TRUE" << endl;
		list.push_back(make_tuple(132, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A208] == true)
	{
		//cout << "133 : xx11_OF_A208 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A208]  =  FALSE" << endl;
		list.push_back(make_tuple(133, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A209] == false) && (boolState[required_OF_A209] && boolState[relevant_evt_OF_A209]))
	{
		//cout << "134 : xx10_OF_A209 : FAULT failF  LABEL \"failure in operation A209\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A209]  =  TRUE" << endl;
		list.push_back(make_tuple(134, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A209] == true)
	{
		//cout << "135 : xx11_OF_A209 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A209]  =  FALSE" << endl;
		list.push_back(make_tuple(135, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A21] == false) && (boolState[required_OF_A21] && boolState[relevant_evt_OF_A21]))
	{
		//cout << "136 : xx10_OF_A21 : FAULT failF  LABEL \"failure in operation A21\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A21]  =  TRUE" << endl;
		list.push_back(make_tuple(136, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A21] == true)
	{
		//cout << "137 : xx11_OF_A21 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A21]  =  FALSE" << endl;
		list.push_back(make_tuple(137, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A212] == false) && (boolState[required_OF_A212] && boolState[relevant_evt_OF_A212]))
	{
		//cout << "138 : xx10_OF_A212 : FAULT failF  LABEL \"failure in operation A212\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A212]  =  TRUE" << endl;
		list.push_back(make_tuple(138, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A212] == true)
	{
		//cout << "139 : xx11_OF_A212 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A212]  =  FALSE" << endl;
		list.push_back(make_tuple(139, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A213] == false) && (boolState[required_OF_A213] && boolState[relevant_evt_OF_A213]))
	{
		//cout << "140 : xx10_OF_A213 : FAULT failF  LABEL \"failure in operation A213\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A213]  =  TRUE" << endl;
		list.push_back(make_tuple(140, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A213] == true)
	{
		//cout << "141 : xx11_OF_A213 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A213]  =  FALSE" << endl;
		list.push_back(make_tuple(141, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A214] == false) && (boolState[required_OF_A214] && boolState[relevant_evt_OF_A214]))
	{
		//cout << "142 : xx10_OF_A214 : FAULT failF  LABEL \"failure in operation A214\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A214]  =  TRUE" << endl;
		list.push_back(make_tuple(142, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A214] == true)
	{
		//cout << "143 : xx11_OF_A214 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A214]  =  FALSE" << endl;
		list.push_back(make_tuple(143, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A215] == false) && (boolState[required_OF_A215] && boolState[relevant_evt_OF_A215]))
	{
		//cout << "144 : xx10_OF_A215 : FAULT failF  LABEL \"failure in operation A215\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A215]  =  TRUE" << endl;
		list.push_back(make_tuple(144, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A215] == true)
	{
		//cout << "145 : xx11_OF_A215 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A215]  =  FALSE" << endl;
		list.push_back(make_tuple(145, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A217] == false) && (boolState[required_OF_A217] && boolState[relevant_evt_OF_A217]))
	{
		//cout << "146 : xx10_OF_A217 : FAULT failF  LABEL \"failure in operation A217\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A217]  =  TRUE" << endl;
		list.push_back(make_tuple(146, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A217] == true)
	{
		//cout << "147 : xx11_OF_A217 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A217]  =  FALSE" << endl;
		list.push_back(make_tuple(147, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A218] == false) && (boolState[required_OF_A218] && boolState[relevant_evt_OF_A218]))
	{
		//cout << "148 : xx10_OF_A218 : FAULT failF  LABEL \"failure in operation A218\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A218]  =  TRUE" << endl;
		list.push_back(make_tuple(148, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A218] == true)
	{
		//cout << "149 : xx11_OF_A218 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A218]  =  FALSE" << endl;
		list.push_back(make_tuple(149, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A22] == false) && (boolState[required_OF_A22] && boolState[relevant_evt_OF_A22]))
	{
		//cout << "150 : xx10_OF_A22 : FAULT failF  LABEL \"failure in operation A22\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A22]  =  TRUE" << endl;
		list.push_back(make_tuple(150, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A22] == true)
	{
		//cout << "151 : xx11_OF_A22 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A22]  =  FALSE" << endl;
		list.push_back(make_tuple(151, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A220] == false) && (boolState[required_OF_A220] && boolState[relevant_evt_OF_A220]))
	{
		//cout << "152 : xx10_OF_A220 : FAULT failF  LABEL \"failure in operation A220\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A220]  =  TRUE" << endl;
		list.push_back(make_tuple(152, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A220] == true)
	{
		//cout << "153 : xx11_OF_A220 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A220]  =  FALSE" << endl;
		list.push_back(make_tuple(153, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A221] == false) && (boolState[required_OF_A221] && boolState[relevant_evt_OF_A221]))
	{
		//cout << "154 : xx10_OF_A221 : FAULT failF  LABEL \"failure in operation A221\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A221]  =  TRUE" << endl;
		list.push_back(make_tuple(154, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A221] == true)
	{
		//cout << "155 : xx11_OF_A221 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A221]  =  FALSE" << endl;
		list.push_back(make_tuple(155, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A222] == false) && (boolState[required_OF_A222] && boolState[relevant_evt_OF_A222]))
	{
		//cout << "156 : xx10_OF_A222 : FAULT failF  LABEL \"failure in operation A222\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A222]  =  TRUE" << endl;
		list.push_back(make_tuple(156, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A222] == true)
	{
		//cout << "157 : xx11_OF_A222 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A222]  =  FALSE" << endl;
		list.push_back(make_tuple(157, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A223] == false) && (boolState[required_OF_A223] && boolState[relevant_evt_OF_A223]))
	{
		//cout << "158 : xx10_OF_A223 : FAULT failF  LABEL \"failure in operation A223\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A223]  =  TRUE" << endl;
		list.push_back(make_tuple(158, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A223] == true)
	{
		//cout << "159 : xx11_OF_A223 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A223]  =  FALSE" << endl;
		list.push_back(make_tuple(159, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A23] == false) && (boolState[required_OF_A23] && boolState[relevant_evt_OF_A23]))
	{
		//cout << "160 : xx10_OF_A23 : FAULT failF  LABEL \"failure in operation A23\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A23]  =  TRUE" << endl;
		list.push_back(make_tuple(160, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A23] == true)
	{
		//cout << "161 : xx11_OF_A23 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A23]  =  FALSE" << endl;
		list.push_back(make_tuple(161, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A239] == false) && (boolState[required_OF_A239] && boolState[relevant_evt_OF_A239]))
	{
		//cout << "162 : xx10_OF_A239 : FAULT failF  LABEL \"failure in operation A239\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A239]  =  TRUE" << endl;
		list.push_back(make_tuple(162, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A239] == true)
	{
		//cout << "163 : xx11_OF_A239 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A239]  =  FALSE" << endl;
		list.push_back(make_tuple(163, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A240] == false) && (boolState[required_OF_A240] && boolState[relevant_evt_OF_A240]))
	{
		//cout << "164 : xx10_OF_A240 : FAULT failF  LABEL \"failure in operation A240\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A240]  =  TRUE" << endl;
		list.push_back(make_tuple(164, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A240] == true)
	{
		//cout << "165 : xx11_OF_A240 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A240]  =  FALSE" << endl;
		list.push_back(make_tuple(165, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A241] == false) && (boolState[required_OF_A241] && boolState[relevant_evt_OF_A241]))
	{
		//cout << "166 : xx10_OF_A241 : FAULT failF  LABEL \"failure in operation A241\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A241]  =  TRUE" << endl;
		list.push_back(make_tuple(166, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A241] == true)
	{
		//cout << "167 : xx11_OF_A241 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A241]  =  FALSE" << endl;
		list.push_back(make_tuple(167, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A242] == false) && (boolState[required_OF_A242] && boolState[relevant_evt_OF_A242]))
	{
		//cout << "168 : xx10_OF_A242 : FAULT failF  LABEL \"failure in operation A242\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A242]  =  TRUE" << endl;
		list.push_back(make_tuple(168, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A242] == true)
	{
		//cout << "169 : xx11_OF_A242 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A242]  =  FALSE" << endl;
		list.push_back(make_tuple(169, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A244] == false) && (boolState[required_OF_A244] && boolState[relevant_evt_OF_A244]))
	{
		//cout << "170 : xx10_OF_A244 : FAULT failF  LABEL \"failure in operation A244\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A244]  =  TRUE" << endl;
		list.push_back(make_tuple(170, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A244] == true)
	{
		//cout << "171 : xx11_OF_A244 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A244]  =  FALSE" << endl;
		list.push_back(make_tuple(171, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A245] == false) && (boolState[required_OF_A245] && boolState[relevant_evt_OF_A245]))
	{
		//cout << "172 : xx10_OF_A245 : FAULT failF  LABEL \"failure in operation A245\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A245]  =  TRUE" << endl;
		list.push_back(make_tuple(172, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A245] == true)
	{
		//cout << "173 : xx11_OF_A245 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A245]  =  FALSE" << endl;
		list.push_back(make_tuple(173, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A247] == false) && (boolState[required_OF_A247] && boolState[relevant_evt_OF_A247]))
	{
		//cout << "174 : xx10_OF_A247 : FAULT failF  LABEL \"failure in operation A247\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A247]  =  TRUE" << endl;
		list.push_back(make_tuple(174, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A247] == true)
	{
		//cout << "175 : xx11_OF_A247 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A247]  =  FALSE" << endl;
		list.push_back(make_tuple(175, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A248] == false) && (boolState[required_OF_A248] && boolState[relevant_evt_OF_A248]))
	{
		//cout << "176 : xx10_OF_A248 : FAULT failF  LABEL \"failure in operation A248\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A248]  =  TRUE" << endl;
		list.push_back(make_tuple(176, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A248] == true)
	{
		//cout << "177 : xx11_OF_A248 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A248]  =  FALSE" << endl;
		list.push_back(make_tuple(177, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A249] == false) && (boolState[required_OF_A249] && boolState[relevant_evt_OF_A249]))
	{
		//cout << "178 : xx10_OF_A249 : FAULT failF  LABEL \"failure in operation A249\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A249]  =  TRUE" << endl;
		list.push_back(make_tuple(178, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A249] == true)
	{
		//cout << "179 : xx11_OF_A249 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A249]  =  FALSE" << endl;
		list.push_back(make_tuple(179, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A25] == false) && (boolState[required_OF_A25] && boolState[relevant_evt_OF_A25]))
	{
		//cout << "180 : xx10_OF_A25 : FAULT failF  LABEL \"failure in operation A25\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A25]  =  TRUE" << endl;
		list.push_back(make_tuple(180, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A25] == true)
	{
		//cout << "181 : xx11_OF_A25 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A25]  =  FALSE" << endl;
		list.push_back(make_tuple(181, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A250] == false) && (boolState[required_OF_A250] && boolState[relevant_evt_OF_A250]))
	{
		//cout << "182 : xx10_OF_A250 : FAULT failF  LABEL \"failure in operation A250\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A250]  =  TRUE" << endl;
		list.push_back(make_tuple(182, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A250] == true)
	{
		//cout << "183 : xx11_OF_A250 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A250]  =  FALSE" << endl;
		list.push_back(make_tuple(183, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A256] == false) && (boolState[required_OF_A256] && boolState[relevant_evt_OF_A256]))
	{
		//cout << "184 : xx10_OF_A256 : FAULT failF  LABEL \"failure in operation A256\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A256]  =  TRUE" << endl;
		list.push_back(make_tuple(184, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A256] == true)
	{
		//cout << "185 : xx11_OF_A256 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A256]  =  FALSE" << endl;
		list.push_back(make_tuple(185, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A257] == false) && (boolState[required_OF_A257] && boolState[relevant_evt_OF_A257]))
	{
		//cout << "186 : xx10_OF_A257 : FAULT failF  LABEL \"failure in operation A257\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A257]  =  TRUE" << endl;
		list.push_back(make_tuple(186, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A257] == true)
	{
		//cout << "187 : xx11_OF_A257 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A257]  =  FALSE" << endl;
		list.push_back(make_tuple(187, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A258] == false) && (boolState[required_OF_A258] && boolState[relevant_evt_OF_A258]))
	{
		//cout << "188 : xx10_OF_A258 : FAULT failF  LABEL \"failure in operation A258\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A258]  =  TRUE" << endl;
		list.push_back(make_tuple(188, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A258] == true)
	{
		//cout << "189 : xx11_OF_A258 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A258]  =  FALSE" << endl;
		list.push_back(make_tuple(189, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A259] == false) && (boolState[required_OF_A259] && boolState[relevant_evt_OF_A259]))
	{
		//cout << "190 : xx10_OF_A259 : FAULT failF  LABEL \"failure in operation A259\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A259]  =  TRUE" << endl;
		list.push_back(make_tuple(190, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A259] == true)
	{
		//cout << "191 : xx11_OF_A259 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A259]  =  FALSE" << endl;
		list.push_back(make_tuple(191, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A26] == false) && (boolState[required_OF_A26] && boolState[relevant_evt_OF_A26]))
	{
		//cout << "192 : xx10_OF_A26 : FAULT failF  LABEL \"failure in operation A26\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A26]  =  TRUE" << endl;
		list.push_back(make_tuple(192, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A26] == true)
	{
		//cout << "193 : xx11_OF_A26 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A26]  =  FALSE" << endl;
		list.push_back(make_tuple(193, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A261] == false) && (boolState[required_OF_A261] && boolState[relevant_evt_OF_A261]))
	{
		//cout << "194 : xx10_OF_A261 : FAULT failF  LABEL \"failure in operation A261\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A261]  =  TRUE" << endl;
		list.push_back(make_tuple(194, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A261] == true)
	{
		//cout << "195 : xx11_OF_A261 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A261]  =  FALSE" << endl;
		list.push_back(make_tuple(195, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A262] == false) && (boolState[required_OF_A262] && boolState[relevant_evt_OF_A262]))
	{
		//cout << "196 : xx10_OF_A262 : FAULT failF  LABEL \"failure in operation A262\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A262]  =  TRUE" << endl;
		list.push_back(make_tuple(196, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A262] == true)
	{
		//cout << "197 : xx11_OF_A262 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A262]  =  FALSE" << endl;
		list.push_back(make_tuple(197, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A264] == false) && (boolState[required_OF_A264] && boolState[relevant_evt_OF_A264]))
	{
		//cout << "198 : xx10_OF_A264 : FAULT failF  LABEL \"failure in operation A264\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A264]  =  TRUE" << endl;
		list.push_back(make_tuple(198, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A264] == true)
	{
		//cout << "199 : xx11_OF_A264 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A264]  =  FALSE" << endl;
		list.push_back(make_tuple(199, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A265] == false) && (boolState[required_OF_A265] && boolState[relevant_evt_OF_A265]))
	{
		//cout << "200 : xx10_OF_A265 : FAULT failF  LABEL \"failure in operation A265\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A265]  =  TRUE" << endl;
		list.push_back(make_tuple(200, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A265] == true)
	{
		//cout << "201 : xx11_OF_A265 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A265]  =  FALSE" << endl;
		list.push_back(make_tuple(201, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A266] == false) && (boolState[required_OF_A266] && boolState[relevant_evt_OF_A266]))
	{
		//cout << "202 : xx10_OF_A266 : FAULT failF  LABEL \"failure in operation A266\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A266]  =  TRUE" << endl;
		list.push_back(make_tuple(202, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A266] == true)
	{
		//cout << "203 : xx11_OF_A266 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A266]  =  FALSE" << endl;
		list.push_back(make_tuple(203, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A267] == false) && (boolState[required_OF_A267] && boolState[relevant_evt_OF_A267]))
	{
		//cout << "204 : xx10_OF_A267 : FAULT failF  LABEL \"failure in operation A267\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A267]  =  TRUE" << endl;
		list.push_back(make_tuple(204, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A267] == true)
	{
		//cout << "205 : xx11_OF_A267 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A267]  =  FALSE" << endl;
		list.push_back(make_tuple(205, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A272] == false) && (boolState[required_OF_A272] && boolState[relevant_evt_OF_A272]))
	{
		//cout << "206 : xx10_OF_A272 : FAULT failF  LABEL \"failure in operation A272\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A272]  =  TRUE" << endl;
		list.push_back(make_tuple(206, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A272] == true)
	{
		//cout << "207 : xx11_OF_A272 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A272]  =  FALSE" << endl;
		list.push_back(make_tuple(207, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A273] == false) && (boolState[required_OF_A273] && boolState[relevant_evt_OF_A273]))
	{
		//cout << "208 : xx10_OF_A273 : FAULT failF  LABEL \"failure in operation A273\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A273]  =  TRUE" << endl;
		list.push_back(make_tuple(208, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A273] == true)
	{
		//cout << "209 : xx11_OF_A273 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A273]  =  FALSE" << endl;
		list.push_back(make_tuple(209, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A274] == false) && (boolState[required_OF_A274] && boolState[relevant_evt_OF_A274]))
	{
		//cout << "210 : xx10_OF_A274 : FAULT failF  LABEL \"failure in operation A274\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A274]  =  TRUE" << endl;
		list.push_back(make_tuple(210, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A274] == true)
	{
		//cout << "211 : xx11_OF_A274 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A274]  =  FALSE" << endl;
		list.push_back(make_tuple(211, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A275] == false) && (boolState[required_OF_A275] && boolState[relevant_evt_OF_A275]))
	{
		//cout << "212 : xx10_OF_A275 : FAULT failF  LABEL \"failure in operation A275\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A275]  =  TRUE" << endl;
		list.push_back(make_tuple(212, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A275] == true)
	{
		//cout << "213 : xx11_OF_A275 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A275]  =  FALSE" << endl;
		list.push_back(make_tuple(213, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A277] == false) && (boolState[required_OF_A277] && boolState[relevant_evt_OF_A277]))
	{
		//cout << "214 : xx10_OF_A277 : FAULT failF  LABEL \"failure in operation A277\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A277]  =  TRUE" << endl;
		list.push_back(make_tuple(214, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A277] == true)
	{
		//cout << "215 : xx11_OF_A277 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A277]  =  FALSE" << endl;
		list.push_back(make_tuple(215, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A278] == false) && (boolState[required_OF_A278] && boolState[relevant_evt_OF_A278]))
	{
		//cout << "216 : xx10_OF_A278 : FAULT failF  LABEL \"failure in operation A278\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A278]  =  TRUE" << endl;
		list.push_back(make_tuple(216, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A278] == true)
	{
		//cout << "217 : xx11_OF_A278 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A278]  =  FALSE" << endl;
		list.push_back(make_tuple(217, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A28] == false) && (boolState[required_OF_A28] && boolState[relevant_evt_OF_A28]))
	{
		//cout << "218 : xx10_OF_A28 : FAULT failF  LABEL \"failure in operation A28\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A28]  =  TRUE" << endl;
		list.push_back(make_tuple(218, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A28] == true)
	{
		//cout << "219 : xx11_OF_A28 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A28]  =  FALSE" << endl;
		list.push_back(make_tuple(219, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A280] == false) && (boolState[required_OF_A280] && boolState[relevant_evt_OF_A280]))
	{
		//cout << "220 : xx10_OF_A280 : FAULT failF  LABEL \"failure in operation A280\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A280]  =  TRUE" << endl;
		list.push_back(make_tuple(220, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A280] == true)
	{
		//cout << "221 : xx11_OF_A280 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A280]  =  FALSE" << endl;
		list.push_back(make_tuple(221, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A281] == false) && (boolState[required_OF_A281] && boolState[relevant_evt_OF_A281]))
	{
		//cout << "222 : xx10_OF_A281 : FAULT failF  LABEL \"failure in operation A281\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A281]  =  TRUE" << endl;
		list.push_back(make_tuple(222, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A281] == true)
	{
		//cout << "223 : xx11_OF_A281 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A281]  =  FALSE" << endl;
		list.push_back(make_tuple(223, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A282] == false) && (boolState[required_OF_A282] && boolState[relevant_evt_OF_A282]))
	{
		//cout << "224 : xx10_OF_A282 : FAULT failF  LABEL \"failure in operation A282\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A282]  =  TRUE" << endl;
		list.push_back(make_tuple(224, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A282] == true)
	{
		//cout << "225 : xx11_OF_A282 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A282]  =  FALSE" << endl;
		list.push_back(make_tuple(225, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A283] == false) && (boolState[required_OF_A283] && boolState[relevant_evt_OF_A283]))
	{
		//cout << "226 : xx10_OF_A283 : FAULT failF  LABEL \"failure in operation A283\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A283]  =  TRUE" << endl;
		list.push_back(make_tuple(226, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A283] == true)
	{
		//cout << "227 : xx11_OF_A283 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A283]  =  FALSE" << endl;
		list.push_back(make_tuple(227, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A288] == false) && (boolState[required_OF_A288] && boolState[relevant_evt_OF_A288]))
	{
		//cout << "228 : xx10_OF_A288 : FAULT failF  LABEL \"failure in operation A288\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A288]  =  TRUE" << endl;
		list.push_back(make_tuple(228, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A288] == true)
	{
		//cout << "229 : xx11_OF_A288 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A288]  =  FALSE" << endl;
		list.push_back(make_tuple(229, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A289] == false) && (boolState[required_OF_A289] && boolState[relevant_evt_OF_A289]))
	{
		//cout << "230 : xx10_OF_A289 : FAULT failF  LABEL \"failure in operation A289\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A289]  =  TRUE" << endl;
		list.push_back(make_tuple(230, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A289] == true)
	{
		//cout << "231 : xx11_OF_A289 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A289]  =  FALSE" << endl;
		list.push_back(make_tuple(231, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A29] == false) && (boolState[required_OF_A29] && boolState[relevant_evt_OF_A29]))
	{
		//cout << "232 : xx10_OF_A29 : FAULT failF  LABEL \"failure in operation A29\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A29]  =  TRUE" << endl;
		list.push_back(make_tuple(232, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A29] == true)
	{
		//cout << "233 : xx11_OF_A29 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A29]  =  FALSE" << endl;
		list.push_back(make_tuple(233, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A290] == false) && (boolState[required_OF_A290] && boolState[relevant_evt_OF_A290]))
	{
		//cout << "234 : xx10_OF_A290 : FAULT failF  LABEL \"failure in operation A290\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A290]  =  TRUE" << endl;
		list.push_back(make_tuple(234, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A290] == true)
	{
		//cout << "235 : xx11_OF_A290 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A290]  =  FALSE" << endl;
		list.push_back(make_tuple(235, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A291] == false) && (boolState[required_OF_A291] && boolState[relevant_evt_OF_A291]))
	{
		//cout << "236 : xx10_OF_A291 : FAULT failF  LABEL \"failure in operation A291\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A291]  =  TRUE" << endl;
		list.push_back(make_tuple(236, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A291] == true)
	{
		//cout << "237 : xx11_OF_A291 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A291]  =  FALSE" << endl;
		list.push_back(make_tuple(237, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A293] == false) && (boolState[required_OF_A293] && boolState[relevant_evt_OF_A293]))
	{
		//cout << "238 : xx10_OF_A293 : FAULT failF  LABEL \"failure in operation A293\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A293]  =  TRUE" << endl;
		list.push_back(make_tuple(238, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A293] == true)
	{
		//cout << "239 : xx11_OF_A293 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A293]  =  FALSE" << endl;
		list.push_back(make_tuple(239, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A294] == false) && (boolState[required_OF_A294] && boolState[relevant_evt_OF_A294]))
	{
		//cout << "240 : xx10_OF_A294 : FAULT failF  LABEL \"failure in operation A294\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A294]  =  TRUE" << endl;
		list.push_back(make_tuple(240, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A294] == true)
	{
		//cout << "241 : xx11_OF_A294 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A294]  =  FALSE" << endl;
		list.push_back(make_tuple(241, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A296] == false) && (boolState[required_OF_A296] && boolState[relevant_evt_OF_A296]))
	{
		//cout << "242 : xx10_OF_A296 : FAULT failF  LABEL \"failure in operation A296\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A296]  =  TRUE" << endl;
		list.push_back(make_tuple(242, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A296] == true)
	{
		//cout << "243 : xx11_OF_A296 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A296]  =  FALSE" << endl;
		list.push_back(make_tuple(243, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A297] == false) && (boolState[required_OF_A297] && boolState[relevant_evt_OF_A297]))
	{
		//cout << "244 : xx10_OF_A297 : FAULT failF  LABEL \"failure in operation A297\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A297]  =  TRUE" << endl;
		list.push_back(make_tuple(244, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A297] == true)
	{
		//cout << "245 : xx11_OF_A297 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A297]  =  FALSE" << endl;
		list.push_back(make_tuple(245, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A298] == false) && (boolState[required_OF_A298] && boolState[relevant_evt_OF_A298]))
	{
		//cout << "246 : xx10_OF_A298 : FAULT failF  LABEL \"failure in operation A298\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A298]  =  TRUE" << endl;
		list.push_back(make_tuple(246, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A298] == true)
	{
		//cout << "247 : xx11_OF_A298 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A298]  =  FALSE" << endl;
		list.push_back(make_tuple(247, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A299] == false) && (boolState[required_OF_A299] && boolState[relevant_evt_OF_A299]))
	{
		//cout << "248 : xx10_OF_A299 : FAULT failF  LABEL \"failure in operation A299\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A299]  =  TRUE" << endl;
		list.push_back(make_tuple(248, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A299] == true)
	{
		//cout << "249 : xx11_OF_A299 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A299]  =  FALSE" << endl;
		list.push_back(make_tuple(249, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A30] == false) && (boolState[required_OF_A30] && boolState[relevant_evt_OF_A30]))
	{
		//cout << "250 : xx10_OF_A30 : FAULT failF  LABEL \"failure in operation A30\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A30]  =  TRUE" << endl;
		list.push_back(make_tuple(250, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A30] == true)
	{
		//cout << "251 : xx11_OF_A30 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A30]  =  FALSE" << endl;
		list.push_back(make_tuple(251, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A31] == false) && (boolState[required_OF_A31] && boolState[relevant_evt_OF_A31]))
	{
		//cout << "252 : xx10_OF_A31 : FAULT failF  LABEL \"failure in operation A31\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A31]  =  TRUE" << endl;
		list.push_back(make_tuple(252, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A31] == true)
	{
		//cout << "253 : xx11_OF_A31 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A31]  =  FALSE" << endl;
		list.push_back(make_tuple(253, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A317] == false) && (boolState[required_OF_A317] && boolState[relevant_evt_OF_A317]))
	{
		//cout << "254 : xx10_OF_A317 : FAULT failF  LABEL \"failure in operation A317\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A317]  =  TRUE" << endl;
		list.push_back(make_tuple(254, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A317] == true)
	{
		//cout << "255 : xx11_OF_A317 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A317]  =  FALSE" << endl;
		list.push_back(make_tuple(255, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A318] == false) && (boolState[required_OF_A318] && boolState[relevant_evt_OF_A318]))
	{
		//cout << "256 : xx10_OF_A318 : FAULT failF  LABEL \"failure in operation A318\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A318]  =  TRUE" << endl;
		list.push_back(make_tuple(256, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A318] == true)
	{
		//cout << "257 : xx11_OF_A318 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A318]  =  FALSE" << endl;
		list.push_back(make_tuple(257, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A319] == false) && (boolState[required_OF_A319] && boolState[relevant_evt_OF_A319]))
	{
		//cout << "258 : xx10_OF_A319 : FAULT failF  LABEL \"failure in operation A319\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A319]  =  TRUE" << endl;
		list.push_back(make_tuple(258, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A319] == true)
	{
		//cout << "259 : xx11_OF_A319 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A319]  =  FALSE" << endl;
		list.push_back(make_tuple(259, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A320] == false) && (boolState[required_OF_A320] && boolState[relevant_evt_OF_A320]))
	{
		//cout << "260 : xx10_OF_A320 : FAULT failF  LABEL \"failure in operation A320\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A320]  =  TRUE" << endl;
		list.push_back(make_tuple(260, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A320] == true)
	{
		//cout << "261 : xx11_OF_A320 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A320]  =  FALSE" << endl;
		list.push_back(make_tuple(261, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A322] == false) && (boolState[required_OF_A322] && boolState[relevant_evt_OF_A322]))
	{
		//cout << "262 : xx10_OF_A322 : FAULT failF  LABEL \"failure in operation A322\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A322]  =  TRUE" << endl;
		list.push_back(make_tuple(262, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A322] == true)
	{
		//cout << "263 : xx11_OF_A322 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A322]  =  FALSE" << endl;
		list.push_back(make_tuple(263, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A323] == false) && (boolState[required_OF_A323] && boolState[relevant_evt_OF_A323]))
	{
		//cout << "264 : xx10_OF_A323 : FAULT failF  LABEL \"failure in operation A323\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A323]  =  TRUE" << endl;
		list.push_back(make_tuple(264, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A323] == true)
	{
		//cout << "265 : xx11_OF_A323 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A323]  =  FALSE" << endl;
		list.push_back(make_tuple(265, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A325] == false) && (boolState[required_OF_A325] && boolState[relevant_evt_OF_A325]))
	{
		//cout << "266 : xx10_OF_A325 : FAULT failF  LABEL \"failure in operation A325\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A325]  =  TRUE" << endl;
		list.push_back(make_tuple(266, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A325] == true)
	{
		//cout << "267 : xx11_OF_A325 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A325]  =  FALSE" << endl;
		list.push_back(make_tuple(267, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A326] == false) && (boolState[required_OF_A326] && boolState[relevant_evt_OF_A326]))
	{
		//cout << "268 : xx10_OF_A326 : FAULT failF  LABEL \"failure in operation A326\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A326]  =  TRUE" << endl;
		list.push_back(make_tuple(268, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A326] == true)
	{
		//cout << "269 : xx11_OF_A326 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A326]  =  FALSE" << endl;
		list.push_back(make_tuple(269, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A327] == false) && (boolState[required_OF_A327] && boolState[relevant_evt_OF_A327]))
	{
		//cout << "270 : xx10_OF_A327 : FAULT failF  LABEL \"failure in operation A327\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A327]  =  TRUE" << endl;
		list.push_back(make_tuple(270, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A327] == true)
	{
		//cout << "271 : xx11_OF_A327 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A327]  =  FALSE" << endl;
		list.push_back(make_tuple(271, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A328] == false) && (boolState[required_OF_A328] && boolState[relevant_evt_OF_A328]))
	{
		//cout << "272 : xx10_OF_A328 : FAULT failF  LABEL \"failure in operation A328\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A328]  =  TRUE" << endl;
		list.push_back(make_tuple(272, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A328] == true)
	{
		//cout << "273 : xx11_OF_A328 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A328]  =  FALSE" << endl;
		list.push_back(make_tuple(273, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A333] == false) && (boolState[required_OF_A333] && boolState[relevant_evt_OF_A333]))
	{
		//cout << "274 : xx10_OF_A333 : FAULT failF  LABEL \"failure in operation A333\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A333]  =  TRUE" << endl;
		list.push_back(make_tuple(274, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A333] == true)
	{
		//cout << "275 : xx11_OF_A333 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A333]  =  FALSE" << endl;
		list.push_back(make_tuple(275, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A335] == false) && (boolState[required_OF_A335] && boolState[relevant_evt_OF_A335]))
	{
		//cout << "276 : xx10_OF_A335 : FAULT failF  LABEL \"failure in operation A335\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A335]  =  TRUE" << endl;
		list.push_back(make_tuple(276, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A335] == true)
	{
		//cout << "277 : xx11_OF_A335 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A335]  =  FALSE" << endl;
		list.push_back(make_tuple(277, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A337] == false) && (boolState[required_OF_A337] && boolState[relevant_evt_OF_A337]))
	{
		//cout << "278 : xx10_OF_A337 : FAULT failF  LABEL \"failure in operation A337\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A337]  =  TRUE" << endl;
		list.push_back(make_tuple(278, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A337] == true)
	{
		//cout << "279 : xx11_OF_A337 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A337]  =  FALSE" << endl;
		list.push_back(make_tuple(279, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A338] == false) && (boolState[required_OF_A338] && boolState[relevant_evt_OF_A338]))
	{
		//cout << "280 : xx10_OF_A338 : FAULT failF  LABEL \"failure in operation A338\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A338]  =  TRUE" << endl;
		list.push_back(make_tuple(280, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A338] == true)
	{
		//cout << "281 : xx11_OF_A338 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A338]  =  FALSE" << endl;
		list.push_back(make_tuple(281, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A339] == false) && (boolState[required_OF_A339] && boolState[relevant_evt_OF_A339]))
	{
		//cout << "282 : xx10_OF_A339 : FAULT failF  LABEL \"failure in operation A339\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A339]  =  TRUE" << endl;
		list.push_back(make_tuple(282, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A339] == true)
	{
		//cout << "283 : xx11_OF_A339 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A339]  =  FALSE" << endl;
		list.push_back(make_tuple(283, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A340] == false) && (boolState[required_OF_A340] && boolState[relevant_evt_OF_A340]))
	{
		//cout << "284 : xx10_OF_A340 : FAULT failF  LABEL \"failure in operation A340\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A340]  =  TRUE" << endl;
		list.push_back(make_tuple(284, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A340] == true)
	{
		//cout << "285 : xx11_OF_A340 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A340]  =  FALSE" << endl;
		list.push_back(make_tuple(285, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A342] == false) && (boolState[required_OF_A342] && boolState[relevant_evt_OF_A342]))
	{
		//cout << "286 : xx10_OF_A342 : FAULT failF  LABEL \"failure in operation A342\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A342]  =  TRUE" << endl;
		list.push_back(make_tuple(286, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A342] == true)
	{
		//cout << "287 : xx11_OF_A342 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A342]  =  FALSE" << endl;
		list.push_back(make_tuple(287, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A343] == false) && (boolState[required_OF_A343] && boolState[relevant_evt_OF_A343]))
	{
		//cout << "288 : xx10_OF_A343 : FAULT failF  LABEL \"failure in operation A343\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A343]  =  TRUE" << endl;
		list.push_back(make_tuple(288, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A343] == true)
	{
		//cout << "289 : xx11_OF_A343 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A343]  =  FALSE" << endl;
		list.push_back(make_tuple(289, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A345] == false) && (boolState[required_OF_A345] && boolState[relevant_evt_OF_A345]))
	{
		//cout << "290 : xx10_OF_A345 : FAULT failF  LABEL \"failure in operation A345\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A345]  =  TRUE" << endl;
		list.push_back(make_tuple(290, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A345] == true)
	{
		//cout << "291 : xx11_OF_A345 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A345]  =  FALSE" << endl;
		list.push_back(make_tuple(291, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A346] == false) && (boolState[required_OF_A346] && boolState[relevant_evt_OF_A346]))
	{
		//cout << "292 : xx10_OF_A346 : FAULT failF  LABEL \"failure in operation A346\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A346]  =  TRUE" << endl;
		list.push_back(make_tuple(292, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A346] == true)
	{
		//cout << "293 : xx11_OF_A346 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A346]  =  FALSE" << endl;
		list.push_back(make_tuple(293, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A347] == false) && (boolState[required_OF_A347] && boolState[relevant_evt_OF_A347]))
	{
		//cout << "294 : xx10_OF_A347 : FAULT failF  LABEL \"failure in operation A347\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A347]  =  TRUE" << endl;
		list.push_back(make_tuple(294, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A347] == true)
	{
		//cout << "295 : xx11_OF_A347 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A347]  =  FALSE" << endl;
		list.push_back(make_tuple(295, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A348] == false) && (boolState[required_OF_A348] && boolState[relevant_evt_OF_A348]))
	{
		//cout << "296 : xx10_OF_A348 : FAULT failF  LABEL \"failure in operation A348\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A348]  =  TRUE" << endl;
		list.push_back(make_tuple(296, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A348] == true)
	{
		//cout << "297 : xx11_OF_A348 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A348]  =  FALSE" << endl;
		list.push_back(make_tuple(297, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A36] == false) && (boolState[required_OF_A36] && boolState[relevant_evt_OF_A36]))
	{
		//cout << "298 : xx10_OF_A36 : FAULT failF  LABEL \"failure in operation A36\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A36]  =  TRUE" << endl;
		list.push_back(make_tuple(298, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A36] == true)
	{
		//cout << "299 : xx11_OF_A36 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A36]  =  FALSE" << endl;
		list.push_back(make_tuple(299, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A37] == false) && (boolState[required_OF_A37] && boolState[relevant_evt_OF_A37]))
	{
		//cout << "300 : xx10_OF_A37 : FAULT failF  LABEL \"failure in operation A37\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A37]  =  TRUE" << endl;
		list.push_back(make_tuple(300, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A37] == true)
	{
		//cout << "301 : xx11_OF_A37 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A37]  =  FALSE" << endl;
		list.push_back(make_tuple(301, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A38] == false) && (boolState[required_OF_A38] && boolState[relevant_evt_OF_A38]))
	{
		//cout << "302 : xx10_OF_A38 : FAULT failF  LABEL \"failure in operation A38\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A38]  =  TRUE" << endl;
		list.push_back(make_tuple(302, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A38] == true)
	{
		//cout << "303 : xx11_OF_A38 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A38]  =  FALSE" << endl;
		list.push_back(make_tuple(303, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A39] == false) && (boolState[required_OF_A39] && boolState[relevant_evt_OF_A39]))
	{
		//cout << "304 : xx10_OF_A39 : FAULT failF  LABEL \"failure in operation A39\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A39]  =  TRUE" << endl;
		list.push_back(make_tuple(304, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A39] == true)
	{
		//cout << "305 : xx11_OF_A39 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A39]  =  FALSE" << endl;
		list.push_back(make_tuple(305, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A4] == false) && (boolState[required_OF_A4] && boolState[relevant_evt_OF_A4]))
	{
		//cout << "306 : xx10_OF_A4 : FAULT failF  LABEL \"failure in operation A4\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A4]  =  TRUE" << endl;
		list.push_back(make_tuple(306, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A4] == true)
	{
		//cout << "307 : xx11_OF_A4 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A4]  =  FALSE" << endl;
		list.push_back(make_tuple(307, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A41] == false) && (boolState[required_OF_A41] && boolState[relevant_evt_OF_A41]))
	{
		//cout << "308 : xx10_OF_A41 : FAULT failF  LABEL \"failure in operation A41\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A41]  =  TRUE" << endl;
		list.push_back(make_tuple(308, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A41] == true)
	{
		//cout << "309 : xx11_OF_A41 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A41]  =  FALSE" << endl;
		list.push_back(make_tuple(309, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A42] == false) && (boolState[required_OF_A42] && boolState[relevant_evt_OF_A42]))
	{
		//cout << "310 : xx10_OF_A42 : FAULT failF  LABEL \"failure in operation A42\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A42]  =  TRUE" << endl;
		list.push_back(make_tuple(310, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A42] == true)
	{
		//cout << "311 : xx11_OF_A42 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A42]  =  FALSE" << endl;
		list.push_back(make_tuple(311, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A44] == false) && (boolState[required_OF_A44] && boolState[relevant_evt_OF_A44]))
	{
		//cout << "312 : xx10_OF_A44 : FAULT failF  LABEL \"failure in operation A44\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A44]  =  TRUE" << endl;
		list.push_back(make_tuple(312, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A44] == true)
	{
		//cout << "313 : xx11_OF_A44 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A44]  =  FALSE" << endl;
		list.push_back(make_tuple(313, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A45] == false) && (boolState[required_OF_A45] && boolState[relevant_evt_OF_A45]))
	{
		//cout << "314 : xx10_OF_A45 : FAULT failF  LABEL \"failure in operation A45\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A45]  =  TRUE" << endl;
		list.push_back(make_tuple(314, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A45] == true)
	{
		//cout << "315 : xx11_OF_A45 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A45]  =  FALSE" << endl;
		list.push_back(make_tuple(315, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A46] == false) && (boolState[required_OF_A46] && boolState[relevant_evt_OF_A46]))
	{
		//cout << "316 : xx10_OF_A46 : FAULT failF  LABEL \"failure in operation A46\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A46]  =  TRUE" << endl;
		list.push_back(make_tuple(316, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A46] == true)
	{
		//cout << "317 : xx11_OF_A46 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A46]  =  FALSE" << endl;
		list.push_back(make_tuple(317, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A47] == false) && (boolState[required_OF_A47] && boolState[relevant_evt_OF_A47]))
	{
		//cout << "318 : xx10_OF_A47 : FAULT failF  LABEL \"failure in operation A47\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A47]  =  TRUE" << endl;
		list.push_back(make_tuple(318, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A47] == true)
	{
		//cout << "319 : xx11_OF_A47 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A47]  =  FALSE" << endl;
		list.push_back(make_tuple(319, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A5] == false) && (boolState[required_OF_A5] && boolState[relevant_evt_OF_A5]))
	{
		//cout << "320 : xx10_OF_A5 : FAULT failF  LABEL \"failure in operation A5\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A5]  =  TRUE" << endl;
		list.push_back(make_tuple(320, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A5] == true)
	{
		//cout << "321 : xx11_OF_A5 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A5]  =  FALSE" << endl;
		list.push_back(make_tuple(321, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A52] == false) && (boolState[required_OF_A52] && boolState[relevant_evt_OF_A52]))
	{
		//cout << "322 : xx10_OF_A52 : FAULT failF  LABEL \"failure in operation A52\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A52]  =  TRUE" << endl;
		list.push_back(make_tuple(322, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A52] == true)
	{
		//cout << "323 : xx11_OF_A52 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A52]  =  FALSE" << endl;
		list.push_back(make_tuple(323, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A53] == false) && (boolState[required_OF_A53] && boolState[relevant_evt_OF_A53]))
	{
		//cout << "324 : xx10_OF_A53 : FAULT failF  LABEL \"failure in operation A53\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A53]  =  TRUE" << endl;
		list.push_back(make_tuple(324, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A53] == true)
	{
		//cout << "325 : xx11_OF_A53 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A53]  =  FALSE" << endl;
		list.push_back(make_tuple(325, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A54] == false) && (boolState[required_OF_A54] && boolState[relevant_evt_OF_A54]))
	{
		//cout << "326 : xx10_OF_A54 : FAULT failF  LABEL \"failure in operation A54\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A54]  =  TRUE" << endl;
		list.push_back(make_tuple(326, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A54] == true)
	{
		//cout << "327 : xx11_OF_A54 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A54]  =  FALSE" << endl;
		list.push_back(make_tuple(327, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A55] == false) && (boolState[required_OF_A55] && boolState[relevant_evt_OF_A55]))
	{
		//cout << "328 : xx10_OF_A55 : FAULT failF  LABEL \"failure in operation A55\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A55]  =  TRUE" << endl;
		list.push_back(make_tuple(328, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A55] == true)
	{
		//cout << "329 : xx11_OF_A55 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A55]  =  FALSE" << endl;
		list.push_back(make_tuple(329, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A57] == false) && (boolState[required_OF_A57] && boolState[relevant_evt_OF_A57]))
	{
		//cout << "330 : xx10_OF_A57 : FAULT failF  LABEL \"failure in operation A57\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A57]  =  TRUE" << endl;
		list.push_back(make_tuple(330, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A57] == true)
	{
		//cout << "331 : xx11_OF_A57 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A57]  =  FALSE" << endl;
		list.push_back(make_tuple(331, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A58] == false) && (boolState[required_OF_A58] && boolState[relevant_evt_OF_A58]))
	{
		//cout << "332 : xx10_OF_A58 : FAULT failF  LABEL \"failure in operation A58\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A58]  =  TRUE" << endl;
		list.push_back(make_tuple(332, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A58] == true)
	{
		//cout << "333 : xx11_OF_A58 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A58]  =  FALSE" << endl;
		list.push_back(make_tuple(333, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A6] == false) && (boolState[required_OF_A6] && boolState[relevant_evt_OF_A6]))
	{
		//cout << "334 : xx10_OF_A6 : FAULT failF  LABEL \"failure in operation A6\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A6]  =  TRUE" << endl;
		list.push_back(make_tuple(334, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A6] == true)
	{
		//cout << "335 : xx11_OF_A6 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A6]  =  FALSE" << endl;
		list.push_back(make_tuple(335, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A60] == false) && (boolState[required_OF_A60] && boolState[relevant_evt_OF_A60]))
	{
		//cout << "336 : xx10_OF_A60 : FAULT failF  LABEL \"failure in operation A60\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A60]  =  TRUE" << endl;
		list.push_back(make_tuple(336, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A60] == true)
	{
		//cout << "337 : xx11_OF_A60 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A60]  =  FALSE" << endl;
		list.push_back(make_tuple(337, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A61] == false) && (boolState[required_OF_A61] && boolState[relevant_evt_OF_A61]))
	{
		//cout << "338 : xx10_OF_A61 : FAULT failF  LABEL \"failure in operation A61\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A61]  =  TRUE" << endl;
		list.push_back(make_tuple(338, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A61] == true)
	{
		//cout << "339 : xx11_OF_A61 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A61]  =  FALSE" << endl;
		list.push_back(make_tuple(339, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A62] == false) && (boolState[required_OF_A62] && boolState[relevant_evt_OF_A62]))
	{
		//cout << "340 : xx10_OF_A62 : FAULT failF  LABEL \"failure in operation A62\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A62]  =  TRUE" << endl;
		list.push_back(make_tuple(340, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A62] == true)
	{
		//cout << "341 : xx11_OF_A62 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A62]  =  FALSE" << endl;
		list.push_back(make_tuple(341, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A63] == false) && (boolState[required_OF_A63] && boolState[relevant_evt_OF_A63]))
	{
		//cout << "342 : xx10_OF_A63 : FAULT failF  LABEL \"failure in operation A63\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A63]  =  TRUE" << endl;
		list.push_back(make_tuple(342, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A63] == true)
	{
		//cout << "343 : xx11_OF_A63 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A63]  =  FALSE" << endl;
		list.push_back(make_tuple(343, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A7] == false) && (boolState[required_OF_A7] && boolState[relevant_evt_OF_A7]))
	{
		//cout << "344 : xx10_OF_A7 : FAULT failF  LABEL \"failure in operation A7\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A7]  =  TRUE" << endl;
		list.push_back(make_tuple(344, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A7] == true)
	{
		//cout << "345 : xx11_OF_A7 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A7]  =  FALSE" << endl;
		list.push_back(make_tuple(345, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A70] == false) && (boolState[required_OF_A70] && boolState[relevant_evt_OF_A70]))
	{
		//cout << "346 : xx10_OF_A70 : FAULT failF  LABEL \"failure in operation A70\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A70]  =  TRUE" << endl;
		list.push_back(make_tuple(346, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A70] == true)
	{
		//cout << "347 : xx11_OF_A70 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A70]  =  FALSE" << endl;
		list.push_back(make_tuple(347, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A71] == false) && (boolState[required_OF_A71] && boolState[relevant_evt_OF_A71]))
	{
		//cout << "348 : xx10_OF_A71 : FAULT failF  LABEL \"failure in operation A71\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A71]  =  TRUE" << endl;
		list.push_back(make_tuple(348, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A71] == true)
	{
		//cout << "349 : xx11_OF_A71 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A71]  =  FALSE" << endl;
		list.push_back(make_tuple(349, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A72] == false) && (boolState[required_OF_A72] && boolState[relevant_evt_OF_A72]))
	{
		//cout << "350 : xx10_OF_A72 : FAULT failF  LABEL \"failure in operation A72\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A72]  =  TRUE" << endl;
		list.push_back(make_tuple(350, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A72] == true)
	{
		//cout << "351 : xx11_OF_A72 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A72]  =  FALSE" << endl;
		list.push_back(make_tuple(351, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A73] == false) && (boolState[required_OF_A73] && boolState[relevant_evt_OF_A73]))
	{
		//cout << "352 : xx10_OF_A73 : FAULT failF  LABEL \"failure in operation A73\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A73]  =  TRUE" << endl;
		list.push_back(make_tuple(352, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A73] == true)
	{
		//cout << "353 : xx11_OF_A73 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A73]  =  FALSE" << endl;
		list.push_back(make_tuple(353, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A75] == false) && (boolState[required_OF_A75] && boolState[relevant_evt_OF_A75]))
	{
		//cout << "354 : xx10_OF_A75 : FAULT failF  LABEL \"failure in operation A75\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A75]  =  TRUE" << endl;
		list.push_back(make_tuple(354, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A75] == true)
	{
		//cout << "355 : xx11_OF_A75 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A75]  =  FALSE" << endl;
		list.push_back(make_tuple(355, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A76] == false) && (boolState[required_OF_A76] && boolState[relevant_evt_OF_A76]))
	{
		//cout << "356 : xx10_OF_A76 : FAULT failF  LABEL \"failure in operation A76\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A76]  =  TRUE" << endl;
		list.push_back(make_tuple(356, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A76] == true)
	{
		//cout << "357 : xx11_OF_A76 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A76]  =  FALSE" << endl;
		list.push_back(make_tuple(357, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A78] == false) && (boolState[required_OF_A78] && boolState[relevant_evt_OF_A78]))
	{
		//cout << "358 : xx10_OF_A78 : FAULT failF  LABEL \"failure in operation A78\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A78]  =  TRUE" << endl;
		list.push_back(make_tuple(358, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A78] == true)
	{
		//cout << "359 : xx11_OF_A78 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A78]  =  FALSE" << endl;
		list.push_back(make_tuple(359, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A79] == false) && (boolState[required_OF_A79] && boolState[relevant_evt_OF_A79]))
	{
		//cout << "360 : xx10_OF_A79 : FAULT failF  LABEL \"failure in operation A79\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A79]  =  TRUE" << endl;
		list.push_back(make_tuple(360, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A79] == true)
	{
		//cout << "361 : xx11_OF_A79 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A79]  =  FALSE" << endl;
		list.push_back(make_tuple(361, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A80] == false) && (boolState[required_OF_A80] && boolState[relevant_evt_OF_A80]))
	{
		//cout << "362 : xx10_OF_A80 : FAULT failF  LABEL \"failure in operation A80\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A80]  =  TRUE" << endl;
		list.push_back(make_tuple(362, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A80] == true)
	{
		//cout << "363 : xx11_OF_A80 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A80]  =  FALSE" << endl;
		list.push_back(make_tuple(363, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A81] == false) && (boolState[required_OF_A81] && boolState[relevant_evt_OF_A81]))
	{
		//cout << "364 : xx10_OF_A81 : FAULT failF  LABEL \"failure in operation A81\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A81]  =  TRUE" << endl;
		list.push_back(make_tuple(364, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A81] == true)
	{
		//cout << "365 : xx11_OF_A81 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A81]  =  FALSE" << endl;
		list.push_back(make_tuple(365, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A86] == false) && (boolState[required_OF_A86] && boolState[relevant_evt_OF_A86]))
	{
		//cout << "366 : xx10_OF_A86 : FAULT failF  LABEL \"failure in operation A86\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A86]  =  TRUE" << endl;
		list.push_back(make_tuple(366, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A86] == true)
	{
		//cout << "367 : xx11_OF_A86 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A86]  =  FALSE" << endl;
		list.push_back(make_tuple(367, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A87] == false) && (boolState[required_OF_A87] && boolState[relevant_evt_OF_A87]))
	{
		//cout << "368 : xx10_OF_A87 : FAULT failF  LABEL \"failure in operation A87\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A87]  =  TRUE" << endl;
		list.push_back(make_tuple(368, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A87] == true)
	{
		//cout << "369 : xx11_OF_A87 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A87]  =  FALSE" << endl;
		list.push_back(make_tuple(369, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A88] == false) && (boolState[required_OF_A88] && boolState[relevant_evt_OF_A88]))
	{
		//cout << "370 : xx10_OF_A88 : FAULT failF  LABEL \"failure in operation A88\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A88]  =  TRUE" << endl;
		list.push_back(make_tuple(370, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A88] == true)
	{
		//cout << "371 : xx11_OF_A88 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A88]  =  FALSE" << endl;
		list.push_back(make_tuple(371, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A89] == false) && (boolState[required_OF_A89] && boolState[relevant_evt_OF_A89]))
	{
		//cout << "372 : xx10_OF_A89 : FAULT failF  LABEL \"failure in operation A89\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A89]  =  TRUE" << endl;
		list.push_back(make_tuple(372, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A89] == true)
	{
		//cout << "373 : xx11_OF_A89 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A89]  =  FALSE" << endl;
		list.push_back(make_tuple(373, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A9] == false) && (boolState[required_OF_A9] && boolState[relevant_evt_OF_A9]))
	{
		//cout << "374 : xx10_OF_A9 : FAULT failF  LABEL \"failure in operation A9\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A9]  =  TRUE" << endl;
		list.push_back(make_tuple(374, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A9] == true)
	{
		//cout << "375 : xx11_OF_A9 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A9]  =  FALSE" << endl;
		list.push_back(make_tuple(375, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A91] == false) && (boolState[required_OF_A91] && boolState[relevant_evt_OF_A91]))
	{
		//cout << "376 : xx10_OF_A91 : FAULT failF  LABEL \"failure in operation A91\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A91]  =  TRUE" << endl;
		list.push_back(make_tuple(376, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A91] == true)
	{
		//cout << "377 : xx11_OF_A91 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A91]  =  FALSE" << endl;
		list.push_back(make_tuple(377, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A92] == false) && (boolState[required_OF_A92] && boolState[relevant_evt_OF_A92]))
	{
		//cout << "378 : xx10_OF_A92 : FAULT failF  LABEL \"failure in operation A92\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A92]  =  TRUE" << endl;
		list.push_back(make_tuple(378, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A92] == true)
	{
		//cout << "379 : xx11_OF_A92 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A92]  =  FALSE" << endl;
		list.push_back(make_tuple(379, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A94] == false) && (boolState[required_OF_A94] && boolState[relevant_evt_OF_A94]))
	{
		//cout << "380 : xx10_OF_A94 : FAULT failF  LABEL \"failure in operation A94\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A94]  =  TRUE" << endl;
		list.push_back(make_tuple(380, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A94] == true)
	{
		//cout << "381 : xx11_OF_A94 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A94]  =  FALSE" << endl;
		list.push_back(make_tuple(381, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A95] == false) && (boolState[required_OF_A95] && boolState[relevant_evt_OF_A95]))
	{
		//cout << "382 : xx10_OF_A95 : FAULT failF  LABEL \"failure in operation A95\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A95]  =  TRUE" << endl;
		list.push_back(make_tuple(382, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A95] == true)
	{
		//cout << "383 : xx11_OF_A95 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A95]  =  FALSE" << endl;
		list.push_back(make_tuple(383, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A96] == false) && (boolState[required_OF_A96] && boolState[relevant_evt_OF_A96]))
	{
		//cout << "384 : xx10_OF_A96 : FAULT failF  LABEL \"failure in operation A96\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A96]  =  TRUE" << endl;
		list.push_back(make_tuple(384, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A96] == true)
	{
		//cout << "385 : xx11_OF_A96 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A96]  =  FALSE" << endl;
		list.push_back(make_tuple(385, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A97] == false) && (boolState[required_OF_A97] && boolState[relevant_evt_OF_A97]))
	{
		//cout << "386 : xx10_OF_A97 : FAULT failF  LABEL \"failure in operation A97\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A97]  =  TRUE" << endl;
		list.push_back(make_tuple(386, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A97] == true)
	{
		//cout << "387 : xx11_OF_A97 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A97]  =  FALSE" << endl;
		list.push_back(make_tuple(387, 0.1, "EXP", 0));
	}
	return list;
}


void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A10] == true )
	{
...
void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_stationH_alternative_Trim_Article_repair::fireinsttransitiongroup(std::string user_input_ins)
