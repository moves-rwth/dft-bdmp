    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_stationH_alternative_Trim_Article_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_stationH_alternative_Trim_Article_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_A0" , 0},
            	{"already_S_OF_A0" , 1},
            	{"S_OF_A0" , 2},
