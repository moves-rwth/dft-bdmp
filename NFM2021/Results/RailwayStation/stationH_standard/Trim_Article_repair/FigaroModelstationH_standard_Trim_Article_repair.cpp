#include <iostream>
#include "FigaroModelstationH_standard_Trim_Article_repair.h"
...
void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::init()
{
	...
	FIRE_xx11_OF_A194 = false;
	FIRE_xx10_OF_A195 = false;
	FIRE_xx11_OF_A195 = false;
	FIRE_xx10_OF_A196 = false;
	FIRE_xx11_OF_A196 = false;
	FIRE_xx10_OF_A197 = false;
	FIRE_xx11_OF_A197 = false;
	...
	FIRE_xx11_OF_A286 = false;
	FIRE_xx10_OF_A287 = false;
	FIRE_xx11_OF_A287 = false;
...
void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::printState()
{
...
bool storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	// Occurrence xx11_OF_A131
	if (boolState[failF_OF_A131] == true) 
	{
		 
		if (FIRE_xx11_OF_A131)
		{
			boolState[failF_OF_A131]  =  false;
			FIRE_xx11_OF_A131 = false;
		}
	...
	// Occurrence xx11_OF_A140
	if (boolState[failF_OF_A140] == true) 
	{
		 
		if (FIRE_xx11_OF_A140)
		{
			boolState[failF_OF_A140]  =  false;
			FIRE_xx11_OF_A140 = false;
		}
	...
	// Occurrence xx11_OF_A157
	if (boolState[failF_OF_A157] == true) 
	{
		 
		if (FIRE_xx11_OF_A157)
		{
			boolState[failF_OF_A157]  =  false;
			FIRE_xx11_OF_A157 = false;
		}
	...
	// Occurrence xx11_OF_A177
	if (boolState[failF_OF_A177] == true) 
	{
		 
		if (FIRE_xx11_OF_A177)
		{
			boolState[failF_OF_A177]  =  false;
			FIRE_xx11_OF_A177 = false;
		}
	...
	// Occurrence xx11_OF_A194
	if (boolState[failF_OF_A194] == true) 
	{
		 
		if (FIRE_xx11_OF_A194)
		{
			boolState[failF_OF_A194]  =  false;
			FIRE_xx11_OF_A194 = false;
		}
	...
	// Occurrence xx11_OF_A195
	if (boolState[failF_OF_A195] == true) 
	{
		 
		if (FIRE_xx11_OF_A195)
		{
			boolState[failF_OF_A195]  =  false;
			FIRE_xx11_OF_A195 = false;
		}
	...
	// Occurrence xx11_OF_A196
	if (boolState[failF_OF_A196] == true) 
	{
		 
		if (FIRE_xx11_OF_A196)
		{
			boolState[failF_OF_A196]  =  false;
			FIRE_xx11_OF_A196 = false;
		}
	...
	// Occurrence xx11_OF_A197
	if (boolState[failF_OF_A197] == true) 
	{
		 
		if (FIRE_xx11_OF_A197)
		{
			boolState[failF_OF_A197]  =  false;
			FIRE_xx11_OF_A197 = false;
		}
	...
	// Occurrence xx11_OF_A202
	if (boolState[failF_OF_A202] == true) 
	{
		 
		if (FIRE_xx11_OF_A202)
		{
			boolState[failF_OF_A202]  =  false;
			FIRE_xx11_OF_A202 = false;
		}
	...
	// Occurrence xx11_OF_A205
	if (boolState[failF_OF_A205] == true) 
	{
		 
		if (FIRE_xx11_OF_A205)
		{
			boolState[failF_OF_A205]  =  false;
			FIRE_xx11_OF_A205 = false;
		}
	...
	// Occurrence xx11_OF_A216
	if (boolState[failF_OF_A216] == true) 
	{
		 
		if (FIRE_xx11_OF_A216)
		{
			boolState[failF_OF_A216]  =  false;
			FIRE_xx11_OF_A216 = false;
		}
	...
	// Occurrence xx11_OF_A219
	if (boolState[failF_OF_A219] == true) 
	{
		 
		if (FIRE_xx11_OF_A219)
		{
			boolState[failF_OF_A219]  =  false;
			FIRE_xx11_OF_A219 = false;
		}
	...
	// Occurrence xx11_OF_A224
	if (boolState[failF_OF_A224] == true) 
	{
		 
		if (FIRE_xx11_OF_A224)
		{
			boolState[failF_OF_A224]  =  false;
			FIRE_xx11_OF_A224 = false;
		}
	...
	// Occurrence xx11_OF_A225
	if (boolState[failF_OF_A225] == true) 
	{
		 
		if (FIRE_xx11_OF_A225)
		{
			boolState[failF_OF_A225]  =  false;
			FIRE_xx11_OF_A225 = false;
		}
	...
	// Occurrence xx11_OF_A235
	if (boolState[failF_OF_A235] == true) 
	{
		 
		if (FIRE_xx11_OF_A235)
		{
			boolState[failF_OF_A235]  =  false;
			FIRE_xx11_OF_A235 = false;
		}
	...
	// Occurrence xx11_OF_A236
	if (boolState[failF_OF_A236] == true) 
	{
		 
		if (FIRE_xx11_OF_A236)
		{
			boolState[failF_OF_A236]  =  false;
			FIRE_xx11_OF_A236 = false;
		}
	...
	// Occurrence xx11_OF_A237
	if (boolState[failF_OF_A237] == true) 
	{
		 
		if (FIRE_xx11_OF_A237)
		{
			boolState[failF_OF_A237]  =  false;
			FIRE_xx11_OF_A237 = false;
		}
	...
	// Occurrence xx11_OF_A238
	if (boolState[failF_OF_A238] == true) 
	{
		 
		if (FIRE_xx11_OF_A238)
		{
			boolState[failF_OF_A238]  =  false;
			FIRE_xx11_OF_A238 = false;
		}
	...
	// Occurrence xx11_OF_A243
	if (boolState[failF_OF_A243] == true) 
	{
		 
		if (FIRE_xx11_OF_A243)
		{
			boolState[failF_OF_A243]  =  false;
			FIRE_xx11_OF_A243 = false;
		}
	...
	// Occurrence xx11_OF_A246
	if (boolState[failF_OF_A246] == true) 
	{
		 
		if (FIRE_xx11_OF_A246)
		{
			boolState[failF_OF_A246]  =  false;
			FIRE_xx11_OF_A246 = false;
		}
	...
	// Occurrence xx11_OF_A251
	if (boolState[failF_OF_A251] == true) 
	{
		 
		if (FIRE_xx11_OF_A251)
		{
			boolState[failF_OF_A251]  =  false;
			FIRE_xx11_OF_A251 = false;
		}
	...
	// Occurrence xx11_OF_A252
	if (boolState[failF_OF_A252] == true) 
	{
		 
		if (FIRE_xx11_OF_A252)
		{
			boolState[failF_OF_A252]  =  false;
			FIRE_xx11_OF_A252 = false;
		}
	...
	// Occurrence xx11_OF_A253
	if (boolState[failF_OF_A253] == true) 
	{
		 
		if (FIRE_xx11_OF_A253)
		{
			boolState[failF_OF_A253]  =  false;
			FIRE_xx11_OF_A253 = false;
		}
	...
	// Occurrence xx11_OF_A254
	if (boolState[failF_OF_A254] == true) 
	{
		 
		if (FIRE_xx11_OF_A254)
		{
			boolState[failF_OF_A254]  =  false;
			FIRE_xx11_OF_A254 = false;
		}
	...
	// Occurrence xx11_OF_A260
	if (boolState[failF_OF_A260] == true) 
	{
		 
		if (FIRE_xx11_OF_A260)
		{
			boolState[failF_OF_A260]  =  false;
			FIRE_xx11_OF_A260 = false;
		}
	...
	// Occurrence xx11_OF_A270
	if (boolState[failF_OF_A270] == true) 
	{
		 
		if (FIRE_xx11_OF_A270)
		{
			boolState[failF_OF_A270]  =  false;
			FIRE_xx11_OF_A270 = false;
		}
	...
	// Occurrence xx11_OF_A271
	if (boolState[failF_OF_A271] == true) 
	{
		 
		if (FIRE_xx11_OF_A271)
		{
			boolState[failF_OF_A271]  =  false;
			FIRE_xx11_OF_A271 = false;
		}
	...
	// Occurrence xx11_OF_A276
	if (boolState[failF_OF_A276] == true) 
	{
		 
		if (FIRE_xx11_OF_A276)
		{
			boolState[failF_OF_A276]  =  false;
			FIRE_xx11_OF_A276 = false;
		}
	...
	// Occurrence xx11_OF_A279
	if (boolState[failF_OF_A279] == true) 
	{
		 
		if (FIRE_xx11_OF_A279)
		{
			boolState[failF_OF_A279]  =  false;
			FIRE_xx11_OF_A279 = false;
		}
	...
	// Occurrence xx11_OF_A286
	if (boolState[failF_OF_A286] == true) 
	{
		 
		if (FIRE_xx11_OF_A286)
		{
			boolState[failF_OF_A286]  =  false;
			FIRE_xx11_OF_A286 = false;
		}
	...
	// Occurrence xx11_OF_A287
	if (boolState[failF_OF_A287] == true) 
	{
		 
		if (FIRE_xx11_OF_A287)
		{
			boolState[failF_OF_A287]  =  false;
			FIRE_xx11_OF_A287 = false;
		}
	...
	// Occurrence xx11_OF_A292
	if (boolState[failF_OF_A292] == true) 
	{
		 
		if (FIRE_xx11_OF_A292)
		{
			boolState[failF_OF_A292]  =  false;
			FIRE_xx11_OF_A292 = false;
		}
	...
	// Occurrence xx11_OF_A295
	if (boolState[failF_OF_A295] == true) 
	{
		 
		if (FIRE_xx11_OF_A295)
		{
			boolState[failF_OF_A295]  =  false;
			FIRE_xx11_OF_A295 = false;
		}
	...
	// Occurrence xx11_OF_A302
	if (boolState[failF_OF_A302] == true) 
	{
		 
		if (FIRE_xx11_OF_A302)
		{
			boolState[failF_OF_A302]  =  false;
			FIRE_xx11_OF_A302 = false;
		}
	...
	// Occurrence xx11_OF_A304
	if (boolState[failF_OF_A304] == true) 
	{
		 
		if (FIRE_xx11_OF_A304)
		{
			boolState[failF_OF_A304]  =  false;
			FIRE_xx11_OF_A304 = false;
		}
	...
	// Occurrence xx11_OF_A307
	if (boolState[failF_OF_A307] == true) 
	{
		 
		if (FIRE_xx11_OF_A307)
		{
			boolState[failF_OF_A307]  =  false;
			FIRE_xx11_OF_A307 = false;
		}
	...
	// Occurrence xx11_OF_A308
	if (boolState[failF_OF_A308] == true) 
	{
		 
		if (FIRE_xx11_OF_A308)
		{
			boolState[failF_OF_A308]  =  false;
			FIRE_xx11_OF_A308 = false;
		}
	...
	// Occurrence xx11_OF_A309
	if (boolState[failF_OF_A309] == true) 
	{
		 
		if (FIRE_xx11_OF_A309)
		{
			boolState[failF_OF_A309]  =  false;
			FIRE_xx11_OF_A309 = false;
		}
	...
	// Occurrence xx11_OF_A310
	if (boolState[failF_OF_A310] == true) 
	{
		 
		if (FIRE_xx11_OF_A310)
		{
			boolState[failF_OF_A310]  =  false;
			FIRE_xx11_OF_A310 = false;
		}
	...
	// Occurrence xx11_OF_A312
	if (boolState[failF_OF_A312] == true) 
	{
		 
		if (FIRE_xx11_OF_A312)
		{
			boolState[failF_OF_A312]  =  false;
			FIRE_xx11_OF_A312 = false;
		}
	...
	// Occurrence xx11_OF_A313
	if (boolState[failF_OF_A313] == true) 
	{
		 
		if (FIRE_xx11_OF_A313)
		{
			boolState[failF_OF_A313]  =  false;
			FIRE_xx11_OF_A313 = false;
		}
	...
	// Occurrence xx11_OF_A315
	if (boolState[failF_OF_A315] == true) 
	{
		 
		if (FIRE_xx11_OF_A315)
		{
			boolState[failF_OF_A315]  =  false;
			FIRE_xx11_OF_A315 = false;
		}
	...
	// Occurrence xx11_OF_A316
	if (boolState[failF_OF_A316] == true) 
	{
		 
		if (FIRE_xx11_OF_A316)
		{
			boolState[failF_OF_A316]  =  false;
			FIRE_xx11_OF_A316 = false;
		}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_A122] == false) && (boolState[required_OF_A122] && boolState[relevant_evt_OF_A122]))
	{
		//cout << "24 : xx10_OF_A122 : FAULT failF  LABEL \"failure in operation A122\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A122]  =  TRUE" << endl;
		list.push_back(make_tuple(24, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A122] == true)
	{
		//cout << "25 : xx11_OF_A122 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A122]  =  FALSE" << endl;
		list.push_back(make_tuple(25, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A123] == false) && (boolState[required_OF_A123] && boolState[relevant_evt_OF_A123]))
	{
		//cout << "26 : xx10_OF_A123 : FAULT failF  LABEL \"failure in operation A123\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A123]  =  TRUE" << endl;
		list.push_back(make_tuple(26, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A123] == true)
	{
		//cout << "27 : xx11_OF_A123 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A123]  =  FALSE" << endl;
		list.push_back(make_tuple(27, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A124] == false) && (boolState[required_OF_A124] && boolState[relevant_evt_OF_A124]))
	{
		//cout << "28 : xx10_OF_A124 : FAULT failF  LABEL \"failure in operation A124\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A124]  =  TRUE" << endl;
		list.push_back(make_tuple(28, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A124] == true)
	{
		//cout << "29 : xx11_OF_A124 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A124]  =  FALSE" << endl;
		list.push_back(make_tuple(29, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A125] == false) && (boolState[required_OF_A125] && boolState[relevant_evt_OF_A125]))
	{
		//cout << "30 : xx10_OF_A125 : FAULT failF  LABEL \"failure in operation A125\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A125]  =  TRUE" << endl;
		list.push_back(make_tuple(30, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A125] == true)
	{
		//cout << "31 : xx11_OF_A125 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A125]  =  FALSE" << endl;
		list.push_back(make_tuple(31, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A127] == false) && (boolState[required_OF_A127] && boolState[relevant_evt_OF_A127]))
	{
		//cout << "32 : xx10_OF_A127 : FAULT failF  LABEL \"failure in operation A127\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A127]  =  TRUE" << endl;
		list.push_back(make_tuple(32, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A127] == true)
	{
	...
	if ((boolState[failF_OF_A128] == false) && (boolState[required_OF_A128] && boolState[relevant_evt_OF_A128]))
	{
		//cout << "34 : xx10_OF_A128 : FAULT failF  LABEL \"failure in operation A128\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A128]  =  TRUE" << endl;
		list.push_back(make_tuple(34, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A128] == true)
	{
	...
	if ((boolState[failF_OF_A13] == false) && (boolState[required_OF_A13] && boolState[relevant_evt_OF_A13]))
	{
		//cout << "36 : xx10_OF_A13 : FAULT failF  LABEL \"failure in operation A13\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A13]  =  TRUE" << endl;
		list.push_back(make_tuple(36, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A13] == true)
	{
		//cout << "37 : xx11_OF_A13 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A13]  =  FALSE" << endl;
		list.push_back(make_tuple(37, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A130] == false) && (boolState[required_OF_A130] && boolState[relevant_evt_OF_A130]))
	{
		//cout << "38 : xx10_OF_A130 : FAULT failF  LABEL \"failure in operation A130\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A130]  =  TRUE" << endl;
		list.push_back(make_tuple(38, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A130] == true)
	{
		//cout << "39 : xx11_OF_A130 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A130]  =  FALSE" << endl;
		list.push_back(make_tuple(39, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A131] == false) && (boolState[required_OF_A131] && boolState[relevant_evt_OF_A131]))
	{
		//cout << "40 : xx10_OF_A131 : FAULT failF  LABEL \"failure in operation A131\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A131]  =  TRUE" << endl;
		list.push_back(make_tuple(40, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A131] == true)
	{
		//cout << "41 : xx11_OF_A131 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A131]  =  FALSE" << endl;
		list.push_back(make_tuple(41, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A132] == false) && (boolState[required_OF_A132] && boolState[relevant_evt_OF_A132]))
	{
		//cout << "42 : xx10_OF_A132 : FAULT failF  LABEL \"failure in operation A132\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A132]  =  TRUE" << endl;
		list.push_back(make_tuple(42, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A132] == true)
	{
		//cout << "43 : xx11_OF_A132 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A132]  =  FALSE" << endl;
		list.push_back(make_tuple(43, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A133] == false) && (boolState[required_OF_A133] && boolState[relevant_evt_OF_A133]))
	{
		//cout << "44 : xx10_OF_A133 : FAULT failF  LABEL \"failure in operation A133\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A133]  =  TRUE" << endl;
		list.push_back(make_tuple(44, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A133] == true)
	{
		//cout << "45 : xx11_OF_A133 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A133]  =  FALSE" << endl;
		list.push_back(make_tuple(45, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A139] == false) && (boolState[required_OF_A139] && boolState[relevant_evt_OF_A139]))
	{
		//cout << "46 : xx10_OF_A139 : FAULT failF  LABEL \"failure in operation A139\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A139]  =  TRUE" << endl;
		list.push_back(make_tuple(46, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A139] == true)
	{
	...
	if ((boolState[failF_OF_A14] == false) && (boolState[required_OF_A14] && boolState[relevant_evt_OF_A14]))
	{
		//cout << "48 : xx10_OF_A14 : FAULT failF  LABEL \"failure in operation A14\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A14]  =  TRUE" << endl;
		list.push_back(make_tuple(48, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A14] == true)
	{
		//cout << "49 : xx11_OF_A14 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A14]  =  FALSE" << endl;
		list.push_back(make_tuple(49, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A140] == false) && (boolState[required_OF_A140] && boolState[relevant_evt_OF_A140]))
	{
		//cout << "50 : xx10_OF_A140 : FAULT failF  LABEL \"failure in operation A140\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A140]  =  TRUE" << endl;
		list.push_back(make_tuple(50, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A140] == true)
	{
		//cout << "51 : xx11_OF_A140 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A140]  =  FALSE" << endl;
		list.push_back(make_tuple(51, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A141] == false) && (boolState[required_OF_A141] && boolState[relevant_evt_OF_A141]))
	{
		//cout << "52 : xx10_OF_A141 : FAULT failF  LABEL \"failure in operation A141\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A141]  =  TRUE" << endl;
		list.push_back(make_tuple(52, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A141] == true)
	{
		//cout << "53 : xx11_OF_A141 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A141]  =  FALSE" << endl;
		list.push_back(make_tuple(53, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A142] == false) && (boolState[required_OF_A142] && boolState[relevant_evt_OF_A142]))
	{
		//cout << "54 : xx10_OF_A142 : FAULT failF  LABEL \"failure in operation A142\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A142]  =  TRUE" << endl;
		list.push_back(make_tuple(54, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A142] == true)
	{
		//cout << "55 : xx11_OF_A142 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A142]  =  FALSE" << endl;
		list.push_back(make_tuple(55, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A144] == false) && (boolState[required_OF_A144] && boolState[relevant_evt_OF_A144]))
	{
		//cout << "56 : xx10_OF_A144 : FAULT failF  LABEL \"failure in operation A144\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A144]  =  TRUE" << endl;
		list.push_back(make_tuple(56, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A144] == true)
	{
		//cout << "57 : xx11_OF_A144 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A144]  =  FALSE" << endl;
		list.push_back(make_tuple(57, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A145] == false) && (boolState[required_OF_A145] && boolState[relevant_evt_OF_A145]))
	{
		//cout << "58 : xx10_OF_A145 : FAULT failF  LABEL \"failure in operation A145\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A145]  =  TRUE" << endl;
		list.push_back(make_tuple(58, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A145] == true)
	{
		//cout << "59 : xx11_OF_A145 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A145]  =  FALSE" << endl;
		list.push_back(make_tuple(59, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A147] == false) && (boolState[required_OF_A147] && boolState[relevant_evt_OF_A147]))
	{
		//cout << "60 : xx10_OF_A147 : FAULT failF  LABEL \"failure in operation A147\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A147]  =  TRUE" << endl;
		list.push_back(make_tuple(60, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A147] == true)
	{
		//cout << "61 : xx11_OF_A147 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A147]  =  FALSE" << endl;
		list.push_back(make_tuple(61, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A148] == false) && (boolState[required_OF_A148] && boolState[relevant_evt_OF_A148]))
	{
		//cout << "62 : xx10_OF_A148 : FAULT failF  LABEL \"failure in operation A148\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A148]  =  TRUE" << endl;
		list.push_back(make_tuple(62, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A148] == true)
	{
		//cout << "63 : xx11_OF_A148 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A148]  =  FALSE" << endl;
		list.push_back(make_tuple(63, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A149] == false) && (boolState[required_OF_A149] && boolState[relevant_evt_OF_A149]))
	{
		//cout << "64 : xx10_OF_A149 : FAULT failF  LABEL \"failure in operation A149\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A149]  =  TRUE" << endl;
		list.push_back(make_tuple(64, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A149] == true)
	{
		//cout << "65 : xx11_OF_A149 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A149]  =  FALSE" << endl;
		list.push_back(make_tuple(65, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A15] == false) && (boolState[required_OF_A15] && boolState[relevant_evt_OF_A15]))
	{
		//cout << "66 : xx10_OF_A15 : FAULT failF  LABEL \"failure in operation A15\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A15]  =  TRUE" << endl;
		list.push_back(make_tuple(66, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A15] == true)
	{
		//cout << "67 : xx11_OF_A15 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A15]  =  FALSE" << endl;
		list.push_back(make_tuple(67, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A150] == false) && (boolState[required_OF_A150] && boolState[relevant_evt_OF_A150]))
	{
		//cout << "68 : xx10_OF_A150 : FAULT failF  LABEL \"failure in operation A150\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A150]  =  TRUE" << endl;
		list.push_back(make_tuple(68, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A150] == true)
	{
		//cout << "69 : xx11_OF_A150 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A150]  =  FALSE" << endl;
		list.push_back(make_tuple(69, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A155] == false) && (boolState[required_OF_A155] && boolState[relevant_evt_OF_A155]))
	{
		//cout << "70 : xx10_OF_A155 : FAULT failF  LABEL \"failure in operation A155\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A155]  =  TRUE" << endl;
		list.push_back(make_tuple(70, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A155] == true)
	{
		//cout << "71 : xx11_OF_A155 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A155]  =  FALSE" << endl;
		list.push_back(make_tuple(71, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A156] == false) && (boolState[required_OF_A156] && boolState[relevant_evt_OF_A156]))
	{
		//cout << "72 : xx10_OF_A156 : FAULT failF  LABEL \"failure in operation A156\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A156]  =  TRUE" << endl;
		list.push_back(make_tuple(72, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A156] == true)
	{
		//cout << "73 : xx11_OF_A156 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A156]  =  FALSE" << endl;
		list.push_back(make_tuple(73, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A157] == false) && (boolState[required_OF_A157] && boolState[relevant_evt_OF_A157]))
	{
		//cout << "74 : xx10_OF_A157 : FAULT failF  LABEL \"failure in operation A157\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A157]  =  TRUE" << endl;
		list.push_back(make_tuple(74, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A157] == true)
	{
		//cout << "75 : xx11_OF_A157 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A157]  =  FALSE" << endl;
		list.push_back(make_tuple(75, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A158] == false) && (boolState[required_OF_A158] && boolState[relevant_evt_OF_A158]))
	{
		//cout << "76 : xx10_OF_A158 : FAULT failF  LABEL \"failure in operation A158\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A158]  =  TRUE" << endl;
		list.push_back(make_tuple(76, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A158] == true)
	{
		//cout << "77 : xx11_OF_A158 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A158]  =  FALSE" << endl;
		list.push_back(make_tuple(77, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A160] == false) && (boolState[required_OF_A160] && boolState[relevant_evt_OF_A160]))
	{
		//cout << "78 : xx10_OF_A160 : FAULT failF  LABEL \"failure in operation A160\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A160]  =  TRUE" << endl;
		list.push_back(make_tuple(78, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A160] == true)
	{
		//cout << "79 : xx11_OF_A160 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A160]  =  FALSE" << endl;
		list.push_back(make_tuple(79, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A161] == false) && (boolState[required_OF_A161] && boolState[relevant_evt_OF_A161]))
	{
		//cout << "80 : xx10_OF_A161 : FAULT failF  LABEL \"failure in operation A161\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A161]  =  TRUE" << endl;
		list.push_back(make_tuple(80, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A161] == true)
	{
		//cout << "81 : xx11_OF_A161 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A161]  =  FALSE" << endl;
		list.push_back(make_tuple(81, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A163] == false) && (boolState[required_OF_A163] && boolState[relevant_evt_OF_A163]))
	{
		//cout << "82 : xx10_OF_A163 : FAULT failF  LABEL \"failure in operation A163\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A163]  =  TRUE" << endl;
		list.push_back(make_tuple(82, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A163] == true)
	{
		//cout << "83 : xx11_OF_A163 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A163]  =  FALSE" << endl;
		list.push_back(make_tuple(83, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A164] == false) && (boolState[required_OF_A164] && boolState[relevant_evt_OF_A164]))
	{
		//cout << "84 : xx10_OF_A164 : FAULT failF  LABEL \"failure in operation A164\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A164]  =  TRUE" << endl;
		list.push_back(make_tuple(84, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A164] == true)
	{
		//cout << "85 : xx11_OF_A164 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A164]  =  FALSE" << endl;
		list.push_back(make_tuple(85, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A165] == false) && (boolState[required_OF_A165] && boolState[relevant_evt_OF_A165]))
	{
		//cout << "86 : xx10_OF_A165 : FAULT failF  LABEL \"failure in operation A165\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A165]  =  TRUE" << endl;
		list.push_back(make_tuple(86, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A165] == true)
	{
		//cout << "87 : xx11_OF_A165 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A165]  =  FALSE" << endl;
		list.push_back(make_tuple(87, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A166] == false) && (boolState[required_OF_A166] && boolState[relevant_evt_OF_A166]))
	{
		//cout << "88 : xx10_OF_A166 : FAULT failF  LABEL \"failure in operation A166\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A166]  =  TRUE" << endl;
		list.push_back(make_tuple(88, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A166] == true)
	{
		//cout << "89 : xx11_OF_A166 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A166]  =  FALSE" << endl;
		list.push_back(make_tuple(89, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A174] == false) && (boolState[required_OF_A174] && boolState[relevant_evt_OF_A174]))
	{
		//cout << "90 : xx10_OF_A174 : FAULT failF  LABEL \"failure in operation A174\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A174]  =  TRUE" << endl;
		list.push_back(make_tuple(90, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A174] == true)
	{
		//cout << "91 : xx11_OF_A174 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A174]  =  FALSE" << endl;
		list.push_back(make_tuple(91, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A175] == false) && (boolState[required_OF_A175] && boolState[relevant_evt_OF_A175]))
	{
		//cout << "92 : xx10_OF_A175 : FAULT failF  LABEL \"failure in operation A175\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A175]  =  TRUE" << endl;
		list.push_back(make_tuple(92, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A175] == true)
	{
		//cout << "93 : xx11_OF_A175 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A175]  =  FALSE" << endl;
		list.push_back(make_tuple(93, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A176] == false) && (boolState[required_OF_A176] && boolState[relevant_evt_OF_A176]))
	{
		//cout << "94 : xx10_OF_A176 : FAULT failF  LABEL \"failure in operation A176\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A176]  =  TRUE" << endl;
		list.push_back(make_tuple(94, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A176] == true)
	{
		//cout << "95 : xx11_OF_A176 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A176]  =  FALSE" << endl;
		list.push_back(make_tuple(95, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A177] == false) && (boolState[required_OF_A177] && boolState[relevant_evt_OF_A177]))
	{
		//cout << "96 : xx10_OF_A177 : FAULT failF  LABEL \"failure in operation A177\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A177]  =  TRUE" << endl;
		list.push_back(make_tuple(96, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A177] == true)
	{
		//cout << "97 : xx11_OF_A177 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A177]  =  FALSE" << endl;
		list.push_back(make_tuple(97, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A179] == false) && (boolState[required_OF_A179] && boolState[relevant_evt_OF_A179]))
	{
		//cout << "98 : xx10_OF_A179 : FAULT failF  LABEL \"failure in operation A179\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A179]  =  TRUE" << endl;
		list.push_back(make_tuple(98, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A179] == true)
	{
		//cout << "99 : xx11_OF_A179 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A179]  =  FALSE" << endl;
		list.push_back(make_tuple(99, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A180] == false) && (boolState[required_OF_A180] && boolState[relevant_evt_OF_A180]))
	{
		//cout << "100 : xx10_OF_A180 : FAULT failF  LABEL \"failure in operation A180\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A180]  =  TRUE" << endl;
		list.push_back(make_tuple(100, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A180] == true)
	{
		//cout << "101 : xx11_OF_A180 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A180]  =  FALSE" << endl;
		list.push_back(make_tuple(101, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A182] == false) && (boolState[required_OF_A182] && boolState[relevant_evt_OF_A182]))
	{
		//cout << "102 : xx10_OF_A182 : FAULT failF  LABEL \"failure in operation A182\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A182]  =  TRUE" << endl;
		list.push_back(make_tuple(102, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A182] == true)
	{
		//cout << "103 : xx11_OF_A182 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A182]  =  FALSE" << endl;
		list.push_back(make_tuple(103, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A183] == false) && (boolState[required_OF_A183] && boolState[relevant_evt_OF_A183]))
	{
		//cout << "104 : xx10_OF_A183 : FAULT failF  LABEL \"failure in operation A183\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A183]  =  TRUE" << endl;
		list.push_back(make_tuple(104, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A183] == true)
	{
		//cout << "105 : xx11_OF_A183 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A183]  =  FALSE" << endl;
		list.push_back(make_tuple(105, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A184] == false) && (boolState[required_OF_A184] && boolState[relevant_evt_OF_A184]))
	{
		//cout << "106 : xx10_OF_A184 : FAULT failF  LABEL \"failure in operation A184\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A184]  =  TRUE" << endl;
		list.push_back(make_tuple(106, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A184] == true)
	{
		//cout << "107 : xx11_OF_A184 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A184]  =  FALSE" << endl;
		list.push_back(make_tuple(107, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A185] == false) && (boolState[required_OF_A185] && boolState[relevant_evt_OF_A185]))
	{
		//cout << "108 : xx10_OF_A185 : FAULT failF  LABEL \"failure in operation A185\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A185]  =  TRUE" << endl;
		list.push_back(make_tuple(108, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A185] == true)
	{
		//cout << "109 : xx11_OF_A185 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A185]  =  FALSE" << endl;
		list.push_back(make_tuple(109, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A190] == false) && (boolState[required_OF_A190] && boolState[relevant_evt_OF_A190]))
	{
		//cout << "110 : xx10_OF_A190 : FAULT failF  LABEL \"failure in operation A190\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A190]  =  TRUE" << endl;
		list.push_back(make_tuple(110, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A190] == true)
	{
		//cout << "111 : xx11_OF_A190 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A190]  =  FALSE" << endl;
		list.push_back(make_tuple(111, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A192] == false) && (boolState[required_OF_A192] && boolState[relevant_evt_OF_A192]))
	{
		//cout << "112 : xx10_OF_A192 : FAULT failF  LABEL \"failure in operation A192\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A192]  =  TRUE" << endl;
		list.push_back(make_tuple(112, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A192] == true)
	{
		//cout << "113 : xx11_OF_A192 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A192]  =  FALSE" << endl;
		list.push_back(make_tuple(113, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A194] == false) && (boolState[required_OF_A194] && boolState[relevant_evt_OF_A194]))
	{
		//cout << "114 : xx10_OF_A194 : FAULT failF  LABEL \"failure in operation A194\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A194]  =  TRUE" << endl;
		list.push_back(make_tuple(114, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A194] == true)
	{
		//cout << "115 : xx11_OF_A194 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A194]  =  FALSE" << endl;
		list.push_back(make_tuple(115, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A195] == false) && (boolState[required_OF_A195] && boolState[relevant_evt_OF_A195]))
	{
		//cout << "116 : xx10_OF_A195 : FAULT failF  LABEL \"failure in operation A195\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A195]  =  TRUE" << endl;
		list.push_back(make_tuple(116, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A195] == true)
	{
		//cout << "117 : xx11_OF_A195 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A195]  =  FALSE" << endl;
		list.push_back(make_tuple(117, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A196] == false) && (boolState[required_OF_A196] && boolState[relevant_evt_OF_A196]))
	{
		//cout << "118 : xx10_OF_A196 : FAULT failF  LABEL \"failure in operation A196\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A196]  =  TRUE" << endl;
		list.push_back(make_tuple(118, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A196] == true)
	{
		//cout << "119 : xx11_OF_A196 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A196]  =  FALSE" << endl;
		list.push_back(make_tuple(119, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A197] == false) && (boolState[required_OF_A197] && boolState[relevant_evt_OF_A197]))
	{
		//cout << "120 : xx10_OF_A197 : FAULT failF  LABEL \"failure in operation A197\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A197]  =  TRUE" << endl;
		list.push_back(make_tuple(120, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A197] == true)
	{
		//cout << "121 : xx11_OF_A197 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A197]  =  FALSE" << endl;
		list.push_back(make_tuple(121, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A199] == false) && (boolState[required_OF_A199] && boolState[relevant_evt_OF_A199]))
	{
		//cout << "122 : xx10_OF_A199 : FAULT failF  LABEL \"failure in operation A199\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A199]  =  TRUE" << endl;
		list.push_back(make_tuple(122, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A199] == true)
	{
		//cout << "123 : xx11_OF_A199 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A199]  =  FALSE" << endl;
		list.push_back(make_tuple(123, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A20] == false) && (boolState[required_OF_A20] && boolState[relevant_evt_OF_A20]))
	{
		//cout << "124 : xx10_OF_A20 : FAULT failF  LABEL \"failure in operation A20\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A20]  =  TRUE" << endl;
		list.push_back(make_tuple(124, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A20] == true)
	{
		//cout << "125 : xx11_OF_A20 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A20]  =  FALSE" << endl;
		list.push_back(make_tuple(125, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A200] == false) && (boolState[required_OF_A200] && boolState[relevant_evt_OF_A200]))
	{
		//cout << "126 : xx10_OF_A200 : FAULT failF  LABEL \"failure in operation A200\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A200]  =  TRUE" << endl;
		list.push_back(make_tuple(126, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A200] == true)
	{
		//cout << "127 : xx11_OF_A200 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A200]  =  FALSE" << endl;
		list.push_back(make_tuple(127, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A202] == false) && (boolState[required_OF_A202] && boolState[relevant_evt_OF_A202]))
	{
		//cout << "128 : xx10_OF_A202 : FAULT failF  LABEL \"failure in operation A202\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A202]  =  TRUE" << endl;
		list.push_back(make_tuple(128, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A202] == true)
	{
		//cout << "129 : xx11_OF_A202 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A202]  =  FALSE" << endl;
		list.push_back(make_tuple(129, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A203] == false) && (boolState[required_OF_A203] && boolState[relevant_evt_OF_A203]))
	{
		//cout << "130 : xx10_OF_A203 : FAULT failF  LABEL \"failure in operation A203\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A203]  =  TRUE" << endl;
		list.push_back(make_tuple(130, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A203] == true)
	{
		//cout << "131 : xx11_OF_A203 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A203]  =  FALSE" << endl;
		list.push_back(make_tuple(131, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A204] == false) && (boolState[required_OF_A204] && boolState[relevant_evt_OF_A204]))
	{
		//cout << "132 : xx10_OF_A204 : FAULT failF  LABEL \"failure in operation A204\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A204]  =  TRUE" << endl;
		list.push_back(make_tuple(132, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A204] == true)
	{
		//cout << "133 : xx11_OF_A204 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A204]  =  FALSE" << endl;
		list.push_back(make_tuple(133, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A205] == false) && (boolState[required_OF_A205] && boolState[relevant_evt_OF_A205]))
	{
		//cout << "134 : xx10_OF_A205 : FAULT failF  LABEL \"failure in operation A205\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A205]  =  TRUE" << endl;
		list.push_back(make_tuple(134, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A205] == true)
	{
		//cout << "135 : xx11_OF_A205 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A205]  =  FALSE" << endl;
	...
	if ((boolState[failF_OF_A214] == false) && (boolState[required_OF_A214] && boolState[relevant_evt_OF_A214]))
	{
		//cout << "138 : xx10_OF_A214 : FAULT failF  LABEL \"failure in operation A214\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A214]  =  TRUE" << endl;
		list.push_back(make_tuple(138, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A214] == true)
	{
		//cout << "139 : xx11_OF_A214 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A214]  =  FALSE" << endl;
		list.push_back(make_tuple(139, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A215] == false) && (boolState[required_OF_A215] && boolState[relevant_evt_OF_A215]))
	{
		//cout << "140 : xx10_OF_A215 : FAULT failF  LABEL \"failure in operation A215\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A215]  =  TRUE" << endl;
		list.push_back(make_tuple(140, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A215] == true)
	{
		//cout << "141 : xx11_OF_A215 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A215]  =  FALSE" << endl;
		list.push_back(make_tuple(141, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A216] == false) && (boolState[required_OF_A216] && boolState[relevant_evt_OF_A216]))
	{
		//cout << "142 : xx10_OF_A216 : FAULT failF  LABEL \"failure in operation A216\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A216]  =  TRUE" << endl;
		list.push_back(make_tuple(142, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A216] == true)
	{
		//cout << "143 : xx11_OF_A216 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A216]  =  FALSE" << endl;
		list.push_back(make_tuple(143, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A217] == false) && (boolState[required_OF_A217] && boolState[relevant_evt_OF_A217]))
	{
		//cout << "144 : xx10_OF_A217 : FAULT failF  LABEL \"failure in operation A217\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A217]  =  TRUE" << endl;
		list.push_back(make_tuple(144, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A217] == true)
	{
		//cout << "145 : xx11_OF_A217 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A217]  =  FALSE" << endl;
		list.push_back(make_tuple(145, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A219] == false) && (boolState[required_OF_A219] && boolState[relevant_evt_OF_A219]))
	{
		//cout << "146 : xx10_OF_A219 : FAULT failF  LABEL \"failure in operation A219\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A219]  =  TRUE" << endl;
		list.push_back(make_tuple(146, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A219] == true)
	{
		//cout << "147 : xx11_OF_A219 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A219]  =  FALSE" << endl;
		list.push_back(make_tuple(147, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A22] == false) && (boolState[required_OF_A22] && boolState[relevant_evt_OF_A22]))
	{
		//cout << "148 : xx10_OF_A22 : FAULT failF  LABEL \"failure in operation A22\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A22]  =  TRUE" << endl;
		list.push_back(make_tuple(148, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A22] == true)
	{
		//cout << "149 : xx11_OF_A22 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A22]  =  FALSE" << endl;
		list.push_back(make_tuple(149, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A220] == false) && (boolState[required_OF_A220] && boolState[relevant_evt_OF_A220]))
	{
		//cout << "150 : xx10_OF_A220 : FAULT failF  LABEL \"failure in operation A220\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A220]  =  TRUE" << endl;
		list.push_back(make_tuple(150, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A220] == true)
	{
		//cout << "151 : xx11_OF_A220 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A220]  =  FALSE" << endl;
		list.push_back(make_tuple(151, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A222] == false) && (boolState[required_OF_A222] && boolState[relevant_evt_OF_A222]))
	{
		//cout << "152 : xx10_OF_A222 : FAULT failF  LABEL \"failure in operation A222\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A222]  =  TRUE" << endl;
		list.push_back(make_tuple(152, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A222] == true)
	{
		//cout << "153 : xx11_OF_A222 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A222]  =  FALSE" << endl;
		list.push_back(make_tuple(153, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A223] == false) && (boolState[required_OF_A223] && boolState[relevant_evt_OF_A223]))
	{
		//cout << "154 : xx10_OF_A223 : FAULT failF  LABEL \"failure in operation A223\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A223]  =  TRUE" << endl;
		list.push_back(make_tuple(154, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A223] == true)
	{
		//cout << "155 : xx11_OF_A223 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A223]  =  FALSE" << endl;
		list.push_back(make_tuple(155, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A224] == false) && (boolState[required_OF_A224] && boolState[relevant_evt_OF_A224]))
	{
		//cout << "156 : xx10_OF_A224 : FAULT failF  LABEL \"failure in operation A224\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A224]  =  TRUE" << endl;
		list.push_back(make_tuple(156, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A224] == true)
	{
		//cout << "157 : xx11_OF_A224 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A224]  =  FALSE" << endl;
		list.push_back(make_tuple(157, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A225] == false) && (boolState[required_OF_A225] && boolState[relevant_evt_OF_A225]))
	{
		//cout << "158 : xx10_OF_A225 : FAULT failF  LABEL \"failure in operation A225\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A225]  =  TRUE" << endl;
		list.push_back(make_tuple(158, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A225] == true)
	{
		//cout << "159 : xx11_OF_A225 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A225]  =  FALSE" << endl;
	...
	if ((boolState[failF_OF_A235] == false) && (boolState[required_OF_A235] && boolState[relevant_evt_OF_A235]))
	{
		//cout << "162 : xx10_OF_A235 : FAULT failF  LABEL \"failure in operation A235\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A235]  =  TRUE" << endl;
		list.push_back(make_tuple(162, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A235] == true)
	{
		//cout << "163 : xx11_OF_A235 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A235]  =  FALSE" << endl;
		list.push_back(make_tuple(163, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A236] == false) && (boolState[required_OF_A236] && boolState[relevant_evt_OF_A236]))
	{
		//cout << "164 : xx10_OF_A236 : FAULT failF  LABEL \"failure in operation A236\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A236]  =  TRUE" << endl;
		list.push_back(make_tuple(164, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A236] == true)
	{
		//cout << "165 : xx11_OF_A236 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A236]  =  FALSE" << endl;
		list.push_back(make_tuple(165, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A237] == false) && (boolState[required_OF_A237] && boolState[relevant_evt_OF_A237]))
	{
		//cout << "166 : xx10_OF_A237 : FAULT failF  LABEL \"failure in operation A237\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A237]  =  TRUE" << endl;
		list.push_back(make_tuple(166, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A237] == true)
	{
		//cout << "167 : xx11_OF_A237 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A237]  =  FALSE" << endl;
		list.push_back(make_tuple(167, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A238] == false) && (boolState[required_OF_A238] && boolState[relevant_evt_OF_A238]))
	{
		//cout << "168 : xx10_OF_A238 : FAULT failF  LABEL \"failure in operation A238\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A238]  =  TRUE" << endl;
		list.push_back(make_tuple(168, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A238] == true)
	{
		//cout << "169 : xx11_OF_A238 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A238]  =  FALSE" << endl;
		list.push_back(make_tuple(169, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A240] == false) && (boolState[required_OF_A240] && boolState[relevant_evt_OF_A240]))
	{
		//cout << "170 : xx10_OF_A240 : FAULT failF  LABEL \"failure in operation A240\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A240]  =  TRUE" << endl;
		list.push_back(make_tuple(170, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A240] == true)
	{
		//cout << "171 : xx11_OF_A240 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A240]  =  FALSE" << endl;
		list.push_back(make_tuple(171, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A241] == false) && (boolState[required_OF_A241] && boolState[relevant_evt_OF_A241]))
	{
		//cout << "172 : xx10_OF_A241 : FAULT failF  LABEL \"failure in operation A241\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A241]  =  TRUE" << endl;
		list.push_back(make_tuple(172, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A241] == true)
	{
		//cout << "173 : xx11_OF_A241 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A241]  =  FALSE" << endl;
		list.push_back(make_tuple(173, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A243] == false) && (boolState[required_OF_A243] && boolState[relevant_evt_OF_A243]))
	{
		//cout << "174 : xx10_OF_A243 : FAULT failF  LABEL \"failure in operation A243\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A243]  =  TRUE" << endl;
		list.push_back(make_tuple(174, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A243] == true)
	{
		//cout << "175 : xx11_OF_A243 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A243]  =  FALSE" << endl;
		list.push_back(make_tuple(175, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A244] == false) && (boolState[required_OF_A244] && boolState[relevant_evt_OF_A244]))
	{
		//cout << "176 : xx10_OF_A244 : FAULT failF  LABEL \"failure in operation A244\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A244]  =  TRUE" << endl;
		list.push_back(make_tuple(176, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A244] == true)
	{
		//cout << "177 : xx11_OF_A244 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A244]  =  FALSE" << endl;
		list.push_back(make_tuple(177, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A245] == false) && (boolState[required_OF_A245] && boolState[relevant_evt_OF_A245]))
	{
		//cout << "178 : xx10_OF_A245 : FAULT failF  LABEL \"failure in operation A245\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A245]  =  TRUE" << endl;
		list.push_back(make_tuple(178, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A245] == true)
	{
		//cout << "179 : xx11_OF_A245 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A245]  =  FALSE" << endl;
		list.push_back(make_tuple(179, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A246] == false) && (boolState[required_OF_A246] && boolState[relevant_evt_OF_A246]))
	{
		//cout << "180 : xx10_OF_A246 : FAULT failF  LABEL \"failure in operation A246\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A246]  =  TRUE" << endl;
		list.push_back(make_tuple(180, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A246] == true)
	{
		//cout << "181 : xx11_OF_A246 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A246]  =  FALSE" << endl;
		list.push_back(make_tuple(181, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A25] == false) && (boolState[required_OF_A25] && boolState[relevant_evt_OF_A25]))
	{
		//cout << "182 : xx10_OF_A25 : FAULT failF  LABEL \"failure in operation A25\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A25]  =  TRUE" << endl;
		list.push_back(make_tuple(182, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A25] == true)
	{
		//cout << "183 : xx11_OF_A25 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A25]  =  FALSE" << endl;
		list.push_back(make_tuple(183, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A251] == false) && (boolState[required_OF_A251] && boolState[relevant_evt_OF_A251]))
	{
		//cout << "184 : xx10_OF_A251 : FAULT failF  LABEL \"failure in operation A251\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A251]  =  TRUE" << endl;
		list.push_back(make_tuple(184, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A251] == true)
	{
		//cout << "185 : xx11_OF_A251 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A251]  =  FALSE" << endl;
		list.push_back(make_tuple(185, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A252] == false) && (boolState[required_OF_A252] && boolState[relevant_evt_OF_A252]))
	{
		//cout << "186 : xx10_OF_A252 : FAULT failF  LABEL \"failure in operation A252\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A252]  =  TRUE" << endl;
		list.push_back(make_tuple(186, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A252] == true)
	{
		//cout << "187 : xx11_OF_A252 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A252]  =  FALSE" << endl;
		list.push_back(make_tuple(187, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A253] == false) && (boolState[required_OF_A253] && boolState[relevant_evt_OF_A253]))
	{
		//cout << "188 : xx10_OF_A253 : FAULT failF  LABEL \"failure in operation A253\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A253]  =  TRUE" << endl;
		list.push_back(make_tuple(188, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A253] == true)
	{
		//cout << "189 : xx11_OF_A253 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A253]  =  FALSE" << endl;
		list.push_back(make_tuple(189, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A254] == false) && (boolState[required_OF_A254] && boolState[relevant_evt_OF_A254]))
	{
		//cout << "190 : xx10_OF_A254 : FAULT failF  LABEL \"failure in operation A254\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A254]  =  TRUE" << endl;
		list.push_back(make_tuple(190, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A254] == true)
	{
		//cout << "191 : xx11_OF_A254 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A254]  =  FALSE" << endl;
		list.push_back(make_tuple(191, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A256] == false) && (boolState[required_OF_A256] && boolState[relevant_evt_OF_A256]))
	{
		//cout << "192 : xx10_OF_A256 : FAULT failF  LABEL \"failure in operation A256\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A256]  =  TRUE" << endl;
		list.push_back(make_tuple(192, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A256] == true)
	{
		//cout << "193 : xx11_OF_A256 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A256]  =  FALSE" << endl;
		list.push_back(make_tuple(193, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A257] == false) && (boolState[required_OF_A257] && boolState[relevant_evt_OF_A257]))
	{
		//cout << "194 : xx10_OF_A257 : FAULT failF  LABEL \"failure in operation A257\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A257]  =  TRUE" << endl;
		list.push_back(make_tuple(194, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A257] == true)
	{
		//cout << "195 : xx11_OF_A257 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A257]  =  FALSE" << endl;
		list.push_back(make_tuple(195, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A259] == false) && (boolState[required_OF_A259] && boolState[relevant_evt_OF_A259]))
	{
		//cout << "196 : xx10_OF_A259 : FAULT failF  LABEL \"failure in operation A259\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A259]  =  TRUE" << endl;
		list.push_back(make_tuple(196, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A259] == true)
	{
		//cout << "197 : xx11_OF_A259 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A259]  =  FALSE" << endl;
		list.push_back(make_tuple(197, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A26] == false) && (boolState[required_OF_A26] && boolState[relevant_evt_OF_A26]))
	{
		//cout << "198 : xx10_OF_A26 : FAULT failF  LABEL \"failure in operation A26\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A26]  =  TRUE" << endl;
		list.push_back(make_tuple(198, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A26] == true)
	{
		//cout << "199 : xx11_OF_A26 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A26]  =  FALSE" << endl;
		list.push_back(make_tuple(199, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A260] == false) && (boolState[required_OF_A260] && boolState[relevant_evt_OF_A260]))
	{
		//cout << "200 : xx10_OF_A260 : FAULT failF  LABEL \"failure in operation A260\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A260]  =  TRUE" << endl;
		list.push_back(make_tuple(200, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A260] == true)
	{
		//cout << "201 : xx11_OF_A260 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A260]  =  FALSE" << endl;
		list.push_back(make_tuple(201, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A261] == false) && (boolState[required_OF_A261] && boolState[relevant_evt_OF_A261]))
	{
		//cout << "202 : xx10_OF_A261 : FAULT failF  LABEL \"failure in operation A261\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A261]  =  TRUE" << endl;
		list.push_back(make_tuple(202, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A261] == true)
	{
		//cout << "203 : xx11_OF_A261 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A261]  =  FALSE" << endl;
		list.push_back(make_tuple(203, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A262] == false) && (boolState[required_OF_A262] && boolState[relevant_evt_OF_A262]))
	{
		//cout << "204 : xx10_OF_A262 : FAULT failF  LABEL \"failure in operation A262\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A262]  =  TRUE" << endl;
		list.push_back(make_tuple(204, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A262] == true)
	{
		//cout << "205 : xx11_OF_A262 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A262]  =  FALSE" << endl;
		list.push_back(make_tuple(205, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A270] == false) && (boolState[required_OF_A270] && boolState[relevant_evt_OF_A270]))
	{
		//cout << "206 : xx10_OF_A270 : FAULT failF  LABEL \"failure in operation A270\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A270]  =  TRUE" << endl;
		list.push_back(make_tuple(206, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A270] == true)
	{
		//cout << "207 : xx11_OF_A270 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A270]  =  FALSE" << endl;
		list.push_back(make_tuple(207, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A271] == false) && (boolState[required_OF_A271] && boolState[relevant_evt_OF_A271]))
	{
		//cout << "208 : xx10_OF_A271 : FAULT failF  LABEL \"failure in operation A271\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A271]  =  TRUE" << endl;
		list.push_back(make_tuple(208, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A271] == true)
	{
		//cout << "209 : xx11_OF_A271 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A271]  =  FALSE" << endl;
		list.push_back(make_tuple(209, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A272] == false) && (boolState[required_OF_A272] && boolState[relevant_evt_OF_A272]))
	{
		//cout << "210 : xx10_OF_A272 : FAULT failF  LABEL \"failure in operation A272\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A272]  =  TRUE" << endl;
		list.push_back(make_tuple(210, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A272] == true)
	{
		//cout << "211 : xx11_OF_A272 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A272]  =  FALSE" << endl;
		list.push_back(make_tuple(211, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A273] == false) && (boolState[required_OF_A273] && boolState[relevant_evt_OF_A273]))
	{
		//cout << "212 : xx10_OF_A273 : FAULT failF  LABEL \"failure in operation A273\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A273]  =  TRUE" << endl;
		list.push_back(make_tuple(212, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A273] == true)
	{
		//cout << "213 : xx11_OF_A273 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A273]  =  FALSE" << endl;
		list.push_back(make_tuple(213, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A275] == false) && (boolState[required_OF_A275] && boolState[relevant_evt_OF_A275]))
	{
		//cout << "214 : xx10_OF_A275 : FAULT failF  LABEL \"failure in operation A275\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A275]  =  TRUE" << endl;
		list.push_back(make_tuple(214, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A275] == true)
	{
		//cout << "215 : xx11_OF_A275 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A275]  =  FALSE" << endl;
		list.push_back(make_tuple(215, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A276] == false) && (boolState[required_OF_A276] && boolState[relevant_evt_OF_A276]))
	{
		//cout << "216 : xx10_OF_A276 : FAULT failF  LABEL \"failure in operation A276\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A276]  =  TRUE" << endl;
		list.push_back(make_tuple(216, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A276] == true)
	{
		//cout << "217 : xx11_OF_A276 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A276]  =  FALSE" << endl;
		list.push_back(make_tuple(217, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A278] == false) && (boolState[required_OF_A278] && boolState[relevant_evt_OF_A278]))
	{
		//cout << "218 : xx10_OF_A278 : FAULT failF  LABEL \"failure in operation A278\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A278]  =  TRUE" << endl;
		list.push_back(make_tuple(218, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A278] == true)
	{
		//cout << "219 : xx11_OF_A278 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A278]  =  FALSE" << endl;
		list.push_back(make_tuple(219, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A279] == false) && (boolState[required_OF_A279] && boolState[relevant_evt_OF_A279]))
	{
		//cout << "220 : xx10_OF_A279 : FAULT failF  LABEL \"failure in operation A279\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A279]  =  TRUE" << endl;
		list.push_back(make_tuple(220, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A279] == true)
	{
		//cout << "221 : xx11_OF_A279 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A279]  =  FALSE" << endl;
		list.push_back(make_tuple(221, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A28] == false) && (boolState[required_OF_A28] && boolState[relevant_evt_OF_A28]))
	{
		//cout << "222 : xx10_OF_A28 : FAULT failF  LABEL \"failure in operation A28\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A28]  =  TRUE" << endl;
		list.push_back(make_tuple(222, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A28] == true)
	{
		//cout << "223 : xx11_OF_A28 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A28]  =  FALSE" << endl;
		list.push_back(make_tuple(223, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A280] == false) && (boolState[required_OF_A280] && boolState[relevant_evt_OF_A280]))
	{
		//cout << "224 : xx10_OF_A280 : FAULT failF  LABEL \"failure in operation A280\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A280]  =  TRUE" << endl;
		list.push_back(make_tuple(224, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A280] == true)
	{
		//cout << "225 : xx11_OF_A280 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A280]  =  FALSE" << endl;
		list.push_back(make_tuple(225, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A281] == false) && (boolState[required_OF_A281] && boolState[relevant_evt_OF_A281]))
	{
		//cout << "226 : xx10_OF_A281 : FAULT failF  LABEL \"failure in operation A281\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A281]  =  TRUE" << endl;
		list.push_back(make_tuple(226, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A281] == true)
	{
		//cout << "227 : xx11_OF_A281 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A281]  =  FALSE" << endl;
		list.push_back(make_tuple(227, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A286] == false) && (boolState[required_OF_A286] && boolState[relevant_evt_OF_A286]))
	{
		//cout << "228 : xx10_OF_A286 : FAULT failF  LABEL \"failure in operation A286\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A286]  =  TRUE" << endl;
		list.push_back(make_tuple(228, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A286] == true)
	{
		//cout << "229 : xx11_OF_A286 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A286]  =  FALSE" << endl;
		list.push_back(make_tuple(229, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A287] == false) && (boolState[required_OF_A287] && boolState[relevant_evt_OF_A287]))
	{
		//cout << "230 : xx10_OF_A287 : FAULT failF  LABEL \"failure in operation A287\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A287]  =  TRUE" << endl;
		list.push_back(make_tuple(230, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A287] == true)
	{
		//cout << "231 : xx11_OF_A287 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A287]  =  FALSE" << endl;
		list.push_back(make_tuple(231, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A288] == false) && (boolState[required_OF_A288] && boolState[relevant_evt_OF_A288]))
	{
		//cout << "232 : xx10_OF_A288 : FAULT failF  LABEL \"failure in operation A288\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A288]  =  TRUE" << endl;
		list.push_back(make_tuple(232, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A288] == true)
	{
		//cout << "233 : xx11_OF_A288 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A288]  =  FALSE" << endl;
		list.push_back(make_tuple(233, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A289] == false) && (boolState[required_OF_A289] && boolState[relevant_evt_OF_A289]))
	{
		//cout << "234 : xx10_OF_A289 : FAULT failF  LABEL \"failure in operation A289\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A289]  =  TRUE" << endl;
		list.push_back(make_tuple(234, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A289] == true)
	{
		//cout << "235 : xx11_OF_A289 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A289]  =  FALSE" << endl;
		list.push_back(make_tuple(235, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A29] == false) && (boolState[required_OF_A29] && boolState[relevant_evt_OF_A29]))
	{
		//cout << "236 : xx10_OF_A29 : FAULT failF  LABEL \"failure in operation A29\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A29]  =  TRUE" << endl;
		list.push_back(make_tuple(236, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A29] == true)
	{
		//cout << "237 : xx11_OF_A29 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A29]  =  FALSE" << endl;
		list.push_back(make_tuple(237, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A291] == false) && (boolState[required_OF_A291] && boolState[relevant_evt_OF_A291]))
	{
		//cout << "238 : xx10_OF_A291 : FAULT failF  LABEL \"failure in operation A291\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A291]  =  TRUE" << endl;
		list.push_back(make_tuple(238, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A291] == true)
	{
		//cout << "239 : xx11_OF_A291 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A291]  =  FALSE" << endl;
		list.push_back(make_tuple(239, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A292] == false) && (boolState[required_OF_A292] && boolState[relevant_evt_OF_A292]))
	{
		//cout << "240 : xx10_OF_A292 : FAULT failF  LABEL \"failure in operation A292\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A292]  =  TRUE" << endl;
		list.push_back(make_tuple(240, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A292] == true)
	{
		//cout << "241 : xx11_OF_A292 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A292]  =  FALSE" << endl;
		list.push_back(make_tuple(241, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A294] == false) && (boolState[required_OF_A294] && boolState[relevant_evt_OF_A294]))
	{
		//cout << "242 : xx10_OF_A294 : FAULT failF  LABEL \"failure in operation A294\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A294]  =  TRUE" << endl;
		list.push_back(make_tuple(242, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A294] == true)
	{
		//cout << "243 : xx11_OF_A294 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A294]  =  FALSE" << endl;
		list.push_back(make_tuple(243, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A295] == false) && (boolState[required_OF_A295] && boolState[relevant_evt_OF_A295]))
	{
		//cout << "244 : xx10_OF_A295 : FAULT failF  LABEL \"failure in operation A295\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A295]  =  TRUE" << endl;
		list.push_back(make_tuple(244, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A295] == true)
	{
		//cout << "245 : xx11_OF_A295 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A295]  =  FALSE" << endl;
		list.push_back(make_tuple(245, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A296] == false) && (boolState[required_OF_A296] && boolState[relevant_evt_OF_A296]))
	{
		//cout << "246 : xx10_OF_A296 : FAULT failF  LABEL \"failure in operation A296\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A296]  =  TRUE" << endl;
		list.push_back(make_tuple(246, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A296] == true)
	{
		//cout << "247 : xx11_OF_A296 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A296]  =  FALSE" << endl;
		list.push_back(make_tuple(247, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A297] == false) && (boolState[required_OF_A297] && boolState[relevant_evt_OF_A297]))
	{
		//cout << "248 : xx10_OF_A297 : FAULT failF  LABEL \"failure in operation A297\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A297]  =  TRUE" << endl;
		list.push_back(make_tuple(248, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A297] == true)
	{
		//cout << "249 : xx11_OF_A297 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A297]  =  FALSE" << endl;
	...
	if ((boolState[failF_OF_A302] == false) && (boolState[required_OF_A302] && boolState[relevant_evt_OF_A302]))
	{
		//cout << "252 : xx10_OF_A302 : FAULT failF  LABEL \"failure in operation A302\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A302]  =  TRUE" << endl;
		list.push_back(make_tuple(252, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A302] == true)
	{
		//cout << "253 : xx11_OF_A302 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A302]  =  FALSE" << endl;
		list.push_back(make_tuple(253, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A304] == false) && (boolState[required_OF_A304] && boolState[relevant_evt_OF_A304]))
	{
		//cout << "254 : xx10_OF_A304 : FAULT failF  LABEL \"failure in operation A304\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A304]  =  TRUE" << endl;
		list.push_back(make_tuple(254, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A304] == true)
	{
		//cout << "255 : xx11_OF_A304 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A304]  =  FALSE" << endl;
		list.push_back(make_tuple(255, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A307] == false) && (boolState[required_OF_A307] && boolState[relevant_evt_OF_A307]))
	{
		//cout << "256 : xx10_OF_A307 : FAULT failF  LABEL \"failure in operation A307\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A307]  =  TRUE" << endl;
		list.push_back(make_tuple(256, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A307] == true)
	{
		//cout << "257 : xx11_OF_A307 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A307]  =  FALSE" << endl;
		list.push_back(make_tuple(257, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A308] == false) && (boolState[required_OF_A308] && boolState[relevant_evt_OF_A308]))
	{
		//cout << "258 : xx10_OF_A308 : FAULT failF  LABEL \"failure in operation A308\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A308]  =  TRUE" << endl;
		list.push_back(make_tuple(258, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A308] == true)
	{
		//cout << "259 : xx11_OF_A308 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A308]  =  FALSE" << endl;
		list.push_back(make_tuple(259, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A309] == false) && (boolState[required_OF_A309] && boolState[relevant_evt_OF_A309]))
	{
		//cout << "260 : xx10_OF_A309 : FAULT failF  LABEL \"failure in operation A309\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A309]  =  TRUE" << endl;
		list.push_back(make_tuple(260, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A309] == true)
	{
		//cout << "261 : xx11_OF_A309 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A309]  =  FALSE" << endl;
		list.push_back(make_tuple(261, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A31] == false) && (boolState[required_OF_A31] && boolState[relevant_evt_OF_A31]))
	{
		//cout << "262 : xx10_OF_A31 : FAULT failF  LABEL \"failure in operation A31\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A31]  =  TRUE" << endl;
		list.push_back(make_tuple(262, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A31] == true)
	{
		//cout << "263 : xx11_OF_A31 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A31]  =  FALSE" << endl;
		list.push_back(make_tuple(263, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A310] == false) && (boolState[required_OF_A310] && boolState[relevant_evt_OF_A310]))
	{
		//cout << "264 : xx10_OF_A310 : FAULT failF  LABEL \"failure in operation A310\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A310]  =  TRUE" << endl;
		list.push_back(make_tuple(264, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A310] == true)
	{
		//cout << "265 : xx11_OF_A310 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A310]  =  FALSE" << endl;
		list.push_back(make_tuple(265, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A312] == false) && (boolState[required_OF_A312] && boolState[relevant_evt_OF_A312]))
	{
		//cout << "266 : xx10_OF_A312 : FAULT failF  LABEL \"failure in operation A312\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A312]  =  TRUE" << endl;
		list.push_back(make_tuple(266, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A312] == true)
	{
		//cout << "267 : xx11_OF_A312 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A312]  =  FALSE" << endl;
		list.push_back(make_tuple(267, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A313] == false) && (boolState[required_OF_A313] && boolState[relevant_evt_OF_A313]))
	{
		//cout << "268 : xx10_OF_A313 : FAULT failF  LABEL \"failure in operation A313\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A313]  =  TRUE" << endl;
		list.push_back(make_tuple(268, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A313] == true)
	{
		//cout << "269 : xx11_OF_A313 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A313]  =  FALSE" << endl;
		list.push_back(make_tuple(269, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A315] == false) && (boolState[required_OF_A315] && boolState[relevant_evt_OF_A315]))
	{
		//cout << "270 : xx10_OF_A315 : FAULT failF  LABEL \"failure in operation A315\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A315]  =  TRUE" << endl;
		list.push_back(make_tuple(270, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A315] == true)
	{
		//cout << "271 : xx11_OF_A315 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A315]  =  FALSE" << endl;
		list.push_back(make_tuple(271, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A316] == false) && (boolState[required_OF_A316] && boolState[relevant_evt_OF_A316]))
	{
		//cout << "272 : xx10_OF_A316 : FAULT failF  LABEL \"failure in operation A316\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A316]  =  TRUE" << endl;
		list.push_back(make_tuple(272, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A316] == true)
	{
		//cout << "273 : xx11_OF_A316 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A316]  =  FALSE" << endl;
		list.push_back(make_tuple(273, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A317] == false) && (boolState[required_OF_A317] && boolState[relevant_evt_OF_A317]))
	{
		//cout << "274 : xx10_OF_A317 : FAULT failF  LABEL \"failure in operation A317\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A317]  =  TRUE" << endl;
		list.push_back(make_tuple(274, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A317] == true)
	{
		//cout << "275 : xx11_OF_A317 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A317]  =  FALSE" << endl;
		list.push_back(make_tuple(275, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A318] == false) && (boolState[required_OF_A318] && boolState[relevant_evt_OF_A318]))
	{
		//cout << "276 : xx10_OF_A318 : FAULT failF  LABEL \"failure in operation A318\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A318]  =  TRUE" << endl;
		list.push_back(make_tuple(276, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A318] == true)
	{
		//cout << "277 : xx11_OF_A318 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A318]  =  FALSE" << endl;
		list.push_back(make_tuple(277, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A36] == false) && (boolState[required_OF_A36] && boolState[relevant_evt_OF_A36]))
	{
		//cout << "278 : xx10_OF_A36 : FAULT failF  LABEL \"failure in operation A36\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A36]  =  TRUE" << endl;
		list.push_back(make_tuple(278, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A36] == true)
	{
		//cout << "279 : xx11_OF_A36 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A36]  =  FALSE" << endl;
		list.push_back(make_tuple(279, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A37] == false) && (boolState[required_OF_A37] && boolState[relevant_evt_OF_A37]))
	{
		//cout << "280 : xx10_OF_A37 : FAULT failF  LABEL \"failure in operation A37\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A37]  =  TRUE" << endl;
		list.push_back(make_tuple(280, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A37] == true)
	{
		//cout << "281 : xx11_OF_A37 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A37]  =  FALSE" << endl;
		list.push_back(make_tuple(281, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A38] == false) && (boolState[required_OF_A38] && boolState[relevant_evt_OF_A38]))
	{
		//cout << "282 : xx10_OF_A38 : FAULT failF  LABEL \"failure in operation A38\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A38]  =  TRUE" << endl;
		list.push_back(make_tuple(282, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A38] == true)
	{
		//cout << "283 : xx11_OF_A38 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A38]  =  FALSE" << endl;
		list.push_back(make_tuple(283, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A39] == false) && (boolState[required_OF_A39] && boolState[relevant_evt_OF_A39]))
	{
		//cout << "284 : xx10_OF_A39 : FAULT failF  LABEL \"failure in operation A39\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A39]  =  TRUE" << endl;
		list.push_back(make_tuple(284, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A39] == true)
	{
		//cout << "285 : xx11_OF_A39 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A39]  =  FALSE" << endl;
		list.push_back(make_tuple(285, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A4] == false) && (boolState[required_OF_A4] && boolState[relevant_evt_OF_A4]))
	{
		//cout << "286 : xx10_OF_A4 : FAULT failF  LABEL \"failure in operation A4\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A4]  =  TRUE" << endl;
		list.push_back(make_tuple(286, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A4] == true)
	{
		//cout << "287 : xx11_OF_A4 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A4]  =  FALSE" << endl;
		list.push_back(make_tuple(287, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A41] == false) && (boolState[required_OF_A41] && boolState[relevant_evt_OF_A41]))
	{
		//cout << "288 : xx10_OF_A41 : FAULT failF  LABEL \"failure in operation A41\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A41]  =  TRUE" << endl;
		list.push_back(make_tuple(288, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A41] == true)
	{
		//cout << "289 : xx11_OF_A41 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A41]  =  FALSE" << endl;
		list.push_back(make_tuple(289, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A42] == false) && (boolState[required_OF_A42] && boolState[relevant_evt_OF_A42]))
	{
		//cout << "290 : xx10_OF_A42 : FAULT failF  LABEL \"failure in operation A42\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A42]  =  TRUE" << endl;
		list.push_back(make_tuple(290, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A42] == true)
	{
		//cout << "291 : xx11_OF_A42 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A42]  =  FALSE" << endl;
		list.push_back(make_tuple(291, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A44] == false) && (boolState[required_OF_A44] && boolState[relevant_evt_OF_A44]))
	{
		//cout << "292 : xx10_OF_A44 : FAULT failF  LABEL \"failure in operation A44\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A44]  =  TRUE" << endl;
		list.push_back(make_tuple(292, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A44] == true)
	{
		//cout << "293 : xx11_OF_A44 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A44]  =  FALSE" << endl;
		list.push_back(make_tuple(293, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A45] == false) && (boolState[required_OF_A45] && boolState[relevant_evt_OF_A45]))
	{
		//cout << "294 : xx10_OF_A45 : FAULT failF  LABEL \"failure in operation A45\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A45]  =  TRUE" << endl;
		list.push_back(make_tuple(294, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A45] == true)
	{
		//cout << "295 : xx11_OF_A45 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A45]  =  FALSE" << endl;
		list.push_back(make_tuple(295, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A46] == false) && (boolState[required_OF_A46] && boolState[relevant_evt_OF_A46]))
	{
		//cout << "296 : xx10_OF_A46 : FAULT failF  LABEL \"failure in operation A46\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A46]  =  TRUE" << endl;
		list.push_back(make_tuple(296, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A46] == true)
	{
		//cout << "297 : xx11_OF_A46 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A46]  =  FALSE" << endl;
		list.push_back(make_tuple(297, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A47] == false) && (boolState[required_OF_A47] && boolState[relevant_evt_OF_A47]))
	{
		//cout << "298 : xx10_OF_A47 : FAULT failF  LABEL \"failure in operation A47\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A47]  =  TRUE" << endl;
		list.push_back(make_tuple(298, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A47] == true)
	{
		//cout << "299 : xx11_OF_A47 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A47]  =  FALSE" << endl;
		list.push_back(make_tuple(299, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A5] == false) && (boolState[required_OF_A5] && boolState[relevant_evt_OF_A5]))
	{
		//cout << "300 : xx10_OF_A5 : FAULT failF  LABEL \"failure in operation A5\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A5]  =  TRUE" << endl;
		list.push_back(make_tuple(300, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A5] == true)
	{
		//cout << "301 : xx11_OF_A5 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A5]  =  FALSE" << endl;
		list.push_back(make_tuple(301, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A55] == false) && (boolState[required_OF_A55] && boolState[relevant_evt_OF_A55]))
	{
		//cout << "302 : xx10_OF_A55 : FAULT failF  LABEL \"failure in operation A55\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A55]  =  TRUE" << endl;
		list.push_back(make_tuple(302, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A55] == true)
	{
		//cout << "303 : xx11_OF_A55 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A55]  =  FALSE" << endl;
		list.push_back(make_tuple(303, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A56] == false) && (boolState[required_OF_A56] && boolState[relevant_evt_OF_A56]))
	{
		//cout << "304 : xx10_OF_A56 : FAULT failF  LABEL \"failure in operation A56\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A56]  =  TRUE" << endl;
		list.push_back(make_tuple(304, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A56] == true)
	{
		//cout << "305 : xx11_OF_A56 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A56]  =  FALSE" << endl;
		list.push_back(make_tuple(305, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A57] == false) && (boolState[required_OF_A57] && boolState[relevant_evt_OF_A57]))
	{
		//cout << "306 : xx10_OF_A57 : FAULT failF  LABEL \"failure in operation A57\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A57]  =  TRUE" << endl;
		list.push_back(make_tuple(306, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A57] == true)
	{
		//cout << "307 : xx11_OF_A57 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A57]  =  FALSE" << endl;
		list.push_back(make_tuple(307, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A58] == false) && (boolState[required_OF_A58] && boolState[relevant_evt_OF_A58]))
	{
		//cout << "308 : xx10_OF_A58 : FAULT failF  LABEL \"failure in operation A58\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A58]  =  TRUE" << endl;
		list.push_back(make_tuple(308, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A58] == true)
	{
		//cout << "309 : xx11_OF_A58 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A58]  =  FALSE" << endl;
		list.push_back(make_tuple(309, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A6] == false) && (boolState[required_OF_A6] && boolState[relevant_evt_OF_A6]))
	{
		//cout << "310 : xx10_OF_A6 : FAULT failF  LABEL \"failure in operation A6\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A6]  =  TRUE" << endl;
		list.push_back(make_tuple(310, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A6] == true)
	{
		//cout << "311 : xx11_OF_A6 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A6]  =  FALSE" << endl;
		list.push_back(make_tuple(311, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A60] == false) && (boolState[required_OF_A60] && boolState[relevant_evt_OF_A60]))
	{
		//cout << "312 : xx10_OF_A60 : FAULT failF  LABEL \"failure in operation A60\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A60]  =  TRUE" << endl;
		list.push_back(make_tuple(312, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A60] == true)
	{
		//cout << "313 : xx11_OF_A60 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A60]  =  FALSE" << endl;
		list.push_back(make_tuple(313, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A61] == false) && (boolState[required_OF_A61] && boolState[relevant_evt_OF_A61]))
	{
		//cout << "314 : xx10_OF_A61 : FAULT failF  LABEL \"failure in operation A61\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A61]  =  TRUE" << endl;
		list.push_back(make_tuple(314, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A61] == true)
	{
		//cout << "315 : xx11_OF_A61 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A61]  =  FALSE" << endl;
		list.push_back(make_tuple(315, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A63] == false) && (boolState[required_OF_A63] && boolState[relevant_evt_OF_A63]))
	{
		//cout << "316 : xx10_OF_A63 : FAULT failF  LABEL \"failure in operation A63\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A63]  =  TRUE" << endl;
		list.push_back(make_tuple(316, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A63] == true)
	{
		//cout << "317 : xx11_OF_A63 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A63]  =  FALSE" << endl;
		list.push_back(make_tuple(317, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A64] == false) && (boolState[required_OF_A64] && boolState[relevant_evt_OF_A64]))
	{
		//cout << "318 : xx10_OF_A64 : FAULT failF  LABEL \"failure in operation A64\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A64]  =  TRUE" << endl;
		list.push_back(make_tuple(318, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A64] == true)
	{
		//cout << "319 : xx11_OF_A64 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A64]  =  FALSE" << endl;
		list.push_back(make_tuple(319, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A65] == false) && (boolState[required_OF_A65] && boolState[relevant_evt_OF_A65]))
	{
		//cout << "320 : xx10_OF_A65 : FAULT failF  LABEL \"failure in operation A65\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A65]  =  TRUE" << endl;
		list.push_back(make_tuple(320, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A65] == true)
	{
		//cout << "321 : xx11_OF_A65 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A65]  =  FALSE" << endl;
		list.push_back(make_tuple(321, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A66] == false) && (boolState[required_OF_A66] && boolState[relevant_evt_OF_A66]))
	{
		//cout << "322 : xx10_OF_A66 : FAULT failF  LABEL \"failure in operation A66\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A66]  =  TRUE" << endl;
		list.push_back(make_tuple(322, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A66] == true)
	{
		//cout << "323 : xx11_OF_A66 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A66]  =  FALSE" << endl;
		list.push_back(make_tuple(323, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A7] == false) && (boolState[required_OF_A7] && boolState[relevant_evt_OF_A7]))
	{
		//cout << "324 : xx10_OF_A7 : FAULT failF  LABEL \"failure in operation A7\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A7]  =  TRUE" << endl;
		list.push_back(make_tuple(324, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A7] == true)
	{
		//cout << "325 : xx11_OF_A7 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A7]  =  FALSE" << endl;
		list.push_back(make_tuple(325, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A71] == false) && (boolState[required_OF_A71] && boolState[relevant_evt_OF_A71]))
	{
		//cout << "326 : xx10_OF_A71 : FAULT failF  LABEL \"failure in operation A71\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A71]  =  TRUE" << endl;
		list.push_back(make_tuple(326, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A71] == true)
	{
		//cout << "327 : xx11_OF_A71 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A71]  =  FALSE" << endl;
		list.push_back(make_tuple(327, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A72] == false) && (boolState[required_OF_A72] && boolState[relevant_evt_OF_A72]))
	{
		//cout << "328 : xx10_OF_A72 : FAULT failF  LABEL \"failure in operation A72\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A72]  =  TRUE" << endl;
		list.push_back(make_tuple(328, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A72] == true)
	{
		//cout << "329 : xx11_OF_A72 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A72]  =  FALSE" << endl;
		list.push_back(make_tuple(329, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A73] == false) && (boolState[required_OF_A73] && boolState[relevant_evt_OF_A73]))
	{
		//cout << "330 : xx10_OF_A73 : FAULT failF  LABEL \"failure in operation A73\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A73]  =  TRUE" << endl;
		list.push_back(make_tuple(330, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A73] == true)
	{
		//cout << "331 : xx11_OF_A73 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A73]  =  FALSE" << endl;
		list.push_back(make_tuple(331, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A74] == false) && (boolState[required_OF_A74] && boolState[relevant_evt_OF_A74]))
	{
		//cout << "332 : xx10_OF_A74 : FAULT failF  LABEL \"failure in operation A74\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A74]  =  TRUE" << endl;
		list.push_back(make_tuple(332, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A74] == true)
	{
		//cout << "333 : xx11_OF_A74 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A74]  =  FALSE" << endl;
		list.push_back(make_tuple(333, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A76] == false) && (boolState[required_OF_A76] && boolState[relevant_evt_OF_A76]))
	{
		//cout << "334 : xx10_OF_A76 : FAULT failF  LABEL \"failure in operation A76\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A76]  =  TRUE" << endl;
		list.push_back(make_tuple(334, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A76] == true)
	{
		//cout << "335 : xx11_OF_A76 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A76]  =  FALSE" << endl;
		list.push_back(make_tuple(335, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A77] == false) && (boolState[required_OF_A77] && boolState[relevant_evt_OF_A77]))
	{
		//cout << "336 : xx10_OF_A77 : FAULT failF  LABEL \"failure in operation A77\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A77]  =  TRUE" << endl;
		list.push_back(make_tuple(336, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A77] == true)
	{
		//cout << "337 : xx11_OF_A77 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A77]  =  FALSE" << endl;
		list.push_back(make_tuple(337, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A79] == false) && (boolState[required_OF_A79] && boolState[relevant_evt_OF_A79]))
	{
		//cout << "338 : xx10_OF_A79 : FAULT failF  LABEL \"failure in operation A79\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A79]  =  TRUE" << endl;
		list.push_back(make_tuple(338, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A79] == true)
	{
		//cout << "339 : xx11_OF_A79 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A79]  =  FALSE" << endl;
		list.push_back(make_tuple(339, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A80] == false) && (boolState[required_OF_A80] && boolState[relevant_evt_OF_A80]))
	{
		//cout << "340 : xx10_OF_A80 : FAULT failF  LABEL \"failure in operation A80\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A80]  =  TRUE" << endl;
		list.push_back(make_tuple(340, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A80] == true)
	{
		//cout << "341 : xx11_OF_A80 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A80]  =  FALSE" << endl;
		list.push_back(make_tuple(341, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A81] == false) && (boolState[required_OF_A81] && boolState[relevant_evt_OF_A81]))
	{
		//cout << "342 : xx10_OF_A81 : FAULT failF  LABEL \"failure in operation A81\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A81]  =  TRUE" << endl;
		list.push_back(make_tuple(342, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A81] == true)
	{
		//cout << "343 : xx11_OF_A81 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A81]  =  FALSE" << endl;
		list.push_back(make_tuple(343, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A82] == false) && (boolState[required_OF_A82] && boolState[relevant_evt_OF_A82]))
	{
		//cout << "344 : xx10_OF_A82 : FAULT failF  LABEL \"failure in operation A82\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A82]  =  TRUE" << endl;
		list.push_back(make_tuple(344, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A82] == true)
	{
		//cout << "345 : xx11_OF_A82 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A82]  =  FALSE" << endl;
		list.push_back(make_tuple(345, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A85] == false) && (boolState[required_OF_A85] && boolState[relevant_evt_OF_A85]))
	{
		//cout << "346 : xx10_OF_A85 : FAULT failF  LABEL \"failure in operation A85\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A85]  =  TRUE" << endl;
		list.push_back(make_tuple(346, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A85] == true)
	{
		//cout << "347 : xx11_OF_A85 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A85]  =  FALSE" << endl;
		list.push_back(make_tuple(347, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A86] == false) && (boolState[required_OF_A86] && boolState[relevant_evt_OF_A86]))
	{
		//cout << "348 : xx10_OF_A86 : FAULT failF  LABEL \"failure in operation A86\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A86]  =  TRUE" << endl;
		list.push_back(make_tuple(348, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A86] == true)
	{
		//cout << "349 : xx11_OF_A86 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A86]  =  FALSE" << endl;
		list.push_back(make_tuple(349, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A87] == false) && (boolState[required_OF_A87] && boolState[relevant_evt_OF_A87]))
	{
		//cout << "350 : xx10_OF_A87 : FAULT failF  LABEL \"failure in operation A87\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A87]  =  TRUE" << endl;
		list.push_back(make_tuple(350, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A87] == true)
	{
		//cout << "351 : xx11_OF_A87 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A87]  =  FALSE" << endl;
		list.push_back(make_tuple(351, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A88] == false) && (boolState[required_OF_A88] && boolState[relevant_evt_OF_A88]))
	{
		//cout << "352 : xx10_OF_A88 : FAULT failF  LABEL \"failure in operation A88\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A88]  =  TRUE" << endl;
		list.push_back(make_tuple(352, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A88] == true)
	{
		//cout << "353 : xx11_OF_A88 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A88]  =  FALSE" << endl;
		list.push_back(make_tuple(353, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A9] == false) && (boolState[required_OF_A9] && boolState[relevant_evt_OF_A9]))
	{
		//cout << "354 : xx10_OF_A9 : FAULT failF  LABEL \"failure in operation A9\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A9]  =  TRUE" << endl;
		list.push_back(make_tuple(354, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A9] == true)
	{
		//cout << "355 : xx11_OF_A9 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A9]  =  FALSE" << endl;
		list.push_back(make_tuple(355, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A90] == false) && (boolState[required_OF_A90] && boolState[relevant_evt_OF_A90]))
	{
		//cout << "356 : xx10_OF_A90 : FAULT failF  LABEL \"failure in operation A90\"  DIST EXP (0.0002320213)  INDUCING boolState[failF_OF_A90]  =  TRUE" << endl;
		list.push_back(make_tuple(356, 0.0002320213, "EXP", 0));
	}
	if (boolState[failF_OF_A90] == true)
	{
		//cout << "357 : xx11_OF_A90 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A90]  =  FALSE" << endl;
		list.push_back(make_tuple(357, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A91] == false) && (boolState[required_OF_A91] && boolState[relevant_evt_OF_A91]))
	{
		//cout << "358 : xx10_OF_A91 : FAULT failF  LABEL \"failure in operation A91\"  DIST EXP (1.601934e-05)  INDUCING boolState[failF_OF_A91]  =  TRUE" << endl;
		list.push_back(make_tuple(358, 1.601934e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A91] == true)
	{
		//cout << "359 : xx11_OF_A91 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A91]  =  FALSE" << endl;
		list.push_back(make_tuple(359, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A93] == false) && (boolState[required_OF_A93] && boolState[relevant_evt_OF_A93]))
	{
		//cout << "360 : xx10_OF_A93 : FAULT failF  LABEL \"failure in operation A93\"  DIST EXP (0.0002488955)  INDUCING boolState[failF_OF_A93]  =  TRUE" << endl;
		list.push_back(make_tuple(360, 0.0002488955, "EXP", 0));
	}
	if (boolState[failF_OF_A93] == true)
	{
		//cout << "361 : xx11_OF_A93 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A93]  =  FALSE" << endl;
		list.push_back(make_tuple(361, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A94] == false) && (boolState[required_OF_A94] && boolState[relevant_evt_OF_A94]))
	{
		//cout << "362 : xx10_OF_A94 : FAULT failF  LABEL \"failure in operation A94\"  DIST EXP (0.0001131343)  INDUCING boolState[failF_OF_A94]  =  TRUE" << endl;
		list.push_back(make_tuple(362, 0.0001131343, "EXP", 0));
	}
	if (boolState[failF_OF_A94] == true)
	{
		//cout << "363 : xx11_OF_A94 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A94]  =  FALSE" << endl;
		list.push_back(make_tuple(363, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A95] == false) && (boolState[required_OF_A95] && boolState[relevant_evt_OF_A95]))
	{
		//cout << "364 : xx10_OF_A95 : FAULT failF  LABEL \"failure in operation A95\"  DIST EXP (6.396848e-05)  INDUCING boolState[failF_OF_A95]  =  TRUE" << endl;
		list.push_back(make_tuple(364, 6.396848e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A95] == true)
	{
		//cout << "365 : xx11_OF_A95 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A95]  =  FALSE" << endl;
		list.push_back(make_tuple(365, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A96] == false) && (boolState[required_OF_A96] && boolState[relevant_evt_OF_A96]))
	{
		//cout << "366 : xx10_OF_A96 : FAULT failF  LABEL \"failure in operation A96\"  DIST EXP (6.480551e-05)  INDUCING boolState[failF_OF_A96]  =  TRUE" << endl;
		list.push_back(make_tuple(366, 6.480551e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A96] == true)
	{
		//cout << "367 : xx11_OF_A96 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A96]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A10] == true )
	{
...
void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_stationH_standard_Trim_Article_repair::fireinsttransitiongroup(std::string user_input_ins)
