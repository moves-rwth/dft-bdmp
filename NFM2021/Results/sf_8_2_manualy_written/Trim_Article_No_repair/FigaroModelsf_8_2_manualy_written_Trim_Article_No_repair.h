    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_E1_1" , 0},
            	{"already_S_OF_E1_1" , 1},
            	{"S_OF_E1_1" , 2},
