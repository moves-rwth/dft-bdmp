...
- The [NFM 2021](2021-NFM) submission presents a lazy abstraction approch enabled on a recently developed BDMP model checker (<i> the submission presenting BDMP model checker is under review at a double blind conference</i>).
