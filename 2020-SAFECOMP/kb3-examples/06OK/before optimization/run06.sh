...
#rm 06.dot 06_ctmc.drn 06_ma.drn 06.pdf  06.jani 06.drn 06-jani.dot 06-jani.pdf 06-drn.pdf 06-drn.dot 06.modest 06.jani

#python3 /home/shahid/PycharmProjects/Fi2Modest/src/main.py -i '06.fi' -o '06.modest'
#mono /home/shahid/modest/mcsta.exe  06.modest -E  "B=10" --long-run-alg ValueIteration 
#mono /home/shahid/modest/mosta.exe  06.modest -O  06.dot  
#dot -Tpdf 06.dot -o 06.pdf
#okular 06.pdf 
#mono /home/shahid/modest/moconv.exe  06.modest -O  06.jani -E  "B=1"
#storm --jani 06.jani --io:exportexplicit  06_ctmc.drn  --prop "Tmax=? [F Fail]" --buildfull --eliminate-chains --ec-label-#behavior delete -e dd -bisim --bisimulation:quot sparse

storm -drn '06.drn' --io:exportexplicit  06_int.drn --prop "Tmax=? [F \"Fail\"]" --precision 1e-8 --eliminate-chains --ec-label-behavior delete
python3 /home/shahid/PycharmProjects/stormpy-project/src/main.py -i '06_int.drn' -o '06_ma.drn'
storm -drn '06_ma.drn' --io:exportexplicit  06_ctmc.drn --prop "Pmax=? [F<=200 \"Fail\"]" --precision 1e-8 --eliminate-chains --ec-label-behavior delete

storm -drn '06_ctmc.drn'  --prop "Pmax=? [F [3000,3000] \"Fail\"]" --precision 1e-8
exit
storm -drn '06_ctmc.drn'  --prop "Pmax=? [F [3000,3000] \"Fail\"];Pmin=? [F [3000,3000] \"Fail\"]" --precision 1e-8
