...
rm 36.dot 36_ctmc.drn 36.pdf  36.jani 36.drn 36-jani.dot 36-jani.pdf 36-drn.pdf 36-drn.dot  36.jani 36.drn 36.modest
python3 /home/shahid/PycharmProjects/Fi2Modest/src/main.py -i '36.fi' -o '36.modest'
#mono /home/shahid/modest/mcsta.exe  36.modest -E  "B=1"  
mono /home/shahid/modest/moconv.exe  36.modest -O  36.jani -E  "B=10"
scp 36.jani yg112533@login18-1.hpc.itc.rwth-aachen.de:/home/yg112533/job/36.jani
read -p "Press any key to continue"
scp  yg112533@login18-1.hpc.itc.rwth-aachen.de:/home/yg112533/job/36.drn 36.drn
storm -drn 36.drn  --io:exportexplicit 36_int.drn --prop "Tmax=? [F \"Fail\"]" --buildfull --eliminate-chains --ec-label-behavior delete
python3 /home/shahid/PycharmProjects/stormpy-project/src/main.py -i '36_int.drn' -o '36_ma.drn'
storm -drn '36_ma.drn' --io:exportexplicit  36_ctmc.drn --prop "Tmax=? [F \"Fail\"]" --buildfull --precision 1e-8 --eliminate-chains --ec-label-behavior delete
storm -drn '36_ctmc.drn'  --prop "Pmax=? [F<=10 \"Fail\"]" --precision 1e-8
storm -drn '36_ctmc.drn'  --prop "Pmax=? [F [10,10] \"Fail\"]" --precision 1e-8

exit
storm --jani 36.jani --prop "	Pmax=? [F<=1  Fail];  Pmin=? [F<=1  Fail];
...
storm --jani 36.jani --prop  "Tmax=? [F  Fail]; Tmin=? [F  Fail]" --exact

exit
#storm --jani 36.jani --prop "Tmax=? [F  Fail] " --precision 1e-8 --exact
...
#storm-dft -dft 36.dft --timebound 100
#dftcalc exp.dft -p -u
