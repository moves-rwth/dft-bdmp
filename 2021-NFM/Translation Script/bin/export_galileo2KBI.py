...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Export a DFT into KBI format.')

    parser.add_argument('--dft', '-i', help='The path for the dft file in JSON encoding', required=True)
    parser.add_argument('--out', '-o', help='The path for the saved dft file in KBI format', required=True)
    ...
    # Save DFT again
    dftlib.io.export.export_dft_kbi(dft, args.out)
