#include <iostream>
#include "FigaroModelNPPS_Trim_article_No_repair.h"
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::init()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_BATTERY_A_lost] && ( !boolState[S_OF_BATTERY_A_lost])  ) || ( !boolState[S_OF_BAT_A2]) )
	{
	...
	if ((boolState[relevant_evt_OF_BATTERY_B_lost] && ( !boolState[S_OF_BATTERY_B_lost])  ) || ( !boolState[S_OF_BAT_B2]) )
	{
	...
	if ((boolState[relevant_evt_OF_LBA_not_fed] && ( !boolState[S_OF_LBA_not_fed])) || (   !boolState[S_OF_LBAothers_lost]) )
	{
	...
	if ((boolState[relevant_evt_OF_LBAothers_lost] && ( !boolState[S_OF_LBAothers_lost])  ) || ( !boolState[S_OF_BATTERY_A_lost]) )
	{
	...
	if ((boolState[relevant_evt_OF_LBB_not_fed] && ( !boolState[S_OF_LBB_not_fed])) || (   !boolState[S_OF_AND_3]) )
	{
	...
	if ((boolState[relevant_evt_OF_AND_3] && ( !boolState[S_OF_AND_3])) || ( !boolState[S_OF_BATTERY_B_lost]) )
	{
	...
	if (((boolState[relevant_evt_OF_CB_LHA3_unable] && ( !boolState[S_OF_CB_LHA3_unable])) || (boolState[relevant_evt_OF_loss_of_supply_by_DGA_and_TAC] && ( !boolState[S_OF_loss_of_supply_by_DGA_and_TAC]))) || ( !boolState[S_OF_loss_of_supply_by_TAC]) )
	{
	...
	if ((boolState[relevant_evt_OF_TS_not_fed] && ( !boolState[S_OF_TS_not_fed])) || (   !boolState[S_OF_loss_of_houseload_operation]) )
	{
	...
	if (((boolState[relevant_evt_OF_CB_LHA12_unable] && ( !boolState[S_OF_CB_LHA12_unable])) || (boolState[relevant_evt_OF_LHA_not_fed] && ( !boolState[S_OF_LHA_not_fed]))) || ( !boolState[S_OF_loss_of_supply_by_DGA_and_TAC]) )
	{
	...
	if (((boolState[relevant_evt_OF_CB_LHB12_unable] && ( !boolState[S_OF_CB_LHB12_unable])) || (boolState[relevant_evt_OF_LHB_not_fed] && ( !boolState[S_OF_LHB_not_fed]))) || ( !boolState[S_OF_loss_of_supply_by_DGB]) )
	{
	...
	if (((boolState[relevant_evt_OF_CB_LGD2_unable] && ( !boolState[S_OF_CB_LGD2_unable])) || (boolState[relevant_evt_OF_LGD_not_fed] && ( !boolState[S_OF_LGD_not_fed]))) || ( !boolState[S_OF_loss_of_supply_by_TA]) )
	{
	...
	if (((boolState[relevant_evt_OF_CB_LGF2_unable] && ( !boolState[S_OF_CB_LGF2_unable])) || (boolState[relevant_evt_OF_LGF_not_fed] && ( !boolState[S_OF_LGF_not_fed]))) || ( !boolState[S_OF_loss_of_supply_by_TA1]) )
	{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_NPPS_Trim_article_No_repair::fireinsttransitiongroup(std::string user_input_ins)
