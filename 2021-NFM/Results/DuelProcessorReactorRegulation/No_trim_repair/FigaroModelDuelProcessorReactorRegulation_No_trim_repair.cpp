#include <iostream>
#include "FigaroModelDuelProcessorReactorRegulation_No_trim_repair.h"
...
void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::init()
{
	...
	FIRE_xx11_OF_ADA27_A = false;
	FIRE_xx10_OF_ADA27_B = false;
	FIRE_xx11_OF_ADA27_B = false;
	FIRE_xx10_OF_ANAMB_P16_A = false;
	FIRE_xx11_OF_ANAMB_P16_A = false;
	FIRE_xx10_OF_ANAMB_P16_B = false;
	FIRE_xx11_OF_ANAMB_P16_B = false;
	FIRE_xx10_OF_ANAMB_P17_A = false;
	FIRE_xx11_OF_ANAMB_P17_A = false;
	FIRE_xx10_OF_ANAMB_P17_B = false;
	FIRE_xx11_OF_ANAMB_P17_B = false;
	FIRE_xx10_OF_CPU86_102_A = false;
	FIRE_xx11_OF_CPU86_102_A = false;
	FIRE_xx10_OF_CPU86_102_B = false;
	FIRE_xx11_OF_CPU86_102_B = false;
	FIRE_xx10_OF_CPU86_105_A = false;
	FIRE_xx11_OF_CPU86_105_A = false;
	FIRE_xx10_OF_CPU86_105_B = false;
	FIRE_xx11_OF_CPU86_105_B = false;
	FIRE_xx10_OF_CTU = false;
	FIRE_xx11_OF_CTU = false;
	FIRE_xx10_OF_DIFIT31_A = false;
	FIRE_xx11_OF_DIFIT31_A = false;
	FIRE_xx10_OF_DIFIT31_B = false;
	FIRE_xx11_OF_DIFIT31_B = false;
	FIRE_xx10_OF_DIFIT32_A = false;
	FIRE_xx11_OF_DIFIT32_A = false;
	FIRE_xx10_OF_DIFIT32_B = false;
	FIRE_xx11_OF_DIFIT32_B = false;
	FIRE_xx10_OF_DOSC_1_DCHS4_A = false;
	FIRE_xx11_OF_DOSC_1_DCHS4_A = false;
	FIRE_xx10_OF_DOSC_1_DCHS4_B = false;
	FIRE_xx11_OF_DOSC_1_DCHS4_B = false;
	FIRE_xx10_OF_DOSC_1_DCHS5_A = false;
	FIRE_xx11_OF_DOSC_1_DCHS5_A = false;
	FIRE_xx10_OF_DOSC_1_DCHS5_B = false;
	FIRE_xx11_OF_DOSC_1_DCHS5_B = false;
	FIRE_xx10_OF_DPBMB_P31_A = false;
	FIRE_xx11_OF_DPBMB_P31_A = false;
	FIRE_xx10_OF_DPBMB_P31_B = false;
	FIRE_xx11_OF_DPBMB_P31_B = false;
	FIRE_xx10_OF_DPBMB_P32_A = false;
	FIRE_xx11_OF_DPBMB_P32_A = false;
	FIRE_xx10_OF_DPBMB_P32_B = false;
	FIRE_xx11_OF_DPBMB_P32_B = false;
	FIRE_xx10_OF_HS_136F = false;
	FIRE_xx11_OF_HS_136F = false;
	FIRE_xx10_OF_HS_138F = false;
	FIRE_xx11_OF_HS_138F = false;
	FIRE_xx10_OF_HS_139F = false;
	FIRE_xx11_OF_HS_139F = false;
	FIRE_xx10_OF_ISOCTX31_A = false;
	FIRE_xx11_OF_ISOCTX31_A = false;
	FIRE_xx10_OF_ISOCTX31_B = false;
	FIRE_xx11_OF_ISOCTX31_B = false;
	FIRE_xx10_OF_ISOCTX32_A = false;
	FIRE_xx11_OF_ISOCTX32_A = false;
	FIRE_xx10_OF_ISOCTX32_B = false;
	FIRE_xx11_OF_ISOCTX32_B = false;
	FIRE_xx10_OF_MEM527_A = false;
	FIRE_xx11_OF_MEM527_A = false;
	FIRE_xx10_OF_MEM527_B = false;
	FIRE_xx11_OF_MEM527_B = false;
	FIRE_xx10_OF_OE = false;
	FIRE_xx11_OF_OE = false;
	FIRE_xx10_OF_RLYS_1 = false;
	FIRE_xx11_OF_RLYS_1 = false;
	FIRE_xx10_OF_RORB31_A = false;
	FIRE_xx11_OF_RORB31_A = false;
	FIRE_xx10_OF_RORB31_B = false;
	FIRE_xx11_OF_RORB31_B = false;
	FIRE_xx10_OF_RORB32_A = false;
	FIRE_xx11_OF_RORB32_A = false;
	FIRE_xx10_OF_RORB32_B = false;
	FIRE_xx11_OF_RORB32_B = false;
	FIRE_xx10_OF_SM_271_A = false;
	FIRE_xx11_OF_SM_271_A = false;
	FIRE_xx10_OF_SM_271_B = false;
	FIRE_xx11_OF_SM_271_B = false;

}

void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::printState()
{
...
bool storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 31)
	{
		FIRE_xx11_OF_DOSC_1_DCHS4_A = true;
	}
	...
	if (numFire == 33)
	{
		FIRE_xx11_OF_DOSC_1_DCHS4_B = true;
	}
	...
	if (numFire == 35)
	{
		FIRE_xx11_OF_DOSC_1_DCHS5_A = true;
	}
	...
	if (numFire == 37)
	{
		FIRE_xx11_OF_DOSC_1_DCHS5_B = true;
	}
	...
	if (numFire == 79)
	{
		FIRE_xx11_OF_SM_271_B = true;
	}

/* ---------- DECLARATION OF OCCURRENCE RULES------------ */

	// Occurrence xx10_OF_ADA27_A
	if ((boolState[failF_OF_ADA27_A] == false) && boolState[required_OF_ADA27_A]) 
	{
	...
	// Occurrence xx11_OF_ADA27_A
	if (boolState[failF_OF_ADA27_A] == true) 
	{
		 
		if (FIRE_xx11_OF_ADA27_A)
		{
			boolState[failF_OF_ADA27_A]  =  false;
			FIRE_xx11_OF_ADA27_A = false;
		}
	...
	if ((boolState[failF_OF_ADA27_B] == false) && boolState[required_OF_ADA27_B]) 
	{
	...
	// Occurrence xx11_OF_ADA27_B
	if (boolState[failF_OF_ADA27_B] == true) 
	{
		 
		if (FIRE_xx11_OF_ADA27_B)
		{
			boolState[failF_OF_ADA27_B]  =  false;
			FIRE_xx11_OF_ADA27_B = false;
		}
	...
	// Occurrence xx11_OF_ANAMB_P16_A
	if (boolState[failF_OF_ANAMB_P16_A] == true) 
	{
		 
		if (FIRE_xx11_OF_ANAMB_P16_A)
		{
			boolState[failF_OF_ANAMB_P16_A]  =  false;
			FIRE_xx11_OF_ANAMB_P16_A = false;
		}
	...
	// Occurrence xx11_OF_ANAMB_P16_B
	if (boolState[failF_OF_ANAMB_P16_B] == true) 
	{
		 
		if (FIRE_xx11_OF_ANAMB_P16_B)
		{
			boolState[failF_OF_ANAMB_P16_B]  =  false;
			FIRE_xx11_OF_ANAMB_P16_B = false;
		}
	...
	// Occurrence xx11_OF_ANAMB_P17_A
	if (boolState[failF_OF_ANAMB_P17_A] == true) 
	{
		 
		if (FIRE_xx11_OF_ANAMB_P17_A)
		{
			boolState[failF_OF_ANAMB_P17_A]  =  false;
			FIRE_xx11_OF_ANAMB_P17_A = false;
		}
	...
	// Occurrence xx11_OF_ANAMB_P17_B
	if (boolState[failF_OF_ANAMB_P17_B] == true) 
	{
		 
		if (FIRE_xx11_OF_ANAMB_P17_B)
		{
			boolState[failF_OF_ANAMB_P17_B]  =  false;
			FIRE_xx11_OF_ANAMB_P17_B = false;
		}
	...
	// Occurrence xx11_OF_CPU86_102_A
	if (boolState[failF_OF_CPU86_102_A] == true) 
	{
		 
		if (FIRE_xx11_OF_CPU86_102_A)
		{
			boolState[failF_OF_CPU86_102_A]  =  false;
			FIRE_xx11_OF_CPU86_102_A = false;
		}
	...
	// Occurrence xx11_OF_CPU86_102_B
	if (boolState[failF_OF_CPU86_102_B] == true) 
	{
		 
		if (FIRE_xx11_OF_CPU86_102_B)
		{
			boolState[failF_OF_CPU86_102_B]  =  false;
			FIRE_xx11_OF_CPU86_102_B = false;
		}
	...
	// Occurrence xx11_OF_CPU86_105_A
	if (boolState[failF_OF_CPU86_105_A] == true) 
	{
		 
		if (FIRE_xx11_OF_CPU86_105_A)
		{
			boolState[failF_OF_CPU86_105_A]  =  false;
			FIRE_xx11_OF_CPU86_105_A = false;
		}
	...
	// Occurrence xx11_OF_CPU86_105_B
	if (boolState[failF_OF_CPU86_105_B] == true) 
	{
		 
		if (FIRE_xx11_OF_CPU86_105_B)
		{
			boolState[failF_OF_CPU86_105_B]  =  false;
			FIRE_xx11_OF_CPU86_105_B = false;
		}
	...
	if ((boolState[failF_OF_CTU] == false) && boolState[required_OF_CTU]) 
	{
	...
	if ((boolState[failF_OF_DIFIT31_A] == false) && boolState[required_OF_DIFIT31_A]) 
	{
	...
	// Occurrence xx11_OF_DIFIT31_A
	if (boolState[failF_OF_DIFIT31_A] == true) 
	{
		 
		if (FIRE_xx11_OF_DIFIT31_A)
		{
			boolState[failF_OF_DIFIT31_A]  =  false;
			FIRE_xx11_OF_DIFIT31_A = false;
		}
	...
	if ((boolState[failF_OF_DIFIT31_B] == false) && boolState[required_OF_DIFIT31_B]) 
	{
	...
	// Occurrence xx11_OF_DIFIT31_B
	if (boolState[failF_OF_DIFIT31_B] == true) 
	{
		 
		if (FIRE_xx11_OF_DIFIT31_B)
		{
			boolState[failF_OF_DIFIT31_B]  =  false;
			FIRE_xx11_OF_DIFIT31_B = false;
		}
	...
	if ((boolState[failF_OF_DIFIT32_A] == false) && boolState[required_OF_DIFIT32_A]) 
	{
	...
	// Occurrence xx11_OF_DIFIT32_A
	if (boolState[failF_OF_DIFIT32_A] == true) 
	{
		 
		if (FIRE_xx11_OF_DIFIT32_A)
		{
			boolState[failF_OF_DIFIT32_A]  =  false;
			FIRE_xx11_OF_DIFIT32_A = false;
		}
	...
	if ((boolState[failF_OF_DIFIT32_B] == false) && boolState[required_OF_DIFIT32_B]) 
	{
	...
	// Occurrence xx11_OF_DIFIT32_B
	if (boolState[failF_OF_DIFIT32_B] == true) 
	{
		 
		if (FIRE_xx11_OF_DIFIT32_B)
		{
			boolState[failF_OF_DIFIT32_B]  =  false;
			FIRE_xx11_OF_DIFIT32_B = false;
		}
	...
	if ((boolState[failF_OF_DOSC_1_DCHS4_A] == false) && boolState[required_OF_DOSC_1_DCHS4_A]) 
	{
	...
	// Occurrence xx11_OF_DOSC_1_DCHS4_A
	if (boolState[failF_OF_DOSC_1_DCHS4_A] == true) 
	{
		 
		if (FIRE_xx11_OF_DOSC_1_DCHS4_A)
		{
			boolState[failF_OF_DOSC_1_DCHS4_A]  =  false;
			FIRE_xx11_OF_DOSC_1_DCHS4_A = false;
		}
	...
	if ((boolState[failF_OF_DOSC_1_DCHS4_B] == false) && boolState[required_OF_DOSC_1_DCHS4_B]) 
	{
	...
	// Occurrence xx11_OF_DOSC_1_DCHS4_B
	if (boolState[failF_OF_DOSC_1_DCHS4_B] == true) 
	{
		 
		if (FIRE_xx11_OF_DOSC_1_DCHS4_B)
		{
			boolState[failF_OF_DOSC_1_DCHS4_B]  =  false;
			FIRE_xx11_OF_DOSC_1_DCHS4_B = false;
		}
	...
	if ((boolState[failF_OF_DOSC_1_DCHS5_A] == false) && boolState[required_OF_DOSC_1_DCHS5_A]) 
	{
	...
	// Occurrence xx11_OF_DOSC_1_DCHS5_A
	if (boolState[failF_OF_DOSC_1_DCHS5_A] == true) 
	{
		 
		if (FIRE_xx11_OF_DOSC_1_DCHS5_A)
		{
			boolState[failF_OF_DOSC_1_DCHS5_A]  =  false;
			FIRE_xx11_OF_DOSC_1_DCHS5_A = false;
		}
	...
	if ((boolState[failF_OF_DOSC_1_DCHS5_B] == false) && boolState[required_OF_DOSC_1_DCHS5_B]) 
	{
	...
	// Occurrence xx11_OF_DOSC_1_DCHS5_B
	if (boolState[failF_OF_DOSC_1_DCHS5_B] == true) 
	{
		 
		if (FIRE_xx11_OF_DOSC_1_DCHS5_B)
		{
			boolState[failF_OF_DOSC_1_DCHS5_B]  =  false;
			FIRE_xx11_OF_DOSC_1_DCHS5_B = false;
		}
	...
	// Occurrence xx11_OF_DPBMB_P31_A
	if (boolState[failF_OF_DPBMB_P31_A] == true) 
	{
		 
		if (FIRE_xx11_OF_DPBMB_P31_A)
		{
			boolState[failF_OF_DPBMB_P31_A]  =  false;
			FIRE_xx11_OF_DPBMB_P31_A = false;
		}
	...
	// Occurrence xx11_OF_DPBMB_P31_B
	if (boolState[failF_OF_DPBMB_P31_B] == true) 
	{
		 
		if (FIRE_xx11_OF_DPBMB_P31_B)
		{
			boolState[failF_OF_DPBMB_P31_B]  =  false;
			FIRE_xx11_OF_DPBMB_P31_B = false;
		}
	...
	// Occurrence xx11_OF_DPBMB_P32_A
	if (boolState[failF_OF_DPBMB_P32_A] == true) 
	{
		 
		if (FIRE_xx11_OF_DPBMB_P32_A)
		{
			boolState[failF_OF_DPBMB_P32_A]  =  false;
			FIRE_xx11_OF_DPBMB_P32_A = false;
		}
	...
	// Occurrence xx11_OF_DPBMB_P32_B
	if (boolState[failF_OF_DPBMB_P32_B] == true) 
	{
		 
		if (FIRE_xx11_OF_DPBMB_P32_B)
		{
			boolState[failF_OF_DPBMB_P32_B]  =  false;
			FIRE_xx11_OF_DPBMB_P32_B = false;
		}
	...
	if ((boolState[failF_OF_HS_136F] == false) && boolState[required_OF_HS_136F]) 
	{
	...
	// Occurrence xx11_OF_HS_136F
	if (boolState[failF_OF_HS_136F] == true) 
	{
		 
		if (FIRE_xx11_OF_HS_136F)
		{
			boolState[failF_OF_HS_136F]  =  false;
			FIRE_xx11_OF_HS_136F = false;
		}
	...
	if ((boolState[failF_OF_HS_138F] == false) && boolState[required_OF_HS_138F]) 
	{
	...
	// Occurrence xx11_OF_HS_138F
	if (boolState[failF_OF_HS_138F] == true) 
	{
		 
		if (FIRE_xx11_OF_HS_138F)
		{
			boolState[failF_OF_HS_138F]  =  false;
			FIRE_xx11_OF_HS_138F = false;
		}
	...
	if ((boolState[failF_OF_HS_139F] == false) && boolState[required_OF_HS_139F]) 
	{
	...
	// Occurrence xx11_OF_HS_139F
	if (boolState[failF_OF_HS_139F] == true) 
	{
		 
		if (FIRE_xx11_OF_HS_139F)
		{
			boolState[failF_OF_HS_139F]  =  false;
			FIRE_xx11_OF_HS_139F = false;
		}
	...
	// Occurrence xx11_OF_ISOCTX31_A
	if (boolState[failF_OF_ISOCTX31_A] == true) 
	{
		 
		if (FIRE_xx11_OF_ISOCTX31_A)
		{
			boolState[failF_OF_ISOCTX31_A]  =  false;
			FIRE_xx11_OF_ISOCTX31_A = false;
		}
	...
	// Occurrence xx11_OF_ISOCTX31_B
	if (boolState[failF_OF_ISOCTX31_B] == true) 
	{
		 
		if (FIRE_xx11_OF_ISOCTX31_B)
		{
			boolState[failF_OF_ISOCTX31_B]  =  false;
			FIRE_xx11_OF_ISOCTX31_B = false;
		}
	...
	// Occurrence xx11_OF_ISOCTX32_A
	if (boolState[failF_OF_ISOCTX32_A] == true) 
	{
		 
		if (FIRE_xx11_OF_ISOCTX32_A)
		{
			boolState[failF_OF_ISOCTX32_A]  =  false;
			FIRE_xx11_OF_ISOCTX32_A = false;
		}
	...
	// Occurrence xx11_OF_ISOCTX32_B
	if (boolState[failF_OF_ISOCTX32_B] == true) 
	{
		 
		if (FIRE_xx11_OF_ISOCTX32_B)
		{
			boolState[failF_OF_ISOCTX32_B]  =  false;
			FIRE_xx11_OF_ISOCTX32_B = false;
		}
	...
	if ((boolState[failF_OF_MEM527_A] == false) && boolState[required_OF_MEM527_A]) 
	{
	...
	// Occurrence xx11_OF_MEM527_A
	if (boolState[failF_OF_MEM527_A] == true) 
	{
		 
		if (FIRE_xx11_OF_MEM527_A)
		{
			boolState[failF_OF_MEM527_A]  =  false;
			FIRE_xx11_OF_MEM527_A = false;
		}
	...
	if ((boolState[failF_OF_MEM527_B] == false) && boolState[required_OF_MEM527_B]) 
	{
	...
	// Occurrence xx11_OF_MEM527_B
	if (boolState[failF_OF_MEM527_B] == true) 
	{
		 
		if (FIRE_xx11_OF_MEM527_B)
		{
			boolState[failF_OF_MEM527_B]  =  false;
			FIRE_xx11_OF_MEM527_B = false;
		}
	...
	if ((boolState[failF_OF_OE] == false) && boolState[required_OF_OE]) 
	{
	...
	if ((boolState[failF_OF_RLYS_1] == false) && boolState[required_OF_RLYS_1]) 
	{
	...
	// Occurrence xx11_OF_RLYS_1
	if (boolState[failF_OF_RLYS_1] == true) 
	{
		 
		if (FIRE_xx11_OF_RLYS_1)
		{
			boolState[failF_OF_RLYS_1]  =  false;
			FIRE_xx11_OF_RLYS_1 = false;
		}
	...
	if ((boolState[failF_OF_RORB31_A] == false) && boolState[required_OF_RORB31_A]) 
	{
	...
	// Occurrence xx11_OF_RORB31_A
	if (boolState[failF_OF_RORB31_A] == true) 
	{
		 
		if (FIRE_xx11_OF_RORB31_A)
		{
			boolState[failF_OF_RORB31_A]  =  false;
			FIRE_xx11_OF_RORB31_A = false;
		}
	...
	if ((boolState[failF_OF_RORB31_B] == false) && boolState[required_OF_RORB31_B]) 
	{
	...
	// Occurrence xx11_OF_RORB31_B
	if (boolState[failF_OF_RORB31_B] == true) 
	{
		 
		if (FIRE_xx11_OF_RORB31_B)
		{
			boolState[failF_OF_RORB31_B]  =  false;
			FIRE_xx11_OF_RORB31_B = false;
		}
	...
	if ((boolState[failF_OF_RORB32_A] == false) && boolState[required_OF_RORB32_A]) 
	{
	...
	// Occurrence xx11_OF_RORB32_A
	if (boolState[failF_OF_RORB32_A] == true) 
	{
		 
		if (FIRE_xx11_OF_RORB32_A)
		{
			boolState[failF_OF_RORB32_A]  =  false;
			FIRE_xx11_OF_RORB32_A = false;
		}
	...
	if ((boolState[failF_OF_RORB32_B] == false) && boolState[required_OF_RORB32_B]) 
	{
	...
	// Occurrence xx11_OF_RORB32_B
	if (boolState[failF_OF_RORB32_B] == true) 
	{
		 
		if (FIRE_xx11_OF_RORB32_B)
		{
			boolState[failF_OF_RORB32_B]  =  false;
			FIRE_xx11_OF_RORB32_B = false;
		}
	...
	if ((boolState[failF_OF_SM_271_A] == false) && boolState[required_OF_SM_271_A]) 
	{
	...
	// Occurrence xx11_OF_SM_271_A
	if (boolState[failF_OF_SM_271_A] == true) 
	{
		 
		if (FIRE_xx11_OF_SM_271_A)
		{
			boolState[failF_OF_SM_271_A]  =  false;
			FIRE_xx11_OF_SM_271_A = false;
		}
	...
	if ((boolState[failF_OF_SM_271_B] == false) && boolState[required_OF_SM_271_B]) 
	{
	...
	// Occurrence xx11_OF_SM_271_B
	if (boolState[failF_OF_SM_271_B] == true) 
	{
		 
		if (FIRE_xx11_OF_SM_271_B)
		{
			boolState[failF_OF_SM_271_B]  =  false;
			FIRE_xx11_OF_SM_271_B = false;
		}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::showFireableOccurrences()
{
	...
	if (boolState[failF_OF_ADA27_A] == true)
	{
		//cout << "1 : xx11_OF_ADA27_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ADA27_A]  =  FALSE" << endl;
		list.push_back(make_tuple(1, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_ADA27_B] == false) && boolState[required_OF_ADA27_B])
	{
		//cout << "2 : xx10_OF_ADA27_B : FAULT failF  LABEL \"failure in operation ADA27_B\"  DIST EXP (6.7e-06)  INDUCING boolState[failF_OF_ADA27_B]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 6.7e-06, "EXP", 0));
	}
	if (boolState[failF_OF_ADA27_B] == true)
	{
		//cout << "3 : xx11_OF_ADA27_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ADA27_B]  =  FALSE" << endl;
		list.push_back(make_tuple(3, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_ANAMB_P16_A] == false) && boolState[required_OF_ANAMB_P16_A])
	{
		//cout << "4 : xx10_OF_ANAMB_P16_A : FAULT failF  LABEL \"failure in operation ANAMB_P16_A\"  DIST EXP (3.2e-07)  INDUCING boolState[failF_OF_ANAMB_P16_A]  =  TRUE" << endl;
		list.push_back(make_tuple(4, 3.2e-07, "EXP", 0));
	}
	if (boolState[failF_OF_ANAMB_P16_A] == true)
	{
		//cout << "5 : xx11_OF_ANAMB_P16_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ANAMB_P16_A]  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_ANAMB_P16_B] == false) && boolState[required_OF_ANAMB_P16_B])
	{
		//cout << "6 : xx10_OF_ANAMB_P16_B : FAULT failF  LABEL \"failure in operation ANAMB_P16_B\"  DIST EXP (3.2e-07)  INDUCING boolState[failF_OF_ANAMB_P16_B]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 3.2e-07, "EXP", 0));
	}
	if (boolState[failF_OF_ANAMB_P16_B] == true)
	{
		//cout << "7 : xx11_OF_ANAMB_P16_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ANAMB_P16_B]  =  FALSE" << endl;
		list.push_back(make_tuple(7, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_ANAMB_P17_A] == false) && boolState[required_OF_ANAMB_P17_A])
	{
		//cout << "8 : xx10_OF_ANAMB_P17_A : FAULT failF  LABEL \"failure in operation ANAMB_P17_A\"  DIST EXP (3.2e-07)  INDUCING boolState[failF_OF_ANAMB_P17_A]  =  TRUE" << endl;
		list.push_back(make_tuple(8, 3.2e-07, "EXP", 0));
	}
	if (boolState[failF_OF_ANAMB_P17_A] == true)
	{
		//cout << "9 : xx11_OF_ANAMB_P17_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ANAMB_P17_A]  =  FALSE" << endl;
		list.push_back(make_tuple(9, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_ANAMB_P17_B] == false) && boolState[required_OF_ANAMB_P17_B])
	{
		//cout << "10 : xx10_OF_ANAMB_P17_B : FAULT failF  LABEL \"failure in operation ANAMB_P17_B\"  DIST EXP (3.2e-07)  INDUCING boolState[failF_OF_ANAMB_P17_B]  =  TRUE" << endl;
		list.push_back(make_tuple(10, 3.2e-07, "EXP", 0));
	}
	if (boolState[failF_OF_ANAMB_P17_B] == true)
	{
		//cout << "11 : xx11_OF_ANAMB_P17_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ANAMB_P17_B]  =  FALSE" << endl;
		list.push_back(make_tuple(11, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_CPU86_102_A] == false) && boolState[required_OF_CPU86_102_A])
	{
		//cout << "12 : xx10_OF_CPU86_102_A : FAULT failF  LABEL \"failure in operation CPU86_102_A\"  DIST EXP (9.5e-06)  INDUCING boolState[failF_OF_CPU86_102_A]  =  TRUE" << endl;
		list.push_back(make_tuple(12, 9.5e-06, "EXP", 0));
	}
	if (boolState[failF_OF_CPU86_102_A] == true)
	{
		//cout << "13 : xx11_OF_CPU86_102_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_CPU86_102_A]  =  FALSE" << endl;
		list.push_back(make_tuple(13, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_CPU86_102_B] == false) && boolState[required_OF_CPU86_102_B])
	{
		//cout << "14 : xx10_OF_CPU86_102_B : FAULT failF  LABEL \"failure in operation CPU86_102_B\"  DIST EXP (9.5e-06)  INDUCING boolState[failF_OF_CPU86_102_B]  =  TRUE" << endl;
		list.push_back(make_tuple(14, 9.5e-06, "EXP", 0));
	}
	if (boolState[failF_OF_CPU86_102_B] == true)
	{
		//cout << "15 : xx11_OF_CPU86_102_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_CPU86_102_B]  =  FALSE" << endl;
		list.push_back(make_tuple(15, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_CPU86_105_A] == false) && boolState[required_OF_CPU86_105_A])
	{
		//cout << "16 : xx10_OF_CPU86_105_A : FAULT failF  LABEL \"failure in operation CPU86_105_A\"  DIST EXP (9.5e-06)  INDUCING boolState[failF_OF_CPU86_105_A]  =  TRUE" << endl;
		list.push_back(make_tuple(16, 9.5e-06, "EXP", 0));
	}
	if (boolState[failF_OF_CPU86_105_A] == true)
	{
		//cout << "17 : xx11_OF_CPU86_105_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_CPU86_105_A]  =  FALSE" << endl;
		list.push_back(make_tuple(17, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_CPU86_105_B] == false) && boolState[required_OF_CPU86_105_B])
	{
		//cout << "18 : xx10_OF_CPU86_105_B : FAULT failF  LABEL \"failure in operation CPU86_105_B\"  DIST EXP (9.5e-06)  INDUCING boolState[failF_OF_CPU86_105_B]  =  TRUE" << endl;
		list.push_back(make_tuple(18, 9.5e-06, "EXP", 0));
	}
	if (boolState[failF_OF_CPU86_105_B] == true)
	{
		//cout << "19 : xx11_OF_CPU86_105_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_CPU86_105_B]  =  FALSE" << endl;
		list.push_back(make_tuple(19, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_CTU] == false) && boolState[required_OF_CTU])
	{
		//cout << "20 : xx10_OF_CTU : FAULT failF  LABEL \"failure in operation CTU\"  DIST EXP (5.4e-06)  INDUCING boolState[failF_OF_CTU]  =  TRUE" << endl;
		list.push_back(make_tuple(20, 5.4e-06, "EXP", 0));
	}
	if (boolState[failF_OF_CTU] == true)
	{
		//cout << "21 : xx11_OF_CTU : REPAIR rep  DIST EXP (1)  INDUCING boolState[failF_OF_CTU]  =  FALSE" << endl;
		list.push_back(make_tuple(21, 1, "EXP", 0));
	}
	if ((boolState[failF_OF_DIFIT31_A] == false) && boolState[required_OF_DIFIT31_A])
	{
		//cout << "22 : xx10_OF_DIFIT31_A : FAULT failF  LABEL \"failure in operation DIFIT31_A\"  DIST EXP (1e-05)  INDUCING boolState[failF_OF_DIFIT31_A]  =  TRUE" << endl;
		list.push_back(make_tuple(22, 1e-05, "EXP", 0));
	}
	if (boolState[failF_OF_DIFIT31_A] == true)
	{
		//cout << "23 : xx11_OF_DIFIT31_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DIFIT31_A]  =  FALSE" << endl;
		list.push_back(make_tuple(23, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DIFIT31_B] == false) && boolState[required_OF_DIFIT31_B])
	{
		//cout << "24 : xx10_OF_DIFIT31_B : FAULT failF  LABEL \"failure in operation DIFIT31_B\"  DIST EXP (1e-05)  INDUCING boolState[failF_OF_DIFIT31_B]  =  TRUE" << endl;
		list.push_back(make_tuple(24, 1e-05, "EXP", 0));
	}
	if (boolState[failF_OF_DIFIT31_B] == true)
	{
		//cout << "25 : xx11_OF_DIFIT31_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DIFIT31_B]  =  FALSE" << endl;
		list.push_back(make_tuple(25, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DIFIT32_A] == false) && boolState[required_OF_DIFIT32_A])
	{
		//cout << "26 : xx10_OF_DIFIT32_A : FAULT failF  LABEL \"failure in operation DIFIT32_A\"  DIST EXP (1e-05)  INDUCING boolState[failF_OF_DIFIT32_A]  =  TRUE" << endl;
		list.push_back(make_tuple(26, 1e-05, "EXP", 0));
	}
	if (boolState[failF_OF_DIFIT32_A] == true)
	{
		//cout << "27 : xx11_OF_DIFIT32_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DIFIT32_A]  =  FALSE" << endl;
		list.push_back(make_tuple(27, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DIFIT32_B] == false) && boolState[required_OF_DIFIT32_B])
	{
		//cout << "28 : xx10_OF_DIFIT32_B : FAULT failF  LABEL \"failure in operation DIFIT32_B\"  DIST EXP (1e-05)  INDUCING boolState[failF_OF_DIFIT32_B]  =  TRUE" << endl;
		list.push_back(make_tuple(28, 1e-05, "EXP", 0));
	}
	if (boolState[failF_OF_DIFIT32_B] == true)
	{
		//cout << "29 : xx11_OF_DIFIT32_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DIFIT32_B]  =  FALSE" << endl;
		list.push_back(make_tuple(29, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DOSC_1_DCHS4_A] == false) && boolState[required_OF_DOSC_1_DCHS4_A])
	{
		//cout << "30 : xx10_OF_DOSC_1_DCHS4_A : FAULT failF  LABEL \"failure in operation DOSC_1_DCHS4_A\"  DIST EXP (7e-06)  INDUCING boolState[failF_OF_DOSC_1_DCHS4_A]  =  TRUE" << endl;
		list.push_back(make_tuple(30, 7e-06, "EXP", 0));
	}
	if (boolState[failF_OF_DOSC_1_DCHS4_A] == true)
	{
		//cout << "31 : xx11_OF_DOSC_1_DCHS4_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DOSC_1_DCHS4_A]  =  FALSE" << endl;
		list.push_back(make_tuple(31, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DOSC_1_DCHS4_B] == false) && boolState[required_OF_DOSC_1_DCHS4_B])
	{
		//cout << "32 : xx10_OF_DOSC_1_DCHS4_B : FAULT failF  LABEL \"failure in operation DOSC_1_DCHS4_B\"  DIST EXP (7e-06)  INDUCING boolState[failF_OF_DOSC_1_DCHS4_B]  =  TRUE" << endl;
		list.push_back(make_tuple(32, 7e-06, "EXP", 0));
	}
	if (boolState[failF_OF_DOSC_1_DCHS4_B] == true)
	{
		//cout << "33 : xx11_OF_DOSC_1_DCHS4_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DOSC_1_DCHS4_B]  =  FALSE" << endl;
		list.push_back(make_tuple(33, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DOSC_1_DCHS5_A] == false) && boolState[required_OF_DOSC_1_DCHS5_A])
	{
		//cout << "34 : xx10_OF_DOSC_1_DCHS5_A : FAULT failF  LABEL \"failure in operation DOSC_1_DCHS5_A\"  DIST EXP (7e-06)  INDUCING boolState[failF_OF_DOSC_1_DCHS5_A]  =  TRUE" << endl;
		list.push_back(make_tuple(34, 7e-06, "EXP", 0));
	}
	if (boolState[failF_OF_DOSC_1_DCHS5_A] == true)
	{
		//cout << "35 : xx11_OF_DOSC_1_DCHS5_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DOSC_1_DCHS5_A]  =  FALSE" << endl;
		list.push_back(make_tuple(35, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DOSC_1_DCHS5_B] == false) && boolState[required_OF_DOSC_1_DCHS5_B])
	{
		//cout << "36 : xx10_OF_DOSC_1_DCHS5_B : FAULT failF  LABEL \"failure in operation DOSC_1_DCHS5_B\"  DIST EXP (7e-06)  INDUCING boolState[failF_OF_DOSC_1_DCHS5_B]  =  TRUE" << endl;
		list.push_back(make_tuple(36, 7e-06, "EXP", 0));
	}
	if (boolState[failF_OF_DOSC_1_DCHS5_B] == true)
	{
		//cout << "37 : xx11_OF_DOSC_1_DCHS5_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DOSC_1_DCHS5_B]  =  FALSE" << endl;
		list.push_back(make_tuple(37, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DPBMB_P31_A] == false) && boolState[required_OF_DPBMB_P31_A])
	{
		//cout << "38 : xx10_OF_DPBMB_P31_A : FAULT failF  LABEL \"failure in operation DPBMB_P31_A\"  DIST EXP (4.9e-07)  INDUCING boolState[failF_OF_DPBMB_P31_A]  =  TRUE" << endl;
		list.push_back(make_tuple(38, 4.9e-07, "EXP", 0));
	}
	if (boolState[failF_OF_DPBMB_P31_A] == true)
	{
		//cout << "39 : xx11_OF_DPBMB_P31_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DPBMB_P31_A]  =  FALSE" << endl;
		list.push_back(make_tuple(39, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DPBMB_P31_B] == false) && boolState[required_OF_DPBMB_P31_B])
	{
		//cout << "40 : xx10_OF_DPBMB_P31_B : FAULT failF  LABEL \"failure in operation DPBMB_P31_B\"  DIST EXP (4.9e-07)  INDUCING boolState[failF_OF_DPBMB_P31_B]  =  TRUE" << endl;
		list.push_back(make_tuple(40, 4.9e-07, "EXP", 0));
	}
	if (boolState[failF_OF_DPBMB_P31_B] == true)
	{
		//cout << "41 : xx11_OF_DPBMB_P31_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DPBMB_P31_B]  =  FALSE" << endl;
		list.push_back(make_tuple(41, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DPBMB_P32_A] == false) && boolState[required_OF_DPBMB_P32_A])
	{
		//cout << "42 : xx10_OF_DPBMB_P32_A : FAULT failF  LABEL \"failure in operation DPBMB_P32_A\"  DIST EXP (4.9e-07)  INDUCING boolState[failF_OF_DPBMB_P32_A]  =  TRUE" << endl;
		list.push_back(make_tuple(42, 4.9e-07, "EXP", 0));
	}
	if (boolState[failF_OF_DPBMB_P32_A] == true)
	{
		//cout << "43 : xx11_OF_DPBMB_P32_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DPBMB_P32_A]  =  FALSE" << endl;
		list.push_back(make_tuple(43, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_DPBMB_P32_B] == false) && boolState[required_OF_DPBMB_P32_B])
	{
		//cout << "44 : xx10_OF_DPBMB_P32_B : FAULT failF  LABEL \"failure in operation DPBMB_P32_B\"  DIST EXP (4.9e-07)  INDUCING boolState[failF_OF_DPBMB_P32_B]  =  TRUE" << endl;
		list.push_back(make_tuple(44, 4.9e-07, "EXP", 0));
	}
	if (boolState[failF_OF_DPBMB_P32_B] == true)
	{
		//cout << "45 : xx11_OF_DPBMB_P32_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_DPBMB_P32_B]  =  FALSE" << endl;
		list.push_back(make_tuple(45, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_HS_136F] == false) && boolState[required_OF_HS_136F])
	{
		//cout << "46 : xx10_OF_HS_136F : FAULT failF  LABEL \"failure in operation HS_136F\"  DIST EXP (0.001)  INDUCING boolState[failF_OF_HS_136F]  =  TRUE" << endl;
		list.push_back(make_tuple(46, 0.001, "EXP", 0));
	}
	if (boolState[failF_OF_HS_136F] == true)
	{
		//cout << "47 : xx11_OF_HS_136F : REPAIR rep  DIST EXP (1e-200)  INDUCING boolState[failF_OF_HS_136F]  =  FALSE" << endl;
		list.push_back(make_tuple(47, 1e-200, "EXP", 0));
	}
	if ((boolState[failF_OF_HS_138F] == false) && boolState[required_OF_HS_138F])
	{
		//cout << "48 : xx10_OF_HS_138F : FAULT failF  LABEL \"failure in operation HS_138F\"  DIST EXP (0.001)  INDUCING boolState[failF_OF_HS_138F]  =  TRUE" << endl;
		list.push_back(make_tuple(48, 0.001, "EXP", 0));
	}
	if (boolState[failF_OF_HS_138F] == true)
	{
		//cout << "49 : xx11_OF_HS_138F : REPAIR rep  DIST EXP (1e-200)  INDUCING boolState[failF_OF_HS_138F]  =  FALSE" << endl;
		list.push_back(make_tuple(49, 1e-200, "EXP", 0));
	}
	if ((boolState[failF_OF_HS_139F] == false) && boolState[required_OF_HS_139F])
	{
		//cout << "50 : xx10_OF_HS_139F : FAULT failF  LABEL \"failure in operation HS_139F\"  DIST EXP (0.001)  INDUCING boolState[failF_OF_HS_139F]  =  TRUE" << endl;
		list.push_back(make_tuple(50, 0.001, "EXP", 0));
	}
	if (boolState[failF_OF_HS_139F] == true)
	{
		//cout << "51 : xx11_OF_HS_139F : REPAIR rep  DIST EXP (1e-200)  INDUCING boolState[failF_OF_HS_139F]  =  FALSE" << endl;
		list.push_back(make_tuple(51, 1e-200, "EXP", 0));
	}
	if ((boolState[failF_OF_ISOCTX31_A] == false) && boolState[required_OF_ISOCTX31_A])
	{
		//cout << "52 : xx10_OF_ISOCTX31_A : FAULT failF  LABEL \"failure in operation ISOCTX31_A\"  DIST EXP (8.1e-06)  INDUCING boolState[failF_OF_ISOCTX31_A]  =  TRUE" << endl;
		list.push_back(make_tuple(52, 8.1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_ISOCTX31_A] == true)
	{
		//cout << "53 : xx11_OF_ISOCTX31_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ISOCTX31_A]  =  FALSE" << endl;
		list.push_back(make_tuple(53, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_ISOCTX31_B] == false) && boolState[required_OF_ISOCTX31_B])
	{
		//cout << "54 : xx10_OF_ISOCTX31_B : FAULT failF  LABEL \"failure in operation ISOCTX31_B\"  DIST EXP (8.1e-06)  INDUCING boolState[failF_OF_ISOCTX31_B]  =  TRUE" << endl;
		list.push_back(make_tuple(54, 8.1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_ISOCTX31_B] == true)
	{
		//cout << "55 : xx11_OF_ISOCTX31_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ISOCTX31_B]  =  FALSE" << endl;
		list.push_back(make_tuple(55, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_ISOCTX32_A] == false) && boolState[required_OF_ISOCTX32_A])
	{
		//cout << "56 : xx10_OF_ISOCTX32_A : FAULT failF  LABEL \"failure in operation ISOCTX32_A\"  DIST EXP (8.1e-06)  INDUCING boolState[failF_OF_ISOCTX32_A]  =  TRUE" << endl;
		list.push_back(make_tuple(56, 8.1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_ISOCTX32_A] == true)
	{
		//cout << "57 : xx11_OF_ISOCTX32_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ISOCTX32_A]  =  FALSE" << endl;
		list.push_back(make_tuple(57, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_ISOCTX32_B] == false) && boolState[required_OF_ISOCTX32_B])
	{
		//cout << "58 : xx10_OF_ISOCTX32_B : FAULT failF  LABEL \"failure in operation ISOCTX32_B\"  DIST EXP (8.1e-06)  INDUCING boolState[failF_OF_ISOCTX32_B]  =  TRUE" << endl;
		list.push_back(make_tuple(58, 8.1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_ISOCTX32_B] == true)
	{
		//cout << "59 : xx11_OF_ISOCTX32_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_ISOCTX32_B]  =  FALSE" << endl;
		list.push_back(make_tuple(59, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_MEM527_A] == false) && boolState[required_OF_MEM527_A])
	{
		//cout << "60 : xx10_OF_MEM527_A : FAULT failF  LABEL \"failure in operation MEM527_A\"  DIST EXP (3.9e-06)  INDUCING boolState[failF_OF_MEM527_A]  =  TRUE" << endl;
		list.push_back(make_tuple(60, 3.9e-06, "EXP", 0));
	}
	if (boolState[failF_OF_MEM527_A] == true)
	{
		//cout << "61 : xx11_OF_MEM527_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_MEM527_A]  =  FALSE" << endl;
		list.push_back(make_tuple(61, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_MEM527_B] == false) && boolState[required_OF_MEM527_B])
	{
		//cout << "62 : xx10_OF_MEM527_B : FAULT failF  LABEL \"failure in operation MEM527_B\"  DIST EXP (3.9e-06)  INDUCING boolState[failF_OF_MEM527_B]  =  TRUE" << endl;
		list.push_back(make_tuple(62, 3.9e-06, "EXP", 0));
	}
	if (boolState[failF_OF_MEM527_B] == true)
	{
		//cout << "63 : xx11_OF_MEM527_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_MEM527_B]  =  FALSE" << endl;
		list.push_back(make_tuple(63, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_OE] == false) && boolState[required_OF_OE])
	{
		//cout << "64 : xx10_OF_OE : FAULT failF  LABEL \"failure in operation OE\"  DIST EXP (0.1)  INDUCING boolState[failF_OF_OE]  =  TRUE" << endl;
		list.push_back(make_tuple(64, 0.1, "EXP", 0));
	}
	if (boolState[failF_OF_OE] == true)
	{
		//cout << "65 : xx11_OF_OE : REPAIR rep  DIST EXP (1e-200)  INDUCING boolState[failF_OF_OE]  =  FALSE" << endl;
		list.push_back(make_tuple(65, 1e-200, "EXP", 0));
	}
	if ((boolState[failF_OF_RLYS_1] == false) && boolState[required_OF_RLYS_1])
	{
		//cout << "66 : xx10_OF_RLYS_1 : FAULT failF  LABEL \"failure in operation RLYS_1\"  DIST EXP (0.00052)  INDUCING boolState[failF_OF_RLYS_1]  =  TRUE" << endl;
		list.push_back(make_tuple(66, 0.00052, "EXP", 0));
	}
	if (boolState[failF_OF_RLYS_1] == true)
	{
		//cout << "67 : xx11_OF_RLYS_1 : REPAIR rep  DIST EXP (1)  INDUCING boolState[failF_OF_RLYS_1]  =  FALSE" << endl;
		list.push_back(make_tuple(67, 1, "EXP", 0));
	}
	if ((boolState[failF_OF_RORB31_A] == false) && boolState[required_OF_RORB31_A])
	{
		//cout << "68 : xx10_OF_RORB31_A : FAULT failF  LABEL \"failure in operation RORB31_A\"  DIST EXP (2.9e-06)  INDUCING boolState[failF_OF_RORB31_A]  =  TRUE" << endl;
		list.push_back(make_tuple(68, 2.9e-06, "EXP", 0));
	}
	if (boolState[failF_OF_RORB31_A] == true)
	{
		//cout << "69 : xx11_OF_RORB31_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_RORB31_A]  =  FALSE" << endl;
		list.push_back(make_tuple(69, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_RORB31_B] == false) && boolState[required_OF_RORB31_B])
	{
		//cout << "70 : xx10_OF_RORB31_B : FAULT failF  LABEL \"failure in operation RORB31_B\"  DIST EXP (2.9e-06)  INDUCING boolState[failF_OF_RORB31_B]  =  TRUE" << endl;
		list.push_back(make_tuple(70, 2.9e-06, "EXP", 0));
	}
	if (boolState[failF_OF_RORB31_B] == true)
	{
		//cout << "71 : xx11_OF_RORB31_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_RORB31_B]  =  FALSE" << endl;
		list.push_back(make_tuple(71, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_RORB32_A] == false) && boolState[required_OF_RORB32_A])
	{
		//cout << "72 : xx10_OF_RORB32_A : FAULT failF  LABEL \"failure in operation RORB32_A\"  DIST EXP (2.9e-06)  INDUCING boolState[failF_OF_RORB32_A]  =  TRUE" << endl;
		list.push_back(make_tuple(72, 2.9e-06, "EXP", 0));
	}
	if (boolState[failF_OF_RORB32_A] == true)
	{
		//cout << "73 : xx11_OF_RORB32_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_RORB32_A]  =  FALSE" << endl;
		list.push_back(make_tuple(73, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_RORB32_B] == false) && boolState[required_OF_RORB32_B])
	{
		//cout << "74 : xx10_OF_RORB32_B : FAULT failF  LABEL \"failure in operation RORB32_B\"  DIST EXP (2.9e-06)  INDUCING boolState[failF_OF_RORB32_B]  =  TRUE" << endl;
		list.push_back(make_tuple(74, 2.9e-06, "EXP", 0));
	}
	if (boolState[failF_OF_RORB32_B] == true)
	{
		//cout << "75 : xx11_OF_RORB32_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_RORB32_B]  =  FALSE" << endl;
		list.push_back(make_tuple(75, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_SM_271_A] == false) && boolState[required_OF_SM_271_A])
	{
		//cout << "76 : xx10_OF_SM_271_A : FAULT failF  LABEL \"failure in operation SM_271_A\"  DIST EXP (4.4e-06)  INDUCING boolState[failF_OF_SM_271_A]  =  TRUE" << endl;
		list.push_back(make_tuple(76, 4.4e-06, "EXP", 0));
	}
	if (boolState[failF_OF_SM_271_A] == true)
	{
		//cout << "77 : xx11_OF_SM_271_A : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_SM_271_A]  =  FALSE" << endl;
		list.push_back(make_tuple(77, 0.041, "EXP", 0));
	}
	if ((boolState[failF_OF_SM_271_B] == false) && boolState[required_OF_SM_271_B])
	{
		//cout << "78 : xx10_OF_SM_271_B : FAULT failF  LABEL \"failure in operation SM_271_B\"  DIST EXP (4.4e-06)  INDUCING boolState[failF_OF_SM_271_B]  =  TRUE" << endl;
		list.push_back(make_tuple(78, 4.4e-06, "EXP", 0));
	}
	if (boolState[failF_OF_SM_271_B] == true)
	{
		//cout << "79 : xx11_OF_SM_271_B : REPAIR rep  DIST EXP (0.041)  INDUCING boolState[failF_OF_SM_271_B]  =  FALSE" << endl;
		list.push_back(make_tuple(79, 0.041, "EXP", 0));
	}
	return list;
}


void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_ADA27_A] == true )
	{
...
void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_DuelProcessorReactorRegulation_No_trim_repair::fireinsttransitiongroup(std::string user_input_ins)
