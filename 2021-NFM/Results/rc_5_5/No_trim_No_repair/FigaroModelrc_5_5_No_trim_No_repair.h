    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_rc_5_5_No_trim_No_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_rc_5_5_No_trim_No_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
