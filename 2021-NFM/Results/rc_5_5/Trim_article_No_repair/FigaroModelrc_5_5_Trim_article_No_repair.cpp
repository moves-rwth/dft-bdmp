#include <iostream>
#include "FigaroModelrc_5_5_Trim_article_No_repair.h"
...
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::init()
{
...
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if (((boolState[relevant_evt_OF_motor_1] && ( !boolState[S_OF_motor_1])) || (  boolState[relevant_evt_OF_switch_1] && ( !boolState[S_OF_switch_1]))) || ( !boolState[S_OF_ms1]) )
	{
	...
	if (((boolState[relevant_evt_OF_motor_2] && ( !boolState[S_OF_motor_2])) || (  boolState[relevant_evt_OF_switch_2] && ( !boolState[S_OF_switch_2]))) || ( !boolState[S_OF_ms2]) )
	{
	...
	if (((boolState[relevant_evt_OF_motor_3] && ( !boolState[S_OF_motor_3])) || (  boolState[relevant_evt_OF_switch_3] && ( !boolState[S_OF_switch_3]))) || ( !boolState[S_OF_ms3]) )
	{
	...
	if (((boolState[relevant_evt_OF_motor_4] && ( !boolState[S_OF_motor_4])) || (  boolState[relevant_evt_OF_switch_4] && ( !boolState[S_OF_switch_4]))) || ( !boolState[S_OF_ms4]) )
	{
	...
	if (((boolState[relevant_evt_OF_motor_5] && ( !boolState[S_OF_motor_5])) || (  boolState[relevant_evt_OF_switch_5] && ( !boolState[S_OF_switch_5]))) || ( !boolState[S_OF_ms5]) )
	{
	...
	if (((( !boolState[S_OF_sA_1_I]) || ( !boolState[S_OF_sB_1_I])) || ( !boolState[S_OF_sC_1_I])) || ( !boolState[S_OF_sD_1_I]) )
	{
		boolState[relevant_evt_OF_network_1]  =  true;
	}

	if (((( !boolState[S_OF_sA_2_I]) || ( !boolState[S_OF_sB_2_I])) || ( !boolState[S_OF_sC_2_I])) || ( !boolState[S_OF_sD_2_I]) )
	{
		boolState[relevant_evt_OF_network_2]  =  true;
	}

	if (((( !boolState[S_OF_sA_3_I]) || ( !boolState[S_OF_sB_3_I])) || ( !boolState[S_OF_sC_3_I])) || ( !boolState[S_OF_sD_3_I]) )
	{
		boolState[relevant_evt_OF_network_3]  =  true;
	}

	if (((( !boolState[S_OF_sA_4_I]) || ( !boolState[S_OF_sB_4_I])) || ( !boolState[S_OF_sC_4_I])) || ( !boolState[S_OF_sD_4_I]) )
	{
		boolState[relevant_evt_OF_network_4]  =  true;
	}

	if (((( !boolState[S_OF_sA_5_I]) || ( !boolState[S_OF_sB_5_I])) || ( !boolState[S_OF_sC_5_I])) || ( !boolState[S_OF_sD_5_I]) )
	{
...
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_rc_5_5_Trim_article_No_repair::fireinsttransitiongroup(std::string user_input_ins)
