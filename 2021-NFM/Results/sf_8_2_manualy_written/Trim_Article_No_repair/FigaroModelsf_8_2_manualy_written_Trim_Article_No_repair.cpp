#include <iostream>
#include "FigaroModelsf_8_2_manualy_written_Trim_Article_No_repair.h"
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::init()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_sf_8_2_manualy_written_Trim_Article_No_repair::fireinsttransitiongroup(std::string user_input_ins)
