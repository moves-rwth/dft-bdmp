#include <iostream>
#include "FigaroModelsf_8_2_manualy_written_No_trim_No_repair.h"
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::init()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_E1_1] == false) && boolState[required_OF_E1_1]) 
	{
	...
	if ((boolState[failF_OF_E1_2] == false) && boolState[required_OF_E1_2]) 
	{
	...
	if ((boolState[failF_OF_E1_3] == false) && boolState[required_OF_E1_3]) 
	{
	...
	if ((boolState[failF_OF_E1_4] == false) && boolState[required_OF_E1_4]) 
	{
	...
	if ((boolState[failF_OF_E1_5] == false) && boolState[required_OF_E1_5]) 
	{
	...
	if ((boolState[failF_OF_E1_6] == false) && boolState[required_OF_E1_6]) 
	{
	...
	if ((boolState[failF_OF_E1_7] == false) && boolState[required_OF_E1_7]) 
	{
	...
	if ((boolState[failF_OF_E1_8] == false) && boolState[required_OF_E1_8]) 
	{
	...
	if ((boolState[failF_OF_E2_1] == false) && boolState[required_OF_E2_1]) 
	{
	...
	if ((boolState[failF_OF_E2_2] == false) && boolState[required_OF_E2_2]) 
	{
	...
	if ((boolState[failF_OF_E2_3] == false) && boolState[required_OF_E2_3]) 
	{
	...
	if ((boolState[failF_OF_E2_4] == false) && boolState[required_OF_E2_4]) 
	{
	...
	if ((boolState[failF_OF_E2_5] == false) && boolState[required_OF_E2_5]) 
	{
	...
	if ((boolState[failF_OF_E2_6] == false) && boolState[required_OF_E2_6]) 
	{
	...
	if ((boolState[failF_OF_E2_7] == false) && boolState[required_OF_E2_7]) 
	{
	...
	if ((boolState[failF_OF_E2_8] == false) && boolState[required_OF_E2_8]) 
	{
	...
	if ((boolState[failF_OF_E3_1] == false) && boolState[required_OF_E3_1]) 
	{
	...
	if ((boolState[failF_OF_E3_2] == false) && boolState[required_OF_E3_2]) 
	{
	...
	if ((boolState[failF_OF_E3_3] == false) && boolState[required_OF_E3_3]) 
	{
	...
	if ((boolState[failF_OF_E3_4] == false) && boolState[required_OF_E3_4]) 
	{
	...
	if ((boolState[failF_OF_E3_5] == false) && boolState[required_OF_E3_5]) 
	{
	...
	if ((boolState[failF_OF_E3_6] == false) && boolState[required_OF_E3_6]) 
	{
	...
	if ((boolState[failF_OF_E3_7] == false) && boolState[required_OF_E3_7]) 
	{
	...
	if ((boolState[failF_OF_E3_8] == false) && boolState[required_OF_E3_8]) 
	{
	...
	if ((boolState[failF_OF_E4_1] == false) && boolState[required_OF_E4_1]) 
	{
	...
	if ((boolState[failF_OF_E4_2] == false) && boolState[required_OF_E4_2]) 
	{
	...
	if ((boolState[failF_OF_E4_3] == false) && boolState[required_OF_E4_3]) 
	{
	...
	if ((boolState[failF_OF_E4_4] == false) && boolState[required_OF_E4_4]) 
	{
	...
	if ((boolState[failF_OF_E4_5] == false) && boolState[required_OF_E4_5]) 
	{
	...
	if ((boolState[failF_OF_E4_6] == false) && boolState[required_OF_E4_6]) 
	{
	...
	if ((boolState[failF_OF_E4_7] == false) && boolState[required_OF_E4_7]) 
	{
	...
	if ((boolState[failF_OF_E4_8] == false) && boolState[required_OF_E4_8]) 
	{
	...
	if ((boolState[failF_OF_EC1_1] == false) && boolState[required_OF_EC1_1]) 
	{
	...
	if ((boolState[failF_OF_EC1_2] == false) && boolState[required_OF_EC1_2]) 
	{
	...
	if ((boolState[failF_OF_EC1_3] == false) && boolState[required_OF_EC1_3]) 
	{
	...
	if ((boolState[failF_OF_EC1_4] == false) && boolState[required_OF_EC1_4]) 
	{
	...
	if ((boolState[failF_OF_EC1_5] == false) && boolState[required_OF_EC1_5]) 
	{
	...
	if ((boolState[failF_OF_EC1_6] == false) && boolState[required_OF_EC1_6]) 
	{
	...
	if ((boolState[failF_OF_EC1_7] == false) && boolState[required_OF_EC1_7]) 
	{
	...
	if ((boolState[failF_OF_EC1_8] == false) && boolState[required_OF_EC1_8]) 
	{
	...
	if ((boolState[failF_OF_EC2_1] == false) && boolState[required_OF_EC2_1]) 
	{
	...
	if ((boolState[failF_OF_EC2_2] == false) && boolState[required_OF_EC2_2]) 
	{
	...
	if ((boolState[failF_OF_EC2_3] == false) && boolState[required_OF_EC2_3]) 
	{
	...
	if ((boolState[failF_OF_EC2_4] == false) && boolState[required_OF_EC2_4]) 
	{
	...
	if ((boolState[failF_OF_EC2_5] == false) && boolState[required_OF_EC2_5]) 
	{
	...
	if ((boolState[failF_OF_EC2_6] == false) && boolState[required_OF_EC2_6]) 
	{
	...
	if ((boolState[failF_OF_EC2_7] == false) && boolState[required_OF_EC2_7]) 
	{
	...
	if ((boolState[failF_OF_EC2_8] == false) && boolState[required_OF_EC2_8]) 
	{
	...
	if ((boolState[failF_OF_EC3_1] == false) && boolState[required_OF_EC3_1]) 
	{
	...
	if ((boolState[failF_OF_EC3_2] == false) && boolState[required_OF_EC3_2]) 
	{
	...
	if ((boolState[failF_OF_EC3_3] == false) && boolState[required_OF_EC3_3]) 
	{
	...
	if ((boolState[failF_OF_EC3_4] == false) && boolState[required_OF_EC3_4]) 
	{
	...
	if ((boolState[failF_OF_EC3_5] == false) && boolState[required_OF_EC3_5]) 
	{
	...
	if ((boolState[failF_OF_EC3_6] == false) && boolState[required_OF_EC3_6]) 
	{
	...
	if ((boolState[failF_OF_EC3_7] == false) && boolState[required_OF_EC3_7]) 
	{
	...
	if ((boolState[failF_OF_EC3_8] == false) && boolState[required_OF_EC3_8]) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_sf_8_2_manualy_written_No_trim_No_repair::fireinsttransitiongroup(std::string user_input_ins)
