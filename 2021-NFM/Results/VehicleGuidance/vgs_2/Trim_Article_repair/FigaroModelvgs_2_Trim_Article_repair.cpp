#include <iostream>
#include "FigaroModelvgs_2_Trim_Article_repair.h"
...
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::init()
{
	...
	FIRE_xx23_OF_i_A44_INS_137 = false;
	FIRE_xx23_OF_i_A44_INS_138 = false;
	FIRE_xx24_OF_i_A44 = false;
	FIRE_xx23_OF_i_A45_INS_140 = false;
	FIRE_xx23_OF_i_A45_INS_141 = false;
	FIRE_xx24_OF_i_A45 = false;
	FIRE_xx23_OF_i_A46_INS_143 = false;
	FIRE_xx23_OF_i_A46_INS_144 = false;
	FIRE_xx24_OF_i_A46 = false;
	FIRE_xx23_OF_i_A47_INS_146 = false;
	FIRE_xx23_OF_i_A47_INS_147 = false;
	FIRE_xx24_OF_i_A47 = false;
	FIRE_xx23_OF_i_A48_INS_149 = false;
	FIRE_xx23_OF_i_A48_INS_150 = false;
	FIRE_xx24_OF_i_A48 = false;
	FIRE_xx23_OF_i_A49_INS_152 = false;
	FIRE_xx23_OF_i_A49_INS_153 = false;
	...
	FIRE_xx23_OF_i_A57_INS_167 = false;
	FIRE_xx23_OF_i_A57_INS_168 = false;
	FIRE_xx24_OF_i_A57 = false;
	FIRE_xx23_OF_i_A58_INS_170 = false;
	FIRE_xx23_OF_i_A58_INS_171 = false;
	FIRE_xx24_OF_i_A58 = false;
	FIRE_xx23_OF_i_A59_INS_173 = false;
	FIRE_xx23_OF_i_A59_INS_174 = false;
	FIRE_xx24_OF_i_A59 = false;
	FIRE_xx23_OF_i_A60_INS_176 = false;
	FIRE_xx23_OF_i_A60_INS_177 = false;
...
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::printState()
{
...
bool storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 137)
	{
		FIRE_xx23_OF_i_A44_INS_137 = true;
	}

	if (numFire == 138)
	{
		FIRE_xx23_OF_i_A44_INS_138 = true;
	}
	...
	if (numFire == 140)
	{
		FIRE_xx23_OF_i_A45_INS_140 = true;
	}

	if (numFire == 141)
	{
		FIRE_xx23_OF_i_A45_INS_141 = true;
	}
	...
	if (numFire == 143)
	{
		FIRE_xx23_OF_i_A46_INS_143 = true;
	}

	if (numFire == 144)
	{
		FIRE_xx23_OF_i_A46_INS_144 = true;
	}
	...
	if (numFire == 146)
	{
		FIRE_xx23_OF_i_A47_INS_146 = true;
	}

	if (numFire == 147)
	{
		FIRE_xx23_OF_i_A47_INS_147 = true;
	}
	...
	if (numFire == 149)
	{
		FIRE_xx23_OF_i_A48_INS_149 = true;
	}

	if (numFire == 150)
	{
		FIRE_xx23_OF_i_A48_INS_150 = true;
	}
	...
	if (numFire == 152)
	{
		FIRE_xx23_OF_i_A49_INS_152 = true;
	}

	if (numFire == 153)
	{
		FIRE_xx23_OF_i_A49_INS_153 = true;
	}
	...
	if (numFire == 167)
	{
		FIRE_xx23_OF_i_A57_INS_167 = true;
	}

	if (numFire == 168)
	{
		FIRE_xx23_OF_i_A57_INS_168 = true;
	}
	...
	if (numFire == 170)
	{
		FIRE_xx23_OF_i_A58_INS_170 = true;
	}

	if (numFire == 171)
	{
		FIRE_xx23_OF_i_A58_INS_171 = true;
	}
	...
	if (numFire == 173)
	{
		FIRE_xx23_OF_i_A59_INS_173 = true;
	}

	if (numFire == 174)
	{
		FIRE_xx23_OF_i_A59_INS_174 = true;
	}
	...
	if (numFire == 176)
	{
		FIRE_xx23_OF_i_A60_INS_176 = true;
	}

	if (numFire == 177)
	{
		FIRE_xx23_OF_i_A60_INS_177 = true;
	}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::showFireableOccurrences()
{
	...
	{
		//cout << "134 :  INS_SUB_COUNT (1) |FAULT | failI  LABEL \"instantaneous failure i_A43\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A43]  =  TRUE,already_standby_OF_i_A43  =  FALSE,already_required_OF_i_A43  =  FALSE" << endl;
		list.push_back(make_tuple(134, 1, "INS", 1));
	}
	if ((boolState[failI_OF_i_A43] == false) && (boolState[to_be_fired_OF_i_A43] &&	boolState[relevant_evt_OF_i_A43]))
	{
		//cout << "135 :  INS_SUB_COUNT (1) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A43]  =  FALSE,already_required_OF_i_A43  =  FALSE" << endl;
		list.push_back(make_tuple(135, 0, "INS", 1));
	}
	if ((boolState[failI_OF_i_A44] == false) && (boolState[to_be_fired_OF_i_A44] &&	boolState[relevant_evt_OF_i_A44]))
	{
		//cout << "137 :  INS_SUB_COUNT (2) |FAULT | failI  LABEL \"instantaneous failure i_A44\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A44]  =  TRUE,already_standby_OF_i_A44  =  FALSE,already_required_OF_i_A44  =  FALSE" << endl;
		list.push_back(make_tuple(137, 1, "INS", 2));
	}
	if ((boolState[failI_OF_i_A44] == false) && (boolState[to_be_fired_OF_i_A44] &&	boolState[relevant_evt_OF_i_A44]))
	{
		//cout << "138 :  INS_SUB_COUNT (2) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A44]  =  FALSE,already_required_OF_i_A44  =  FALSE" << endl;
		list.push_back(make_tuple(138, 0, "INS", 2));
	}
	if ((boolState[failI_OF_i_A45] == false) && (boolState[to_be_fired_OF_i_A45] &&	boolState[relevant_evt_OF_i_A45]))
	{
		//cout << "140 :  INS_SUB_COUNT (3) |FAULT | failI  LABEL \"instantaneous failure i_A45\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A45]  =  TRUE,already_standby_OF_i_A45  =  FALSE,already_required_OF_i_A45  =  FALSE" << endl;
		list.push_back(make_tuple(140, 1, "INS", 3));
	}
	if ((boolState[failI_OF_i_A45] == false) && (boolState[to_be_fired_OF_i_A45] &&	boolState[relevant_evt_OF_i_A45]))
	{
		//cout << "141 :  INS_SUB_COUNT (3) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A45]  =  FALSE,already_required_OF_i_A45  =  FALSE" << endl;
		list.push_back(make_tuple(141, 0, "INS", 3));
	}
	if ((boolState[failI_OF_i_A46] == false) && (boolState[to_be_fired_OF_i_A46] &&	boolState[relevant_evt_OF_i_A46]))
	{
		//cout << "143 :  INS_SUB_COUNT (4) |FAULT | failI  LABEL \"instantaneous failure i_A46\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A46]  =  TRUE,already_standby_OF_i_A46  =  FALSE,already_required_OF_i_A46  =  FALSE" << endl;
		list.push_back(make_tuple(143, 1, "INS", 4));
	}
	if ((boolState[failI_OF_i_A46] == false) && (boolState[to_be_fired_OF_i_A46] &&	boolState[relevant_evt_OF_i_A46]))
	{
		//cout << "144 :  INS_SUB_COUNT (4) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A46]  =  FALSE,already_required_OF_i_A46  =  FALSE" << endl;
		list.push_back(make_tuple(144, 0, "INS", 4));
	}
	if ((boolState[failI_OF_i_A47] == false) && (boolState[to_be_fired_OF_i_A47] &&	boolState[relevant_evt_OF_i_A47]))
	{
		//cout << "146 :  INS_SUB_COUNT (5) |FAULT | failI  LABEL \"instantaneous failure i_A47\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A47]  =  TRUE,already_standby_OF_i_A47  =  FALSE,already_required_OF_i_A47  =  FALSE" << endl;
		list.push_back(make_tuple(146, 1, "INS", 5));
	}
	if ((boolState[failI_OF_i_A47] == false) && (boolState[to_be_fired_OF_i_A47] &&	boolState[relevant_evt_OF_i_A47]))
	{
		//cout << "147 :  INS_SUB_COUNT (5) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A47]  =  FALSE,already_required_OF_i_A47  =  FALSE" << endl;
		list.push_back(make_tuple(147, 0, "INS", 5));
	}
	if ((boolState[failI_OF_i_A48] == false) && (boolState[to_be_fired_OF_i_A48] &&	boolState[relevant_evt_OF_i_A48]))
	{
		//cout << "149 :  INS_SUB_COUNT (6) |FAULT | failI  LABEL \"instantaneous failure i_A48\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A48]  =  TRUE,already_standby_OF_i_A48  =  FALSE,already_required_OF_i_A48  =  FALSE" << endl;
		list.push_back(make_tuple(149, 1, "INS", 6));
	}
	if ((boolState[failI_OF_i_A48] == false) && (boolState[to_be_fired_OF_i_A48] &&	boolState[relevant_evt_OF_i_A48]))
	{
		//cout << "150 :  INS_SUB_COUNT (6) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A48]  =  FALSE,already_required_OF_i_A48  =  FALSE" << endl;
		list.push_back(make_tuple(150, 0, "INS", 6));
	}
	if ((boolState[failI_OF_i_A49] == false) && (boolState[to_be_fired_OF_i_A49] &&	boolState[relevant_evt_OF_i_A49]))
	{
		//cout << "152 :  INS_SUB_COUNT (7) |FAULT | failI  LABEL \"instantaneous failure i_A49\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A49]  =  TRUE,already_standby_OF_i_A49  =  FALSE,already_required_OF_i_A49  =  FALSE" << endl;
		list.push_back(make_tuple(152, 1, "INS", 7));
	}
	if ((boolState[failI_OF_i_A49] == false) && (boolState[to_be_fired_OF_i_A49] &&	boolState[relevant_evt_OF_i_A49]))
	{
		//cout << "153 :  INS_SUB_COUNT (7) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A49]  =  FALSE,already_required_OF_i_A49  =  FALSE" << endl;
		list.push_back(make_tuple(153, 0, "INS", 7));
	}
	if ((boolState[failI_OF_i_A51] == false) && (boolState[to_be_fired_OF_i_A51] &&	boolState[relevant_evt_OF_i_A51]))
	{
		//cout << "155 :  INS_SUB_COUNT (8) |FAULT | failI  LABEL \"instantaneous failure i_A51\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A51]  =  TRUE,already_standby_OF_i_A51  =  FALSE,already_required_OF_i_A51  =  FALSE" << endl;
		list.push_back(make_tuple(155, 1, "INS", 8));
	}
	if ((boolState[failI_OF_i_A51] == false) && (boolState[to_be_fired_OF_i_A51] &&	boolState[relevant_evt_OF_i_A51]))
	{
		//cout << "156 :  INS_SUB_COUNT (8) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A51]  =  FALSE,already_required_OF_i_A51  =  FALSE" << endl;
		list.push_back(make_tuple(156, 0, "INS", 8));
	}
	if ((boolState[failI_OF_i_A52] == false) && (boolState[to_be_fired_OF_i_A52] &&	boolState[relevant_evt_OF_i_A52]))
	{
		//cout << "158 :  INS_SUB_COUNT (9) |FAULT | failI  LABEL \"instantaneous failure i_A52\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A52]  =  TRUE,already_standby_OF_i_A52  =  FALSE,already_required_OF_i_A52  =  FALSE" << endl;
		list.push_back(make_tuple(158, 1, "INS", 9));
	}
	if ((boolState[failI_OF_i_A52] == false) && (boolState[to_be_fired_OF_i_A52] &&	boolState[relevant_evt_OF_i_A52]))
	{
		//cout << "159 :  INS_SUB_COUNT (9) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A52]  =  FALSE,already_required_OF_i_A52  =  FALSE" << endl;
		list.push_back(make_tuple(159, 0, "INS", 9));
	}
	if ((boolState[failI_OF_i_A54] == false) && (boolState[to_be_fired_OF_i_A54] &&	boolState[relevant_evt_OF_i_A54]))
	{
		//cout << "161 :  INS_SUB_COUNT (10) |FAULT | failI  LABEL \"instantaneous failure i_A54\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A54]  =  TRUE,already_standby_OF_i_A54  =  FALSE,already_required_OF_i_A54  =  FALSE" << endl;
		list.push_back(make_tuple(161, 1, "INS", 10));
	}
	if ((boolState[failI_OF_i_A54] == false) && (boolState[to_be_fired_OF_i_A54] &&	boolState[relevant_evt_OF_i_A54]))
	{
		//cout << "162 :  INS_SUB_COUNT (10) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A54]  =  FALSE,already_required_OF_i_A54  =  FALSE" << endl;
		list.push_back(make_tuple(162, 0, "INS", 10));
	}
	if ((boolState[failI_OF_i_A55] == false) && (boolState[to_be_fired_OF_i_A55] &&	boolState[relevant_evt_OF_i_A55]))
	{
		//cout << "164 :  INS_SUB_COUNT (11) |FAULT | failI  LABEL \"instantaneous failure i_A55\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A55]  =  TRUE,already_standby_OF_i_A55  =  FALSE,already_required_OF_i_A55  =  FALSE" << endl;
		list.push_back(make_tuple(164, 1, "INS", 11));
	}
	if ((boolState[failI_OF_i_A55] == false) && (boolState[to_be_fired_OF_i_A55] &&	boolState[relevant_evt_OF_i_A55]))
	{
		//cout << "165 :  INS_SUB_COUNT (11) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A55]  =  FALSE,already_required_OF_i_A55  =  FALSE" << endl;
		list.push_back(make_tuple(165, 0, "INS", 11));
	}
	if ((boolState[failI_OF_i_A57] == false) && (boolState[to_be_fired_OF_i_A57] &&	boolState[relevant_evt_OF_i_A57]))
	{
		//cout << "167 :  INS_SUB_COUNT (12) |FAULT | failI  LABEL \"instantaneous failure i_A57\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A57]  =  TRUE,already_standby_OF_i_A57  =  FALSE,already_required_OF_i_A57  =  FALSE" << endl;
		list.push_back(make_tuple(167, 1, "INS", 12));
	}
	if ((boolState[failI_OF_i_A57] == false) && (boolState[to_be_fired_OF_i_A57] &&	boolState[relevant_evt_OF_i_A57]))
	{
		//cout << "168 :  INS_SUB_COUNT (12) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A57]  =  FALSE,already_required_OF_i_A57  =  FALSE" << endl;
		list.push_back(make_tuple(168, 0, "INS", 12));
	}
	if ((boolState[failI_OF_i_A58] == false) && (boolState[to_be_fired_OF_i_A58] &&	boolState[relevant_evt_OF_i_A58]))
	{
		//cout << "170 :  INS_SUB_COUNT (13) |FAULT | failI  LABEL \"instantaneous failure i_A58\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A58]  =  TRUE,already_standby_OF_i_A58  =  FALSE,already_required_OF_i_A58  =  FALSE" << endl;
		list.push_back(make_tuple(170, 1, "INS", 13));
	}
	if ((boolState[failI_OF_i_A58] == false) && (boolState[to_be_fired_OF_i_A58] &&	boolState[relevant_evt_OF_i_A58]))
	{
		//cout << "171 :  INS_SUB_COUNT (13) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A58]  =  FALSE,already_required_OF_i_A58  =  FALSE" << endl;
		list.push_back(make_tuple(171, 0, "INS", 13));
	}
	if ((boolState[failI_OF_i_A59] == false) && (boolState[to_be_fired_OF_i_A59] &&	boolState[relevant_evt_OF_i_A59]))
	{
		//cout << "173 :  INS_SUB_COUNT (14) |FAULT | failI  LABEL \"instantaneous failure i_A59\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A59]  =  TRUE,already_standby_OF_i_A59  =  FALSE,already_required_OF_i_A59  =  FALSE" << endl;
		list.push_back(make_tuple(173, 1, "INS", 14));
	}
	if ((boolState[failI_OF_i_A59] == false) && (boolState[to_be_fired_OF_i_A59] &&	boolState[relevant_evt_OF_i_A59]))
	{
		//cout << "174 :  INS_SUB_COUNT (14) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A59]  =  FALSE,already_required_OF_i_A59  =  FALSE" << endl;
		list.push_back(make_tuple(174, 0, "INS", 14));
	}
	if ((boolState[failI_OF_i_A60] == false) && (boolState[to_be_fired_OF_i_A60] &&	boolState[relevant_evt_OF_i_A60]))
	{
		//cout << "176 :  INS_SUB_COUNT (15) |FAULT | failI  LABEL \"instantaneous failure i_A60\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A60]  =  TRUE,already_standby_OF_i_A60  =  FALSE,already_required_OF_i_A60  =  FALSE" << endl;
		list.push_back(make_tuple(176, 1, "INS", 15));
	}
	if ((boolState[failI_OF_i_A60] == false) && (boolState[to_be_fired_OF_i_A60] &&	boolState[relevant_evt_OF_i_A60]))
	{
		//cout << "177 :  INS_SUB_COUNT (15) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A60]  =  FALSE,already_required_OF_i_A60  =  FALSE" << endl;
		list.push_back(make_tuple(177, 0, "INS", 15));
	}
	if ((boolState[failI_OF_i_A61] == false) && (boolState[to_be_fired_OF_i_A61] &&	boolState[relevant_evt_OF_i_A61]))
	{
		//cout << "179 :  INS_SUB_COUNT (16) |FAULT | failI  LABEL \"instantaneous failure i_A61\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A61]  =  TRUE,already_standby_OF_i_A61  =  FALSE,already_required_OF_i_A61  =  FALSE" << endl;
		list.push_back(make_tuple(179, 1, "INS", 16));
	}
	if ((boolState[failI_OF_i_A61] == false) && (boolState[to_be_fired_OF_i_A61] &&	boolState[relevant_evt_OF_i_A61]))
	{
		//cout << "180 :  INS_SUB_COUNT (16) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A61]  =  FALSE,already_required_OF_i_A61  =  FALSE" << endl;
		list.push_back(make_tuple(180, 0, "INS", 16));
	}
	if ((boolState[failI_OF_i_A62] == false) && (boolState[to_be_fired_OF_i_A62] &&	boolState[relevant_evt_OF_i_A62]))
	{
		//cout << "182 :  INS_SUB_COUNT (17) |FAULT | failI  LABEL \"instantaneous failure i_A62\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A62]  =  TRUE,already_standby_OF_i_A62  =  FALSE,already_required_OF_i_A62  =  FALSE" << endl;
		list.push_back(make_tuple(182, 1, "INS", 17));
	}
	if ((boolState[failI_OF_i_A62] == false) && (boolState[to_be_fired_OF_i_A62] &&	boolState[relevant_evt_OF_i_A62]))
	{
		//cout << "183 :  INS_SUB_COUNT (17) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A62]  =  FALSE,already_required_OF_i_A62  =  FALSE" << endl;
		list.push_back(make_tuple(183, 0, "INS", 17));
	}
	if ((boolState[failI_OF_i_A63] == false) && (boolState[to_be_fired_OF_i_A63] &&	boolState[relevant_evt_OF_i_A63]))
	{
		//cout << "185 :  INS_SUB_COUNT (18) |FAULT | failI  LABEL \"instantaneous failure i_A63\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A63]  =  TRUE,already_standby_OF_i_A63  =  FALSE,already_required_OF_i_A63  =  FALSE" << endl;
		list.push_back(make_tuple(185, 1, "INS", 18));
	}
	if ((boolState[failI_OF_i_A63] == false) && (boolState[to_be_fired_OF_i_A63] &&	boolState[relevant_evt_OF_i_A63]))
	{
		//cout << "186 :  INS_SUB_COUNT (18) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A63]  =  FALSE,already_required_OF_i_A63  =  FALSE" << endl;
		list.push_back(make_tuple(186, 0, "INS", 18));
	}
	if ((boolState[failI_OF_i_A64] == false) && (boolState[to_be_fired_OF_i_A64] &&	boolState[relevant_evt_OF_i_A64]))
	{
		//cout << "188 :  INS_SUB_COUNT (19) |FAULT | failI  LABEL \"instantaneous failure i_A64\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A64]  =  TRUE,already_standby_OF_i_A64  =  FALSE,already_required_OF_i_A64  =  FALSE" << endl;
		list.push_back(make_tuple(188, 1, "INS", 19));
	}
	if ((boolState[failI_OF_i_A64] == false) && (boolState[to_be_fired_OF_i_A64] &&	boolState[relevant_evt_OF_i_A64]))
	{
		//cout << "189 :  INS_SUB_COUNT (19) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A64]  =  FALSE,already_required_OF_i_A64  =  FALSE" << endl;
		list.push_back(make_tuple(189, 0, "INS", 19));
	}
	if ((boolState[failI_OF_i_A65] == false) && (boolState[to_be_fired_OF_i_A65] &&	boolState[relevant_evt_OF_i_A65]))
	{
		//cout << "191 :  INS_SUB_COUNT (20) |FAULT | failI  LABEL \"instantaneous failure i_A65\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A65]  =  TRUE,already_standby_OF_i_A65  =  FALSE,already_required_OF_i_A65  =  FALSE" << endl;
		list.push_back(make_tuple(191, 1, "INS", 20));
	}
	if ((boolState[failI_OF_i_A65] == false) && (boolState[to_be_fired_OF_i_A65] &&	boolState[relevant_evt_OF_i_A65]))
	{
		//cout << "192 :  INS_SUB_COUNT (20) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A65]  =  FALSE,already_required_OF_i_A65  =  FALSE" << endl;
		list.push_back(make_tuple(192, 0, "INS", 20));
	}
	if ((boolState[failI_OF_i_A66] == false) && (boolState[to_be_fired_OF_i_A66] &&	boolState[relevant_evt_OF_i_A66]))
	{
		//cout << "194 :  INS_SUB_COUNT (21) |FAULT | failI  LABEL \"instantaneous failure i_A66\" | DIST INS (1) | INDUCING boolState[failI_OF_i_A66]  =  TRUE,already_standby_OF_i_A66  =  FALSE,already_required_OF_i_A66  =  FALSE" << endl;
		list.push_back(make_tuple(194, 1, "INS", 21));
	}
	if ((boolState[failI_OF_i_A66] == false) && (boolState[to_be_fired_OF_i_A66] &&	boolState[relevant_evt_OF_i_A66]))
	{
		//cout << "195 :  INS_SUB_COUNT (21) |TRANSITION | good | DIST INS (0) | INDUCING boolState[already_standby_OF_i_A66]  =  FALSE,already_required_OF_i_A66  =  FALSE" << endl;
		list.push_back(make_tuple(195, 0, "INS", 21));
	}
        if (list.size() > 0)
        {
	...
	if ((boolState[failF_OF_A119] == false) && (boolState[required_OF_A119] && boolState[relevant_evt_OF_A119]))
	{
		//cout << "22 : xx10_OF_A119 : FAULT failF  LABEL \"failure in operation A119\"  DIST EXP (9.9e-06)  INDUCING boolState[failF_OF_A119]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_A120] == false) && (boolState[required_OF_A120] && boolState[relevant_evt_OF_A120]))
	{
		//cout << "24 : xx10_OF_A120 : FAULT failF  LABEL \"failure in operation A120\"  DIST EXP (1e-07)  INDUCING boolState[failF_OF_A120]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_A121] == false) && (boolState[required_OF_A121] && boolState[relevant_evt_OF_A121]))
	{
		//cout << "26 : xx10_OF_A121 : FAULT failF  LABEL \"failure in operation A121\"  DIST EXP (1e-06)  INDUCING boolState[failF_OF_A121]  =  TRUE" << endl;
		list.push_back(make_tuple(26, 1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_A121] == true)
	{
		//cout << "27 : xx11_OF_A121 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A121]  =  FALSE" << endl;
		list.push_back(make_tuple(27, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A124] == false) && (boolState[required_OF_A124] && boolState[relevant_evt_OF_A124]))
	{
		//cout << "28 : xx10_OF_A124 : FAULT failF  LABEL \"failure in operation A124\"  DIST EXP (9.9e-07)  INDUCING boolState[failF_OF_A124]  =  TRUE" << endl;
	...
	if ((boolState[failF_OF_A125] == false) && (boolState[required_OF_A125] && boolState[relevant_evt_OF_A125]))
	{
		//cout << "30 : xx10_OF_A125 : FAULT failF  LABEL \"failure in operation A125\"  DIST EXP (1e-08)  INDUCING boolState[failF_OF_A125]  =  TRUE" << endl;
		list.push_back(make_tuple(30, 1e-08, "EXP", 0));
	}
	if (boolState[failF_OF_A125] == true)
	{
	...
	if ((boolState[failF_OF_A126] == false) && (boolState[required_OF_A126] && boolState[relevant_evt_OF_A126]))
	{
		//cout << "32 : xx10_OF_A126 : FAULT failF  LABEL \"failure in operation A126\"  DIST EXP (1e-06)  INDUCING boolState[failF_OF_A126]  =  TRUE" << endl;
		list.push_back(make_tuple(32, 1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_A126] == true)
	{
		//cout << "33 : xx11_OF_A126 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A126]  =  FALSE" << endl;
	...
	if ((boolState[failF_OF_A16] == false) && (boolState[required_OF_A16] && boolState[relevant_evt_OF_A16]))
	{
		//cout << "36 : xx10_OF_A16 : FAULT failF  LABEL \"failure in operation A16\"  DIST EXP (0)  INDUCING boolState[failF_OF_A16]  =  TRUE" << endl;
		list.push_back(make_tuple(36, 0, "EXP", 0));
	}
	if (boolState[failF_OF_A16] == true)
	{
		//cout << "37 : xx11_OF_A16 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A16]  =  FALSE" << endl;
		list.push_back(make_tuple(37, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A19] == false) && (boolState[required_OF_A19] && boolState[relevant_evt_OF_A19]))
	{
		//cout << "38 : xx10_OF_A19 : FAULT failF  LABEL \"failure in operation A19\"  DIST EXP (0)  INDUCING boolState[failF_OF_A19]  =  TRUE" << endl;
		list.push_back(make_tuple(38, 0, "EXP", 0));
	}
	if (boolState[failF_OF_A19] == true)
	{
		//cout << "39 : xx11_OF_A19 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A19]  =  FALSE" << endl;
		list.push_back(make_tuple(39, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A22] == false) && (boolState[required_OF_A22] && boolState[relevant_evt_OF_A22]))
	{
		//cout << "40 : xx10_OF_A22 : FAULT failF  LABEL \"failure in operation A22\"  DIST EXP (0)  INDUCING boolState[failF_OF_A22]  =  TRUE" << endl;
		list.push_back(make_tuple(40, 0, "EXP", 0));
	}
	if (boolState[failF_OF_A22] == true)
	{
		//cout << "41 : xx11_OF_A22 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A22]  =  FALSE" << endl;
		list.push_back(make_tuple(41, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A25] == false) && (boolState[required_OF_A25] && boolState[relevant_evt_OF_A25]))
	{
		//cout << "42 : xx10_OF_A25 : FAULT failF  LABEL \"failure in operation A25\"  DIST EXP (0)  INDUCING boolState[failF_OF_A25]  =  TRUE" << endl;
		list.push_back(make_tuple(42, 0, "EXP", 0));
	}
	if (boolState[failF_OF_A25] == true)
	{
		//cout << "43 : xx11_OF_A25 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A25]  =  FALSE" << endl;
		list.push_back(make_tuple(43, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A28] == false) && (boolState[required_OF_A28] && boolState[relevant_evt_OF_A28]))
	{
		//cout << "44 : xx10_OF_A28 : FAULT failF  LABEL \"failure in operation A28\"  DIST EXP (1e-07)  INDUCING boolState[failF_OF_A28]  =  TRUE" << endl;
		list.push_back(make_tuple(44, 1e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A28] == true)
	{
		//cout << "45 : xx11_OF_A28 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A28]  =  FALSE" << endl;
		list.push_back(make_tuple(45, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A29] == false) && (boolState[required_OF_A29] && boolState[relevant_evt_OF_A29]))
	{
		//cout << "46 : xx10_OF_A29 : FAULT failF  LABEL \"failure in operation A29\"  DIST EXP (1e-07)  INDUCING boolState[failF_OF_A29]  =  TRUE" << endl;
		list.push_back(make_tuple(46, 1e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A29] == true)
	{
		//cout << "47 : xx11_OF_A29 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A29]  =  FALSE" << endl;
		list.push_back(make_tuple(47, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A33] == false) && (boolState[required_OF_A33] && boolState[relevant_evt_OF_A33]))
	{
		//cout << "48 : xx10_OF_A33 : FAULT failF  LABEL \"failure in operation A33\"  DIST EXP (2e-07)  INDUCING boolState[failF_OF_A33]  =  TRUE" << endl;
		list.push_back(make_tuple(48, 2e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A33] == true)
	{
		//cout << "49 : xx11_OF_A33 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A33]  =  FALSE" << endl;
		list.push_back(make_tuple(49, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A36] == false) && (boolState[required_OF_A36] && boolState[relevant_evt_OF_A36]))
	{
		//cout << "50 : xx10_OF_A36 : FAULT failF  LABEL \"failure in operation A36\"  DIST EXP (2e-07)  INDUCING boolState[failF_OF_A36]  =  TRUE" << endl;
		list.push_back(make_tuple(50, 2e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A36] == true)
	{
		//cout << "51 : xx11_OF_A36 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A36]  =  FALSE" << endl;
		list.push_back(make_tuple(51, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A39] == false) && (boolState[required_OF_A39] && boolState[relevant_evt_OF_A39]))
	{
		//cout << "52 : xx10_OF_A39 : FAULT failF  LABEL \"failure in operation A39\"  DIST EXP (2e-07)  INDUCING boolState[failF_OF_A39]  =  TRUE" << endl;
		list.push_back(make_tuple(52, 2e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A39] == true)
	{
		//cout << "53 : xx11_OF_A39 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A39]  =  FALSE" << endl;
		list.push_back(make_tuple(53, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A4] == false) && (boolState[required_OF_A4] && boolState[relevant_evt_OF_A4]))
	{
		//cout << "54 : xx10_OF_A4 : FAULT failF  LABEL \"failure in operation A4\"  DIST EXP (0)  INDUCING boolState[failF_OF_A4]  =  TRUE" << endl;
		list.push_back(make_tuple(54, 0, "EXP", 0));
	}
	if (boolState[failF_OF_A4] == true)
	{
		//cout << "55 : xx11_OF_A4 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A4]  =  FALSE" << endl;
		list.push_back(make_tuple(55, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A67] == false) && (boolState[required_OF_A67] && boolState[relevant_evt_OF_A67]))
	{
		//cout << "56 : xx10_OF_A67 : FAULT failF  LABEL \"failure in operation A67\"  DIST EXP (1e-07)  INDUCING boolState[failF_OF_A67]  =  TRUE" << endl;
		list.push_back(make_tuple(56, 1e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A67] == true)
	{
		//cout << "57 : xx11_OF_A67 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A67]  =  FALSE" << endl;
		list.push_back(make_tuple(57, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A68] == false) && (boolState[required_OF_A68] && boolState[relevant_evt_OF_A68]))
	{
		//cout << "58 : xx10_OF_A68 : FAULT failF  LABEL \"failure in operation A68\"  DIST EXP (1e-07)  INDUCING boolState[failF_OF_A68]  =  TRUE" << endl;
		list.push_back(make_tuple(58, 1e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A68] == true)
	{
		//cout << "59 : xx11_OF_A68 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A68]  =  FALSE" << endl;
		list.push_back(make_tuple(59, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A7] == false) && (boolState[required_OF_A7] && boolState[relevant_evt_OF_A7]))
	{
		//cout << "60 : xx10_OF_A7 : FAULT failF  LABEL \"failure in operation A7\"  DIST EXP (0)  INDUCING boolState[failF_OF_A7]  =  TRUE" << endl;
		list.push_back(make_tuple(60, 0, "EXP", 0));
	}
	if (boolState[failF_OF_A7] == true)
	{
		//cout << "61 : xx11_OF_A7 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A7]  =  FALSE" << endl;
		list.push_back(make_tuple(61, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A75] == false) && (boolState[required_OF_A75] && boolState[relevant_evt_OF_A75]))
	{
		//cout << "62 : xx10_OF_A75 : FAULT failF  LABEL \"failure in operation A75\"  DIST EXP (9.9e-06)  INDUCING boolState[failF_OF_A75]  =  TRUE" << endl;
		list.push_back(make_tuple(62, 9.9e-06, "EXP", 0));
	}
	if (boolState[failF_OF_A75] == true)
	{
		//cout << "63 : xx11_OF_A75 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A75]  =  FALSE" << endl;
		list.push_back(make_tuple(63, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A76] == false) && (boolState[required_OF_A76] && boolState[relevant_evt_OF_A76]))
	{
		//cout << "64 : xx10_OF_A76 : FAULT failF  LABEL \"failure in operation A76\"  DIST EXP (1e-07)  INDUCING boolState[failF_OF_A76]  =  TRUE" << endl;
		list.push_back(make_tuple(64, 1e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A76] == true)
	{
		//cout << "65 : xx11_OF_A76 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A76]  =  FALSE" << endl;
		list.push_back(make_tuple(65, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A77] == false) && (boolState[required_OF_A77] && boolState[relevant_evt_OF_A77]))
	{
		//cout << "66 : xx10_OF_A77 : FAULT failF  LABEL \"failure in operation A77\"  DIST EXP (1e-06)  INDUCING boolState[failF_OF_A77]  =  TRUE" << endl;
		list.push_back(make_tuple(66, 1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_A77] == true)
	{
		//cout << "67 : xx11_OF_A77 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A77]  =  FALSE" << endl;
		list.push_back(make_tuple(67, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A80] == false) && (boolState[required_OF_A80] && boolState[relevant_evt_OF_A80]))
	{
		//cout << "68 : xx10_OF_A80 : FAULT failF  LABEL \"failure in operation A80\"  DIST EXP (9.9e-07)  INDUCING boolState[failF_OF_A80]  =  TRUE" << endl;
		list.push_back(make_tuple(68, 9.9e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A80] == true)
	{
		//cout << "69 : xx11_OF_A80 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A80]  =  FALSE" << endl;
		list.push_back(make_tuple(69, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A81] == false) && (boolState[required_OF_A81] && boolState[relevant_evt_OF_A81]))
	{
		//cout << "70 : xx10_OF_A81 : FAULT failF  LABEL \"failure in operation A81\"  DIST EXP (1e-08)  INDUCING boolState[failF_OF_A81]  =  TRUE" << endl;
		list.push_back(make_tuple(70, 1e-08, "EXP", 0));
	}
	if (boolState[failF_OF_A81] == true)
	{
		//cout << "71 : xx11_OF_A81 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A81]  =  FALSE" << endl;
		list.push_back(make_tuple(71, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A82] == false) && (boolState[required_OF_A82] && boolState[relevant_evt_OF_A82]))
	{
		//cout << "72 : xx10_OF_A82 : FAULT failF  LABEL \"failure in operation A82\"  DIST EXP (1e-06)  INDUCING boolState[failF_OF_A82]  =  TRUE" << endl;
		list.push_back(make_tuple(72, 1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_A82] == true)
	{
		//cout << "73 : xx11_OF_A82 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A82]  =  FALSE" << endl;
		list.push_back(make_tuple(73, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A86] == false) && (boolState[required_OF_A86] && boolState[relevant_evt_OF_A86]))
	{
		//cout << "74 : xx10_OF_A86 : FAULT failF  LABEL \"failure in operation A86\"  DIST EXP (9.9e-06)  INDUCING boolState[failF_OF_A86]  =  TRUE" << endl;
		list.push_back(make_tuple(74, 9.9e-06, "EXP", 0));
	}
	if (boolState[failF_OF_A86] == true)
	{
		//cout << "75 : xx11_OF_A86 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A86]  =  FALSE" << endl;
		list.push_back(make_tuple(75, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A87] == false) && (boolState[required_OF_A87] && boolState[relevant_evt_OF_A87]))
	{
		//cout << "76 : xx10_OF_A87 : FAULT failF  LABEL \"failure in operation A87\"  DIST EXP (1e-07)  INDUCING boolState[failF_OF_A87]  =  TRUE" << endl;
		list.push_back(make_tuple(76, 1e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A87] == true)
	{
		//cout << "77 : xx11_OF_A87 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A87]  =  FALSE" << endl;
		list.push_back(make_tuple(77, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A88] == false) && (boolState[required_OF_A88] && boolState[relevant_evt_OF_A88]))
	{
		//cout << "78 : xx10_OF_A88 : FAULT failF  LABEL \"failure in operation A88\"  DIST EXP (1e-06)  INDUCING boolState[failF_OF_A88]  =  TRUE" << endl;
		list.push_back(make_tuple(78, 1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_A88] == true)
	{
		//cout << "79 : xx11_OF_A88 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A88]  =  FALSE" << endl;
		list.push_back(make_tuple(79, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A91] == false) && (boolState[required_OF_A91] && boolState[relevant_evt_OF_A91]))
	{
		//cout << "80 : xx10_OF_A91 : FAULT failF  LABEL \"failure in operation A91\"  DIST EXP (9.9e-07)  INDUCING boolState[failF_OF_A91]  =  TRUE" << endl;
		list.push_back(make_tuple(80, 9.9e-07, "EXP", 0));
	}
	if (boolState[failF_OF_A91] == true)
	{
		//cout << "81 : xx11_OF_A91 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A91]  =  FALSE" << endl;
		list.push_back(make_tuple(81, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A92] == false) && (boolState[required_OF_A92] && boolState[relevant_evt_OF_A92]))
	{
		//cout << "82 : xx10_OF_A92 : FAULT failF  LABEL \"failure in operation A92\"  DIST EXP (1e-08)  INDUCING boolState[failF_OF_A92]  =  TRUE" << endl;
		list.push_back(make_tuple(82, 1e-08, "EXP", 0));
	}
	if (boolState[failF_OF_A92] == true)
	{
		//cout << "83 : xx11_OF_A92 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A92]  =  FALSE" << endl;
		list.push_back(make_tuple(83, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A93] == false) && (boolState[required_OF_A93] && boolState[relevant_evt_OF_A93]))
	{
		//cout << "84 : xx10_OF_A93 : FAULT failF  LABEL \"failure in operation A93\"  DIST EXP (1e-06)  INDUCING boolState[failF_OF_A93]  =  TRUE" << endl;
		list.push_back(make_tuple(84, 1e-06, "EXP", 0));
	}
	if (boolState[failF_OF_A93] == true)
	{
		//cout << "85 : xx11_OF_A93 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A93]  =  FALSE" << endl;
		list.push_back(make_tuple(85, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A97] == false) && (boolState[required_OF_A97] && boolState[relevant_evt_OF_A97]))
	{
		//cout << "86 : xx10_OF_A97 : FAULT failF  LABEL \"failure in operation A97\"  DIST EXP (6e-05)  INDUCING boolState[failF_OF_A97]  =  TRUE" << endl;
		list.push_back(make_tuple(86, 6e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A97] == true)
	{
		//cout << "87 : xx11_OF_A97 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A97]  =  FALSE" << endl;
		list.push_back(make_tuple(87, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A98] == false) && (boolState[required_OF_A98] && boolState[relevant_evt_OF_A98]))
	{
		//cout << "88 : xx10_OF_A98 : FAULT failF  LABEL \"failure in operation A98\"  DIST EXP (4e-05)  INDUCING boolState[failF_OF_A98]  =  TRUE" << endl;
		list.push_back(make_tuple(88, 4e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A98] == true)
	{
		//cout << "89 : xx11_OF_A98 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A98]  =  FALSE" << endl;
		list.push_back(make_tuple(89, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_A99] == false) && (boolState[required_OF_A99] && boolState[relevant_evt_OF_A99]))
	{
		//cout << "90 : xx10_OF_A99 : FAULT failF  LABEL \"failure in operation A99\"  DIST EXP (1e-05)  INDUCING boolState[failF_OF_A99]  =  TRUE" << endl;
		list.push_back(make_tuple(90, 1e-05, "EXP", 0));
	}
	if (boolState[failF_OF_A99] == true)
	{
		//cout << "91 : xx11_OF_A99 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_A99]  =  FALSE" << endl;
		list.push_back(make_tuple(91, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A43] == false) && (boolState[required_OF_f_A43] && boolState[relevant_evt_OF_f_A43]))
	{
		//cout << "92 : xx10_OF_f_A43 : FAULT failF  LABEL \"failure in operation f_A43\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A43]  =  TRUE" << endl;
		list.push_back(make_tuple(92, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A43] == true)
	{
		//cout << "93 : xx11_OF_f_A43 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A43]  =  FALSE" << endl;
		list.push_back(make_tuple(93, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A44] == false) && (boolState[required_OF_f_A44] && boolState[relevant_evt_OF_f_A44]))
	{
		//cout << "94 : xx10_OF_f_A44 : FAULT failF  LABEL \"failure in operation f_A44\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A44]  =  TRUE" << endl;
		list.push_back(make_tuple(94, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A44] == true)
	{
		//cout << "95 : xx11_OF_f_A44 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A44]  =  FALSE" << endl;
		list.push_back(make_tuple(95, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A45] == false) && (boolState[required_OF_f_A45] && boolState[relevant_evt_OF_f_A45]))
	{
		//cout << "96 : xx10_OF_f_A45 : FAULT failF  LABEL \"failure in operation f_A45\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A45]  =  TRUE" << endl;
		list.push_back(make_tuple(96, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A45] == true)
	{
		//cout << "97 : xx11_OF_f_A45 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A45]  =  FALSE" << endl;
		list.push_back(make_tuple(97, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A46] == false) && (boolState[required_OF_f_A46] && boolState[relevant_evt_OF_f_A46]))
	{
		//cout << "98 : xx10_OF_f_A46 : FAULT failF  LABEL \"failure in operation f_A46\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A46]  =  TRUE" << endl;
		list.push_back(make_tuple(98, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A46] == true)
	{
		//cout << "99 : xx11_OF_f_A46 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A46]  =  FALSE" << endl;
		list.push_back(make_tuple(99, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A47] == false) && (boolState[required_OF_f_A47] && boolState[relevant_evt_OF_f_A47]))
	{
		//cout << "100 : xx10_OF_f_A47 : FAULT failF  LABEL \"failure in operation f_A47\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A47]  =  TRUE" << endl;
		list.push_back(make_tuple(100, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A47] == true)
	{
		//cout << "101 : xx11_OF_f_A47 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A47]  =  FALSE" << endl;
		list.push_back(make_tuple(101, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A48] == false) && (boolState[required_OF_f_A48] && boolState[relevant_evt_OF_f_A48]))
	{
		//cout << "102 : xx10_OF_f_A48 : FAULT failF  LABEL \"failure in operation f_A48\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A48]  =  TRUE" << endl;
		list.push_back(make_tuple(102, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A48] == true)
	{
		//cout << "103 : xx11_OF_f_A48 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A48]  =  FALSE" << endl;
		list.push_back(make_tuple(103, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A49] == false) && (boolState[required_OF_f_A49] && boolState[relevant_evt_OF_f_A49]))
	{
		//cout << "104 : xx10_OF_f_A49 : FAULT failF  LABEL \"failure in operation f_A49\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A49]  =  TRUE" << endl;
		list.push_back(make_tuple(104, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A49] == true)
	{
		//cout << "105 : xx11_OF_f_A49 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A49]  =  FALSE" << endl;
		list.push_back(make_tuple(105, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A51] == false) && (boolState[required_OF_f_A51] && boolState[relevant_evt_OF_f_A51]))
	{
		//cout << "106 : xx10_OF_f_A51 : FAULT failF  LABEL \"failure in operation f_A51\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A51]  =  TRUE" << endl;
		list.push_back(make_tuple(106, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A51] == true)
	{
		//cout << "107 : xx11_OF_f_A51 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A51]  =  FALSE" << endl;
		list.push_back(make_tuple(107, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A52] == false) && (boolState[required_OF_f_A52] && boolState[relevant_evt_OF_f_A52]))
	{
		//cout << "108 : xx10_OF_f_A52 : FAULT failF  LABEL \"failure in operation f_A52\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A52]  =  TRUE" << endl;
		list.push_back(make_tuple(108, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A52] == true)
	{
		//cout << "109 : xx11_OF_f_A52 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A52]  =  FALSE" << endl;
		list.push_back(make_tuple(109, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A54] == false) && (boolState[required_OF_f_A54] && boolState[relevant_evt_OF_f_A54]))
	{
		//cout << "110 : xx10_OF_f_A54 : FAULT failF  LABEL \"failure in operation f_A54\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A54]  =  TRUE" << endl;
		list.push_back(make_tuple(110, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A54] == true)
	{
		//cout << "111 : xx11_OF_f_A54 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A54]  =  FALSE" << endl;
		list.push_back(make_tuple(111, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A55] == false) && (boolState[required_OF_f_A55] && boolState[relevant_evt_OF_f_A55]))
	{
		//cout << "112 : xx10_OF_f_A55 : FAULT failF  LABEL \"failure in operation f_A55\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A55]  =  TRUE" << endl;
		list.push_back(make_tuple(112, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A55] == true)
	{
		//cout << "113 : xx11_OF_f_A55 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A55]  =  FALSE" << endl;
		list.push_back(make_tuple(113, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A57] == false) && (boolState[required_OF_f_A57] && boolState[relevant_evt_OF_f_A57]))
	{
		//cout << "114 : xx10_OF_f_A57 : FAULT failF  LABEL \"failure in operation f_A57\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A57]  =  TRUE" << endl;
		list.push_back(make_tuple(114, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A57] == true)
	{
		//cout << "115 : xx11_OF_f_A57 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A57]  =  FALSE" << endl;
		list.push_back(make_tuple(115, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A58] == false) && (boolState[required_OF_f_A58] && boolState[relevant_evt_OF_f_A58]))
	{
		//cout << "116 : xx10_OF_f_A58 : FAULT failF  LABEL \"failure in operation f_A58\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A58]  =  TRUE" << endl;
		list.push_back(make_tuple(116, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A58] == true)
	{
		//cout << "117 : xx11_OF_f_A58 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A58]  =  FALSE" << endl;
		list.push_back(make_tuple(117, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A59] == false) && (boolState[required_OF_f_A59] && boolState[relevant_evt_OF_f_A59]))
	{
		//cout << "118 : xx10_OF_f_A59 : FAULT failF  LABEL \"failure in operation f_A59\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A59]  =  TRUE" << endl;
		list.push_back(make_tuple(118, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A59] == true)
	{
		//cout << "119 : xx11_OF_f_A59 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A59]  =  FALSE" << endl;
		list.push_back(make_tuple(119, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A60] == false) && (boolState[required_OF_f_A60] && boolState[relevant_evt_OF_f_A60]))
	{
		//cout << "120 : xx10_OF_f_A60 : FAULT failF  LABEL \"failure in operation f_A60\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A60]  =  TRUE" << endl;
		list.push_back(make_tuple(120, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A60] == true)
	{
		//cout << "121 : xx11_OF_f_A60 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A60]  =  FALSE" << endl;
		list.push_back(make_tuple(121, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A61] == false) && (boolState[required_OF_f_A61] && boolState[relevant_evt_OF_f_A61]))
	{
		//cout << "122 : xx10_OF_f_A61 : FAULT failF  LABEL \"failure in operation f_A61\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A61]  =  TRUE" << endl;
		list.push_back(make_tuple(122, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A61] == true)
	{
		//cout << "123 : xx11_OF_f_A61 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A61]  =  FALSE" << endl;
		list.push_back(make_tuple(123, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A62] == false) && (boolState[required_OF_f_A62] && boolState[relevant_evt_OF_f_A62]))
	{
		//cout << "124 : xx10_OF_f_A62 : FAULT failF  LABEL \"failure in operation f_A62\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A62]  =  TRUE" << endl;
		list.push_back(make_tuple(124, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A62] == true)
	{
		//cout << "125 : xx11_OF_f_A62 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A62]  =  FALSE" << endl;
		list.push_back(make_tuple(125, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A63] == false) && (boolState[required_OF_f_A63] && boolState[relevant_evt_OF_f_A63]))
	{
		//cout << "126 : xx10_OF_f_A63 : FAULT failF  LABEL \"failure in operation f_A63\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A63]  =  TRUE" << endl;
		list.push_back(make_tuple(126, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A63] == true)
	{
		//cout << "127 : xx11_OF_f_A63 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A63]  =  FALSE" << endl;
		list.push_back(make_tuple(127, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A64] == false) && (boolState[required_OF_f_A64] && boolState[relevant_evt_OF_f_A64]))
	{
		//cout << "128 : xx10_OF_f_A64 : FAULT failF  LABEL \"failure in operation f_A64\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A64]  =  TRUE" << endl;
		list.push_back(make_tuple(128, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A64] == true)
	{
		//cout << "129 : xx11_OF_f_A64 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A64]  =  FALSE" << endl;
		list.push_back(make_tuple(129, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A65] == false) && (boolState[required_OF_f_A65] && boolState[relevant_evt_OF_f_A65]))
	{
		//cout << "130 : xx10_OF_f_A65 : FAULT failF  LABEL \"failure in operation f_A65\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A65]  =  TRUE" << endl;
		list.push_back(make_tuple(130, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A65] == true)
	{
		//cout << "131 : xx11_OF_f_A65 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A65]  =  FALSE" << endl;
		list.push_back(make_tuple(131, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_f_A66] == false) && (boolState[required_OF_f_A66] && boolState[relevant_evt_OF_f_A66]))
	{
		//cout << "132 : xx10_OF_f_A66 : FAULT failF  LABEL \"failure in operation f_A66\"  DIST EXP (0)  INDUCING boolState[failF_OF_f_A66]  =  TRUE" << endl;
		list.push_back(make_tuple(132, 0, "EXP", 0));
	}
	if (boolState[failF_OF_f_A66] == true)
	{
		//cout << "133 : xx11_OF_f_A66 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_f_A66]  =  FALSE" << endl;
	...
	if (boolState[failI_OF_i_A44] == true)
	{
		//cout << "139 : xx24_OF_i_A44 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A44]  =  FALSE" << endl;
		list.push_back(make_tuple(139, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_i_A45] == true)
	{
		//cout << "142 : xx24_OF_i_A45 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A45]  =  FALSE" << endl;
		list.push_back(make_tuple(142, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_i_A46] == true)
	{
		//cout << "145 : xx24_OF_i_A46 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A46]  =  FALSE" << endl;
		list.push_back(make_tuple(145, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_i_A47] == true)
	{
		//cout << "148 : xx24_OF_i_A47 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A47]  =  FALSE" << endl;
		list.push_back(make_tuple(148, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_i_A48] == true)
	{
		//cout << "151 : xx24_OF_i_A48 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A48]  =  FALSE" << endl;
		list.push_back(make_tuple(151, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_i_A49] == true)
	{
		//cout << "154 : xx24_OF_i_A49 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A49]  =  FALSE" << endl;
	...
	if (boolState[failI_OF_i_A57] == true)
	{
		//cout << "169 : xx24_OF_i_A57 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A57]  =  FALSE" << endl;
		list.push_back(make_tuple(169, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_i_A58] == true)
	{
		//cout << "172 : xx24_OF_i_A58 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A58]  =  FALSE" << endl;
		list.push_back(make_tuple(172, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_i_A59] == true)
	{
		//cout << "175 : xx24_OF_i_A59 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A59]  =  FALSE" << endl;
		list.push_back(make_tuple(175, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_i_A60] == true)
	{
		//cout << "178 : xx24_OF_i_A60 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_i_A60]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_A1] == true )
	{
...
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::runOnceInteractionStep_propagate_effect_S()
{
	...
	if ((((boolState[S_OF_A10] || boolState[S_OF_A129]) || boolState[S_OF_A46]) || boolState[S_OF_A61]) || boolState[S_OF_A85] )
	{
	...
	if (boolState[S_OF_A119] && boolState[S_OF_A121] )
	{
	...
	if (((boolState[S_OF_A120] || boolState[S_OF_A122]) || boolState[S_OF_A125]) || boolState[S_OF_A127] )
	{
		boolState[S_OF_A129]  =  true;
	}

	if ((((boolState[S_OF_A129] || boolState[S_OF_A13]) || boolState[S_OF_A45]) || boolState[S_OF_A54]) || boolState[S_OF_A85] )
	{
		boolState[S_OF_A14]  =  true;
	}

	if ((((boolState[S_OF_A129] || boolState[S_OF_A16]) || boolState[S_OF_A48]) || boolState[S_OF_A62]) || boolState[S_OF_A96] )
	{
	...
	if ((((boolState[S_OF_A129] || boolState[S_OF_A19]) || boolState[S_OF_A47]) || boolState[S_OF_A57]) || boolState[S_OF_A96] )
	{
		boolState[S_OF_A20]  =  true;
	}

	if (((boolState[S_OF_A118] || boolState[S_OF_A22]) || boolState[S_OF_A59]) || boolState[S_OF_A74] )
	{
		boolState[S_OF_A23]  =  true;
	}

	if (((((((boolState[S_OF_A118] || boolState[S_OF_A129]) || boolState[S_OF_A25]) || boolState[S_OF_A58]) || boolState[S_OF_A63]) || boolState[S_OF_A64]) || boolState[S_OF_A65]) || boolState[S_OF_A66] )
	{
	...
	if (boolState[S_OF_A118] || boolState[S_OF_A28] )
	{
	...
	if ((((boolState[S_OF_A107] || boolState[S_OF_A129]) || boolState[S_OF_A4]) || boolState[S_OF_A44]) || boolState[S_OF_A60] )
	{
		boolState[S_OF_A5]  =  true;
	}

	if (boolState[S_OF_A129] || boolState[S_OF_A49] )
	{
	...
	if (boolState[S_OF_A129] || boolState[S_OF_A52] )
	{
	...
	if (boolState[S_OF_A129] || boolState[S_OF_A55] )
	{
	...
	if ((((boolState[S_OF_A107] || boolState[S_OF_A129]) || boolState[S_OF_A43]) || boolState[S_OF_A51]) || boolState[S_OF_A7] )
	{
...
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_A122] && ( !boolState[S_OF_A122])) || ( !boolState[S_OF_A119]) )
	{
...
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        //cout << endl;
    }void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_vgs_2_Trim_Article_repair::fireinsttransitiongroup(std::string user_input_ins)
