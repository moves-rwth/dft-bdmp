...
//            class FigaroStateGenerationInfo;
            ...
            private:
                // Status is bitvector which captures variables of all BDMP components
                storm::storage::BitVector mStatus;
                //We need a vector of bitvectors which keeps all equivalent states for a state
                //We start with single vector
                storm::storage::BitVector mSymmetricStatus;
...
//                         FigaroStateGenerationInfo const &stateGenerationInfo, size_t id);
                ...
                FigaroState(storm::storage::BitVector const &status, storm::storage::BitVector const &symmetricStatus,size_t id);
...
//                }
                ...
                storm::storage::BitVector const &symmetricstatus() const {
                    return mSymmetricStatus;
                }
