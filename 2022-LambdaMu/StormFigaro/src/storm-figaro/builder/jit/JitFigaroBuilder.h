...
namespace figaro {
    namespace builder {
        namespace jit {
            ...
            class JitFigaroBuilder {
            public:
                typedef std::shared_ptr<storm::figaro::FigaroProgram> (CreateFunctionType)();
//                boost::function<CreateFunctionType> ImportCreateFunctionType;
                 boost::function<CreateFunctionType> creator;
                void delete_files();
                void getcreator(boost::function<CreateFunctionType>&);
                /*!
                 ...
                 * the model is built.
                 */
                JitFigaroBuilder(storm::jani::Model const& model, storm::builder::BuilderOptions const& options = storm::builder::BuilderOptions());

                JitFigaroBuilder(std::string figaromodel, std::string figaroanalysis, storm::builder::BuilderOptions const& options = storm::builder::BuilderOptions());

                /*!
                 * Builds and returns the sparse model.
                 */
                std::shared_ptr<storm::figaro::FigaroProgram> build();
            ...
            private:
                 ...
                 * binary file.
                 */
                boost::filesystem::path compileToSharedLibrary(boost::filesystem::path const &sourceHppFile, boost::filesystem::path const &sourceCppFile);
                ...
                std::shared_ptr<storm::figaro::FigaroProgram> createFigaroModel(boost::filesystem::path const& dynamicLibraryPath);
...
//                typename JitFigaroBuilder<ValueType, RewardModelType>::ImportCreateFunctionType jitBuilderCreateFunction;

                /// The pointer to the builder object created via the shared library.
                std::shared_ptr<storm::figaro::FigaroProgram>  builder;
                std::string figaroSourceFileName;
                std::string figaroSourceFilePath;
                std::string figaroAnalysisFileName;
                ...
                /// The include directory of Fig2cpp.
                std::string fig2cppIncludeDirectory;
