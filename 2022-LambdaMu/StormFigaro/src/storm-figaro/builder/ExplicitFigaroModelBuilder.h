...
#include "storm-figaro/storage/FigaroBucketPriorityQueue.h"
...
namespace storm{
    namespace figaro{
        namespace builder{
            /*!
            *  Build a Markov chain from Figaro Program.
            */
            ...
            class ExplicitFigaroModelBuilder {
                ...
                using ExplorationHeuristic = storm::figaro::builder::FigaroExplorationHeuristic<ValueType>;
//                typedef storm::storage::BitVector CompressedState;
            ...
            public:
                ...
                ExplicitFigaroModelBuilder(std::shared_ptr<storm::figaro::FigaroProgram> figaroporgram, std::shared_ptr<storm::figaro::storage::FigaroIndependentSymmetries> symmetries, bool topnonrep);

                ExplicitFigaroModelBuilder(std::shared_ptr<storm::figaro::FigaroProgram> figaroporgram,  bool topnonrep);
                /*!
                 * Build model from Figaro.
                 *
                 * @param iteration Current number of iteration.
                 * @stateMap to track  transition labels for simulation heuristic
                 ...
                 */
                void buildModel(size_t iteration,storm::figaro::storage::StatesMap<ValueType, StateType>&, double approximationThreshold = 0.0, storm::builder::ApproximationHeuristic approximationHeuristic = storm::builder::ApproximationHeuristic::DEPTH);
                 ...
                 */
                 ...
                 std::shared_ptr<storm::models::sparse::Model<ValueType>> buildModelNoApproximation();
            ...
            private:
                ...
                void exploreStateSpace(double approximationThreshold,storm::figaro::storage::StatesMap<ValueType,StateType>&);

                /*!
                 * Initialize the matrix for a refinement iteration.
                 */
                void initializeNextIteration(storm::figaro::storage::StatesMap<ValueType, StateType>&);
                ...
                // Dft
                std::shared_ptr<storm::figaro::FigaroProgram> figaroprogram;
                //  to see if the top is non repairable
                bool isTopNonRepairableSet;
                std::set<size_t> relevanceValues = {1};


                // General information for state generation

                std::shared_ptr<storm::generator::VariableInformation> variable_info;
                // Expression Manager
                ...
                std::shared_ptr<storm::figaro::generator::FigaroNextStateGenerator<ValueType, uint32_t>> generator;
                ...
                storm::figaro::storage::FigaroBucketPriorityQueue<ExplorationHeuristic> explorationQueue;
