...
//            if ((boolState[failF_OF_F_1] == false) && boolState[required_OF_F_1])
//            {
//                //cout << "0 : xx10_OF_F_1 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.1)  INDUCING boolState[failF_OF_F_1]  =  TRUE" << endl;
//                list.push_back(make_tuple(0, 0.1, "EXP", 0));
//            }
//            if (boolState[failF_OF_F_1] == true)
//            {
//                //cout << "1 : xx11_OF_F_1 : REPAIR rep  DIST EXP (0.0001)  INDUCING boolState[failF_OF_F_1]  =  FALSE" << endl;
//                list.push_back(make_tuple(1, 0.0001, "EXP", 0));
//            }
//            if ((boolState[failF_OF_F_2] == false) && boolState[required_OF_F_2])
//            {
//                //cout << "2 : xx10_OF_F_2 : FAULT failF  LABEL \"défaillance en fonctionnement %OBJET\"  DIST EXP (0.1)  INDUCING boolState[failF_OF_F_2]  =  TRUE" << endl;
//                list.push_back(make_tuple(2, 0.1, "EXP", 0));
//            }
//            if (boolState[failF_OF_F_2] == true)
//            {
//                //cout << "3 : xx11_OF_F_2 : REPAIR rep  DIST EXP (0.0001)  INDUCING boolState[failF_OF_F_2]  =  FALSE" << endl;
...
//
//        void
//        storm::figaro::FigaroProgram3::runInteractions() {
//            int counter = 0;
//            int comparator = 1;
//            doReinitialisations();
...
//
//        }
//        int_fast64_t storm::figaro::FigaroProgram3::stateSize() const{
//            return numBoolState;
//        }
