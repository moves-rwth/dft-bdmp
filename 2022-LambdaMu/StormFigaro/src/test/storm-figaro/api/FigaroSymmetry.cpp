...
namespace {
    ...
    class FigaroSymmetryTest : public ::testing::Test {
    public:
        typedef typename TestType::ValueType ValueType;


        FigaroSymmetryTest() : config(TestType::createConfig()) {
        }

        FigaroSymmetryTest const &getConfig() const {
            return config;
        }
...
//            ApproxSimulationConfig
    ...
    TYPED_TEST_SUITE(FigaroSymmetryTest, TestingTypes,);

    TYPED_TEST(FigaroSymmetryTest, 03_CCF_Unr) {
