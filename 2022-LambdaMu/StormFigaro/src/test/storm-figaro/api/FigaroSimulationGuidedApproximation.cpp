...
namespace {
    ...
    class FigaroSimulationGuidedApproximationTest : public ::testing::Test {
    public:
        typedef typename TestType::ValueType ValueType;


        FigaroSimulationGuidedApproximationTest() : config(TestType::createConfig()) {
        }

        FigaroSimulationGuidedApproximationTest const &getConfig() const {
            return config;
        }
...
//            ApproxSimulationConfig
    ...
    TYPED_TEST_SUITE(FigaroSimulationGuidedApproximationTest, TestingTypes,);

    TYPED_TEST(FigaroSimulationGuidedApproximationTest, 03_CCF_Unr) {
